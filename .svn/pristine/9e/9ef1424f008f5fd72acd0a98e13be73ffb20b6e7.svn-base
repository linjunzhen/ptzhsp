...
<script type="text/javascript">
    ...
    function gbxzywUrl() {
        ...
        zTree.setting.async.url = "departmentController.do?treeAuth";
        zTree.setting.async.otherParam = {
            "Q_T.DEPART_NAME_LIKE" : cname,
        }
    ...
    function doChoose(){
		...
		$.post("flowTemplateController.do?checkFlow",{
			    "Q_T.STAGE_ID_EQ":STAGE_ID,
						...
						<div class="e-toolbar-overflow">
							<div style="color: #005588;">
								<img src="plug-in/easyui-1.4/themes/icons/script.png"
									style="position: relative; top: 7px; float: left;" />&nbsp;部门目录树
							</div>
						</div>
					</div>
				</div>
			</div>
<%--			部门名称：<input class="eve-input" style="width: 90px;" name="mlmc"--%>
