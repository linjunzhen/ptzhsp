...
<body class="bg-none" ondragstart="return false" oncontextmenu="return false" onselectstart="return false">
    ...
    <div class="scrollt-left">
			<ul class="scrollt-list" >
				<li >
					<a href="callController.do?toReadCardAppointMacW&roomNo=${roomNo}" >
						<img src="webpage/call/takeNo/images/toReadCardAppoint.png">
						<span style="font-size:22px;font-weight:bold;">预约取号</span>
					</a>
				</li>
				<li >
<!-- 					<a href="newCallController/toYctbBusinessItemChooseMacW.do?departId=${departId}&roomNo=${roomNo}&ifMaterPrint=${ifMaterPrint}&macType=${macType}" > -->
					<a href="callYctbController/toYctbBusinessItemChooseMacW.do?departId=${departId}&roomNo=${roomNo}&ifMaterPrint=${ifMaterPrint}&macType=${macType}&cleanItem=1" >
						<img src="webpage/call/takeNo/images/toDeptChoose.png">
						<span style="font-size:22px;font-weight:bold;">现场取号</span>
					</a>
				</li>
				<li >
					<a href="callController.do?toReadCardAgainMacW&roomNo=${roomNo}" >
						<img src="webpage/call/takeNo/images/toReadCardAppoint.png">
