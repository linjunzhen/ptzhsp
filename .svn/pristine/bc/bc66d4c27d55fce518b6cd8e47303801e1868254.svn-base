...
<body style="margin:0px;background-color: #f7f7f7;">
		...
		<table style="width:100%;border-collapse:collapse;"
			...
			<tr>
				<td>
				<span style="width: 125px;float:left;text-align:right;">组件宽度：</span>
				<input type="text" style="width:150px;float:left;" class="eve-input" name="CONTROL_WIDTH" /> 
				</td>
				<td>
			...
			<tr>
				<td>
				<span style="width: 125px;float:left;text-align:right;">默认值：</span>
				<input
					type="text" style="width:150px;float:left;"
					 class="eve-input" name="DEFAULT_VALUE" /> 
				</td>
			</tr>
