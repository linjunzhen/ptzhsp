 ...
 */
public class PushDataToSJJXXZX implements Job {
    /**
     * log
     */
    private static Log log = LogFactory.getLog(PushDataToSJJXXZX.class);
    /**
     * 引入service
     */
    @Resource
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        pushDataToSJJXXZXService.sendDataToSJJXXZX();
    }
}
