...
<script type="text/javascript">
	...
	function toAddRuleChangeWindow(){
		var unitCode = $("#BusRuleChangeAddForm input[name='BUSSYS_UNITCODE']").val();
		var platCode = $("#BusRuleChangeAddForm input[name='BUSSYS_PLATCODE']").val();
		var busCode = $("#BusRuleChangeAddForm input[name='BUS_CODE']").val();
...
<body style="margin:0px;background-color: #f7f7f7;">
	<form id="BusRuleChangeAddForm" method="post"
		action="busRuleChangeController.do?toAddRule">
		<!--==========隐藏域部分开始 ===========-->
		<!--==========隐藏域部分结束 ===========-->
