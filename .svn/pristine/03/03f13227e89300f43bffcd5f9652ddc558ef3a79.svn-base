	 ...
	 $(function(){
		...
		if(EFLOW_FLOWOBJ){
    		...
    		if(eflowObj.busRecord){
    			FlowUtil.initFormFieldValue(eflowObj.busRecord,"T_BSFW_SHYDYX_FORM");
    		}
		}
		//初始化材料列表
	...
	<div class="eui-main">
        ...
        <div class="bsbox clearfix">
            ...
            <jsp:include page="./matterListZF.jsp" >
                ...
                <jsp:param value="T_BSFW_SHYDYX_FORM" name="formName"/>
            </jsp:include>
		...
		<jsp:include page="./submitdiv.jsp" >
		     <jsp:param value="AppUtil.submitWebSiteFlowForm('T_BSFW_SHYDYX_FORM');" name="submitFn"/>
		     <jsp:param value="AppUtil.tempSaveWebSiteFlowForm('T_BSFW_SHYDYX_FORM');" name="tempSaveFn"/>
		</jsp:include>
		<%--结束引入提交DIV界面 --%>
