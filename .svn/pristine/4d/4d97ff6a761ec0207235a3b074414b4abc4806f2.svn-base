...
<script type="text/javascript"
	src="webpage/wsbs/itemhis/js/itemInfo.js"></script>
</head>
...
<body class="eui-diabody" style="margin:0px;">
	...
	<div id="SysRoleGrantFormDiv" class="easyui-layout" fit="true">
		...
		<div data-options="region:'center',split:true,border:false" >
					...
					<div data-options="region:'center'">
						<form action="departServiceItemController.do?saveOrUpdate"
							...
							<table style="width:100%;border-collapse:collapse;"
								...
								<tr>
									<td colspan="1"  class="dddl-legend"><div class="eui-dddltit"><a>主要信息</a></div></td>
								</tr>
								<tr>
									<td><span
										style="width: 130px;float:left;text-align:right;">所属权责项目：</span>
										<input type="text" style="width:500px;float:left;"
										maxlength="62" class="eve-input validate[required]" readonly="readonly"
										value="${serviceItem.RIGHT_NAME}" name="RIGHT_NAME" /><font
								...
								<tr>
									<td><span
										...
										<input type="text" style="width:500px;float:left;"
										maxlength="62" class="eve-input" disabled="disabled"
								...
								<tr>
									<td><span
										style="width: 130px;float:left;text-align:right;">事项名称：</span>
										<input type="text" style="width:500px;float:left;"
										maxlength="62" class="eve-input validate[required]"
								...
								<tr>
									<td><span
										style="width: 130px;float:left;text-align:right;">本地事项编码：</span>
										<input type="text" style="width:150px;float:left;"
										maxlength="30"
										class="eve-input validate[required,custom[onlyLetterNumber]]"
										readonly="readonly" value="${serviceItem.ITEM_CODE}"
										name="ITEM_CODE" /><font
										class="dddl_platform_html_requiredFlag">*</font> <span
										style="width: 100px;text-align:right; margin-left:68px;">唯一码：</span>
										...
										class="dddl_platform_html_requiredFlag">*唯一码来着省网上办事大厅事项编码。友情链接：
											<a
								...
								<tr>
									<td><span
										style="width: 130px;float:left;text-align:right;">唯一码二次确认：</span>
										<input type="text" style="width:150px;margin-bottom:4px;"
										maxlength="100" class="eve-input validate[required]"
										value="${serviceItem.SWB_ITEM_CODE_ECQR}"
										name="SWB_ITEM_CODE_ECQR" /> <font
										class="dddl_platform_html_requiredFlag">* </font>
								...
								<tr>
									<td><span
										style="width: 130px;float:left;text-align:right;">事项性质：</span>
								...
								<tr id="gftype" style="display: none;">
									<td><span
										style="width: 130px;float:left;text-align:right;">公共服务类别：</span>
										<eve:excheckbox
								...
								<tr>
									<td><span
										style="width: 130px;float:left;text-align:right;">是否投资类项目：</span>
										<eve:radiogroup typecode="YesOrNo" width="250px"
											defaultvalue="0" value="${serviceItem.IS_INVEST}"
											fieldname="IS_INVEST">
										</eve:radiogroup> <font class="dddl_platform_html_requiredFlag">*</font></td>
								</tr>
								<tr>
									<td><span
										style="width: 130px;float:left;text-align:right;">办件类型：</span>
								...
								<tr>
									<td><span
										style="width: 130px;float:left;text-align:right;">是否开通预约：</span>
										<eve:radiogroup typecode="YesOrNo" width="130px"
											defaultvalue="1" value="${serviceItem.IS_APPOINT}"
								...
								<tr>
									<td><span
										...
										<eve:radiogroup typecode="YesOrNo" width="130px"
											defaultvalue="1" value="${serviceItem.IS_YCTB}"
											fieldname="IS_YCTB">
										</eve:radiogroup></td>
								</tr>
								<tr>
									<td><span
										style="width: 130px;float:left;text-align:right;">权利来源：</span>
										<eve:radiogroup onclick="qllyCheck(this)" typecode="qlly"
							...
							<table style="width:100%;border-collapse:collapse;"
								...
								<tr style="height:29px;">
									<td colspan="1" class="dddl-legend" style="font-weight:bold;">申报对象</td>
								</tr>
								<tr>
									<td><span
								...
								<tr id="pevent" style="display: none;">
									<td><span
										style="width: 130px;float:left;text-align:right;">个人人生事件：</span>
										<eve:excheckbox
											dataInterface="busTypeService.findDatasByClassForSelect"
											name="GRRSSJ" width="650px;"
											clazz="checkbox  validate[required]" dataParams="GRRSSJ"
											value="${serviceItem.GRRSSJ}">
										</eve:excheckbox></td>
								</tr>
								<tr id="pobject" style="display: none;">
									<td><span
										style="width: 130px;float:left;text-align:right;">个人特定人群：</span>
										<eve:excheckbox
											dataInterface="busTypeService.findDatasByClassForSelect"
											name="GRTDRQ" width="650px;"
											clazz="checkbox validate[required]" dataParams="GRTDRQ"
											value="${serviceItem.GRTDRQ}">
										</eve:excheckbox></td>
								</tr>
								...
								<tr id="lobject" style="display: none;">
									<td><span
										style="width: 130px;float:left;text-align:right;">法人对象分类：</span>
										<eve:excheckbox
											dataInterface="busTypeService.findDatasByClassForSelect"
											name="QYDXFL" width="650px;"
											clazz="checkbox validate[required]" dataParams="QYDXFL"
											value="${serviceItem.QYDXFL}">
										</eve:excheckbox></td>
								</tr>
								<tr id="levent" style="display: none;">
									<td><span
										style="width: 130px;float:left;text-align:right;">法人经营活动：</span>
										<eve:excheckbox
											dataInterface="busTypeService.findDatasByClassForSelect"
											name="QYJYHD" width="650px;"
											clazz="checkbox validate[required]" dataParams="QYJYHD"
											value="${serviceItem.QYJYHD}">
										</eve:excheckbox></td>
								</tr>
			...
			<div title="法定依据及申请条件" style="display: none;" id="StepDiv_2">
				<form action="departServiceItemController.do?saveOrUpdate"
					...
					<table style="width:100%;border-collapse:collapse;"
						...
						<tr>
							<td><span style="width: 100px;float:left;text-align:right;">法定依据：</span>
			...
			<div title="申请方式" style="display: none;" id="StepDiv_3">
				<form action="departServiceItemController.do?saveOrUpdate"
					id="StepForm_3">
					...
					<table style="width:100%;border-collapse:collapse;"
						...
						<tr>
							<td><span style="width: 150px;float:left;text-align:right;">入驻办事大厅方式<font
									class="dddl_platform_html_requiredFlag">*</font>：
							</span> <c:if
									test="${null==serviceItem||serviceItem.RZBSDTFS==null||serviceItem.RZBSDTFS==''}">
									<eve:radiogroup typecode="RZBSDTFS" width="150px" value="in04"
										fieldname="RZBSDTFS">
									</eve:radiogroup>
								</c:if> <c:if
									test="${null!=serviceItem&&serviceItem.RZBSDTFS!=null&&serviceItem.RZBSDTFS!=''}">
								...
								</c:if>   (备注：入驻方式更改为“指南式“或”链接式“需来函申请)</td>
						</tr>
						<tr id="APPLY_URL_TR">
							...
							</span> <input type="text" style="width:400px;float:left;"
								maxlength="254"
								<c:if test="${serviceItem.RZBSDTFS!='in02'}">class="eve-input"</c:if>
								<c:if test="${serviceItem.RZBSDTFS!='in02'}">class="eve-input"</c:if>
								value="${serviceItem.APPLY_URL}" id="APPLY_URL" name="APPLY_URL" />
								<font class="dddl_platform_html_requiredFlag">仅限互联网</font></td>
						</tr>
					</table>
					<p class="info">
			...
			<div title="时限配置" style="display: none;height: 450px;" id="StepDiv_4">
				<form action="departServiceItemController.do?saveOrUpdate"
					id="StepForm_4">
					<table style="width:100%;border-collapse:collapse;"
						class="dddl-contentBorder dddl_table">
						...
						<tr>
							<td><span style="width: 100px;float:left;text-align:right;">承诺时限：</span>
								...
								class="dddl_platform_html_requiredFlag">*(若即办件类型，承诺时限为0个工作日。)</font></td>
						</tr>
						<tr>
							<td><span style="width: 100px;float:left;text-align:right;">法定时限：</span>
								<input type="text" style="width:150px;float:left;" maxlength="3"
						...
						<tr>
							<td><span style="width: 100px;float:left;text-align:right;">承诺时限说明：</span>
								<textarea rows="3" cols="5"
									...
									style="width: 400px" name="CNQXSM">${serviceItem.CNQXSM}</textarea><font
								class="dddl_platform_html_requiredFlag">*(没有说明请填无，有特殊环节必须在下方“新增特殊环节”。)</font></td>
						</tr>
						<tr>
							<td><span style="width: 100px;float:left;text-align:right;">法定时限说明：</span>
								<textarea rows="3" cols="5"
									class="eve-textarea validate[required,maxSize[500]]"
									style="width: 400px" name="FDQX">${serviceItem.FDQX}</textarea><font
								class="dddl_platform_html_requiredFlag">*</font></td>
						</tr>
						<tr>
							<td><span style="width: 100px;float:left;text-align:right;">外网预审时限：</span>
								...
								readonly="readonly" value="2" name="PREDAY" />工作日</td>
						</tr>
				...
				<table class="easyui-datagrid" rownumbers="true" pagination="true" pageSize="5" pageList="[5,10,15]"
					id="tshjGrid" fitColumns="true" toolbar="#tshjToolbar" nowrap="false"
					method="post" idField="RECORD_ID" checkOnSelect="false" fit="true" striped="true"
					selectOnCheck="false" border="false"
					url="departServiceItemController.do?hisSpecialLinkData&itemId=${serviceItem.ITEM_ID}&version=${serviceItem.C_VERSION}">
					<thead>
						<tr>
							<th data-options="field:'RECORD_ID',hidden:true" width="80">RECORD_ID</th>
							<th data-options="field:'LINK_NAME',align:'left'" width="130">特殊环节名称</th>
							<th data-options="field:'LINK_LIMITTIME',align:'left'"
								width="90" formatter="dayformatter">特殊环节时限</th>
							<th data-options="field:'OPERATOR_NAME',align:'left'" width="80">经办人</th>
							<th data-options="field:'LINK_BASIS',align:'left'" width="200">特殊环节设定依据</th>
							<th data-options="field:'SUIT_SITUATION',align:'left'" width="200">适用情形</th>
							<th data-options="field:'REVIEW_CONTENT',align:'left'" width="200">（法定）审查内容</th>
							<th data-options="field:'REVIEW_STANDARD',align:'left'" width="200">审查标准</th>
							<th data-options="field:'RESPONSIBILITY',align:'left'" width="200">办理责任</th>
						</tr>
					</thead>
				</table>
				</div>
			...
			<div title="办公指引" style="display: none;" id="StepDiv_5">
				<form action="departServiceItemController.do?saveOrUpdate"
					...
					<table style="width:100%;border-collapse:collapse;"
						class="dddl-contentBorder dddl_table">
						<tr>
							<td colspan="2" class="dddl-legend"><div class="eui-dddltit"><a>办公指引</a></div></td>
						</tr>
						<tr>
							<td colspan="2"><span
								style="width: 100px;float:left;text-align:right;">办理窗口：</span> <input
								type="text" style="width:400px;float:left;" maxlength="62"
								class="eve-input validate[required]"
								value="${serviceItem.SSZTMC}" name="SSZTMC" /><font
								class="dddl_platform_html_requiredFlag">*
									备注：建议填写LED上窗口中文名称，不填写数字窗口号，以免反复调整。</font></td>
						</tr>
						<tr>
							<td colspan="2"><span
								style="width: 100px;float:left;text-align:right;">对外办公时间：</span>
								<textarea rows="3" cols="5"
									class="eve-textarea validate[required,maxSize[500]]"
						...
						<tr>
							<td colspan="2"><span
								style="width: 100px;float:left;text-align:right;">受理地址：</span> <textarea
									rows="3" cols="5"
						...
						<tr>
							<td colspan="2"><span
								style="width: 100px;float:left;text-align:right;">交通指引：</span> <textarea
									rows="3" cols="5"
						...
						<tr>
							<td colspan="2"><span
								style="width: 100px;float:left;text-align:right;">实施单位：</span> <input
								type="text" style="width:400px;float:left;" maxlength="200"
								class="eve-input validate[required]"
						...
						<tr>
							<td><span style="width: 100px;float:left;text-align:right;">主办处室：</span>
								...
								name="ZBCS" /> <font
								class="dddl_platform_html_requiredFlag">*</font></td>
							<td><span style="width: 100px;float:left;text-align:right;">会办处室：</span>
								<input type="text" style="width:400px;float:left;"
						...
						<tr>
							<td><span style="width: 100px;float:left;text-align:right;">实施主体性质：</span>
						...
						<tr>
							<td><span style="width: 100px;float:left;text-align:right;">联系人：</span>
								<input type="text" style="width:400px;float:left;"
								maxlength="200" class="eve-input validate[required]"
								value="${serviceItem.LXR}" name="LXR" /> <font
								class="dddl_platform_html_requiredFlag">*</font></td>
							<td><span style="width: 100px;float:left;text-align:right;">联办机构：</span>
								<input type="text" style="width:400px;float:left;"
								maxlength="62" class="eve-input" value="${serviceItem.LBJG}"
								name="LBJG" /></td>
						</tr>
						<tr>
							<td colspan="2"><span
								style="width: 100px;float:left;text-align:right;">联系电话：</span> <textarea
									rows="3" cols="5"
									class="eve-textarea validate[required,maxSize[120]]"
						...
						<tr>
							<td colspan="2"><span
								style="width: 100px;float:left;text-align:right;">监督投诉：</span> <textarea
									rows="3" cols="5"
									class="eve-textarea validate[required,maxSize[120]]"
						...
						<tr>
							<td><span style="width: 100px;float:left;text-align:right;">监督部门：</span>
								<input type="text" style="width:400px;float:left;"
								maxlength="62" class="eve-input" value="${serviceItem.JDBM}"
								name="JDBM" /></td>
							<td><span style="width: 100px;float:left;text-align:right;">入驻方式：</span>
								<eve:eveselect clazz="eve-input validate[]"
									defaultEmptyText="请选择入驻方式" dataParams="RZFS"
									value="${serviceItem.RZFS}"
									dataInterface="dictionaryService.findDatasForSelect"
									name="RZFS">
								</eve:eveselect></td>
						</tr>
						<tr>
							<td colspan="2"><span
								style="width: 100px;float:left;text-align:right;">窗口描述：</span> <textarea
									rows="3" cols="5"
						...
						<tr>
							<td colspan="2"><span
								style="width: 100px;float:left;text-align:right;">备注信息：</span> <textarea
									rows="3" cols="5"
									class="eve-textarea validate[[],maxSize[126]]"
						...
						<tr>
							<td colspan="2"><span
								style="width: 100px;float:left;text-align:right;">地图坐标：</span> <input
			...
			<div title="申请材料" style="display: none;height: 450px;" id="StepDiv_6">
				...
				<div style="height:440px;">
					<table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
						...
						url="departServiceItemController.do?hisforItemDatas&start=0&limit=100&itemId=${serviceItem.ITEM_ID}&version=${serviceItem.C_VERSION}">
						<thead>
							<tr>
								...
								<th data-options="field:'MATER_CODE',align:'left'" width="160">材料编码</th>
								<th data-options="field:'MATER_NAME',align:'left'" width="250">材料名称</th>
								<th data-options="field:'BUSCLASS_NAME',align:'left'"
									width="150" formatter="formatBusclassName">事项子项</th>
								<th data-options="field:'MATER_ISNEED',align:'left'" width="80"
									formatter="formatIsNeed">是否必须提供</th>
								<th data-options="field:'MATER_DESC',align:'left'" width="150">材料说明</th>
								<th data-options="field:'MATER_CLSMLX',align:'left'" width="100">材料类型</th>
								<th data-options="field:'MATER_XZ',align:'left'" width="80"
									formatter="formatclfl">材料分类</th>
								<th data-options="field:'MATER_SOURCE',align:'left'" width="120"
									formatter="formatMaterSource">材料来源/出具单位</th>
								<th data-options="field:'PAGE_NUM',align:'left'" width="60">原件份数</th>
								<th data-options="field:'PAGECOPY_NUM',align:'left'" width="80">复印件份数</th>
							</tr>
						</thead>
					</table>
				</div>
			</div>
			<div title="快递服务" style="display: none;height: 436px;" id="StepDiv_7">
				<form action="departServiceItemController.do?saveOrUpdate"
					id="StepForm_7">
					<table style="width:100%;border-collapse:collapse;"
						class="dddl-contentBorder dddl_table">
						...
						<tr>
							<td><span style="width: 130px;float:left;text-align:right;">纸质材料提交方式：</span>
						...
						<tr id="addressee" style="display: none;">
							<td><span style="width: 130px;float:left;text-align:right;"><font
								...
								class="eve-input validate[required]" maxlength="16"
								value="${serviceItem.ITEM_SEND_ADDRESSEE}"
								name="ITEM_SEND_ADDRESSEE" /></td>
						</tr>
						<tr id="expressname" style="display: none;">
							<td><span style="width: 130px;float:left;text-align:right;"> 姓名：</span>
								<input type="text"
								style="width:200px;float:left;"
								class="eve-input" maxlength="16"
								value="${serviceItem.EXPRESS_NAME}"
								name="EXPRESS_NAME" /></td>
						</tr>
						<tr id="addrmobile" style="display: none;">
							<td><span style="width: 130px;float:left;text-align:right;"> 移动电话：</span> 
								<input type="text"
								style="width:200px;float:left;"
								class="eve-input validate[[],custom[mobilePhoneLoose]]"
								maxlength="11" value="${serviceItem.ITEM_SEND_MOBILE}"
								name="ITEM_SEND_MOBILE" /></td>
						</tr>
						<tr id="officephone" style="display: none;">
							<td><span style="width: 130px;float:left;text-align:right;"><font
								class="dddl_platform_html_requiredFlag">*</font> 办公电话：</span> 
								<input type="text"
								style="width:200px;float:left;"
								class="eve-input validate[[required],custom[fixPhoneWithAreaCode]]"
								maxlength="11" value="${serviceItem.OFFICE_PHONE}"
						...
						<tr id="addrprov" style="display: none;">
							<td><span style="width: 130px;float:left;text-align:right;"><font
								...
								<input name="ITEM_SEND_COUNTY" id="county" class="easyui-combobox" style="width:120px; height:26px;" 
									data-options="
				                ...
				                " value="${serviceItem.ITEM_SEND_COUNTY}" />	      
							</td>
							<td />
						</tr>
						<tr id="addrpostcode" style="display: none;">
							<td><span style="width: 130px;float:left;text-align:right;"><font
									class="tab_color">*</font>邮政编码：</span> <input type="text"
								style="width:200px;float:left;"
						...
						<tr id="addr" style="display: none;">
							<td><span style="width: 130px;float:left;text-align:right;"><font
								...
								class="eve-input  validate[required]" maxlength="50"
			...
			<div title="收费配置" style="display: none;height: 450px;" id="StepDiv_8">
				<form action="departServiceItemController.do?saveOrUpdate"
					id="StepForm_8">
					<table style="width:100%;border-collapse:collapse;"
						class="dddl-contentBorder dddl_table">
						...
						<tr>
							<td><span style="width: 120px;float:left;text-align:right;">是否收费：</span>
								<eve:radiogroup typecode="YesOrNo" width="130px" defaultvalue="0"
									value="${serviceItem.SFSF}" fieldname="SFSF">
								</eve:radiogroup> <font class="dddl_platform_html_requiredFlag">*</font></td>
						</tr>
						<tr id="SFFS_TR"
						...
						<tr id="SFBZJYJ_TR"
							...
							<td><span style="width: 120px;float:left;text-align:right;">收费标准及依据：</span>
								<textarea style="width: 400px;height: 100px;"
									class="eve-textarea validate[required]" name="SFBZJYJ">${serviceItem.SFBZJYJ}</textarea>
								<font class="dddl_platform_html_requiredFlag">*</font>
							</td>
						</tr>
						<tr id="SFZFQD_TR"
				...
				<div style="height:210px;" id="sfmxtable">
				<table class="easyui-datagrid" rownumbers="true" pagination="true" pageSize="5" pageList="[5,10,15]"
					id="sfmxGrid" fitColumns="true" toolbar="#sfmxToolbar"
					method="post" idField="RECORD_ID" checkOnSelect="true" fit="true" striped="true"
					selectOnCheck="false" border="false"
					url="departServiceItemController.do?hisChargeData&start=0&limit=100&itemId=${serviceItem.ITEM_ID}&version=${serviceItem.C_VERSION}">
					<thead>
						<tr>
							<th field="ck" checkbox="true"></th>
							<th data-options="field:'RECORD_ID',hidden:true" width="80">RECORD_ID</th>
							<th data-options="field:'CHARGE_DETAIL',align:'left'" width="500">收费明细</th>
							<th data-options="field:'CHARGE_AMOUNT',align:'left'" width="250"
								formatter="amountformatter">收费金额</th>
						</tr>
					</thead>
				</table>
				</div>
			...
			<div title="预审人员" style="display: none;" id="StepDiv_9">
			...
			<div title="办理结果" style="display: none;" id="StepDiv_10">
				<form action="departServiceItemController.do?saveOrUpdate"
					id="StepForm_10">
					<input type="hidden" name="RESULT_PATH"
						value="${serviceItem.RESULT_PATH}">
					<table style="width:100%;border-collapse:collapse;"
						class="dddl-contentBorder dddl_table">
						<tr>
						...
						<tr>
							<td><span style="width: 120px;float:left;text-align:right;"><font
									class="dddl_platform_html_requiredFlag">*</font>办理结果：</span> <eve:excheckbox
									dataInterface="dictionaryService.findDatasForSelect"
						...
						<tr>
							<td><span style="width: 120px;float:left;text-align:right;"><font
									class="dddl_platform_html_requiredFlag">*</font>获取方式：</span> <eve:excheckbox
									dataInterface="dictionaryService.findDatasForSelect"
						...
						<tr>
							<td><span style="width: 120px;float:left;text-align:right;">结果获取说明：</span>
								<textarea rows="5" cols="5"
									class="eve-textarea validate[maxSize[250]]"
									style="width: 550px" name="FINISH_INFO">${serviceItem.FINISH_INFO}</textarea>

								<p style="margin-left: 120px;">填写是否可以代领，需要提供什么证明材料,如要邮递材料还应说明邮递地址、邮递接收人、收费方式、接收人电话、是否有指定的快递等说明;
								</p></td>
						</tr>
						<tr>
							<td><span style="width: 120px;float:left;text-align:right;"><font
									class="dddl_platform_html_requiredFlag">*</font>审批结果名称：</span>
								<input type="text" style="width:400px;float:left;"
								maxlength="64" class="eve-input validate[required]"
								value="${serviceItem.RESULT_NAME}" name="RESULT_NAME" /></td>
						</tr>
						<tr>
							<td><span style="width: 170px;float:left;text-align:right;"><font
									class="dddl_platform_html_requiredFlag">*</font>审批结果样本(仅限图片)：</span>
								<a id="RESULT_PATH_BTN"></a>
								<div id="RESULT_PATH_DIV"></div></td>
						</tr>
						<tr>
							<td><span style="width: 120px;float:left;text-align:right;">审批结果说明：</span>
								<input type="text" style="width:400px;float:left;"
			...
			<div title="自查条件" style="display: none;height: 450px;" id="StepDiv_11">
				<div class="easyui-layout" fit="true" id="layout_11">
					...
					<div data-options="region:'center',split:false">
						...
						<table class="easyui-datagrid" rownumbers="true" pagination="true"
							...
							url="departServiceItemController.do?hisSelfExamData&itemId=${serviceItem.ITEM_ID}&version=${serviceItem.C_VERSION}">
							<thead>
								<tr>
									<th field="ck" checkbox="true"></th>
			...
			<div title="常见问题" style="display: none;height: 450px;"
				id="StepDiv_12">
				...
				<table class="easyui-datagrid" rownumbers="true" pagination="true"
					...
					border="false"
					url="commonProblemController.do?hisDatagrid&&itemId=${serviceItem.ITEM_ID}&version=${serviceItem.C_VERSION}">
					<thead>
						<tr>
							<th field="ck" checkbox="true"></th>
			...
			<div title="流程配置" style="display: none;height:450px;" id="StepDiv_13" >
				...
				<table class="easyui-datagrid" rownumbers="true" pagination="false" nowrap="false"
					...
					url="departServiceItemController.do?hisDefNodeData&itemId=${serviceItem.ITEM_ID}&version=${serviceItem.C_VERSION}">
					<thead>
						<tr>
							<th field="ck" checkbox="true"></th>
							<th data-options="field:'RECORD_ID',hidden:true" width="80">RECORD_ID</th>
							<th data-options="field:'ITEM_ID',hidden:true" width="80">ITEM_ID</th>
							<th data-options="field:'DEF_ID',hidden:true" width="80">DEF_ID</th>
							<th data-options="field:'NODE_NAME',align:'left'" width="80">当前环节</th>
							<th data-options="field:'USER_ACCOUNT',hidden:true" width="80">USER_ACCOUNT</th>
							<th data-options="field:'USER_NAME',align:'left'" width="100">办理人员</th>
							<th data-options="field:'TIME_LIMIT',align:'left'"
								formatter="blsxformater" width="100">审查时限</th>
							<th data-options="field:'TIME_TYPE',hidden:true" width="80">TIME_TYPE</th>
							<th data-options="field:'REVIEW_CONTENT',align:'left'" width="200">法定审查内容</th>
							<th data-options="field:'REVIEW_STANDARD',align:'left'" width="200">审查标准</th>
<!-- 							<th data-options="field:'EXAMINANT',align:'left'" width="200">审查程序及审查人</th> -->
							<th data-options="field:'HANDLE_OPINIONS',align:'left'" width="200">审查意见（结果）</th>
							<th data-options="field:'RESPONSIBILITY',align:'left'" width="200">审查责任</th>
						</tr>
					</thead>
				</table>
				</div>
			...
			<div title="其他配置" style="display: none;" id="StepDiv_14">
				<form action="departServiceItemController.do?saveOrUpdate"
					id="StepForm_14">
					<table style="width:100%;border-collapse:collapse;"
						class="dddl-contentBorder dddl_table">
						...
						<tr>
							<td><span style="width: 180px;float:left;text-align:right;">行使层级：</span>
								<eve:radiogroup
									typecode="xzcj" width="130px" value="${serviceItem.EXERCISE_LEVEL}"
						...
						<tr>
							<td><span style="width: 180px;float:left;text-align:right;">事项备注：</span>
								...
								<textarea style="width: 400px;height: 100px;"
									class="eve-textarea" name="ITEM_REMARK">${serviceItem.ITEM_REMARK}</textarea>
							</td>
						</tr>
					</table>
				</form>
			</div>
			<div title="操作日志" style="display: none;" id="StepDiv_15">
