                    ...
                    <link rel="stylesheet" type="text/css" href="<%=basePath%>/webpage/bsdt/ptwgform/scan/css/style.css">
                        <script type="text/javascript">
                            ...
                            function UploadFile() {
                                ...
                                $.post("callController.do?videoInputTakeNo", {
                                    ...
                                    function(responseText1, status, xhr) {
                                        ...
                                        parent.$("#QueuingUndoGrid").datagrid("reload");
                                        AppUtil.closeLayer();
                                    });
                            }
                            function getTiff() {
...
<body onload="opendevice()" onload="release()">
    ...
    <div class="gpy">
                ...
                <table style="width:100%;border-collapse:collapse;" class="dddl-contentBorder dddl_table">
                    ...
                    <tr>
                        <td><span style="width: 100px;float:left;text-align:right;">手机号码：</span> <input type="text" style="width:150px;float:left;" maxlength="18" id="phoneNo"
                            class="eve-input validate[required]" name="phoneNo" /> <font class="dddl_platform_html_requiredFlag">*</font></td>
                        <td></td>
                        <%--					<td><span--%>
        ...
        <div class="gpy-sub">
            ...
            <a class="submit" onclick="readCard()"><span><i></i>读 卡</span></a> <a class="submit" onclick="if(confirm( '请确认是否已拍取取号人照片及身份证人像面照片!')==false)return   false; UploadFileToHttp()"><span><i></i>确
                    认</span></a> <a class="cancel" onclick="AppUtil.closeLayer();"><span><i></i>取 消</span></a>
        </div>
    </div>
