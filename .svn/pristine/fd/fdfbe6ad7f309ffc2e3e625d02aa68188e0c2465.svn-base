				...
				AppUtil.ajaxProgress({
					...
					callback : function(resultJson) {
						if(resultJson.success){
							...
							parent.$("#logConfigGrid").datagrid("reload");
							AppUtil.closeLayer();
						}else{
							parent.art.dialog({
								content: resultJson.msg,
...
<body class="eui-diabody" style="margin:0px;">
	<form id="ColumnInfoForm" method="post" action="logConfigController.do?saveOrUpdateColumn">
		...
		<table style="width:100%;border-collapse:collapse;"
			...
			<tr>
				<td>
				<span style="width: 100px;float:left;text-align:right;">是否字典数据：</span>
					<eve:radiogroup typecode="YesOrNo" width="130px"  defaultvalue="0"
							value="${columnInfo.IS_DIC}" fieldname="IS_DIC">
					</eve:radiogroup>
				</td>
				<td >
				...
				<input
					type="text" style="width:150px;float:left;" 
					value="${columnInfo.TYPE_CODE}" maxlength="32"
					class="eve-input" name="TYPE_CODE" /> 
				</td>
			</tr>
			
			<tr>
				<td>
				<span style="width: 100px;float:left;text-align:right;">是否主键ID：</span>
					<eve:radiogroup typecode="YesOrNo" width="130px"  defaultvalue="0"
							value="${columnInfo.IS_PRIMARYKEY}" fieldname="IS_PRIMARYKEY">
					</eve:radiogroup>
				</td>
				<td >
				<span style="width:100px;float:left;text-align:right;">主键ID关联表：</span>
				
				<input
					type="text" style="width:150px;float:left;" 
					value="${columnInfo.RELATE_TABLE}" maxlength="32"
					class="eve-input" name="RELATE_TABLE" /> 
				</td>
			</tr>
			
			<tr>
				<td colspan="2">
				<span style="width:100px;float:left;text-align:right;">查询列名称：</span>
				
				<input
					type="text" style="width:150px;float:left;" 
					value="${columnInfo.RELATE_COLUMN}" maxlength="32"
					class="eve-input" name="RELATE_COLUMN" /> 
				</td>
			</tr>
