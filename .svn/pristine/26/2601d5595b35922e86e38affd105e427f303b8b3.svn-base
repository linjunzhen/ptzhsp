...
<title>平潭综合实验区行政服务中心-网上办事大厅</title>
	...
	<script src="<%=path%>/webpage/website/applyforms/gcjsxm/gcjssgskfqzbl/js/gcjssgskfqzbl.js"></script>
	<!-- my97 begin -->
        ...
        <div class="syj-sbmain2 tmargin20"  id="jbxx">
            ...
            <div class="syj-tyys tmargin20" style="z-index: 99;" id="formcontainer">
                ...
                <div class="bd margin20">
					<div>						
						<%--开始引入企业基本信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/gcjsxm/gcjssgskfqzbl/info.jsp" />
						<%--结束引入企业基本信息界面 --%>
					</div>
                	<div>
                    	<%--开始引入责任主体信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/gcjsxm/gcjssgskfqzbl/zrztxx.jsp" />
						<%--结束引入责任主体信息界面 --%>
                    </div>
					<div>
						<%--开始引入前台用户上传界面 --%>						
						<jsp:include page="/webpage/website/applyforms/gcjsxm/gcjssgskfqzbl/applyMaterList.jsp" >
                    ...
                    <div>								
                    	<%--开始引入经办人信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/gcjsxm/gcjssgskfqzbl/userinfo.jsp" />
						<%--结束引入经办人信息界面 --%>
					</div>
                </div>
            </div>
