...
import net.evecom.platform.hflow.service.impl.FlowEventServiceImpl;
 ...
 */
public class ExRadioGroup extends TagSupport {
    /**
     * logger
     */
    private static Log logger = LogFactory.getLog(ExRadioGroup.class);
    /**
     * 单选框命名
     */
    private String name;
