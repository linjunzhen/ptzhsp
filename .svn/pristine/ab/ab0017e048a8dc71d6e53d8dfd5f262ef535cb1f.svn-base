...
<script type="text/javascript">
    ...
    function setUploadHidden(attachKey) {
        ...
        $("#" + attachKey + "__LICENSE1").attr("style", "display: none;");
        $("#" + attachKey + "__HISMAT").attr("style", "display: none;");
...
<table cellpadding="0" cellspacing="1" class="tab_tk_pro1" id="materCheckList">
    <!-- <tr>
