	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 ">
		...
		<tr>
			...
			<td>
				...
				dataInterface="dictionaryService.findDatasForSelect"  onchange="setGdlxValidate(this.value,'${s.index}LEGAL_PERSON');setGdlxValidate(this.value,'${s.index}LEGAL_IDNO_PERSON');"
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 " style="margin-top: -1px;">
		...
		<tr>
			...
			<td colspan="3"><input type="text" class="syj-input1 w878 validate[required]"
				name="${currentTime}ID_ADDRESS" placeholder="请输入身份证件地址，请按身份证上的地址申报" maxlength="64" value="${holder.ID_ADDRESS}"/></td>
		</tr>
		<tr>
			...
			<td>
				<eve:eveselect clazz="input-dropdown w280 validate[required]" dataParams="ssdjgb"
							   ...
							   name="${currentTime}SHAREHOLDER_COMPANYCOUNTRY" value="${holder.SHAREHOLDER_COMPANYCOUNTRY}">
				</eve:eveselect>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text"  class="syj-input1 validate[required,custom[JustNumber]]"  onblur="onlyNumber(this);isEqualToSjcze(this.value)" onkeyup="onlyNumber(this);"
