									...
									<thead>
										<tr>
											...
											<th data-options="field:'NUM',align:'center',editor:{type:'numberbox',options:{required:true,min:0}}"
												width="5%">数量</th>
											<th data-options="field:'BUS_NUM',align:'center',editor:{type:'numberbox',options:{required:true,min:0}}"
												width="10%">座位数（个）</th>
											<th data-options="field:'BUS_TYPELEVEL',align:'center',editor:{type:'validatebox',options:{required:true}}"
												width="15%">车辆类型及等级</th>
											<th data-options="field:'BUS_LEVEL',align:'center',editor:{type:'validatebox',options:{required:true}}"
												width="15%">车辆技术等级</th>
											<th data-options="field:'BUS_WEIGHT',align:'center',editor:{type:'validatebox',options:{required:true}}"
												width="15%">车辆外廓长宽高</th>
											<th data-options="field:'GET_TIME',align:'center',editor:{type:'datebox',options:{required:true,editable:false}}"
												width="10%">购置时间</th>
											<th data-options="field:'REMARK',align:'center',editor:{type:'validatebox',options:{}}"
												width="19%">备注</th>
										</tr>
									</thead>
								</table>
						...
						<div id="purchasePlanDiv">
							<div style="position:relative;">
								...
								<table class="easyui-datagrid" toolbar="#inpurchaseBusToolbar" id="inpurchaseBusGrid" rownumbers="true" border="true" fitColumns="true"
									data-options="singleSelect:true,autoSave:true,url:'',method:'post',onClickRow: onClickRowInpurchaseBus" nowrap="false">
									<thead>
										<tr>
											<th data-options="field:'BRAND_MODEL',align:'center',editor:{type:'validatebox',options:{required:true}}"
												width="15%">厂牌型号</th>
						...
						<div id="currentDiv">
							<div style="position:relative;">
								...
								<table class="easyui-datagrid" toolbar="#operatingBusToolbar" id="operatingBusGrid" rownumbers="true" border="true" fitColumns="true"
									data-options="singleSelect:true,autoSave:true,url:'',method:'post',onClickRow: onClickRowOperatingBus" nowrap="false">
									<thead>
										<tr>
											...
											<th data-options="field:'BRAND_MODEL',align:'center',editor:{type:'validatebox',options:{required:true}}"
												width="12%">厂牌型号</th>
											<th data-options="field:'LICENSE',align:'center',editor:{type:'validatebox',options:{required:true}}"
												width="10%">车牌号码</th>
											<th data-options="field:'NUM',align:'center',editor:{type:'numberbox',options:{required:true,min:0}}"
												width="10%">座位数（个）</th>
											<th data-options="field:'BUS_TYPELEVEL',align:'center',editor:{type:'validatebox',options:{required:true}}"
