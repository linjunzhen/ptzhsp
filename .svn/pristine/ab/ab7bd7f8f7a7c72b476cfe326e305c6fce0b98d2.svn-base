...
<form action="" id="OTHER_FORM"  >
	...
	<div id="bankInfo" style="display: none;">
		...
		<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="syj-table2 tmargin20">
			...
			<tr>
				...
				<td><input type="text" class="syj-input1 inputBackgroundCcc" 
					id="REG_CAPITAL" name="INVESTMENT" readonly="readonly" value="${busRecord.REGISTERED_CAPITAL}"/></td>
				<th> 法定代表人：</th>
				<td><input type="text" class="syj-input1" 
					id="legalPersonName" name="LEGAL_NAME" value="${busRecord.LEGAL_NAME}"/></td>
			</tr>
			<tr>
				<th> 证件类型：</th>
				<td>
				...
				<th> 证件号码：</th>
				<td><input type="text" class="syj-input1"
					id="legalPersonIDNo" name="LEGAL_IDNO" value="${busRecord.LEGAL_IDNO}"/></td>
			</tr>
			<tr>
				<th> 经营范围：</th>
				<td colspan="3">
	...
	<div style="position:relative;">
		...
		<table  style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="syj-table2 tmargin20">
			...
			<!--<tr>
				<th><font class="syj-color2">*</font>是否申请进口设备免税：</th>
				<td colspan="3">
					<input type="radio" class="radio validate[required]" name="IS_FREEIMPORT" value="1" 
					<c:if test="${busRecord.IS_FREEIMPORT==1}"> checked="checked"</c:if>/>是
					<input type="radio" class="radio validate[required]" name="IS_FREEIMPORT" value="0" 
					<c:if test="${busRecord.IS_FREEIMPORT==0}"> checked="checked"</c:if>/>否
				</td>
			</tr>-->
			<tr>
				<th>填表日期：</th>
