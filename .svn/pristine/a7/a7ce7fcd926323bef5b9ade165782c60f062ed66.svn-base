...
<script type="text/javascript">
    ...
    function exportBjzttjExcel(){
    	var beginDate = $("input[name='Q_T.CREATE_TIME_>=']").val();
    	var endDate = $("input[name='Q_T.CREATE_TIME_<=']").val();
    	window.location.href = "statisticsController.do?exportBjzttjExcel&Q_T.CREATE_TIME_GE="+beginDate+" 00:00:00&Q_T.CREATE_TIME_LE="+endDate+" 23:59:59&beginDate="+beginDate+"&endDate="+endDate;
    }
	...
	$('#bjzttjStatisGrid').datagrid({ pagination: false,
		onLoadSuccess: function (data) {
			if (data.rows.length > 0) {
				//调用mergeCellsByField()合并单元格
				mergeCellsByField("bjzttjStatisGrid", "PARENT_NAME");
			}
		}
	});		
	/**
...
<div class="easyui-layout eui-jh-box" fit="true">
	<div region="center">
				...
				<div class="e-toolbar" style="z-index: 1111;top: 0px;left: 0px;">
					<div class="e-toolbar-ct">
						<div class="e-toolbar-overflow">
					         ...
					         onclick="exportBjzttjExcel();">导出数据</a> 
					...
					<tbody>
						<tr style="height:28px;">
							...
							<td colspan="2"><input type="button" value="查询"
								class="eve-button"
								onclick="AppUtil.gridDoSearch('bjzttjStatisToolBar','bjzttjStatisGrid')" />
		...
		<table class="easyui-datagrid" rownumbers="true" pagination="false" striped="true"
			id="bjzttjStatisGrid" fitcolumns="false" toolbar="#bjzttjStatisToolBar"
			method="post" idfield="LOG_ID" checkonselect="false"
			selectoncheck="false" fit="true" border="true"
			url="statisticsController.do?bjzttjData">
			<thead>
				<tr>
					<th data-options="field:'PARENT_NAME'" width="15%" rowspan="3">上级部门</th>
					<th data-options="field:'NUM_'" width="6%" rowspan="3">序号</th>
					<th data-options="field:'DEPART_NAME'" width="15%" rowspan="3">部门</th>
					<th colspan="5">办件统计</th>
					<th colspan="11">预登记统计</th>
				</tr>
				<tr>
					
					<th data-options="field:'COUNTS',align:'center'" width="8%" rowspan="2">办件总数</th>
					<th data-options="field:'BANJS',align:'center'" width="8%" rowspan="2">办结数</th>
					<th data-options="field:'ZBS',align:'center'" width="8%" rowspan="2">在办数</th>					
					<th data-options="field:'BUJS',align:'center'" width="8%" rowspan="2">补件数</th>
					<th data-options="field:'TJS',align:'center'" width="8%" rowspan="2">退件数</th>
				...
				<tr>
					...
					<th data-options="field:'YTL',align:'center'" width="9%">一条龙审批数</th>
					<th data-options="field:'QTXD',align:'center'" width="9%">其他导向数</th>
