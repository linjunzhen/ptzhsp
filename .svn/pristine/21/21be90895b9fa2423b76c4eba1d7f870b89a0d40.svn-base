	...
	<div class="bsboxC">
		...
		<table cellpadding="0" cellspacing="0" class="bstable1"  id="tzjbxx">
			...
			<tr class="isCanHide">
				...
				<th>项目阶段</th>
				<td>
					<eve:eveselect clazz="tab_text validate[] field_width" dataParams="PROJECTSTAGE"
					dataInterface="dictionaryService.findDatasForSelect"
			...
			<tr>
				...
				<span ><a href="javascript:void(0);" onclick="showInfos(this);" style="color:red;">显示项目更多信息</a></span>
				</td>
			</tr>
			<tr class="isCanHide">
				<th>身份证号码</th>
...
<%--				</td>--%>
			...
			<tr class="isCanHide">
				...
				<th>投资项目行业分类</th>
				<td>					
					<eve:eveselect clazz="tab_text validate[] permitIndustrySelect" dataParams="PERMITINDUSTRY"
					dataInterface="dictionaryService.findDatasForSelect"
			...
			<tr class="isCanHide">
				...
				<td  colspan="3">
					<textarea id="placeCodeDetail" class="eve-textarea validate[required],maxSize[512]" rows="3" cols="200"  
					  name="PLACE_CODE_DETAIL" style="width:660px;height:100px;"  readonly="true"></textarea>
				</td>
			</tr>
			<tr class="isCanHide">
				...
				<td  colspan="3">
					<textarea id="scaleContent" class="eve-textarea validate[required],maxSize[2000]" rows="3" cols="200"  
					  name="SCALE_CONTENT" style="width:660px;height:150px;"  readonly="true"></textarea>
				</td>
			</tr>
			<tr class="isCanHide">
				<th>项目备注</th>
				<td  colspan="3">
					<textarea id="projectRemark" class="eve-textarea  validate[],maxSize[2000]" rows="3" cols="200"  
					  name="PROJECT_REMARK" style="width:660px;height:100px;" readonly="true"></textarea>
				</td>
			</tr>
		</table>
		<table cellpadding="0" cellspacing="1" class="bstable1" id="wstzxx" style="display:" >
			<tr>
				<th colspan="4" style="text-align: center;">外商投资信息</th>
			</tr>
			<tr>
			...
			<tr id="otherInvestmentApplyInfoTr" style="display: ">
				...
				<textarea id="otherInvestmentApplyInfo" class="eve-textarea validate[maxSize[2000]]" rows="3" cols="200"  
				 name="OTHER_INVESTMENT_APPLY_INFO"  style="width:760px;height:100px;" ></textarea>
				</td>
			</tr>
			<tr id="transactionBothInfoTr" style="display: ">
				...
				<textarea id="transactionBothInfo" class="eve-textarea validate[maxSize[2000]]" rows="3" cols="200"  
				 name="TRANSACTION_BOTH_INFO"  style="width:760px;height:100px;" ></textarea>
				</td>
			</tr>
			<tr id="mergerPlanTr" style="display: ">
				...
				<textarea id="mergerPlan" class="eve-textarea validate[maxSize[2000]]" rows="3" cols="200"  
				 name="MERGER_PLAN"  style="width:760px;height:100px;" ></textarea>
				</td>
			</tr>
			<tr id="mergerManagementModeScopeTr" style="display: ">
				...
				<textarea id="mergerManagementModeScope" class="eve-textarea validate[maxSize[2000]]" rows="3" cols="200"  
				 name="MERGER_MANAGEMENT_MODE_SCOPE"  style="width:760px;height:100px;" ></textarea>
				</td>
			</tr>
			<tr>
