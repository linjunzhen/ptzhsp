	...
	<table cellpadding="0" cellspacing="1" class="tab_tk_pro2">
		<tr>
			<th>
				...
				<input type="button" class="eflowbutton" style="float:right; margin: 2px 5px; padding: 0 20px;" value="批量删除幢明细" onclick="addTable('PowerSourceInfo');"/>
				<input type="button" class="eflowbutton" style="float:right; margin: 2px 5px; padding: 0 20px;" value="查看户信息" onclick="updateTable('PowerSourceInfo');"/>
				<input type="button" class="eflowbutton" style="float:right; margin: 2px 5px; padding: 0 20px;" value="查看幢信息" onclick="updateTable('PowerSourceInfo');"/>
				<input type="button" class="eflowbutton" style="float:right; margin: 2px 5px; padding: 0 20px;" value="添加幢明细" onclick="showTJMX();"/>
				<input type="button" class="eflowbutton" style="float:right; margin: 2px 5px; padding: 0 20px;" value="添加套间明细" onclick="showTJMX();"/>
				<input type="button" class="eflowbutton" style="float:right; margin: 2px 5px; padding: 0 20px;" value="打印套间明细" onclick="updateTable('PowerSourceInfo');"/>
			</th>
		</tr>
	</table>
	<div class="tab_height"></div>
