...
<body class="eui-diabody" style="margin:0px;">
	<form id="dwinfoForm" method="post">
		...
		<table style="width:100%;border-collapse:collapse;"
			...
			<tr>
				<td colspan="2">
					<span style="width: 130px;float:left;text-align:right;">单位类型</span>				
					<eve:eveselect clazz="eve-input validate[required]" dataParams="UNITTYPE"
					dataInterface="dictionaryService.findDatasForSelect" 
					defaultEmptyText="请选择单位类型" name="UNITTYPE"   value="${info.UNITTYPE}">
					</eve:eveselect>
					<font class="dddl_platform_html_requiredFlag">*</font>
				</td>		
			</tr>
