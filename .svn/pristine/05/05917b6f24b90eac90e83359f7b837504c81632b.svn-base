...
<script type="text/javascript">
	...
	$(function () {
		var RIGHT_SOURCE = $("input[name='RIGHT_SOURCE']:checked").val();
		if (RIGHT_SOURCE == 'qt') {
				...
				<div class="easyui-layout" fit="true">
					...
					<div data-options="region:'center'">
						<form id="draftInfoForm" method="post"
							action="billOfRightController.do?saveOrUpdate">
							<div id="draftInfoFormDiv">
								<%--==========隐藏域部分开始 ===========--%>
								<input type="hidden" name="RIGHT_ID"
									value="${draftInfo.RIGHT_ID}"> <input type="hidden"
									...
									<tr>
										<td><span
											style="width: 120px;float:left;text-align:right;"><font
												...
												maxlength="4000" style="width: 600px;height:180px;"
												name="IMPL_BASIS">${draftInfo.IMPL_BASIS}</textarea></td>
									</tr>
									<tr>
										<td><span
											style="width: 120px;float:left;text-align:right;"><font
