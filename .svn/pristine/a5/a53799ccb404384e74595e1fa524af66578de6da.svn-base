                    ...
                    AppUtil.ajaxProgress({
                        ...
                        callback : function(resultJson) {
                            if (resultJson.success) {
                                ...
                                parent.$.fn.zTree.getZTreeObj("yqyzqhTree").reAsyncChildNodes(null, "refresh");
                                AppUtil.closeLayer();
                            } else {
                                parent.art.dialog({
                                    content: resultJson.msg,
...
<form id="DepartmentForm" method="post"
      action="callYqyzController.do?saveOrUpdate">
    <!--==========隐藏域部分开始 ===========-->
    <input type="hidden" name="YQYZQH_ID" value="${callYqyz.YQYZQH_ID}">
    <input type="hidden" name="PARENT_ID" value="${callYqyz.PARENT_ID}">
    <!--==========隐藏域部分结束 ===========-->
    <table style="width:100%;border-collapse:collapse;"
        ...
        <tr>
            <td><span style="width: 100px;float:left;text-align:right;">上级类别：</span>
                ${callYqyz.PARENT_NAME}</td>
        </tr>
        <tr>
            <td><span style="width: 100px;float:left;text-align:right;">类别名称：</span>
                <input type="text" style="width:185px;float:left;" maxlength="50"
                       class="eve-input validate[required]"
                       value="${callYqyz.TYPE_NAME}" name="TYPE_NAME" />
        ...
        <tr>
            <td><span style="width: 100px;float:left;text-align:right;">类别别名：</span>
                <input type="text" style="width:185px;float:left;" maxlength="50"
                       class="eve-input validate[required]"
                       value="${callYqyz.TYPE_ALIAS}" name="TYPE_ALIAS" />
                <font class="dddl_platform_html_requiredFlag">*</font>
            </td>
        </tr>
        ...
        <tr>
            <td><span style="width: 100px;float:left;text-align:right;">类别编码：</span>
                <c:if test="${callYqyz.YQYZQH_ID!=null}">
                    ${callYqyz.TYPE_CODE}
                </c:if> <c:if test="${callYqyz.YQYZQH_ID==null}">
                    <input type="text" style="width:150px;float:left;" maxlength="18"
                           ...
                           value="${callYqyz.TYPE_CODE}" id="TYPE_CODE"
                           name="TYPE_CODE" />
                    <font class="dddl_platform_html_requiredFlag">*</font>
                </c:if>
            </td>
        ...
        <tr>
            ...
            <eve:eveselect clazz="tab_text validate[required]" dataParams="YQYZML"
                           dataInterface="dictionaryService.findDatasForSelect"
                           defaultEmptyText="选择所属目录" name="CATALOG" value="${callYqyz.CATALOG}">
            </eve:eveselect>
                <font class="dddl_platform_html_requiredFlag">*</font>
            </td>
        </tr>
