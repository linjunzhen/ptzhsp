...
<script type="text/javascript">
	$(function(){
		...
		if(EFLOW_FLOWOBJ){
    		...
    		if(eflowObj.busRecord){
    			FlowUtil.initFormFieldValue(eflowObj.busRecord,"T_BSFW_SHTZXMBA_FORM");
	...
	function submitFlow(flowSubmitObj){
		 //先判断表单是否验证通过
		 AppUtil.submitWebSiteFlowForm('T_BSFW_SHTZXMBA_FORM');
	}
...
<body style="background: #f0f0f0;">
	...
	<div class="eui-main">
		...
		<jsp:include page="./submitdiv.jsp" >
		     ...
		     <jsp:param value="AppUtil.tempSaveWebSiteFlowForm('T_BSFW_SHTZXMBA_FORM');" name="tempSaveFn"/>
		</jsp:include>
		<%--结束引入提交DIV界面 --%>
