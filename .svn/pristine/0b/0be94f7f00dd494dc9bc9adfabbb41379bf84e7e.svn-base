...
<script type="text/javascript">
	$(function(){
		...
		if(EFLOW_FLOWOBJ){
    		...
    		if(eflowObj.busRecord){
    			FlowUtil.initFormFieldValue(eflowObj.busRecord,"T_BSFW_ZFKXYJBGZHPS_FORM");
    		}
		}
	...
	//	 var validateResult =$("#T_BSFW_ZFKXYJBGZHPS_FORM").validationEngine("validate");
		 ...
		 AppUtil.submitWebSiteFlowForm('T_BSFW_ZFKXYJBGZHPS_FORM');
...
<body style="background: #f0f0f0;">
	...
	<div class="eui-main">
		...
		<jsp:include page="./submitdiv.jsp" >
		     ...
		     <jsp:param value="AppUtil.tempSaveWebSiteFlowForm('T_BSFW_ZFKXYJBGZHPS_FORM');" name="tempSaveFn"/>
		</jsp:include>
		<%--结束引入提交DIV界面 --%>
