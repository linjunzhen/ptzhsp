...
<table cellpadding="0" cellspacing="1" class="tab_tk_pro">
	...
	<tr>
		...
		<td>
		    ...
		    <a href="javascript:void(0);"  class="easyui-linkbutton" iconcls="eicon-search" plain="true" onclick="personInsureSelector();"></a> 			
		</td>		
	...
	<tr>
		...
		<td>
			<input type="text" class="tab_text" name="QYJY_DWBH" />
		</td>
	</tr>
</table>
<div class="tab_height"></div>
		...
		<td style="height:250px">
			...
			<thead>
				<tr>
					...
					<th data-options="field:'aae140',width:'20%',align:'center',formatter:commonFormat">险种类型</th>
