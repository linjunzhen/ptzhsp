...
<body class="macw" ondragstart="return false" oncontextmenu="return false" onselectstart="return false">
<!-- 头部开始 -->
...
<div class="eui-content">
    <iframe id="takeFrame" frameBorder="0" width="100%" height="100%"
            ...
            src="callController.do?toYqyzTypeChooseMacW&roomNo=${roomNo}&ifMaterPrint=${ifMaterPrint}&departId=${departId}"></iframe>
    </iframe>
</div>
<!-- 主页面结束 -->
