...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		AppUtil.initAuthorityRes("YsbtgToolbar");
...
<div class="easyui-layout eui-jh-box" fit="true">
	<div region="center">
					...
					<tbody>
						<tr style="height:28px;">
							...
							<td style="width:135px;"><input type="text"
								...
								id="Ysbtg.CREATE_TIME_BEGIN" name="Q_T.CREATE_TIME_&gt;=" /></td>
							<td style="width:68px;text-align:right;">提交日期至</td>
							<td style="width:135px;"><input type="text"
								style="width:128px;float:left;" class="laydate-icon"
								id="Ysbtg.CREATE_TIME_END" name="Q_T.CREATE_TIME_&lt;=" /></td>
							<td colspan="2"><input type="button" value="查询"
								class="eve-button"
								onclick="AppUtil.gridDoSearch('YsbtgToolbar','YsbtgGrid')" />
								<input type="button" value="重置" class="eve-button"
								onclick="AppUtil.gridSearchReset('YsbtgForm')" /></td>
						</tr>
					</tbody>
				</table>
			</form>
		...
		<table rownumbers="true" pagination="true" striped="true"
			id="YsbtgGrid" fitcolumns="true" toolbar="#YsbtgToolbar"
			method="post" idfield="EXE_ID" checkonselect="false" 
			selectoncheck="false" fit="true" border="false" nowrap="false"
			url="executionController.do?handledByMe&Q_T.APPLY_STATUS_EQ=3">
			<thead>
				<tr>
