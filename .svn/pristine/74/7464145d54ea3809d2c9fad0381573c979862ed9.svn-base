    		...
    		if(flowSubmitObj.busRecord){
    			if (flowSubmitObj.busRecord.RUN_STATUS) {
					  if (flowSubmitObj.busRecord.RUN_STATUS != 0) {
						if (flowSubmitObj.EFLOW_CURUSEROPERNODENAME == '初审'|| flowSubmitObj.EFLOW_CURUSEROPERNODENAME == '复审') {
							$("#djshOpinion").show();
							$("#djshCsOpinionInfo").show();
							$("#djshCsOpinionInfo").find("text,textarea,.eflowbutton").removeAttr("disabled","disabled");
						}												
						...
						if (flowSubmitObj.EFLOW_CURUSEROPERNODENAME == '登簿') {
							$("#djshOpinion").show();
							$("#djshHzOpinionInfo").show();
							$("#djshHzOpinionInfo").find("text,textarea,.eflowbutton").removeAttr("disabled","disabled");							
							$("#djshCsOpinionInfo").show();
							$("#djshCsOpinionInfo").find("textarea,.eflowbutton").attr("disabled","disabled");
						}
					 	var isEndFlow = false;
                ...
                <tr id="csyj">
                    ...
                    <td>
                        <textarea name="CS_OPINION_CONTENT" cols="140" rows="10"
                                  class="validate[required]" maxlength="1000">${busRecord.CS_OPINION_CONTENT}</textarea>
                        <input type="button" class="eflowbutton" value="意见模板" onclick="cyyjmbSelector('bdcqlcOpinion_cs','CS_OPINION_CONTENT');">
                    </td>
                </tr>
                <tr>
                ...
                <tr id="hzyj">
                    ...
                    <td>
                        <textarea name="HZ_OPINION_CONTENT" cols="140" rows="10"
                                  class="validate[required]" maxlength="1000">${busRecord.HZ_OPINION_CONTENT}</textarea>
