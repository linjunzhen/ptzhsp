...
<script type="text/javascript">
    ...
    function restartFlowTaskExplain(){
        ...
        if (!(rowsData != null && typeof (rowsData) != 'undefined' && rowsData.length != 0)) {
            ...
            if(!isAllowStart){
                ...
                AppUtil.operateDataGridRecord("flowTaskController.do?reStart",{selectTaskIds:selectTaskIds},"YbDwspGrid");
            }else{
     ...
     * 编辑流程实例列表记录
     */
    function editYbDwspGridRecord() {
        var entityId = AppUtil.getEditDataGridRecord("YbDwspGrid");
        if (entityId) {
    ...
    $(document).ready(function() {
        var start1 = {
            elem : "#YbDwspT.CREATE_TIME_BEGIN",
            format : "YYYY-MM-DD",
            istime : false,
    ...
    function showYbDwspBjxxGridRecord() {
        var rows = $("#YbDwspGrid").datagrid("getChecked");
        if(rows.length==0){
            art.dialog({
                content: "请至少选择一条记录!",
                icon:"warning",
...
<div class="easyui-layout eui-jh-box" fit="true">
    <div region="center">
                        ...
                        <div class="e-toolbar-overflow">
                            <div style="color:#005588;">
                                ...
                                <a href="#"
                                   ...
                                   onclick="showYbDwspBjxxGridRecord();">查看补件要求</a>
                                <%--                                <a href="#"--%>
                ...
                <table class="dddl-contentBorder dddl_table"
                    ...
                    <tr style="height:28px;">
                        ...
                        <td style="width:135px;padding-left:4px;"><input type="text"
                                                                         ...
                                                                         id="YbDwspT.CREATE_TIME_BEGIN" name="Q_E.CREATE_TIME_>=" /></td>
                        <td style="width:68px;text-align:right;">申请日期至</td>
                        <td style="width:135px;padding-left:4px;"><input type="text"
                                                                         style="width:108px;float:left;" class="laydate-icon"
                                                                         id="YbDwspT.CREATE_TIME_END" name="Q_E.CREATE_TIME_<=" /></td>
                        ...
                        <td colspan="2"><input type="button" value="查询"
                                               class="eve-button"
                                               onclick="AppUtil.gridDoSearch('YbDwspToolbar','YbDwspGrid')" />
        ...
        <table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
               id="YbDwspGrid" fitcolumns="false" toolbar="#YbDwspToolbar"
               method="post" idfield="EXE_ID" checkonselect="false"
               selectoncheck="false" fit="true" border="false" nowrap="false"
               url="ybExecutionController.do?ybNeedMeHandle&Q_T.TASK_NODENAME_NOTIN=%E5%8F%97%E7%90%86,%e5%be%85%e5%8f%97%e7%90%86,%E7%BD%91%E4%B8%8A%E9%A2%84%E5%AE%A1&isHaveHandup=true">
            <thead>
            <tr>
