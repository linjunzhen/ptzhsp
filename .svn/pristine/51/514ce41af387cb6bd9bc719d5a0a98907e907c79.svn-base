...
<title>平潭综合实验区商事主体登记申报系统</title>
	...
	<!---引入公共JS--->
	<script src="<%=path%>/webpage/website/applyforms/branch/js/commercial.js"></script>
...
<div class="container" >
        <div class="syj-sbmain1 tmargin20" style=" margin-top:0px;"  id="lct">
       		<div class="syj-sbm1l">
                ...
                <p>登记类别：<font id="companyTypeFont">内资分公司</font></p>
            </div>
            <div class="syj-sbm1r" style="width:838px;">
            	<div class="eui-steps-round" style="float:right;padding-right: 10px;">
					...
					<c:if test="${EFLOWOBJ.HJMC!=null}">
						<jsp:include page="/webpage/website/applyforms/branch/flowchart.jsp" >
        ...
        <div class="syj-sbmain2 tmargin20"  id="jbxx">
			...
			<%--开始引入申报信息界面 --%>
			<jsp:include page="/webpage/website/applyforms/branch/sbxx.jsp" >
            ...
            <div class="syj-tyys tmargin20" style="z-index: 99;" id="formcontainer">
                ...
                <div class="bd" style="padding: 25px 30px;">
					<div>						
						<%--开始引入企业基本信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/branch/T_COMMERCIAL_COMPANY.jsp" />
						<%--结束引入企业基本信息界面 --%>
					</div>
                	<div>
                    	<%--开始引入隶属企业信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/branch/T_COMMERCIAL_SUBORDINATE.jsp" />
						<%--结束引入隶属企业信息界面 --%>
                    </div>
                    <div>					
                    	<%--开始引入人员信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/branch/T_COMMERCIAL_PERSONNEL.jsp" />
						<%--结束引入人员信息界面 --%>
                    </div>
                    <div>					
                    	<%--开始引入印章信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/branch/T_COMMERCIAL_SEAL.jsp" />
						<%--结束引入印章信息界面 --%>
                    </div>
                    <div>					
                    	<%--开始引入其他信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/branch/T_COMMERCIAL_OTHER.jsp" />
						<%--结束引入其他信息界面 --%>
                    </div>	
                    ...
                    <div>								
                    	<%--开始引入经办人信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/branch/T_COMMERCIAL_USERINFO.jsp" />
						<%--结束引入经办人信息界面 --%>
					</div>
                    <div>								
                    	<%--开始引入关联事项材料界面 --%>
						<jsp:include page="/webpage/website/applyforms/branch/T_COMMERCIAL_MATER.jsp" />
						<%--结束引入关联事项材料界面 --%>
					</div>
					<c:if test="${isQueryDetail!=null && EFLOWOBJ.EFLOW_CUREXERUNNINGNODENAMES=='窗口办理'}">
					<div>
