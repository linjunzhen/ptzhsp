...
<div style="position:relative;">
		...
		<tr>
			...
			<td colspan="3">
				...
				<input type="text" class="syj-input1 validate[required]" style="width:600px;"
					name="${currentTime}INVESTOR_NAME"  maxlength="32" placeholder="请输入中方投资者名称"  onblur="setInvestorName()"/>
			</td>
		</tr>
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 tmargin20" style="margin-top: -1px;">
		<tr>
			...
			<td><input type="text" class="syj-input1 validate[required]"
				name="${currentTime}INVESTOR_ADDR" maxlength="64" placeholder="请输入地址"/></td>
		...
		<tr>
			...
			<td>
				...
				defaultEmptyText="请选择省/市" name="${currentTime}INVESTOR_PROVINCE">
				</eve:eveselect>
			</td>
		</tr>
		<tr>
