...
import net.evecom.platform.bdc.dao.BdcJtjsydsyqjfwsyqDao;
import net.evecom.platform.bdc.service.BdcBfbdcdjzmService;
import net.evecom.platform.bdc.service.BdcDyqscdjService;
import net.evecom.platform.bdc.service.BdcJtjsydsyqjfwsyqService;
 ...
 */
@Service("bdcJtjsydsyqjfwsyqService")
public class BdcJtjsydsyqjfwsyqServiceImpl extends BaseServiceImpl implements BdcJtjsydsyqjfwsyqService {

    /**
     * 描述:
     *
     * @author Madison You
     * @created 2020/4/21 16:58:00
     * @param
     * @return
     */
    @Resource
    private BdcJtjsydsyqjfwsyqDao bdcJtjsydsyqjfwsyqDao;

    /**
     * 描述:
     *
     * @author Madison You
     * @created 2020/4/28 11:48:00
     * @param
     * @return
     */
    @Resource
    ...
    public void setJtjsydsyqjfwsyqzydjData(Map<String, Map<String, Object>> args) {
        ...
        /*设置预购商品房预告登记业务数据*/
        this.setJtjsydsyqjfwsyqzydjBusInfo(returnMap, busInfo, execution);
    ...
    public void setJtjsydsyqjfwsyqbgdjData(Map<String, Map<String, Object>> args) {
        ...
        /*设置集体建设用地使用权及房屋所有权变更登记数据*/
        this.setJtjsydsyqjfwsyqbgdjBusInfo(returnMap, busInfo, execution);
    ...
    public void setJtjsydsyqjfwsyqscdjData(Map<String, Map<String, Object>> args) {
        ...
        /*设置预购商品房预告登记业务数据*/
        this.setJtjsydsyqjfwsyqscdjBusInfo(returnMap, busInfo, execution);
     ...
     * @return
     */
    private void setJtjsydsyqjfwsyqzydjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
                                               Map<String, Object> execution) {
        returnMap.put("qllx", "集体建设用地使用权/房屋所有权");
     ...
     * @return
     */
    private void setJtjsydsyqjfwsyqbgdjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
                                               Map<String, Object> execution) {
        returnMap.put("qllx", "集体建设用地使用权/房屋所有权");
     ...
     * @return
     */
    private void setJtjsydsyqjfwsyqscdjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
                                               Map<String, Object> execution) {
        returnMap.put("qllx", "集体建设用地使用权/房屋所有权");
