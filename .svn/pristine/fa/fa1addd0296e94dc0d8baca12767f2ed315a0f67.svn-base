 ...
 */
public class PushOnTimeDataToSJJXXZXJOB implements Job {
    /**
     * log
     */
    private static Log log = LogFactory.getLog(PushOnTimeDataToSJJXXZXJOB.class);
    /**
     * 引入service
     */
    @Resource
     ...
     * 
     */
    public PushOnTimeDataToSJJXXZXJOB() {
        super();
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        pushDataToSJJXXZXService.sendDataToSJJXXZXTrueTime();
    }
}
