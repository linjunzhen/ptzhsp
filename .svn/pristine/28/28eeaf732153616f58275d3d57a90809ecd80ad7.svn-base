...
<body class="eui-diabody" style="margin:0px;">
	<form id="WtItemForm" method="post" action="bdcApplyController.do?saveWtItem">
		...
		<table style="width:100%;border-collapse:collapse;"
			...
			<c:if test="${dictionary.TYPE_CODE eq 'CYYHHMC' || dictionary.TYPE_CODE eq 'CYKFS'}">
				<tr>
					<td colspan="2">
					<span style="width:100px;float:left;text-align:right;">统一社会信用代码：</span>
					<input
						type="text" style="width:400px;float:left;" 
						value="${dictionary.DIC_CODE}" maxlength="128"
				...
				<tr>
					...
					<input
						type="text" style="width:400px;float:left;" 
						value="${dictionary.DIC_DESC}" maxlength="128"
						class="eve-input validate[required]" name="DIC_DESC" /> 
						<font class="dddl_platform_html_requiredFlag">*</font>
					</td>
				</tr>
			</c:if>
