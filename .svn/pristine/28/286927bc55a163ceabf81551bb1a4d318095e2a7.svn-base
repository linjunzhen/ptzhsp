...
<!-- 					onclick="showSelectBdcdydacx();">审批表（双方）</a> -->
	...
	<table cellpadding="0" cellspacing="1" class="tab_tk_pro2" id="djshxxInfo">
		...
		<tr>
			<td class="tab_width">初审意见：</td>
			<td colspan="5">
				<input type="text" class="tab_text " maxlength="2000" name="DJSH_CSYJ"
					value="${busRecord.DJSH_CSYJ}" id="DJSH_CSYJ" style="width: 72%;" />
			</td>
		</tr>

		<tr>
			<td class="tab_width">复审意见：</td>
			<td colspan="5">
				<input type="text" class="tab_text " maxlength="2000" name="DJSH_FSYJ"
					value="${busRecord.DJSH_FSYJ}" id="DJSH_FSYJ" style="width: 72%;" />
			</td>
		</tr>

		<tr>
			<td class="tab_width">核准意见：</td>
			<td colspan="5">
				<input type="text" class="tab_text " maxlength="2000" name="DJSH_HZYJ"
					value="${busRecord.DJSH_HZYJ}" id="DJSH_HZYJ" style="width: 72%;" />
			</td>
		</tr>
	</table>
</div>
