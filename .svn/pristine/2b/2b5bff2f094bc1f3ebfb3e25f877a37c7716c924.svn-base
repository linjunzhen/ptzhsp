								...
								<table style="width:100%;border-collapse:collapse;"
									...
									<tr>
										<td><span
											...
											value="${draftInfo.ITEM_CODE}" /> &nbsp;<input type="button"
										...
										<tr>
											<td><span
												...
												<textarea
													...
													readonly="readonly" style="width: 600px;height:150px;"
													name="PRE_ITEMNAMES">${draftInfo.PRE_ITEMNAMES}</textarea>
												<input type="hidden" name="PRE_ITEMCODES"
												value="${draftInfo.PRE_ITEMCODES}" /> &nbsp;<input
							...
							style="width: 600px;height:150px;" name="PRE_ITEMNAMES_WRITE">${draftInfo.PRE_ITEMNAMES_WRITE}</textarea>
									...
									<tr>
										<td><span
											...
											<textarea
												class="eve-textarea validate[required,maxSize[512]]"
												style="width: 600px;height:150px;" name="PRE_BASIS">${draftInfo.PRE_BASIS}</textarea>
