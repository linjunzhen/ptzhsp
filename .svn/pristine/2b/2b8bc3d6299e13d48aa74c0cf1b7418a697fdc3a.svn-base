							...
							<div id="TheoreticalInstructorDiv">
								<div style="position:relative;">
									...
									<table class="easyui-datagrid" toolbar="#TheoreticalInstructorToolbar" id="TheoreticalInstructorGrid" rownumbers="true" border="true" fitColumns="true"
										data-options="singleSelect:true,autoSave:true,url:'',method:'post',onClickRow: onClickRowTheoreticalInstructor">
										<thead>
											<tr>
												<th data-options="field:'XM',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,6]'}}"
													width="10%">姓名</th>
												<th data-options="field:'SFZH',align:'left',editor:{type:'validatebox',options:{required:true,validType:'idcared'}}"
													width="20%">身份证号</th>
												<th data-options="field:'WHCD',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
													width="10%">文化程度</th>
												<th data-options="field:'JSDAH',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,32]'}}"
													width="20%">驾驶档案号</th>
												<th data-options="field:'JLYH',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,32]'}}"
													width="20%">教员证号</th>
												<th data-options="field:'JL',align:'left',editor:{type:'validatebox',options:{required:true,validType:'numberCheckSub'}}"
													width="10%">教龄</th>
												<th data-options="field:'BZ',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,32]'}}"
													width="9%">备注</th>
							...
							<div id="PracticalTeacherDiv">
								<div style="position:relative;">
									...
									<table class="easyui-datagrid" toolbar="#PracticalTeacherToolbar" id="PracticalTeacherGrid" rownumbers="true" border="true" fitColumns="true"
										data-options="singleSelect:true,autoSave:true,url:'',method:'post',onClickRow: onClickRowPracticalTeacher">
										<thead>
											<tr>
												<th data-options="field:'XM',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,6]'}}"
													width="10%">姓名</th>
												...
												<th data-options="field:'WHCD',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
													width="10%">文化程度</th>
												<th data-options="field:'JSDAH',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
													width="10%">驾驶档案号</th>
												<th data-options="field:'JLYH',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
													width="10%">教员证号</th>
												<th data-options="field:'ZJCXH',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
													width="10%">准驾车型</th>
												<th data-options="field:'ZJCX',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
													width="10%">准教车型</th>
												<th data-options="field:'JL',align:'left',editor:{type:'validatebox',options:{required:true,validType:'numberCheckSub'}}"
													width="10%">教龄</th>
												<th data-options="field:'BZ',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,32]'}}"
									...
									<table class="easyui-datagrid" toolbar="#AdministrativeStaffToolbar" id="AdministrativeStaffGrid" rownumbers="true" border="true" fitColumns="true"
										...
										<thead>
											<tr>
												...
												<th data-options="field:'JSDAH',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
													width="20%">驾驶档案号</th>
												<th data-options="field:'ZW',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
													width="20%">职称或职务</th>
												<th data-options="field:'JL',align:'left',editor:{type:'validatebox',options:{required:true,validType:'numberCheckSub'}}"
													width="10%">教龄</th>
												<th data-options="field:'BZ',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,32]'}}"
							...
							<div id="CoachVehicleDiv">
								<div style="position:relative;">
									...
									<table class="easyui-datagrid" toolbar="#CoachVehicleToolbar" id="CoachVehicleGrid" rownumbers="true" border="true" fitColumns="true"
										data-options="singleSelect:true,autoSave:true,url:'',method:'post',onClickRow: onClickRowCoachVehicle" allowHeaderWrap="true">
										<thead>
											<tr>
												...
												<th data-options="field:'BPSJ',align:'left',editor:{type:'validatebox',options:{required:true}}"
													width="20%">报牌时间</th>
												<th data-options="field:'CLJSDJPD',align:'center',editor:{type:'validatebox',options:{required:true,}}"
													width="10%">车辆技术等<br>级评定</th>
