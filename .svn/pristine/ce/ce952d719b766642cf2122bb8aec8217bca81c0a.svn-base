...
<title>平潭综合实验区商事主体登记申报系统</title>
    ...
    <!---引入公共JS--->
    <script src="<%=path%>/webpage/website/applyforms/nzJointVenture/js/commercial.js"></script>
    <script src="<%=path%>/webpage/website/applyforms/zzhy/js/idCardArea.js"></script>
    <!---面签公共JS--->
    <script src="<%=path%>/webpage/website/applyforms/nzJointVenture/js/sign.js"></script>
    <!---秒批JS--->
    <script src="<%=path%>/webpage/website/applyforms/nzJointVenture/js/mp.js"></script>
...
<div class="container" >
            ...
            <div class="syj-sbm1r" style="width:838px;">
                <div class="eui-steps-round" style="float:right; padding-right: 10px;">
                    ...
                    <c:if test="${EFLOWOBJ.HJMC!=null}">
                        <jsp:include page="/webpage/website/applyforms/nzJointVenture/flowchart.jsp" >
        ...
        <div class="syj-sbmain2"  id="jbxx">
            ...
            <%--开始引入申报信息界面 --%>
            <jsp:include page="/webpage/website/applyforms/nzJointVenture/sbxx.jsp" >
            ...
            <div class="syj-tyys " style="z-index: 99;" id="formcontainer">
                <div class="hd syj-tabtitle" id="formtabtitle" style="z-index: 99;">
                    <ul>
                        ...
                        <li><a href="javascript:AppUtil.validateSingleForm('CAPITAL_FORM');"  id="CAPITAL_FORM_A">合伙出资情况</a></li>
...
<c:if test="${requestParams.SSSBLX!='1'&&busRecord.SSSBLX!='1'}">
                    <div>
                        <%--开始引入企业基本信息界面 --%>
                        <jsp:include page="/webpage/website/applyforms/nzJointVenture/T_COMMERCIAL_COMPANY.jsp" />
                        <%--结束引入企业基本信息界面 --%>
                    </div>
                    <div>
                        <%--开始引入企业合伙出资情况信息界面 --%>
                        <jsp:include page="/webpage/website/applyforms/nzJointVenture/T_COMMERCIAL_CAPITAL.jsp" />
                        <%--结束引入企业合伙出资情况东信息界面 --%>
                    </div>
                    <div>
                        <%--开始引入法定代表人信息界面 --%>
                        <jsp:include page="/webpage/website/applyforms/nzJointVenture/T_COMMERCIAL_LEGAL.jsp" />
                        <%--结束引入法定代表人信息界面 --%>
                    </div>
                    
                    <div>                   
                        <%--开始引入印章信息界面 --%>
                        <jsp:include page="/webpage/website/applyforms/nzJointVenture/T_COMMERCIAL_SEAL.jsp" />
                        <%--结束引入印章信息界面 --%>
                    </div>
                    <div>                   
                        <%--开始引入其他信息界面 --%>
                        <jsp:include page="/webpage/website/applyforms/nzJointVenture/T_COMMERCIAL_OTHER.jsp" />
                        <%--结束引入其他信息界面 --%>
                    </div>
                    <div>
                        <%--开始引入多证合一界面 --%>
                    ...
                    <div>                               
                        <%--开始引入经办人信息界面 --%>
                        <jsp:include page="/webpage/website/applyforms/nzJointVenture/T_COMMERCIAL_USERINFO.jsp" />
                        <%--结束引入经办人信息界面 --%>
                    </div>  
                    <div>
                        <%--开始引入前台用户上传界面 --%>
...
<c:if test="${requestParams.SSSBLX=='1'||busRecord.SSSBLX=='1'}">
    <div>
            <%--开始引入企业基本信息界面 --%>
        <jsp:include page="/webpage/website/applyforms/nzJointVenture/T_COMMERCIAL_COMPANY_MP.jsp" />
            <%--结束引入企业基本信息界面 --%>
    </div>
    <div>
            <%--开始引入企业合伙出资情况信息界面 --%>
        <jsp:include page="/webpage/website/applyforms/nzJointVenture/T_COMMERCIAL_CAPITAL_MP.jsp" />
            <%--结束引入企业合伙出资情况东信息界面 --%>
    </div>
    <div>
            <%--开始引入法定代表人信息界面 --%>
        <jsp:include page="/webpage/website/applyforms/nzJointVenture/T_COMMERCIAL_LEGAL_MP.jsp" />
            <%--结束引入法定代表人信息界面 --%>
    </div>
    ...
    <div>
            <%--开始引入其他信息界面 --%>
        <jsp:include page="/webpage/website/applyforms/nzJointVenture/T_COMMERCIAL_OTHER_MP.jsp" />
            <%--结束引入其他信息界面 --%>
    </div>
    <div>
            <%--开始引入多证合一界面 --%>
    ...
    <div>
            <%--开始引入经办人信息界面 --%>
        <jsp:include page="/webpage/website/applyforms/nzJointVenture/T_COMMERCIAL_USERINFO_MP.jsp" />
            <%--结束引入经办人信息界面 --%>
    </div>
    <div>
            <%--开始引入前台用户上传界面 --%>
    ...
    <div>
        ...
        <jsp:include page="/webpage/website/applyforms/zzhy/T_COMMERCIAL_MATER.jsp" />
            <%--结束引入关联事项材料界面 --%>
                    ...
                    <c:if test="${isQueryDetail!=null && EFLOWOBJ.EFLOW_CUREXERUNNINGNODENAMES=='窗口办理'}">
                    <div>
                        <jsp:include page="/webpage/website/applyforms/nzJointVenture/applyMaterList.jsp">
