			...
			<td>
				<table class="tab_tk_pro2">
					...
					<tr>
						...
						<td>
							<input type="text" class="tab_text validate[required]" id="POWERPEOPLEPRO" name="POWERPEOPLEPRO"
								maxlength="62" />
						</td>
						<td class="tab_width">
							<font class="tab_color">*</font>
					...
					<tr>
						...
						<td>
							<input type="text" readonly="true" disabled='disabled' class="tab_text validate[]" maxlength="500" id="BDC_SZZH"
						...
						<td id="print">
							<a href="javascript:void(0);" style="float:left; margin: 2px 0;display: none;" class="eflowbutton"
							   name="zsyl" id="zsyl" onclick="bdcCQZSprint(1);">证书预览</a>
							<a href="javascript:void(0);" style="float:left; margin: 2px 10px;display: none;" class="eflowbutton"
							   name="zsdy" id="zsdy" onclick="bdcCQZSprint(2);">证书打印</a>
						</td>
						<td/>
					</tr>
					<tr>
						...
						<td>
							<input type="text" disabled='disabled' class="tab_text validate[]" maxlength="128" id="BDC_QZBSM"
								style="float: left;" name="BDC_QZBSM" value="${busRecord.BDC_QZBSM}" />
						</td>

						<td class="tab_width">操作人：</td>
						<td>
							<input type="text" readonly="true" disabled='disabled' class="tab_text validate[]" maxlength="128" id="BDC_CZR"
					...
					<tr>
						...
						<td>
							<input type="text" readonly="true" disabled='disabled' class="tab_text" maxlength="32" id="BDC_CZSJ" style="float: left;"
