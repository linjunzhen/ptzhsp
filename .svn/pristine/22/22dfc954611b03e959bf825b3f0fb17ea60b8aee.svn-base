...
<head>
	...
	$(function(){
		...
		if(readFlag=='true'){			
			$("#tabletForm input").attr("readonly",true);
			$("#tabletForm textarea").attr("readonly",true);		
			$("#tabletForm select").attr("disabled",true);	
		}
	});
	//将form中的值转换为键值对
...
<body class="bsbodynew">
    <div class="container" style="width: 900px;padding-left: 0px;margin-left: 0px;">
		...
		<c:choose> 
			...
			<c:when test="${matterCode=='345071904QT00204_03'}">
