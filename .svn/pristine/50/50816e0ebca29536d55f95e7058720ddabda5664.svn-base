...
<head>
    ...
    <script type="text/javascript" src="<%=basePath%>/webpage/website/applyforms/bdcqlc/gyjsjfwzydj/fh/js/fh.js"></script>
    ...
    $(function () {
        ...
        if (EFLOW_FLOWOBJ) {
            ...
            if (flowSubmitObj.busRecord) {
            	...
            	//初始化默认业务类型为'1'-分户-对应字典类别编码为zydjlx1
...
<body  style="background: #f0f0f0;">
	...
	<div class="eui-main">
        ...
        <form id="T_BDCQLC_GYJSJFWZYDJFH_FORM" method="post">
            ...
            <%--开始引入权属来源信息--%>
            <jsp:include page="./bdcqlc/gyjsjfwzydj/fh/bdcQsly.jsp" />
            <%--结束引入权属来源信息--%>
...
<%--            &lt;%&ndash;开始银行询问记录基本信息&ndash;%&gt;--%>
            ...
            <jsp:include page="./submitdiv.jsp" >
                <jsp:param value="submitFlow('T_BDCQLC_GYJSJFWZYDJFH_FORM');" name="submitFn"/>
                <jsp:param value="saveFlow('T_BDCQLC_GYJSJFWZYDJFH_FORM');" name="tempSaveFn"/>
            </jsp:include>
            <%--结束引入提交DIV界面 --%>
