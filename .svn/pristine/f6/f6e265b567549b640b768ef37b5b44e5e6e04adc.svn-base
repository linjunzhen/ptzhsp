...
import net.evecom.platform.bdc.dao.BdcZjfwsybgdjDao;
import net.evecom.platform.bdc.service.BdcSpbPrintConfigService;
import net.evecom.platform.bdc.service.BdcZjfwsybgdjService;
import net.evecom.platform.system.service.DictionaryService;

/**
 * 描述   宅基地使用权及房屋所有权变更登记service
 * @author Allin Lin
 * @created 2020年5月20日 上午11:19:19
 */
@Service("bdcZjfwsybgdjService")
public class BdcZjfwsybgdjServiceImpl extends BaseServiceImpl implements BdcZjfwsybgdjService{
    /**
     * log4J声明
     */
    private static Log log = LogFactory.getLog(BdcZjfwsybgdjServiceImpl.class);
    /**
     * 引入service
     */
    @Resource
    ...
    /**
     * 描述  宅基地使用权及房屋所有权变更登记审批表业务数据
     * @author Allin Lin
     * @created 2020年5月12日 上午10:54:03
     * @param args
     * @see net.evecom.platform.bdc.service.BdcZjfwsybgdjService#setZjfwsybgdjData(java.util.Map)
     */
    @Override
