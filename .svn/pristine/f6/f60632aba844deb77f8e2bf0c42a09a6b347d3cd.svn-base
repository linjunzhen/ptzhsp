...
<head>
    ...
    <script type="text/javascript" src="<%=basePath%>/webpage/website/applyforms/bdcqlc/general/js/bdcgeneral.js"></script>
	...
	<div class="eui-main">
        ...
        <form id="T_BDCQLC_GENERAL_FORM" method="post">
            ...
            <input type="hidden" name="POWERPEOPLEINFO_JSON" id="POWERPEOPLEINFO_JSON"/>
             <%-- 义务人信息明细 --%>
            <input type="hidden" name="YWPEOPLEINFO_JSON" id="YWPEOPLEINFO_JSON"/>
            <%-- 权属来源信息明细 --%>
            ...
            <%--是否全程网办--%>
            <input type="hidden" id="ISQCWB" name="ISQCWB" value="0" />
           ...
           <%--  <jsp:include page="./bdcqlc/bdcZdqlxx.jsp" /> --%>
            ...
            <jsp:include page="./submitdiv.jsp" >
                <jsp:param value="submitFlow('T_BDCQLC_GENERAL_FORM');" name="submitFn"/>
                <jsp:param value="saveFlow('T_BDCQLC_GENERAL_FORM');" name="tempSaveFn"/>
            </jsp:include>
            <%--结束引入提交DIV界面 --%>
