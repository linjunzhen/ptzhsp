...
<%--				</td>--%>
<%--				<td style="text-align: center;">--%>
<%--					<a class="eflowbutton" href="<%=path%>/serviceItemController/bsznDetail.do?itemCode=${efor.ITEM_CODE}&projectType=1" target="_blank">办事指南</a>--%>
<%--				</td>--%>
			</tr>
		</e:for>
	</c:if>
