...
<script type="text/javascript" src="<%=path%>/webpage/flowchange/busEsuperChange/BusEsuperChangeAddWin.js"></script>
...
<body class="easyui-layout" fit="true" onload="initflow()">
	<form id="BusEsuperChangeAddForm" method="post" action="busEsuperChangeController.do?saveEditColumn">
 	...
 	<div region="east"  style="width:386px;font-size: 12px;" title="属性面板" split="true">
		...
		<tr style="width:350px;font-size: 12px;">
			<td style="padding-top: 5px;padding-left: 1px;height: 300px;">
				<!-- =========================表格开始==========================-->
				<div id="BusEsuperChangeAddbar">
					<input type="hidden" name="Q_T.PROCESS_CODE_EQ" id="busesuperchange_addprocess"/>
				</div>
				<table id="BusEsuperChangeAddGrid"></table>
				<!-- =========================表格结束==========================-->
			</td>
		</tr>
	</table>
