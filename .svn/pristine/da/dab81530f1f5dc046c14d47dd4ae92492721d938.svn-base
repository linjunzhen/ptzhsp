	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 tmargin20">			
		...
		<tr>
			...
			<td><input type="text" class="syj-input1 validate[required]" 
				name="${currentTime}DIRECTOR_NAME"  placeholder="请输入姓名"  maxlength="8"/></td>
			<th><font class="syj-color2">*</font>职务：</th>
			<td>	
				<eve:eveselect clazz="input-dropdown w280 validate[required]" dataParams="ssdjzw:01"
				dataInterface="dictionaryService.findTwoDatasForSelect" onchange="setDirectorJob(this.value,'${currentTime}DIRECTOR_APPOINTOR')"
		...
		<tr>
			...
			<th> 职工代表：</th>
			<td>
			<input type="checkbox" name="${currentTime}DIRECTOR_REPRESENTATIVE" class="checkbox validate[]" value="1" dicdesc="null">
			是否为职工代表</td> -->
		</tr>
	</table>
