		...
		<table cellpadding="0" cellspacing="0" class="bstable1"  id="tzjbxx">
			<tr>
				...
				<td style="width: 360px;">
					<input type="checkbox" name="FC_PRJ_TYPE" value="100"> 新建
			...
			<tr>
				...
				<td colspan="3">
					<input id="projectName" type="text" class="tab_text validate[required]" name="PRJ_NAME" 
						 maxlength="128" style="width:660px;"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3">
					<input id="projectAddr" type="text" class="tab_text validate[required]" name="ZFCXJSZGBM" 
						 maxlength="128" style="width:660px;" value="平潭综合试验区行政审批局"/>
				</td>
			</tr>
			<tr>
				<th>施工图审查合格证书编号</th>
