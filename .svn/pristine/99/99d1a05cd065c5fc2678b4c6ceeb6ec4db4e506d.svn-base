...
<div class="syj-title1 ">
	...
	<div style="position:relative;">
		...
		<table cellpadding="0" cellspacing="0" class="syj-table2 " id="sqr" style="table-layout: auto;">	
			<tr>
			...
			<tr>
				<th> 电子邮箱</th>
				<td colspan="3">
				<input type="text" maxlength="30" class="syj-input1 validate[[],custom[email]] w878" name="SQRYJ" value="${sessionScope.curLoginMember.DZYX}"/>
				</td>
			</tr>
		</table>
		</c:if>
		...
		<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="syj-table2 ">
			<tr>
				...
				<td >
				<input type="text" maxlength="8"  style="width: 664px;" name="BJCXMM"  value="${busRecord.BJCXMM}" class="syj-input1 validate[required]"  placeholder="请输入查询密码"/>
