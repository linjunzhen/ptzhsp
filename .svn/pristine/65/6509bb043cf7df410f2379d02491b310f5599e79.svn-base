	...
	$(function() {
		...
		$("#ItemGrid").datagrid({
			onDblClickRow: function(index, row){
				...
				var businessCode = row.BUSINESS_CODE;
				if(businessCode){
					alert("事项已经被（"+businessCode+"）绑定,无法重复绑定!");
					return;
				}
	...
	<div class="easyui-layout eui-dialog" fit="true" >	
			...
			<table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
				...
				<thead>
					<tr>
	                    ...
	                    <th data-options="field:'BUSINESS_CODE',hidden:true" width="80">BUSINESS_CODE</th>
		...
		<div data-options="region:'east',split:false" style="width: 400px;">
			...
			<table class="easyui-datagrid" rownumbers="true" id="SelectedItemGrid" 
				...
				method="post" idField="ITEM_ID" checkOnSelect="false" url="departServiceItemController.do?yctbSelected&businessCode=${businessCode}"
