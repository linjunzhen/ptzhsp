...
<script type="text/javascript" src="<%=basePath%>/webpage/bsdt/applyform/bdcqlc/js/bdcQsly.js"></script>
<div id="bdcqsly" name="bdcqlc_bdcqsly">
				...
				<table class="tab_tk_pro2">				
					<tr>					
						...
						<td colspan="3">
							...
							<input type="text" class="tab_text"  style="width: 500px;"
