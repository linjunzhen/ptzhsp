            ...
            <td>
                ...
                <table cellpadding="0" cellspacing="1" class="tab_tk_pro" id="PowerSourceTable">
                    <tr>
                        ...
                        <td class="tab_width1" style="width: 10%;color: #000; font-weight: bold;text-align: center;">权属来源类型</td>
                        <td class="tab_width1" style="width: 10%;color: #000; font-weight: bold;text-align: center;">权属文号</td>
                        <td class="tab_width1" style="width: 10%;color: #000; font-weight: bold;text-align: center;">产权状态</td>
