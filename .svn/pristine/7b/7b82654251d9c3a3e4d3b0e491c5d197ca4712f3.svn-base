...
$(function(){
	if(stateflg=='3'){
		...
		document.getElementById("submitAudit").disabled=true;	
	}
});
function initflow(){
	...
	myDiagram.div.style.height="1000px";
}
...
<body class="easyui-layout" onload="initflow()">
	...
	<div region="north" style="height:80px;background:white;font-size: medium;">
		<div id="titlediv" style="top: 20px;padding-top: 10px;padding-left: 10px;">${busInfo.busName}&nbsp;&nbsp;
    		<button style="cursor: pointer;" onclick="tempSaveFlow();" 
    			id="tempSave" disabled="disabled">保存</button>
			<button style="cursor: pointer;" onclick="submitAudit();" id="submitAudit">提交审批</button>
		</div>
	...
	<div region="center">
 		...
 		<div id="sample" style="height: 100%;top: 80px;width:860px;margin-left: 136px;">
...
<div id="toolbarDiv" style="position:fixed;z-index:9999;display: block;top: 0px;right: 100px;background-color: silver;
					height: 66px;width: 460px;padding-top: 10px;visibility: hidden;" align="center"></div> 
<div id="toolbarDivShow" style="position:fixed;z-index:9999;display: block;top: 0px;right: 100px;background-color: silver;
	...
	onclick="toolbarShow();">工具栏
 	...
 	<div region="east"  style="width:326px;font-size: 12px;" iconCls="icon-reload" title="属性面板" split="true">
			...
			<td style="padding-top: 5px;padding-left: 3px;">
				<table style="width: 100%;" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
							过程编号：
							<input type="text" id="processCode" name="processCode">
						</td>
					</tr>
				</table>
			</td>
