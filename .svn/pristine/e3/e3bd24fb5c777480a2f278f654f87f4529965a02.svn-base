...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/webpage/cms/article/scripts/editInfo.js"></script>
                          ...
                          <tr>
                            ...
                            <td>
                                <select id="selContentType" name="CONTENTTYPE" style="width:174px" disabled="disabled">
                                    <option value="0" selected="selected">信息类型</option>
                    ...
                    <div class="editor_boxR">
                        ...
                        <div class="editor_table"> 
                            <table border="0" cellspacing="0" cellpadding="0"> 
                                ...
                                <tr class="hideCtrl">
                                    <th>摘要：</th>
                                    <td><textarea name="CONTENT_SUMMARY"  rows="4" style="width:170px; font-size:12px" class="easyui-validatebox" data-options="tipPosition:'left',validType:'maxLength[500]'">${content.CONTENT_SUMMARY}</textarea></td>
                                </tr>
                                <tr class="hideCtrl">
                                    <th></th>
