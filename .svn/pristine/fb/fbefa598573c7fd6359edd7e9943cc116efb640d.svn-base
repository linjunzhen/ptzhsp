...
<div class="mui-content">
    <div class="eui-wrap" style="padding-left: 10px;padding-right: 10px;">
        <div class="title"><span style="position: absolute;left: 3px;padding: 5px 10px 5px 5px;" onclick="toBack()">《</span><span>不动产缴交登记费</span></div>
        <div>
            <div class="display_box box-margin current-ziti">请长按二维码图片进行识别缴交登记费</div>
            ...
            <div class="current-ziti box-padding" >①不动产登记费(住宅80元，非住宅550元)</div>
            <div class="current-ziti box-padding">②不动产工本费(10元)</div>
            <div class="current-ziti box-padding">③支付时务必添加备注：您的申报号及个人真实姓名、身份证</div>
