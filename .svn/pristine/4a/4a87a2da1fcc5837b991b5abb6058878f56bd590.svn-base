...
<head>
	...
	<script type="text/javascript">
	    $(document).ready(function(){
			...
			$('#CCRAPPLY_FORM').find('input,textarea').attr("readonly", true);
			$('#CCRAPPLY_FORM').find('select').attr("disabled", "disabled");
			$('#CCRAPPLY_FORM').find(":radio,:checkbox").attr('disabled',"disabled");
			$('#CCRAPPLY_FORM').find(".laydate-icon").attr('disabled',"disabled");
