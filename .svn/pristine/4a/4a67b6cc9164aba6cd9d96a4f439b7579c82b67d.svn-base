...
<div class="addBox">
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2" style="margin-top: -1px;">
		...
		<tr>
			<th> 现金</th>
			<td colspan="3"638px><input type="text" class="syj-input1 validate[],custom[JustNumber]" onchange="alertInvesment(this.value)"
		...
		<tr>
			<th> 实物</th>
			<td colspan="3"638px><input type="text" class="syj-input1 validate[],custom[JustNumber]"
