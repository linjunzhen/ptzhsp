...
<head>
	...
	<title>商品住宅月销售排行榜-平潭综合实验区行政服务中心</title>
	<!-- CSS -->
...
<body>
	...
	<div class="pub-con eui-crumb" data-aos="fade-up">当前位置：首页 > <span>商品住宅月销售排行榜</span></div>
		
	<div class="pub-con in-box clearfix" data-aos="fade-up">
		<div class="lfloat in-l">
			<jsp:include page="/webpage/website/bdc/leftList.jsp?currentNav=3" />
		</div>
		<div class="rfloat in-r">	
			<form id="postForm" method="post" action="bdcQueryController/spzzyxsphb.do">
