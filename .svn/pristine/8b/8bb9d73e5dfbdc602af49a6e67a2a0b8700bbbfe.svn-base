...
<script type="text/javascript">
	...
	function submitFlow(flowSubmitObj){
		 AppUtil.submitWebSiteFlowForm('T_PROJECT_CODEINFOCHANGE_FORM');
	}
</script>
</head>
...
<body style="background: #f0f0f0;">
	...
	<div class="eui-main">
	    ...
	    <form id="T_PROJECT_CODEINFOCHANGE_FORM" method="post" >
	    <%--===================重要的隐藏域内容=========== --%>
	    <%--开始引入公共隐藏域部分 --%>
        ...
        <%--开始引入基本信息部分 --%>
			<jsp:include page="./gcjsxm/codeInfoChanged/tzjbxx.jsp" />
		<%--结束引入基本信息部分 --%>
		...
		<div class="bsbox clearfix">
            ...
            <jsp:include page="./matterListZF.jsp" >
                ...
                <jsp:param value="T_PROJECT_CODEINFOCHANGE_FORM" name="formName"/>
            </jsp:include>
        </div>
		...
		<jsp:include page="./submitdiv.jsp" >
		     ...
		     <jsp:param value="AppUtil.tempSaveWebSiteFlowForm('T_PROJECT_CODEINFOCHANGE_FORM');" name="tempSaveFn"/>
		</jsp:include>
		<%--结束引入提交DIV界面 --%>
