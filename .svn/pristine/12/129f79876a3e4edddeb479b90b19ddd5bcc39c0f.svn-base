...
<script type="text/javascript">
	...
	function restartFlowTaskExplain(){
		...
		if (!(rowsData != null && typeof (rowsData) != 'undefined' && rowsData.length != 0)) {
			...
			if(!isAllowStart){
				...
				AppUtil.operateDataGridRecord("flowTaskController.do?reStart",{selectTaskIds:selectTaskIds},"ZzhyDwspGrid");
			}else{
	 ...
	 * 编辑流程实例列表记录
	 */
	function editZzhyDwspGridRecord() {
		var entityId = AppUtil.getEditDataGridRecord("ZzhyDwspGrid");
		if (entityId) {
	...
	$(document).ready(function() {
		var start1 = {
			elem : "#ZzhyDwspT.CREATE_TIME_BEGIN",
			format : "YYYY-MM-DD",
			istime : false,
		...
		var end1 = {
			elem : "#ZzhyDwspT.CREATE_TIME_END",
			format : "YYYY-MM-DD",
			istime : false,
			choose : function(datas) {
				var beginTime = $("input[name='Q_T.CREATE_TIME_>=']").val();
	...
	function showBjxxGridRecord() {
		var rows = $("#ZzhyDwspGrid").datagrid("getChecked");
        if(rows.length==0){
            art.dialog({
                content: "请至少选择一条记录!",
                icon:"warning",
...
<%--                                onclick="restartFlowTask();">重启流程任务</a>--%>
				...
				<table class="dddl-contentBorder dddl_table"
					...
					<tbody>
						...
						<tr style="height:28px;">
							...
							<td style="width:135px;padding-left:4px;"><input type="text"
								...
								id="ZzhyDwspT.CREATE_TIME_BEGIN" name="Q_E.CREATE_TIME_>=" /></td>
							<td style="width:68px;text-align:right;">申请日期至</td>
							<td style="width:135px;padding-left:4px;"><input type="text"
								style="width:108px;float:left;" class="laydate-icon"
								id="ZzhyDwspT.CREATE_TIME_END" name="Q_E.CREATE_TIME_<=" /></td>
					...
					url:'dictionaryController.do?load&amp;defaultEmpty=true&amp;typeCode=YesOrNo',editable:false,method: 'post',valueField:'DIC_CODE',textField:'DIC_NAME',panelWidth: 74,panelHeight: 'auto' " />
							...
							<td colspan="2"><input type="button" value="查询"
								class="eve-button"
								onclick="AppUtil.gridDoSearch('ZzhyDwspToolbar','ZzhyDwspGrid')" />
		...
		<table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
			id="ZzhyDwspGrid" fitcolumns="false" toolbar="#ZzhyDwspToolbar"
			method="post" idfield="EXE_ID" checkonselect="false"
			selectoncheck="false" fit="true" border="false" nowrap="false"
			url="flowTaskController.do?zzhyNeedMeHandle&Q_T.TASK_NODENAME_NEQ=%e7%aa%97%e5%8f%a3%e5%8a%9e%e7%90%86&Q_E.APPLY_STATUS_NEQ=1&isHaveHandup=true">
			<thead>
				<tr>
