...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if (flowSubmitObj) {
                ...
                if(flowSubmitObj.EFLOW_CURUSEROPERNODENAME=="审批"){
                    //判断是否要抽查
                    //$("#SPSFTG_TR").attr("style","");
                }  
                if(flowSubmitObj.EFLOW_CURUSEROPERNODENAME=="结论登记"){
                    $("#JLDJSFTG_TR").attr("style","");
                }
                ...
                if (flowSubmitObj.busRecord) {
                    FlowUtil.initFormFieldValue(flowSubmitObj.busRecord,"T_BSFW_GCJSXFYS_FORM");
                    //获取表单字段权限控制信息
                    var currentNodeFieldRights = flowSubmitObj.currentNodeFieldRights;
                    //初始化表单字段权限控制
                    FlowUtil.initFormFieldRightControl(currentNodeFieldRights,"T_BSFW_GCJSXFYS_FORM");
                    /*特殊项目信息判定*/
        ...
        function FLOW_SubmitFun(flowSubmitObj) {
            //先判断表单是否验证通过
            var validateResult = $("#T_BSFW_GCJSXFYS_FORM").validationEngine(
                "validate");
            if (validateResult) {
                ...
                if (submitMaterFileJson || submitMaterFileJson == "") {
                    ...
                    $("input[name='EFLOW_SUBMITMATERFILEJSON']").val(
                        submitMaterFileJson);
                    //先获取表单上的所有值
                    var formData = FlowUtil.getFormEleData("T_BSFW_GCJSXFYS_FORM");
            ...
            if (validateResult) {
                ...
                if (submitMaterFileJson || submitMaterFileJson == "") {
                    ...
                    var formData = FlowUtil
                        .getFormEleData("T_BSFW_GCJSXFYS_FORM");
                    for ( var index in formData) {
                        flowSubmitObj[eval("index")] = formData[index];
                    }
                    return flowSubmitObj;
...
<%--            </td>--%>
    ...
    <table cellpadding="0" cellspacing="1" class="tab_tk_pro" id="YWCZ_TABLE" >
        ...
        <tr id="SLSFTG_TR" style="display: none;">
			...
			<td><eve:radiogroup typecode="SLSFTG" width="130px"
					fieldname="SLSFTG" defaultvalue="1" ></eve:radiogroup></td>
		</tr>
<%--         <tr id="SPSFTG_TR" style="display: none;">
			<td class="tab_width"><font class="tab_color">*</font>审批是否通过：</td>
			<td><eve:radiogroup typecode="SHSFTG" width="130px"
					fieldname="SPSFTG" defaultvalue="1" ></eve:radiogroup></td>
		</tr> --%>
		<tr id="JLDJSFTG_TR" style="display: none;">
			<td class="tab_width"><font class="tab_color">*</font>结论登记是否通过：</td>
			<td><eve:radiogroup typecode="SLSFTG" width="130px"
					fieldname="JLDJSFTG" defaultvalue="1" ></eve:radiogroup></td>
		</tr>
		<tr id="JLSPSFTG_TR" style="display: none;">
			<td class="tab_width"><font class="tab_color">*</font>结论审批是否通过：</td>
			<td><eve:radiogroup typecode="SLSFTG" width="130px"
					fieldname="JLSPSFTG" defaultvalue="1" ></eve:radiogroup></td>
		</tr>
		<tr id="FCSFTG_TR" style="display: none;">
			<td class="tab_width"><font class="tab_color">*</font>复查是否通过：</td>
			<td><eve:radiogroup typecode="SLSFTG" width="130px"
					fieldname="FCSFTG" defaultvalue="1" ></eve:radiogroup></td>
		</tr>	
		<tr id="JDBGCSSFTG_TR" style="display: none;">
			<td class="tab_width"><font class="tab_color">*</font>监督报告初审是否通过：</td>
			<td><eve:radiogroup typecode="SLSFTG" width="130px"
					fieldname="JDBGCSSFTG" defaultvalue="1" ></eve:radiogroup></td>
		</tr>
		<tr id="JDBGSPSFTG_TR" style="display: none;">
			<td class="tab_width"><font class="tab_color">*</font>监督报告审批是否通过：</td>
			<td><eve:radiogroup typecode="SLSFTG" width="130px"
					fieldname="JDBGSPSFTG" defaultvalue="1" ></eve:radiogroup></td>
		</tr>						
    </table>
<%--         开始引入申请表信息部分
