...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body  class="easyui-layout bodySelectNone" fit="true" >
		<div data-options="region:'center'" >
	    	<div class="easyui-tabs eve-tabs" fit="true" style="height:900px">
	    		<div title="共性材料" >
				    <iframe src="projectFlowController.do?generalityMater&entityId=${entityId}&materType=1" 
				    	scrolling="auto" width="100%" height="90%" frameborder="0">
				    </iframe>
				</div>
				<div title="申报材料" >
				    <iframe src="projectFlowController.do?generalityMater&entityId=${entityId}&materType=2" 
				    	scrolling="auto" width="100%" height="90%" frameborder="0">
				    </iframe>
				</div>
		        <div title="流转公文" href="fileAttachController.do?flowFiles&projectId=${entityId}">
		        </div>
		        <div title="许可证材料" >
				    <iframe src="projectFlowController.do?generalityMater&entityId=${entityId}&materType=3" 
				    	scrolling="auto" width="100%" height="90%" frameborder="0">
				    </iframe>
				</div>
		        <!-- <div title="电子证照" href="">
