 ...
 * 描述： 好差评系统评价数据上报定时器
 * @author Luffy Cai
 * @created 2020年7月29日 下午3:25:34
 */
public class BadEvaluatePushFlowJob implements Job {

    /**
     * log
     */
    private static Log log = LogFactory.getLog(BadEvaluatePushFlowJob.class);
     ...
     * 审批互联网服务器地址
     */
    private final String URL = "http://192.168.129.178/evaluateController/pushBadEvaluation.do";

    /**
     * 方法_构造方法
     * 
     */
    public BadEvaluatePushFlowJob() {
        super();
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        /*将定时任务转发到审批互联网服务器上运行*/
        log.info("开始执行好差评系统差评数据上报定时任务");
        HttpRequestUtil.sendPost(URL, null);
        log.info("结束执行好差评系统差评数据上报定时任务");
    }
