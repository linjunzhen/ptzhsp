...
<body class="eui-diabody" style="margin:0px;">
	...
	<form id="draftInfoForm" method="post"
		action="agencyServiceController.do?modify">
		<div id="draftInfoFormDiv">
			...
			<table style="width:100%;border-collapse:collapse;"
				...
				<tr>
					<td>
						<span style="width: 150px;float:left;text-align:right;"><font class="dddl_platform_html_requiredFlag">*</font>变更类别：</span> 
						<eve:radiogroup
							typecode="modifyType" width="130px" value="${draftInfo.MODIFY_TYPE}"
							fieldname="MODIFY_TYPE" defaultvalue="03">
						</eve:radiogroup>
					</td>
				</tr>
				<tr>
					<td>
						<span style="width: 150px;float:left;text-align:right;"><font class="dddl_platform_html_requiredFlag">*</font>变更说明：</span> 
						<input type="text" style="width:600px;float:left;"
							value="${draftInfo.MODIFY_DESC}" maxlength="62"
							class="eve-input validate[required]" name="MODIFY_DESC" /> 
						
					</td>
				</tr>
				<tr>
					<td>
						<span style="width: 150px;float:left;text-align:right;"><font class="dddl_platform_html_requiredFlag">*</font>审批事项名称：</span> 
						<textarea class="eve-textarea validate[required,maxSize[512]]" readonly="readonly"
							style="width: 600px;height:100px;" name="ITEM_NAME">${draftInfo.ITEM_NAME}</textarea>
						<input type="hidden" name="ITEM_CODE" value="${draftInfo.ITEM_CODE}" />
						
					</td>
				</tr>
				<tr>
					<td>
						<span style="width: 150px;float:left;text-align:right;"><font class="dddl_platform_html_requiredFlag">*</font>中介服务事项名称：</span> 
						<input type="text" style="width:600px;float:left;"
				...
				<tr>
					<td>
						<span style="width: 150px;float:left;text-align:right;"> 编码：</span> 
						<input type="text" style="width:600px;float:left;"
							value="${draftInfo.AGENCY_ITEM_CODE}" maxlength="30"
							class="eve-input " name="AGENCY_ITEM_CODE" /> 
						
					</td>
				</tr>
				<tr>
					<td>
						<span style="width: 150px;float:left;text-align:right;">中介服务机构类型：</span> 
						<eve:radiogroup
							typecode="agencyType" width="130px" value="${draftInfo.AGENCY_ORG_TYPE}"
							fieldname="AGENCY_ORG_TYPE">
						</eve:radiogroup> 
					</td>
				</tr>
				<tr>
					<td><span style="width: 150px;float:left;text-align:right;"><font class="dddl_platform_html_requiredFlag">*</font>中介收费标准和依据：</span>
						<textarea class="eve-textarea validate[required,maxSize[512]]"
							style="width: 600px;height:150px;" name="CHARGE_STANDARD_BASIS">${draftInfo.CHARGE_STANDARD_BASIS}</textarea>
						
					</td>
				</tr>
				<tr>
					<td><span style="width: 150px;float:left;text-align:right;"><font class="dddl_platform_html_requiredFlag">*</font>设定中介服务依据：</span>
						<textarea class="eve-textarea validate[required,maxSize[512]]"
				...
				<tr>
					<td><span style="width: 150px;float:left;text-align:right;"><font class="dddl_platform_html_requiredFlag">*</font>中介服务服务时限及依据：</span>
						<textarea class="eve-textarea validate[required,maxSize[512]]"
				...
				<tr>
					<td>
						<span style="width: 150px;float:left;text-align:right;"><font class="dddl_platform_html_requiredFlag">*</font>实施部门：</span> 
						<input type="text" style="width:600px;float:left;" onclick="selectImpl();"
							value="${draftInfo.IMPL_DEPART_NAME}" readonly="readonly"
							class="eve-input validate[required]" name="IMPL_DEPART_NAME" /> 
						
					</td>
				</tr>
				<tr>
					<td>
						<span style="width: 150px;float:left;text-align:right;">共同实施部门：</span> 
						<input type="text" style="width:600px;float:left;" onclick="selectTogetherImpl();"
							value="${draftInfo.TOGETHER_DEPART_NAME}" readonly="readonly"
							class="eve-input" name="TOGETHER_DEPART_NAME" /> 
					</td>
				</tr>
				<tr>
					<td>
						<span style="width: 150px;float:left;text-align:right;">备注：</span> 
						<input type="text" style="width:600px;float:left;"
							value="${draftInfo.AGENCY_REMARK}" maxlength="126"
							class="eve-input" name="AGENCY_REMARK" /> 
					</td>
				</tr>
			</table>
		</div>
