	 ...
	 $(function(){
		...
		if(EFLOW_FLOWOBJ){
    		...
    		if(eflowObj.busRecord){
    			FlowUtil.initFormFieldValue(eflowObj.busRecord,"T_BSFW_SHTZXMGH_FORM");
    		}
		}
		//初始化材料列表
...
<body style="background: #f0f0f0;">
	...
	<div class="eui-main">
		...
		<jsp:include page="./submitdiv.jsp" >
		     <jsp:param value="AppUtil.submitWebSiteFlowForm('T_BSFW_SHTZXMGH_FORM');" name="submitFn"/>
		     <jsp:param value="AppUtil.tempSaveWebSiteFlowForm('T_BSFW_SHTZXMGH_FORM');" name="tempSaveFn"/>
		</jsp:include>
		<%--结束引入提交DIV界面 --%>
