...
<script type="text/javascript">
    ...
    function editBdcDwspGridRecord() {
        var entityId = AppUtil.getEditDataGridRecord("BdcQzjffzGrid");
        if (entityId) {
            showExecutionWindow(entityId);
        }
    }
    
    function formatSubject2(val,row){
        //获取流程状态
        var exeId = row.EXE_ID;
        var href = "<a href='";
        href += "executionController.do?goBdcFzjfmx&exeId="+exeId+"&bdc_optype=2";
        /* if(taskStatus!="1"){
    ...
    function formatPrintState(val,row){
        if(val=="1"){
            ...
            return "<font color='#red'><b>待打印</b></font>";
        }
    }
    ...
    $(document).ready(function() {
        var start1 = {
            elem : "#BdcqlcjffzT.CREATE_TIME_BEGIN",
            format : "YYYY-MM-DD",
            istime : false,
        ...
        var end1 = {
            elem : "#BdcQlcjffzT.CREATE_TIME_END",
            format : "YYYY-MM-DD",
            istime : false,
            choose : function(datas) {
                var beginTime = $("input[name='Q_T.CREATE_TIME_>=']").val();
...
<div class="easyui-layout eui-jh-box" fit="true">
    <div region="center">
        ...
        <div id="BdcQzjffzToolbar">
            ...
            <form action="#" name="BdcQlcQzPrintForm">
                    ...
                    <tbody>
                        ...
                        <tr style="height:28px;">
                            ...
                            <td style="width:135px;padding-left:4px;"><input type="text"
                                ...
                                id="BdcqlcjffzT.CREATE_TIME_BEGIN" name="Q_E.CREATE_TIME_>=" /></td>
                            <td style="width:68px;text-align:right;">申请日期至</td>
                            <td style="width:135px;padding-left:4px;"><input type="text"
                                style="width:108px;float:left;" class="laydate-icon"
                                id="BdcQlcjffzT.CREATE_TIME_END" name="Q_E.CREATE_TIME_<=" /></td>
                            ...
                            <td colspan="2"><input type="button" value="查询"
                                class="eve-button"
                                onclick="AppUtil.gridDoSearch('BdcQzjffzToolbar','BdcQzjffzGrid')" />
                                <input type="button" value="重置" class="eve-button"
                                onclick="AppUtil.gridSearchReset('BdcQlcQzPrintForm')" /></td>
                        </tr>
                    </tbody>
                </table>
            </form>
        ...
        <table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
            id="BdcQzjffzGrid" fitcolumns="false" toolbar="#BdcQzjffzToolbar"
            method="post" idfield="EVEID" checkonselect="false"
            selectoncheck="false" fit="true" border="false" nowrap="false"
            url="bdcQlcSffzInfoController.do?jffzListdatagrid">
            <thead>
                <tr>
                    <th field="ck" checkbox="true"></th>
                    <th data-options="field:'EVEID',hidden:true">EVEID</th>
                    <th data-options="field:'EXE_ID',align:'left'" width="12%">申报号</th>
                    <th data-options="field:'SUBJECT',align:'left'" width="30%" formatter="formatSubject2">流程标题</th>
