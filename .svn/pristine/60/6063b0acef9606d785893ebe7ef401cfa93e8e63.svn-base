...
<!-- 纳税人信息开始 -->
<div class="bsbox clearfix" id="nsrxx" style="display:none">
    <div class="bsboxT">
        <ul>
            <li class="on" style="background:none"><span>纳税人承诺信息</span></li>
        </ul>
    </div>
    <div name="nsrxx">
            ...
            <tr>
                <td style="padding: 10px">
                    <table cellpadding="0" cellspacing="1" class="bstable1" >
                        ...
                        <tr>
                        	<th class="tab_width"><font class="tab_color">*</font>家庭住房情况：</th>
                            <td colspan="3">
                   	...
                   	<div class="syj-title1 tmargin20">
						<a href="javascript:void(0);" onclick="javascript:addChidrenXxDiv();" class="syj-addbtn" id="addChidrenXx" >子女信息</a>
						<span>未成年子女信息</span>		
					</div>
					<div id="chidrenXxDiv">
					         <div  style="position:relative;margin:30px;">						 
					         <table cellpadding="0" cellspacing="0" class="syj-table2 tmargin20" id="children_1">	
		                            <tr>
										<th>姓名：</th>
										<td>
											<input type="text" class="syj-input1 " name="NSR_ZNXM"   maxlength="30" value="${busRecord.NSR_ZNXM}"/>
										</td>
										<th>身份证件号码：</th>
										<td>	
											 <input type="text" class="syj-input1" maxlength="30" id="NSR_ZNZJHM" 
			                                       name="NSR_ZNZJHM" value="${busRecord.NSR_ZNZJHM}" />
										</td>
									</tr>
								</table>
								<a href="javascript:void(0);"
										onclick="delChidrenXxDiv(this);" class="syj-closebtn"></a>
						    </div>
					</div>
                </td>
            </tr>
