...
<c:if test="${isQueryDetail==null}">
	...
	<div class="bsbox clearfix">
		<div class="Ctext clearfix lbpadding32">
		    <input type="checkbox" checked="checked" value="1" onclick="clickAgreeCnsnr();" name="AGREE_CNSNR" style="margin: -2px 4px 0 0;"/>我已阅读并遵守<a href="promiseInfoController/info.do?&itemCode=${serviceItem.ITEM_CODE}" target="_blank"><font color="red">《行政审批承诺书》</font></a>
			<br/>
