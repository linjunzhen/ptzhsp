...
// 	    });
		...
		function backToParent(){		
			window.parent.document.getElementById('takeFrame').src="callYctbController/toYctbBusinessItemChooseMacW.do?roomNo=${roomNo}&ifMaterPrint=${ifMaterPrint}&departId=${departId}";
		}
