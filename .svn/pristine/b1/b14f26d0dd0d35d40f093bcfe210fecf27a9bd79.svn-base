...
<head>
	...
	<link rel="stylesheet" type="text/css" href="webpage/callnew/takeNo/css/marriageeui.css">
</head>
<script>
	$(function(){
        reloadView();
	...
	function reloadView(){
        $.post("callDataController.do?lineInfoJsonForMarriage",{},
