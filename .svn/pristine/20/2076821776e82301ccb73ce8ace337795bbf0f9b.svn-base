...
$(document).ready(function() {
            var start1 = {
                elem : "#Sjaxstj.CREATE_TIME_BEGIN",
                format : "YYYY-MM-DD",
                istime : false,
 ...
 function searchData(){
	 myChart.showLoading();
	 var formData = $("form[name='sjaxstjForm']").serialize();
	 $.post("statisticalReportController.do?sjaxstjData",formData, function(responseText) {
...
<div class="easyui-layout" fit="true">
	<div region="center">
		<!-- =========================查询面板开始========================= -->
		<div id="sjaxstjStatisToolBar">
			<form action="#" name="sjaxstjForm">
					...
					<tbody>
						<tr style="height:28px;">
							...
							<td style="width:135px;"><input type="text"
								...
								id="Sjaxstj.CREATE_TIME_BEGIN" name="Q_T.CREATE_TIME_>=" 
								value="${sTime}" /></td>
							<td style="width:68px;text-align:right;">结束日期</td>
							<td style="width:135px;"><input type="text"
								style="width:128px;float:left;" class="laydate-icon"
								id="Sjaxstj.CREATE_TIME_END" name="Q_T.CREATE_TIME_<=" 
								value="${eTime}"  /></td>
							...
							<td colspan="2"><input type="button" value="查询"
								...
								onclick="AppUtil.gridSearchReset('sjaxstjForm')" /></td>
						</tr>
					</tbody>
				</table>
			</form>
