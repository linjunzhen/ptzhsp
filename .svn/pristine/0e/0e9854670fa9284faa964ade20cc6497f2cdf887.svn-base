					...
					<table class="dddl-contentBorder dddl_table"
						...
						<tr style="height:28px;">
							...
							<td style="width:135px;"><input class="eve-input validate[${required}]"
								type="text" maxlength="50" style="width:128px;"
								name="bdcdjzmh" /></td>
							<td style="width:120px;text-align:right;"><c:if test="${isBank eq 'true'}"><font class="tab_color ">*</font></c:if>权利人姓名：</td>
							<td style="width:135px;"><input class="eve-input validate[${required}]"
								type="text" maxlength="50" style="width:128px;"
								name="qlr" /></td>
						</tr>
						<tr>
							<td style="width:120px;text-align:right;"><c:if test="${isBank eq 'true'}"><font class="tab_color ">*</font></c:if>权利人证件号码：</td>
							<td style="width:135px;"><input class="eve-input"
								type="text" maxlength="50" style="width:128px;"
								name="qlrzjh" /></td>
