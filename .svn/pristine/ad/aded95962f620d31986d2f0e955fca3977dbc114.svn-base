...
<head>
    ...
    <script type="text/javascript">
        ...
        function search() {
            var bdcqzh = $("input[name='bdcqzh']").val();
            ...
            AppUtil.gridDoSearchBdc('bdcdaxxcxToolbar','bdcdaxxcxGrid','bdcdyh');
        }
        function Trim(str)
        {
                ...
                <table class="dddl-contentBorder dddl_table"
                    ...
                    <tr style="height:28px;">
                        ...
                        <td style="width:300px;"><input class="eve-input"
                                                        ...
                                                        name="bdcdyh" /></td>
                        <td style="width:120px;text-align:right;"><font class="tab_color ">*</font>不动产权证号：</td>
                        <td style="width:300px;"><input class="eve-input validate[required]"
                                                        type="text" maxlength="30" style="width:300px;"
                                                        name="bdcqzh" /></td>
                        <td style="width:120px;text-align:right;"><font class="tab_color ">*</font>权利人：</td>
                        <td style="width:300px;"><input class="eve-input validate[required]"
