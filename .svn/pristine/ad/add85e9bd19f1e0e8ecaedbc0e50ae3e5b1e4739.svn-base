...
%>
<style>
.tabcont1 li a:hover{background:#eaf5ff; color:#fff;}
.tabcont1 li a{background:#eaf5ff; color:#fff;}
</style>
<div class="eui-bsl">
	<div class="hd eui-bstitle">
		<div class="hd eui-bstitle">
                <ul>
                    <li><a href="javascript:void(0);">个人办事</a></li>
                    <li><a href="javascript:void(0);">法人办事</a></li>
                    <li><a href="javascript:void(0);">部门办事</a></li>
                </ul>
         </div>
	</div>
	<div class="bd eui-bscon clearfix">
		<div class="grcon">
			<ul>
				...
				<% i=i++; %>
				<li>
					<a href="webSiteController/view.do?navTarget=website/grbs/grbs&sybusTypeId=${grbsInfo.TYPE_ID}" 
					target="_blank">
						<c:if test="${grbsInfo.ICON_PATH!=null}">
						   <img src="${_file_Server}${grbsInfo.ICON_PATH}" />
						</c:if>
						<c:if test="${grbsInfo.ICON_PATH==null}">
