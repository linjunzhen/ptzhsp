...
<script type="text/javascript">
	...
	function editDtjzwInfo() {
		var entityId = AppUtil.getEditDataGridRecord("dtjzwxxGrid");
		if (entityId) {
			...
			<tr>
				<td style="height:155px;">
					<table class="easyui-datagrid" rownumbers="true" pagination="false"
						id="dtjzwxxGrid" idfield="FC_UNIT_INFO_ID" fitcolumns="true"
						checkonselect="true" style="width:100%;height:auto;"
						selectoncheck="true" fit="true" border="false" >
						<thead>
							<tr>
								<th field="ck" checkbox="true"></th>
								<th data-options="field:'FC_UNIT_INFO_ID',hidden:true">ID</th>
