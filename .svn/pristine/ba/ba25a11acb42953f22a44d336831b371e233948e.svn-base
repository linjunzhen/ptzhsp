...
<div class="scrollt-left">
    <ul class="scrollt-list">
        <li >
            <a href="callController.do?toReadCardAppointMacW&roomNo=${roomNo}" style="width: 176px;">
                <img src="webpage/call/takeNo/images/toReadCardAppoint.png">
                <span style="font-size:22px;font-weight:bold;">预约取号</span>
            </a>
        </li>
        <li >
            <a href="callYqyzController/toYqyzZzTypeMacW.do?departId=${departId}&roomNo=${roomNo}&ifMaterPrint=${ifMaterPrint}&cleanItem=1" style="width: 176px;">
                <img src="webpage/call/takeNo/images/toDeptChoose.png" style="margin-top: 10px;">
                <span style="font-size:22px;font-weight:bold;">现场取号<br>(一企一证)</span>
            </a>
        </li>
        <li >
            <a href="newCallController/toDeptChoose.do?roomNo=${roomNo}" style="width: 176px;">
                <img src="webpage/call/takeNo/images/toDeptChoose.png" style="margin-top: 10px;">
                <span style="font-size:22px;font-weight:bold;">现场取号<br>(其他许可事项)</span>
            </a>
        </li>
        <li >
             <a href="callController.do?toReadCardAgainMacW&roomNo=${roomNo}" style="width: 176px;">
                <img src="webpage/call/takeNo/images/toReadCardAppoint.png">
