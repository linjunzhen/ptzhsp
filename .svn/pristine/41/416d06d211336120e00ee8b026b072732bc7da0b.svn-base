...
<script type="text/javascript">
    ...
    function exportBjpyExcel(){
    	...
    	window.location.href = "statisticsController.do?exportSlBjpytjExcel&Q_T.CREATE_TIME_GE="+beginDate+" 00:00:00&Q_T.CREATE_TIME_LE="+endDate+" 23:59:59&beginDate="+beginDate+"&endDate="+endDate;
    }
	...
	$('#SLBJPYStatisGrid').datagrid({ pagination: false,
		onLoadSuccess: function (data) {
			if (data.rows.length > 0) {
				//调用mergeCellsByField()合并单元格
				mergeCellsByField("SLBJPYStatisGrid", "PARENT_NAME,OPERATOR");
			}
		}
	});		
	/**
...
<div class="easyui-layout eui-jh-box" fit="true">
	<div region="center">
					...
					<tbody>
						<tr style="height:28px;">
							...
							<td colspan="2"><input type="button" value="查询"
								class="eve-button"
								onclick="AppUtil.gridDoSearch('SLBJPYStatisToolBar','SLBJPYStatisGrid')" />
		...
		<table class="easyui-datagrid" rownumbers="true" pagination="false" striped="true"
			id="SLBJPYStatisGrid" fitcolumns="false" toolbar="#SLBJPYStatisToolBar"
			method="post" idfield="LOG_ID" checkonselect="false"
			selectoncheck="false" fit="true" border="false"
			url="statisticsController.do?slbjpyData">
			<thead>
				<tr>
					<th data-options="field:'PARENT_NAME',align:'left'" width="20%" rowspan="2">上级部门</th>
