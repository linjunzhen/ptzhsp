...
<script type="text/javascript">
	...
	$(function() {
		...
		var typeCode3 = '${info.INDUSTRY_STRUCTURE}';
		$.post( "dicTypeController/info.do",{
			typeCode:typeCode3},
		...
		$('#tzjbxx').find('input,textarea').prop("readonly", true);
		$('#tzjbxx').find('input,textarea').prop("disabled", "disabled");
		$('#tzjbxx').find('select').prop("disabled", "disabled");
		$('#tzjbxx').find(":radio,:checkbox").attr('disabled',"disabled");
		$('#tzjbxx').find(".laydate-icon").attr('disabled',"disabled");		
	});
	//清除前后空格
	function trim(str){ 
	...
	$().ready(function() {
		//var info = '${info.PROJECTCODE}';
		
		//if(info){
		//	loadTZXMXXData();
		//}
		$("input[name='LEREP_INFO']").val('${info.lerep_info}');
		$("input[name='CONTRIBUTION_INFO']").val('${info.contribution_info}');
		isShowWztzxx();
	});
...
<input type="hidden" id="foreignabroadFlag" name="FOREIGN_ABROAD_FLAG" value="${info.FOREIGN_ABROAD_FLAG}"/>
<input type="hidden" id="theIndustry" name="THE_INDUSTRY" value="${info.THE_INDUSTRY}"/>
...
<table cellpadding="0" cellspacing="0" class="syj-table2" id="tzjbxx">
	<tr>
		...
		<td colspan="3">
			<font style="margin-left: 4px;">${info.PROJECT_CODE}</font>
			<input type="hidden" id="PROJECT_CODE" name="PROJECT_CODE" value="${info.PROJECT_CODE}"/>
		</td>
	</tr>	
	<tr>
		...
		<td>
			...
			class="eve-input validate[required]" value="${info.PROJECT_NAME}" name="PROJECT_NAME" />
		</td>
		...
		<td>
			<eve:eveselect clazz="eve-input1 whf_input validate[required] field_width" dataParams="PROJECTTYPE"
				dataInterface="dictionaryService.findDatasForSelect" value="${info.PROJECT_TYPE}"
	...
	<tr>
		...
		<td>
			...
			class="eve-input validate[required]" value="${info.DIVISION_CODE}" name="DIVISION_CODE" />
		</td>
		...
		<td>
			...
			class="eve-input validate[]" value="${info.PERMIT_ITEM_CODE}" name="PERMIT_ITEM_CODE" />
		</td>
	</tr>			
	<tr>
		...
		<td>
			<eve:eveselect clazz="eve-input1 whf_input validate[required] " dataParams="PROJECTNATURE"
				dataInterface="dictionaryService.findDatasForSelect" value="${info.PROJECT_NATURE}"
	...
	<tr>
		...
		<td>
				<input readonly="true" id="startYear" type="text"  class="eve-input  Wdate"  onclick="WdatePicker({dateFmt:'yyyy',isShowClear:false})"  name="START_YEAR"  value="${info.START_YEAR}"/>
		</td>
		<th style="border-bottom-width: 1px;width:180px;"><font class="dddl_platform_html_requiredFlag">*</font>拟建成时间</th>
		<td>
			<input readonly="true" id="endYear" type="text" class="eve-input  Wdate"  onclick="WdatePicker({dateFmt:'yyyy',isShowClear:false})"  name="END_YEAR" value="${info.END_YEAR}" />
		</td>
	</tr>	
	<tr>
		...
		<td>								
			...
			class="eve-input validate[required]" maxlength="16" name="TOTAL_MONEY"  value="${info.TOTAL_MONEY}" />	
		</td>
		<th style="border-bottom-width: 1px;width:180px;"><font class="dddl_platform_html_requiredFlag">*</font>申报时间</th>
		<td>
			<input readonly="true" id="APPLY_DATE" type="text" class="eve-input  Wdate"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false})"  name="APPLY_DATE"  value="${info.APPLY_DATE}" />
		</td>
	</tr>				
	<tr>
		...
		<td  colspan="3">
			<textarea id="totalMoneyExplain" class="eve-textarea " rows="3" cols="200"  
			  name="TOTAL_MONEY_EXPLAIN" style="width:81.6%;height:75px;"  >${info.TOTAL_MONEY_EXPLAIN}</textarea>
		</td>
	</tr>	
	<tr>
		...
		<td>
			...
			class="eve-input validate[required]"   name="PLACE_CODE_DETAIL"  value="${info.PLACE_CODE_DETAIL}" />
		</td>
	</tr>					
	<tr>
		...
		<td  colspan="3">
			<textarea id="SCALE_CONTENT" class="eve-textarea " rows="3" cols="200"  
			  name="SCALE_CONTENT" style="width:81.6%;height:75px;"  >${info.SCALE_CONTENT}</textarea>
		</td>
	</tr>	
	<tr>
		...
		<td>
			...
			dataInterface="dictionaryService.findDatasForSelect" value="${info.PROJECT_ATTRIBUTES}"
	...
	<tr>	
		...
		<td>
			<eve:eveselect clazz="eve-input1 whf_input validate[required]" dataParams="getLandMode"
				dataInterface="dictionaryService.findDatasForSelect" value="${info.GET_LAND_MODE}"
		...
		<td>
			<eve:eveselect clazz="eve-input1 whf_input validate[required]" dataParams="XMTZLY"
				dataInterface="dictionaryService.findDatasForSelect" value="${info.XMTZLY}"
	...
	<tr>	
		...
		<td>
			<eve:eveselect clazz="eve-input1 whf_input validate[required]" dataParams="TDSFDSJFA"
				dataInterface="dictionaryService.findDatasForSelect" value="${info.TDSFDSJFA}"
		...
		<td>
			<eve:eveselect clazz="eve-input1 whf_input validate[required]" dataParams="SFWCQYPG"
				dataInterface="dictionaryService.findDatasForSelect" value="${info.SFWCQYPG}"
	...
	<tr>	
		...
		<td colspan="3">
			<eve:eveselect clazz="eve-input1 whf_input validate[required]" dataParams="GCFL"
				dataInterface="dictionaryService.findDatasForSelect" value="${info.GCFL}"
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2">			
		<tr>
			...
			<td>
				<eve:eveselect clazz="eve-input1 whf_input validate[required] " dataParams="YesOrNo"
					dataInterface="dictionaryService.findDatasForSelect" value="${info.IS_COUNTRY_SECURITY}" onchange="showSecurityApprovalNumber(this.value)" 
			...
			<td>
				...
				class="eve-input"  name="SECURITY_APPROVAL_NUMBER"  value="${info.SECURITY_APPROVAL_NUMBER}" value="${info.SECURITY_APPROVAL_NUMBER}" />	
			</td>
		</tr>	
		...
		<tr>
			...
			<td>
				<eve:eveselect clazz="eve-input1 whf_input  validate[required]" dataParams="investmentMode"
					dataInterface="dictionaryService.findDatasForSelect" value="${info.INVESTMENT_MODE}"
			...
			<td>
				...
				class="eve-input  validate[required,custom[numberp6plus]]" name="TOTAL_MONEY_DOLLAR"  value="${info.TOTAL_MONEY_DOLLAR}" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				class="eve-input  validate[required,custom[numberp6plus]]" name="TOTAL_MONEY_DOLLAR_RATE"  value="${info.TOTAL_MONEY_DOLLAR_RATE}"  />
			</td>
			...
			<td>
				...
				class="eve-input  validate[required,custom[numberp6plus]]" name="PROJECT_CAPITAL_MONEY"  value="${info.PROJECT_CAPITAL_MONEY}" />
			</td>
		</tr>
		<tr>
			<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font> 项目资本金折合美元<br/>(万元)</th>
			<td>
				<input id="projectCapitalMoneyDollar" class="eve-input  validate[required,custom[numberp6plus]]" style="width:80%;height:25px;float:left;" value="${info.PROJECT_CAPITAL_MONEY_DOLLAR}"
			...
			<td>
				...
				class="eve-input  validate[required,custom[numberp6plus]]" name="PROJECT_CAPITAL_MONEY_RATE"  value="${info.PROJECT_CAPITAL_MONEY_RATE}" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<eve:eveselect clazz="eve-input1 whf_input validate[required]" dataParams="industrialPolicyType"
					dataInterface="dictionaryService.findDatasForSelect" value="${info.INDUSTRIAL_POLICY_TYPE}"
			...
			<td>
				<eve:eveselect clazz="eve-input1 whf_input validate[]" dataParams="industrialPolicy"
					dataInterface="dictionaryService.findDatasForSelect" value="${info.INDUSTRIAL_POLICY}"
		...
		<tr id="otherInvestmentApplyInfoTr" style="display: ">
			...
			<td  colspan="3">
				...
				name="OTHER_INVESTMENT_APPLY_INFO"  style="width:80%;height:75px;" >${info.OTHER_INVESTMENT_APPLY_INFO}</textarea>
			</td>
		</tr>
		<tr id="transactionBothInfoTr" style="display: ">
			...
			<textarea id="transactionBothInfo" class="eve-textarea validate[maxSize[2000]]" rows="3" cols="200"  
			 name="TRANSACTION_BOTH_INFO"  style="width:80%;height:75px;" >${info.TRANSACTION_BOTH_INFO}</textarea>
			</td>
		</tr>
		<tr id="mergerPlanTr" style="display: ">
			...
			<textarea id="mergerPlan" class="eve-textarea validate[maxSize[2000]]" rows="3" cols="200"  
			 name="MERGER_PLAN"  style="width:80%;height:75px;" >${info.MERGER_PLAN}</textarea>
			</td>
		</tr>
		<tr id="mergerManagementModeScopeTr" style="display: ">
			...
			<textarea id="mergerManagementModeScope" class="eve-textarea validate[maxSize[2000]]" rows="3" cols="200"  
			 name="MERGER_MANAGEMENT_MODE_SCOPE"  style="width:80%;height:75px;" >${info.MERGER_MANAGEMENT_MODE_SCOPE}</textarea>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				class="eve-input  validate[required,custom[numberp6plus]]" name="BUILT_AREA"   value="${info.BUILT_AREA}"/>
			</td>
			...
			<td>
				...
				class="eve-input  validate[required,custom[numberp6plus]]" name="LAND_AREA"  value="${info.LAND_AREA}" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<eve:eveselect clazz="eve-input1 whf_input validate[required]" dataParams="YesOrNo"
					dataInterface="dictionaryService.findDatasForSelect" value="${info.IS_ADD_DEVICE}"
			...
			<td>
				<input id="importDeviceNumberMoney" type="text" maxlength="100" class="eve-input   validate[required]" name="IMPORT_DEVICE_NUMBER_MONEY"  style="width:80%;height:25px;float:left;" value="${info.IMPORT_DEVICE_NUMBER_MONEY}"/>
			</td>
		</tr>
	</table>
</div>
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2">	
		<tr>
			...
			<td>
				...
				class="eve-input  validate[required]" name="PROJECT_SITE"  value="${info.PROJECT_SITE}" />
			</td>
			...
			<td>
				...
				class="eve-input validate[required,custom[numberp6plus]]" name="CHINA_TOTAL_MONEY" value="${info.CHINA_TOTAL_MONEY}" />
			</td>
		</tr>
	</table>
</div>
