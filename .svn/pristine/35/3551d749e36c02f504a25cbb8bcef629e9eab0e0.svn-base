	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 tmargin20">
		<tr>
			...
			<td><fda:fda-exradiogroup name="${currentTime}RYXB"
					width="100" datainterface="fdaDictionaryService.findList"
					value=""
		...
		<tr>
			...
			<td><input type="text" value=""
				...
				class="syj-input1 validate[required,custom[integer],min[0]]"
				name="RYNL" /></td> 
		</tr>
		<tr>-->
