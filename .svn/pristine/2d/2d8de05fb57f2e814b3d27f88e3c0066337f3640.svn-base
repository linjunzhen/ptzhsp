...
//***************************卓正PageOffice组件的使用********************************
    ...
    DataRegion dataRegion1 = wordDoc.openDataRegion("PO_Qrcode");
    //dataRegion1.setValue("[image]http://www.zhuozhengsoft.com/images/logo.png[/image]");
    dataRegion1.setValue("[image]"+imagePath+"[/image]");
