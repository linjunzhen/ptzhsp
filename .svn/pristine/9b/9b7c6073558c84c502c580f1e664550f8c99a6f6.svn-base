...
<body style="margin:0px;background-color: #f7f7f7;">
	<form id="mobileForm" method="post"
		action="sysUserController.do?updateMobile">
		<!--==========隐藏域部分开始 ===========-->
		...
		<table style="width:100%;border-collapse:collapse;"
			...
			<tr style="height:29px;">
				<td colspan="2" class="dddl-legend" style="font-weight:bold;">绑定手机信息</td>
			</tr>

			<tr>
				<td><span style="width: 100px;float:left;text-align:right;">手机号码：</span>
					<input type="mobile" style="width:150px;float:left;"
					maxlength="16" class="eve-input validate[custom[mobilePhoneLoose]]"
