...
<div id="fwPowerPeopleInfo" trid="">
    <table cellpadding="0" cellspacing="1" class="tab_tk_pro2">
   	   <tr>
        <th><span>家庭唯一生活用房承诺书</span>
        <input type="button" class="eflowbutton" style="float:right; margin: 2px 5px; padding: 0 20px;" value="保存" onclick="submitFwPowerPeopleInfo('1');"/>
        <input type="button" class="eflowbutton" style="float:right; margin: 2px 5px; padding: 0 20px;" value="添加" onclick="submitFwPowerPeopleInfo('0')"/>
        </th>
     </tr> 
        <tr>
                   ...
                   <tr>
                        ...
                        <td colspan='3'>
                            <input type="text" style="width: 80%;color: red;" disabled="disabled" class="tab_text validate[required]" maxlength="128" id="WYYF_ZZCN" name="WYYF_ZZCN"
                                   value="上述填写内容真实、完整，拟转让房产为本人家庭在福建省辖区范围内的唯一生活用房，如有隐瞒愿负相应法律责任。" />
                        </td>
                   </tr>
