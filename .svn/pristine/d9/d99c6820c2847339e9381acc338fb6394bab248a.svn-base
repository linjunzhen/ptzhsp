	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 tmargin20">
		<tr>
			...
			<td><input type="text" class="syj-input1 validate[required]" onblur="setSgxkjbxx();"
				name="${currentTime}CORPNAME" maxlength="100" placeholder="请输入单位名称" /> 
						<a href="javascript:void(0);" class="eflowbutton"  onclick="showSelectEnterprise('kcdwDiv','${currentTime}CORPNAME','${currentTime}CORPCREDITCODE');">查询</a>
			</td>				
		...
		<tr>
			...
			<td>
				...
				defaultEmptyText="请选择勘察单位资质等级" name="${currentTime}QUALLEVEL">
				</eve:eveselect>
			</td>
			<th><font class="syj-color2">*</font>勘察单位资质证书号</th>
			<td><input type="text" class="syj-input1 validate[required]"
				name="${currentTime}QUALCERTNO"  placeholder="请输入勘察单位资质证书号"  maxlength="32" /></td>
		</tr>
		<tr>	
		...
		<tr>
			...
			<td>
				...
				dataInterface="dictionaryService.findDatasForSelect"  onchange="setSgxkZjValidate(this.value,'${currentTime}KCDW_LEGAL_IDNO');"
				defaultEmptyText="请选择法定代表人证件类型" name="${currentTime}LEGAL_IDTYPE">
				</eve:eveselect>
			</td>
			<th><font class="syj-color2">*</font>证件号码</th>
			<td><input type="text" class="syj-input1 validate[required]"
				name="${currentTime}KCDW_LEGAL_IDNO"  placeholder="请输入法定代表人证件号码"  maxlength="32" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				...
				dataInterface="dictionaryService.findDatasForSelect"  onchange="setSgxkZjValidate(this.value,'${currentTime}KCDW_PERSONIDCARD');"
			...
			<td><input type="text" class="syj-input1 validate[required],custom[vidcard]"
				name="${currentTime}KCDW_PERSONIDCARD"  placeholder="请输入项目负责人师证件号码"  maxlength="32" /></td>
		</tr>
		<tr>
