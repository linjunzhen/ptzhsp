...
<table cellpadding="0" cellspacing="1" class="tab_tk_pro2">
	...
	<tr>
		<td class="tab_width"><font class="tab_color">*</font>适用会计制度：</td>
		<td colspan="3">
			<input type="radio" name="ACCOUNTING_SYSTEM" value="1" <c:if test="${busRecord.ACCOUNTING_SYSTEM==1 }">checked="checked"</c:if> >企业会计准则
			<input type="radio" name="ACCOUNTING_SYSTEM" value="2" <c:if test="${busRecord.ACCOUNTING_SYSTEM==2 }">checked="checked"</c:if> >小企业会计制度
		</td>
	</tr>
	<tr>
