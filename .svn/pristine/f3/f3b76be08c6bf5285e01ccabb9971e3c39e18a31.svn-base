...
$(document).ready(function() {
 ...
 function searchData(){
	 myChart.showLoading();
	 var url = "statisticalReportController.do?cnjbjtjData&Q_T.END_TIME_LE="+$("input[name='Q_T.END_TIME_<=']").val()+" 23:59:59&Q_T.END_TIME_GE="+$("input[name='Q_T.END_TIME_>=']").val()+" 00:00:00&echartType="+$("#echartType").val();
...
<div class="easyui-layout" fit="true">
	<div region="center">
		<!-- =========================查询面板开始========================= -->
		<div id="cnjbjtjStatisToolBar">
			<form action="#" name="cnjbjtjForm">
					...
					<tbody>
						<tr style="height:28px;">
							...
							<td style="width:135px;"><input type="text"
								...
								id="Sjattj.END_TIME_BEGIN" name="Q_T.END_TIME_>=" /></td>
							<td style="width:68px;text-align:right;">结束日期</td>
							<td style="width:135px;"><input type="text"
								style="width:128px;float:left;" class="laydate-icon"
								id="Sjattj.END_TIME_END" name="Q_T.END_TIME_<=" /></td>
							...
							<td colspan="2"><input type="button" value="查询"
								...
								onclick="AppUtil.gridSearchReset('cnjbjtjForm')" /></td>
						</tr>
					</tbody>
				</table>
			</form>
