...
<script type="text/javascript">
	 ...
	 */
	function editZRInfo() {
		var entityId = AppUtil.getEditDataGridRecord("zrztxxGrid");
		if (entityId) {
	...
	function showZrztxxWindow(entityId) {
		...
		$.dialog.open("xfDesignController.do?zrztInfo&entityId=" + 
			...
			<tr>
				<td style="height:155px;">
					<table class="easyui-datagrid" rownumbers="true" pagination="false"
						id="zrztxxGrid" idfield="FC_CORP_INFO_ID" fitcolumns="true"
