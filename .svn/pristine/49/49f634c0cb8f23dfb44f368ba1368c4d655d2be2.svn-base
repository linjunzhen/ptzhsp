...
<script type="text/javascript">
	$(function(){
		...
		if(EFLOW_FLOWOBJ){
    		...
    		if(eflowObj.busRecord){
    			FlowUtil.initFormFieldValue(eflowObj.busRecord,"T_BSFW_ZFTZTYJGYS_FORM");
    		}
		}
	...
	//	 var validateResult =$("#T_BSFW_ZFTZTYJGYS_FORM").validationEngine("validate");
		 ...
		 AppUtil.submitWebSiteFlowForm('T_BSFW_ZFTZTYJGYS_FORM');		
	}
	   ...
	   <form id="T_BSFW_ZFTZTYJGYS_FORM" method="post" >
        ...
        <div class="bsbox clearfix">
            ...
            <div class="bsboxC">
				<table cellpadding="0" cellspacing="0" class="bstable1">
					<tr>			
			            <th><span class="bscolor1">*</span> 《施工图》审查情况：</th>
						<td colspan="3"><textarea name="SGTSCQK" cols="130" rows="10" maxlength="500" class="validate[required]"></textarea></td>
					</tr>
				</table>
            </div>
        </div>
		...
		<jsp:include page="./submitdiv.jsp" >
		     ...
		     <jsp:param value="AppUtil.tempSaveWebSiteFlowForm('T_BSFW_ZFTZTYJGYS_FORM');" name="tempSaveFn"/>
		</jsp:include>
		<%--结束引入提交DIV界面 --%>
