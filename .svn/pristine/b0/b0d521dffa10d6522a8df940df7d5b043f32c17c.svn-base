...
<div class="syj-title1 ">
	...
	<div style="position:relative;">
		<table cellpadding="0" cellspacing="0" class="syj-table2 ">			
			<tr>
				...
				<td  title="自动回填"><input type="text" class="syj-input1 validate[required],custom[JustNumber]" 
					name="INVESTMENT"  placeholder="投资总额"
					 value="${busRecord.INVESTMENT}"/></td>
			...
			<table cellpadding="0" cellspacing="0" class="syj-table2 " style="margin-top: -1px;">
				...
				<tr>
					...
					<td colspan="3"><input type="text" class="syj-input1 validate[],custom[JustNumber]" onchange="alertInvesment(this.value)"
						...
						onblur="onlyNumber(this);setInvestment()" onkeyup="onlyNumber(this);" />
				...
				<tr>
					...
					<td colspan="3"><input type="text" class="syj-input1 validate[],custom[JustNumber]"
						...
						onblur="onlyNumber(this);setInvestment()" onkeyup="onlyNumber(this);" style="width: 663px;"/>
						<eve:eveselect clazz="input-dropdown validate[required]" dataParams="ssdjbz"
							dataInterface="dictionaryService.findDatasForSelect"
							defaultEmptyText="请选择币种" name="CURRENCY_1" value="人民币" onchange="setCurrency(this.value)">
						</eve:eveselect>
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 ">		
		<tr>
			...
			<td ><input type="text" class="Wdate validate[required]" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false})"
