	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 ">
		<tr>
			...
			<td><input type="text" class="syj-input1 validate[required]" 
				name="${currentTime}SUPERVISOR_NAME" placeholder="请输入姓名，须填写自然人姓名"  maxlength="8"/></td>
		...
		<tr>
			...
			<td>
				...
				defaultEmptyText="请选择产生方式" name="${currentTime}SUPERVISOR_GENERATION_MODE"  value="02" >
				</eve:eveselect>
			</td>
