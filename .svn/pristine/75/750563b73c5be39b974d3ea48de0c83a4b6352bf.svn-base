...
<body class="bg-none macw" ondragstart="return false" oncontextmenu="return false" onselectstart="return false">
    ...
    <script type="text/javascript">
		...
		function backToParent(){		
			window.parent.document.getElementById('takeFrame').src="newCallController/toYctbBusinessItemChooseMacW.do?roomNo=${roomNo}&ifMaterPrint=${ifMaterPrint}&departId=${departId}";
		}
		
		function readCard(materTypeId){					
			window.parent.document.getElementById('takeFrame').src="webpage/callnew/takeNo/yctbReadCardWhite.jsp?materTypeId="+
