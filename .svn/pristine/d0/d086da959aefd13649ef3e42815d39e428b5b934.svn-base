...
import net.evecom.platform.bdc.service.BdcSpbdyService;
 ...
 */
@Service("bdcSpbdyService")
public class BdcSpbdyServiceImpl extends BaseServiceImpl implements BdcSpbdyService {
    ...
    public void setGyjsydsyqjfwsyqscdjData(Map<String, Map<String, Object>> args) {
        ...
        //国有建设用地使用权及房屋所有权首次登记业务数据
        this.setGyjsydsyqjfwsyqscdjBusInfo(returnMap, busInfo, execution);
    ...
    /**
     * 
     * 描述  不动产全流程 国有建设用地使用权及房屋所有权变更登记 审批表
     * @author Kester Chen
     * @created 2020年5月19日 下午2:23:18
     * @param args
     */
    ...
    public void setGyjsydsyqjfwsyqbgdjData(Map<String, Map<String, Object>> args) {
        ...
        //国有建设用地使用权及房屋所有权变更登记业务数据
        this.setGyjsydsyqjfwsyqbgdjBusInfo(returnMap, busInfo, execution);
    ...
    public void setGyjsydsyqscdjData(Map<String, Map<String, Object>> args) {
        ...
        //国有建设用地使用权首次登记业务数据
        this.setGyjsydsyqscdjBusInfo(returnMap, busInfo, execution);
    ...
    private void setJtjsydsyqscdjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
        ...
        returnMap.put("djlx", "集体建设用地使用权首次登记");
    ...
    private void setJtjsydsyqbgdjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
                                               Map<String, Object> execution) {
        returnMap.put("qllx", "集体建设用地使用权");
        returnMap.put("djlx", "集体建设用地使用权变更登记");
    ...
    /**
     * 
     * 描述 国有建设用地使用权及房屋所有权变更登记 业务数据
     * @author Kester Chen
     * @created 2020年5月19日 下午2:28:09
     * @param returnMap
     * @param busInfo
     * @param execution
     */
    private void setGyjsydsyqjfwsyqbgdjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
                                               Map<String, Object> execution) {
     ...
     * @param execution
     */
    private void setGyjsydsyqjfwsyqscdjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
                                               Map<String, Object> execution) {
        returnMap.put("qllx", "国有建设用地使用权及房屋所有权首次");
        returnMap.put("djlx", "国有建设用地使用权及房屋所有权首次登记");
     ...
     * @param execution
     */
    private void setGyjsydsyqscdjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
                                               Map<String, Object> execution) {
        returnMap.put("qllx", "国有建设用地使用权首次登记");
        ...
        if (StringUtils.isNotEmpty(qsJson)) {
            ...
            for (Map<String, Object> qsMap : qsList) {
                ywrxm.append(StringUtil.getValue(qsMap, "QLR")).append(",");
                /*证件类型代码转换*/
                String powerpeopleidtype = StringUtil.getValue(qsMap, "BDC_QLRZJLX");
                String documentType = dictionaryService.getDicNames("DocumentType", powerpeopleidtype);
    ...
    private void setJtjsydsyqzydjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
                                               Map<String, Object> execution) {
        returnMap.put("qllx", "集体建设用地使用权");
        returnMap.put("djlx", "集体建设用地使用权转移登记");
