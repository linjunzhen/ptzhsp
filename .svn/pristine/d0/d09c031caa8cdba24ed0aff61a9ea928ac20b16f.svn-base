...
<script type="text/javascript">
	...
	function fixRownumber(){
		var grid = $('#fdaAdnormalStatisGrid');  
	...
	$('#fdaAdnormalStatisGrid').datagrid({
...
<div class="easyui-layout" fit="true">
	<div region="center">
		<!-- =========================查询面板开始========================= -->
		<div id="fdaAdnormalStatisToolBar">
			<!--====================开始编写隐藏域============== -->
			<!--====================结束编写隐藏域============== -->
					...
					<tbody>
						<tr style="height:28px;">
							...
							<td colspan="2"><input type="button" value="查询"
								class="eve-button"
								onclick="AppUtil.gridDoSearch('fdaAdnormalStatisToolBar','fdaAdnormalStatisGrid')" />
		...
		<table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
			id="fdaAdnormalStatisGrid" fitcolumns="false" toolbar="#fdaAdnormalStatisToolBar"
			method="post" idfield="LOG_ID" checkonselect="false" nowrap="false"
			selectoncheck="false" fit="true" border="false"
			url="fdaStaticController.do?adnormalData">
			<thead>
				<tr>
					<th data-options="field:'EXE_ID',align:'left'" width="12%" >申报号</th>
					<th data-options="field:'CREATOR_NAME',align:'left'" width="8%" >经办人</th>
					<th data-options="field:'SUBJECT',align:'left'" width="38%"  formatter="formatSubject">办件名称</th>
					...
					<th data-options="field:'OVERDUE_WORKDAY',align:'left',hidden:true" formatter="formatOverdueDate">超期天数</th>
					<th data-options="field:'CNQXGZR',align:'left',hidden:true" >承诺时限</th>
				</tr>
			</thead>
		</table>
		<!-- =========================表格结束==========================-->
