...
<%--                        </tr>--%>
                        <tr>
                            <th class="tab_width"><font class="tab_color">*</font>套次承诺书：</th>
                            <td colspan="3" >
                                <eve:eveselect clazz="tab_text validate[required]" dataParams="tcCns"
                                               dataInterface="dictionaryService.findDatasForSelect" 
                                               defaultEmptyText="==请选择套次承诺书==" name="POWPERPEOPLECNS" id="POWPERPEOPLECNS" >
                                </eve:eveselect>
                            </td>
                        </tr>
