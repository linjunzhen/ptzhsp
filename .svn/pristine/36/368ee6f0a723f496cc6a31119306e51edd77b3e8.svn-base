...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    newhtml += "<li><a target=\"_blank\" href=\"webSiteController.do?applyItem&itemCode="+itemList[i].ITEM_CODE+"\" >"+itemList[i].ITEM_NAME+"</a></li>"
    } 
     newhtml += "</ul>";
  ...
  <body class="bsbody">
    ...
    <%--结束编写头部文件 --%>
     ...
     <div class="container">
        <div class="current"><span>您现在所在的位置：</span><a href="webSiteController/view.do">首页</a>  > 我要办 >
         <i>${busTypeName}</i></div>
    	<div class="bsMain clearfix">
    	    <form id="bsForm" >
    	    <input type="hidden" id="busTypeId" name="busTypeIds" value="${busTypeIds}"/> 
    	    </form>
