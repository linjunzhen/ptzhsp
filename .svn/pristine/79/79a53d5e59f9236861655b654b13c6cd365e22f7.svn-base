...
<!-- 权属来源信息开始 -->
<div id="powerSourceInfo" name="bdc_qslyxx" trid="">
	<div class="tab_height"></div>
		<tr>
			<th>
				<span class="haveButtonTitle">权属来源</span>
				<div id="bdcdacxButton" style="display:none">
					<a href="javascript:void(0);" class="eflowbutton titleButton" 
							onclick="showSelectBdcdaxxcx();">不动产档案查询 </a>
				</div>
				<div id="addOrSaveButton">
					<a href="javascript:void(0);" class="eflowbutton titleButton" onclick="submitPowSourceInfo();"
						name="addQslyxx">新增 </a>
<!-- 					<a href="javascript:void(0);" class="eflowbutton titleButton" onclick="submitPowSourceInfo('1')"
	...
	<table cellpadding="0" cellspacing="1" class="tab_tk_pro2" >
		<tr id="PowerSourceInfo_1">
			<td>
				...
				<!-- 权属来源明表格开始 -->
				<table cellpadding="0" cellspacing="1" class="tab_tk_pro" id="powerSourceInfoList">
					<tr>
