...
$(document).ready(function() {
 ...
 function searchData(){
	 myChart.showLoading();
	 var url = "statisticalReportController.do?sjlxtjData&Q_T.CREATE_TIME_LE="+$("input[name='Q_T.CREATE_TIME_<=']").val()+" 23:59:59&Q_T.CREATE_TIME_GE="+$("input[name='Q_T.CREATE_TIME_>=']").val()+" 00:00:00&echartType="+$("#echartType").val();
	 $.post(url,{
...
<div class="easyui-layout" fit="true">
	<div region="center">
		<!-- =========================查询面板开始========================= -->
		<div id="sjlxtjStatisToolBar">
			<form action="#" name="sjlxtjForm">
					...
					<tbody>
						<tr style="height:28px;">
							...
							<td colspan="2"><input type="button" value="查询"
								...
								onclick="AppUtil.gridSearchReset('sjlxtjForm')" /></td>
						</tr>
					</tbody>
				</table>
			</form>
