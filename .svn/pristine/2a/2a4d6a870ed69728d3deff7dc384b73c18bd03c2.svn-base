			...
			<td colspan="3">
					...
					<fda:fda-exselect name="ZSXZ" style="width:150px;" datainterface="fdaDictionaryService.findList" clazz="input-dropdown validate[]"
					    	 queryparamjson="{TYPE_CODE:'${EFLOW_VARS.EFLOW_BUSRECORD.ZSXS}',ORDER_TYPE:'ASC'}" defaultemptytext="请选择乡镇/街道" value="${EFLOW_VARS.EFLOW_BUSRECORD.ZSXZ}"
							  ></fda:fda-exselect>
					<label >详细地址:</label><input type="text" style="width: 25%;" placeholder="请输入详细地址" value="${EFLOW_VARS.EFLOW_BUSRECORD.ZSXXDZ}"
						maxlength="200" class="syj-input1 validate[required]" name="ZSXXDZ" onblur="xxdzOnblur();" onfocus="xxdzOnfocus(this);"/><a href="javascript:void(0);" onclick="txsm(this);"
