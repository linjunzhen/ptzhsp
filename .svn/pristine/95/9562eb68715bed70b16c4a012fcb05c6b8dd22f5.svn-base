...
<form action="" id="LEGAL_FORM"  >
		...
		<table cellpadding="0" cellspacing="0" class="syj-table2 ">
			<tr>
				...
				<td>
					...
					<eve:eveselect clazz="input-dropdown w280 validate[required]" dataParams="ssdjzw:01,20"
	...
	<div style="position:relative;">
		<table cellpadding="0" cellspacing="0" class="syj-table2 ">
			<tr>
				...
				<td colspan="3">
					<input type="text" class="Wdate w280 validate[required]" id="VALIDITY_START_DATE" 
					...
					<input type="text" class="Wdate w280 validate[required]" id="VALIDITY_END_DATE" readonly="readonly"
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2" style="table-layout: auto;">
			<tr>
				<th>指定或委托的有效期限：</th>
				<td colspan="3">
					<input type="text" class="Wdate w280 validate[]" id="L_VALIDITY_START_DATE" 
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-%d',maxDate:'#F{$dp.$D(\'L_VALIDITY_END_DATE\')}'})"
					readonly="readonly" name="L_VALIDITY_START_DATE"  placeholder="请输入开始时间" value="${busRecord.L_VALIDITY_START_DATE}"  maxlength="16"/>至
					<input type="text" class="Wdate w280 validate[]" id="L_VALIDITY_END_DATE" readonly="readonly"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'L_VALIDITY_START_DATE\',{M:1})||\'%y-{%M+1}-%d\'}'
					,maxDate:'#F{$dp.$D(\'L_VALIDITY_START_DATE\',{y:1})||\'{%y+1}-%M-%d\'}'})"
					name="L_VALIDITY_END_DATE"  placeholder="请输入结束时间" value="${busRecord.L_VALIDITY_END_DATE}"  maxlength="16"/></td>
			</tr>
			<tr>
