...
<div class="syj-title1" style="height:30px;">
	<span>申报对象信息(<font color="#ff0101">*</font>为必填)</span>
</div>
<table cellpadding="0" cellspacing="1" class="syj-table2">
	...
	<tr>
		<th style="border-bottom-width: 1px;width:180px;"> 申报种类：</th>
	...
	<tr <c:if test="${acceptway!='1'}">style="display: none;"</c:if>>
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>是否出件</th>
		<td colspan="3">
...
<!-- 	<tr <c:if test="${acceptway!='1'}">style="display: none;"</c:if>> -->
	<tr >
			<th style="border-bottom-width: 1px;width:180px;"><span style="width: 125px;float:left;text-align:right;">信息采集：
			     </span>
			</th>
			<td colspan="3">
...
<!-- 	<tr <c:if test="${acceptway!='1'}">style="display: none;"</c:if>> -->
	...
	<tr <c:if test="${takenoway!='3'}">style="display: none;"</c:if>>
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*温馨提示：</font></th>
		<td colspan="3">
			<font class="tab_color">当区号类型为继续取号时，申报对象信息与上一办件相同且不予显示不可修改。</font>
		</td>
	</tr>
	<tr <c:if test="${takenoway=='3'}">style="display: none;"</c:if>>
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>申请人类型：</th>
		<td colspan="3">
...
<table cellpadding="0" cellspacing="1" class="syj-table2" id="sqr" <c:if test="${execution.BSYHLX=='2'|| takenoway=='3' }">style="display: none;margin-top: -1px;"</c:if>  <c:if test="${execution.BSYHLX!='2'&& takenoway!='3' }">style="margin-top: -1px;"</c:if>>
	<tr>
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>申请人：</th>
		<td><input type="text" class="tab_text validate[required]"
		    maxlength="30" style="width: 43%;" id="SQRMC"
			name="SQRMC" value="${execution.SQRMC}"  /></td>
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>申请人性别</th>
		<td>
			<eve:eveselect clazz="tab_text validate[required]"
	...
	<tr>
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>证件类型：</th>
		...
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>证件号码：</th>
		<td>
	...
	<tr>
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>联系手机号：</th>
		...
		<th style="border-bottom-width: 1px;width:180px;">联系电话：</th>
		<td><input type="text" class="tab_text validate[]" maxlength="14"
			name="SQRDHH" value="${execution.SQRDHH}"  /></td>
	</tr>
	<tr>
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>联系地址：</th>
	...
	<tr>
		<th style="border-bottom-width: 1px;width:180px;">电子邮件：</th>
		<td colspan="3" >
		  <input type="text" class="tab_text validate[[],custom[email]]" maxlength="30"
			name="SQRYJ" value="${execution.SQRYJ}"  /></td>
	</tr>
</table>
<table cellpadding="0" cellspacing="1" class="syj-table2" id="sqjg1" <c:if test="${execution.BSYHLX!='2'||takenoway=='3'}">style="display: none;margin-top: -1px;"</c:if> <c:if test="${execution.BSYHLX!='2'&& takenoway!='3' }">style="margin-top: -1px;"</c:if> >
	<tr>
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>申请机构：</th>
	...
	<tr>
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>机构类型：</th>
		...
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>机构代码：</th>
		<td>
	...
	<tr>
		<th style="border-bottom-width: 1px;width:180px;"><c:if test="${serviceItem.SXXZ == '行政许可'}"><font class="tab_color">*</font></c:if>统一社会信用代码：</th>
		...
		<th style="border-bottom-width: 1px;width:180px;">工商注册号：</th>
		<td><input type="text" class="tab_text" maxlength="15"
				   name="REGIST_NUM" value="${execution.REGIST_NUM}" id="REGIST_NUM" />
		</td>
	</tr>
	<tr>
		<th style="border-bottom-width: 1px;width:180px;"><c:if test="${serviceItem.SXXZ == '行政许可'}"><font class="tab_color">*</font></c:if>法人代表：</th>
	...
	<tr>
		<th style="border-bottom-width: 1px;width:180px;"> 证件类型：</th>
		<td style="width:430px">
		...
		<th style="border-bottom-width: 1px;width:180px;"> 证件号码：</th>
		<td>
	...
	<tr>
		<th style="border-bottom-width: 1px;width:180px;">联系地址：</th>
...
<table cellpadding="0" cellspacing="1" class="syj-table2" id="SFXSJBRXX" <c:if test="${execution.BSYHLX=='2'||takenoway=='3'}">style="display: none;"</c:if> <c:if test="${execution.BSYHLX!='2'&& takenoway!='3' }">style="margin-top: -1px;"</c:if>>
    <tr>
        <th style="border-bottom-width: 1px;width:180px;">是否填写代理人：</th>
        <td ><input type="checkbox" name="SFXSJBRXX" value="1" onclick="sfxsjbrxx();">是</td>  
    </tr>
</table>
<table cellpadding="0" cellspacing="1" class="syj-table2" id="JBRXX" 
<c:if test="${execution.BSYHLX!='2'&&execution.SFXSJBRXX!='1'}">style="display: none;margin-top: -1px;"</c:if> 
 <c:if test="${execution.BSYHLX=='2'&&execution.SFXSJBRXX=='1' }">style="margin-top: -1px;"</c:if>>
	<tr>
		<th colspan="4">经办人信息</th>
	</tr>
	<tr>
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>姓名：</th>
		<td style="width:430px">
...
<!-- 			<input type="hidden" name="itemCode" value="${itemCode}"> -->
		...
		<th style="border-bottom-width: 1px;width:180px;"><font class="tab_color">*</font>性别</th>
		<td>
		<eve:eveselect clazz="tab_text validate[required]"
	...
	<tr>
		<th style="border-bottom-width: 1px;width:180px;">邮政编码</th>
		<td>
		<input type="text" maxlength="6" name="JBR_POSTCODE" class="tab_text validate[[],custom[chinaZip]]" />
		</td>
		<th style="border-bottom-width: 1px;width:180px;">电子邮箱</th>
		<td>
	...
	<tr>
		<th style="border-bottom-width: 1px;width:180px;">备注：</th>
		<td colspan="3" >
...
<table cellpadding="0" cellspacing="1" class="syj-table2" style="margin-top: -1px;">
	<tr>
		<c:if test="${serviceItem.APPLY_TYPE!='1'}">
		<th style="border-bottom-width: 1px;width:180px;">
