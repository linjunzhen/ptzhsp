           		...
           		<c:choose>
	           		<c:when test="${infoStatus.index==0}">
           				<ul class="scroll-list nocolor">
							<li class="color1"><a href="javascript:void(0);" onclick="chooseItem('${businessInfo.BUSINESS_CODE}','${businessInfo.BUSINESS_NAME}','${businessInfo.SERVICE_STATUS}','${businessInfo.DEPART_ID}','${businessInfo.BELONG_ROOM}','${businessInfo.DIC_DESC}')" >${businessInfo.BUSINESS_NAME}</a></li>
						</c:when>
