...
<script type="text/javascript"
	src="<%=basePath%>/webpage/bsdt/applyform/js/foreign.js"></script>
...
<body>
	...
	<form id="T_COMMERCIAL_FOREIGN_FORM" method="post">
		...
		<input type="hidden" name="CONTROLLER_JSON" />
		...
		<%--开始引入企业基本信息界面 --%>
		<div id="jbxx" >
		<jsp:include page="./T_COMMERCIAL_COMPANY_FOREIGN.jsp" />
		</div>
		<%--结束引入企业基本信息界面 --%>
		...
		<%--开始引入外方投资者信息界面 --%>
		<div id="wftzzxx" >
		<jsp:include page="./T_COMMERCIAL_INVESTOR_FOREIGN.jsp" />
		</div>
		<%--结束引入外方投资者信息界面 --%>
		
		<%--开始引入中方投资者信息界面 --%>
		<div id="zftzzxx" >
		<jsp:include page="./T_COMMERCIAL_INVESTOR_CHINESE.jsp" />
		</div>
		<%--结束引入中方投资者信息界面 --%>

		<%--开始引入董事、监事、经理信息界面 --%>
		<div id="jgxx" >
		<jsp:include page="./T_COMMERCIAL_AUTHORITY.jsp" />
		</div>
		<%--结束引入董事、监事、经理信息界面 --%>
		...
		<%--开始引入外商投资企业最终实际控制人信息界面 --%>
		<div id="skrxx" >
		<jsp:include page="./T_COMMERCIAL_CONTROLLER.jsp" />
		</div>
		<%--结束引入外商投资企业最终实际控制人信息界面 --%>
		...
		<div id="wtsxx" >
		<jsp:include page="./T_COMMERCIAL_ATTORNEY.jsp" />
		</div>
