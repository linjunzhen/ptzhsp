...
/**
 * 描述 多媒体中心flash类管理Service
 * @author Bryce Zhang
 * @created 2016-10-19 下午5:20:32
 */
public interface SwfFileService extends BaseService{
    
    /**
     * 允许上传的文件后缀，多个逗号分割
     */
    public static final String ACCEPTFILETYPES = "swf";
    
    /**
     * 文件大小限制-字节数
     */
    public static final long FILESIZELIMIT = 10485760L;
    
    /**
     * 文件大小限制
     */
    public static final String FORMAT_FILESIZELIMIT = "10M";
