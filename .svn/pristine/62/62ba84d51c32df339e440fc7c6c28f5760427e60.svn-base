...
<div id="fdcqsjb" style="display: none;">
	...
	<table cellpadding="0" cellspacing="1" class="tab_tk_pro">
		...
		<tr>   
			<td class="tab_width">缴纳契税金额(元)：</td>
			<td style="width:430px">
				<input type="text" class="tab_text validate[custom[numberplus]]" maxlength="18" 
				name="FDCQS_AMOUNT" onblur="setNum(this)" />
			</td>
			<td class="tab_width">纳税时间：</td>
		...
		<tr>
			<td class="tab_width">开户银行：</td>
			<td style="width:430px">
				<input type="text" class="tab_text validate[]" maxlength="18" name="FDCQS_BANK" />
			</td>
			<td class="tab_width">银行账号：</td>
			<td style="width:430px">
				<input type="text" class="tab_text validate[custom[numberplus]]" maxlength="18" name="FDCQS_BANK_ACCOUNT" />
			</td>
		</tr>
		<tr>
			<td class="tab_width">新购房具体位(含楼栋号)：</td>
			<td style="width:430px">
				<input type="text" class="tab_text validate[]" maxlength="18" name="FDCQS_LOCATION" />
			</td>
			<td class="tab_width">开发商及项目名称：</td>
			<td style="width:430px">
				<input type="text" class="tab_text validate[]" maxlength="18" name="FDCQS_DEVELOPERS" />
			</td>
		</tr>
		<tr>
			<td class="tab_width">备案信息表业务宗号：</td>
			<td style="width:430px">
				<input type="text" class="tab_text validate[]" maxlength="18" name="FDCQS_CONTFIL_NUM" />
			</td>
			<td class="tab_width">商品房买卖合同备案时间：</td>
			<td colspan="3"><input type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false})"  class="tab_text validate[] Wdate" maxlength="32"
				name="FDCQS_CONTFIL_TIME"  style="border: 1px solid #bbb;height: 24px;"/></td>
		</tr>
<%--		<tr>--%>
<%--			<td class="tab_width">销售状态：</td>--%>
<%--			<td>--%>
<%--				<select   class="tab_text validate[]" name="FDCQS_TYPE">--%>
<%--					<option value="">销售状态</option>--%>
<%--					<option value="0">现售</option>--%>
...
<%--		</tr>--%>
<%--		<tr>   --%>
<%--			<td class="tab_width">缴纳契税金额(元)一半：</td>--%>
<%--			<td style="width:430px">--%>
<%--				<input type="text" class="tab_text validate[custom[numberplus]]" maxlength="18" --%>
<%--				name="FDCQS_AMOUNT_HALF" />--%>
<%--			</td>--%>
<%--			<td class="tab_width">大写：</td>--%>
<%--			<td style="width:430px">--%>
<%--				<input type="text" class="tab_text validate[]" maxlength="18" --%>
<%--				name="FDCQS_AMOUNT_HALFCAP" />--%>
<%--			</td>--%>
<%--		</tr>--%>
	</table>
