						...
						<div style="position:relative;">
							...
							<table cellpadding="0" cellspacing="0" class="syj-table2">
								...
								<tr>
									...
									<td colspan="3"><input type="text" maxlength="126"
								...
								<tr>
                                    ...
                                    <td><input type="text"
                                        ...
                                        placeholder="请输入传真" maxlength="13" /></td>
								</tr>
								<tr>
                        ...
                        <div style="position:relative;">
                            <table id="equipmentTable" class="syj-table2" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="syj-input1 validate[required,custom[number2plus]]" iptName="area" maxlength="10" style="width:90%;"/>
                                    </td>
                                </tr>
                               <tr>
                                    <th>2</th>
                               ...
                               <tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <input type="text" class="syj-input1 validate[custom[number2plus]]" iptName="area" maxlength="10" style="width:90%;"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
