...
<title>平潭综合实验区商事主体登记申报系统</title>
	...
	<!---引入公共JS--->
	<script src="<%=path%>/webpage/website/applyforms/wzJointVenture/js/commercial.js"></script>
...
<div class="container" >
            ...
            <div class="syj-sbm1r">
            	<div class="eui-steps-round" style="float:right; padding-right: 10px;">
					...
					<c:if test="${EFLOWOBJ.HJMC!=null}">
						<jsp:include page="/webpage/website/applyforms/wzJointVenture/flowchart.jsp" >
        ...
        <div class="syj-sbmain2 tmargin20"  id="jbxx">
			...
			<%--开始引入申报信息界面 --%>
			<jsp:include page="/webpage/website/applyforms/wzJointVenture/sbxx.jsp" >
            ...
            <div class="syj-tyys tmargin20" style="z-index: 99;" id="formcontainer">
            	<div class="hd syj-tabtitle" id="formtabtitle" style="z-index: 99;">
                    <ul>
                        ...
                        <li><a href="javascript:AppUtil.validateSingleForm('ATTORNEY_FORM');"  id="ATTORNEY_FORM_A">送达接受人</a></li>						
                        <li><a href="javascript:AppUtil.validateSingleForm('LEGAL_FORM');"  id="LEGAL_FORM_A">人员信息</a></li>
                        <li><a href="javascript:AppUtil.validateSingleForm('SEAL_FORM');"  id="SEAL_FORM_A">印章信息</a></li>      
                        <li><a href="javascript:AppUtil.validateSingleForm('OTHER_FORM');"  id="OTHER_FORM_A">银行开户和其他信息</a></li>    
                ...
                <div class="bd margin20">
					<div>						
						<%--开始引入企业基本信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/wzJointVenture/T_COMMERCIAL_COMPANY.jsp" />
						<%--结束引入企业基本信息界面 --%>
					</div>
                	<div>
                    	<%--开始引入企业合伙出资情况信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/wzJointVenture/T_COMMERCIAL_CAPITAL.jsp" />
						<%--结束引入企业合伙出资情况东信息界面 --%>
                    </div>
                    <div>
                    	<%--开始引入法律文件送达接受人信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/wzJointVenture/T_COMMERCIAL_ATTORNEY.jsp" />
						<%--结束引入法律文件送达接受人信息界面 --%>
                    </div>
					<div>
                    	<%--开始引入法定代表人信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/wzJointVenture/T_COMMERCIAL_LEGAL.jsp" />
						<%--结束引入法定代表人信息界面 --%>
                    </div>
                    <div>					
                    	<%--开始引入印章信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/wzJointVenture/T_COMMERCIAL_SEAL.jsp" />
						<%--结束引入印章信息界面 --%>
                    </div>
                    <div>					
                    	<%--开始引入其他信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/wzJointVenture/T_COMMERCIAL_OTHER.jsp" />
						<%--结束引入其他信息界面 --%>
                    </div>
                    ...
                    <div>								
                    	<%--开始引入经办人信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/wzJointVenture/T_COMMERCIAL_USERINFO.jsp" />
						<%--结束引入经办人信息界面 --%>
					</div>	
                    <div>								
                    	<%--开始引入关联事项材料界面 --%>
					...
					<c:if test="${isQueryDetail!=null && EFLOWOBJ.EFLOW_CUREXERUNNINGNODENAMES=='窗口办理'}">
					<div>
						<jsp:include page="/webpage/website/applyforms/wzJointVenture/applyMaterList.jsp">
