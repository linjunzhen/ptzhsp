...
<script type="text/javascript">
	 ...
	 * 删除流程实例列表记录
	 */
	function deleteZzhyJwspGridRecord() {
	...
	function revokeFlowExe() {
		var exeId = AppUtil.getEditDataGridRecord("ZzhyJwspGrid");
		if (exeId) {
	...
	$(document).ready(function() {
		...
		AppUtil.initAuthorityRes("ZzhyJwspToolbar");

	});

	//空数据，横向滚动
	$('#ZzhyJwspGrid').datagrid({
...
url:'dictionaryController.do?load&amp;defaultEmpty=true&amp;typeCode=FlowRunStatus',editable:false,method: 'post',valueField:'DIC_CODE',textField:'DIC_NAME',panelWidth: 128,panelHeight: 'auto' " />
						...
						<tr style="height:28px;">
							...
							<td style="width:135px;"> <input class="easyui-combobox" type="text" maxlength="20" style="width:78px;" name="Q_T.ISNEEDSIGN_="  data-options="
					url:'dictionaryController.do?load&amp;defaultEmpty=true&amp;typeCode=YesOrNo',editable:false,method: 'post',valueField:'DIC_CODE',textField:'DIC_NAME',panelWidth: 74,panelHeight: 'auto' " />
							...
							<td colspan="2"><input type="button" value="查询"
								class="eve-button"
								onclick="AppUtil.gridDoSearch('ZzhyJwspToolbar','ZzhyJwspGrid')" />
		...
		<table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
			id="ZzhyJwspGrid" fitcolumns="true" toolbar="#ZzhyJwspToolbar"
			method="post" idfield="EXE_ID" checkonselect="false" 
			selectoncheck="false" fit="true" border="false" nowrap="false"
			url="executionController.do?zzhyHandledByMe">
			<thead>
				<tr>
