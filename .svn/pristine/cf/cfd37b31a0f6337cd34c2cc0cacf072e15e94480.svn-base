	...
	<div style="position:relative;">
		...
		<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="syj-table2 " id="sqr" >	
			...
			<tr>
				...
				<td colspan="3">
				<input type="text" maxlength="60" class="syj-input1 validate[required] w878" name="SQRLXDZ" value="${sessionScope.curLoginMember.ZTZZ}" />
		...
		<table style="table-layout: auto;" cellpadding="0" cellspacing="0" class="syj-table2 " id="sqjg" >	
			<tr>
				<th><span class="syj-color2">*</span> 申请机构</th>
				<td colspan="3">
				<input type="hidden" maxlength="30" name="SQRMC" value="${sessionScope.curLoginMember.YHMC}"/>
				<input  type="text" maxlength="60" name="SQJG_NAME" class="syj-input1" value="${sessionScope.curLoginMember.YHMC}"/>
				</td>
			</tr>
			<tr>			    
