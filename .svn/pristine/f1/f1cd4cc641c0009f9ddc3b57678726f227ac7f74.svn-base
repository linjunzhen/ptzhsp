	...
	<div style="position:relative;">
		<table cellpadding="0" cellspacing="0" class="syj-table2 ">
			<tr>
				...
				<td style="border-right-style: none;">
					<input type="text" class="syj-input1" readonly="readonly" style="border: thin;"
		...
		<table cellpadding="0" cellspacing="0" class="syj-table2 " id="sqjg" style="table-layout: auto;">	
			<tr>
				...
				<td colspan="3">
				<input type="hidden" class=" w878" maxlength="30" name="SQRMC" value="${sessionScope.curLoginMember.YHMC}"/>
				<input type="text" class=" w878" maxlength="60" name="SQJG_NAME" class="syj-input1 validate[required,custom[equalsSgsStr]]" value="${sessionScope.curLoginMember.YHMC}"/>
				</td>
			</tr>
			<tr>			    
