	...
	$(function(){
		...
		if(dataObj){
    		...
    		if(dataObj.variableMap){
    			WordUtil.initFormFieldValue(dataObj.variableMap,"TYYSCWJSYJHZB");
    		}
    	}
    	//初始化input时宽度自适应
    	$("input").each(function(){
		...
		AppUtil.initWindowForm("TYYSCWJSYJHZB", function(form, valid) {
			if (valid) {
				$("input[type='submit']").attr("disabled","disabled");
				var formData = WordUtil.getFormEleData("TYYSCWJSYJHZB");
				var url = $("#TYYSCWJSYJHZB").attr("action");
...
<body>
	<form id="TYYSCWJSYJHZB" method="post" action="variableController.do?saveHtmlData">
		<!-- ==============开始引入通用的隐藏界面============= -->
			...
			<div class="eui-word-con">
				<div class="eui-word-title">
					<input type="text" class="eui-ipt" data-validation-engine="validate[required]" style="min-width: 200px;" 
					 name="VB_CGLSUBJECT_ST" maxlength="200" value="${SQData.blxmmc}" />项目<br />联合竣工验收意见汇总表（二）
				</div>
				<br>
				...
				<div class="eio-word-content">	
					...
					name="VB_HBYSYJ_ST" ></textarea><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;人防工程验收意见：<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_RFYSYJ_ST" ></textarea><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;建设工程消防验收意见：<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_XFYSYJ_ST" ></textarea><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;建设工程规划验收意见：<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_GHYSYJ_ST" ></textarea><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;档案验收意见：<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_DAYSYJ_ST" ></textarea><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;建设工程验收备案：<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_YSBA_ST" ></textarea><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;工程结算审核意见：<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_GCJSYJ_ST" ></textarea><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;竣工财务决算审批意见：<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_CWJSYJ_ST" ></textarea><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;其他事项：<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
