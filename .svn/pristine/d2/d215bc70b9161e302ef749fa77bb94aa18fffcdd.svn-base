...
<div class="bsbox clearfix" id="fjbdDiv">
	...
	<div class="bsboxT">
		<ul>
			<li class="on" style="background:none"><span>政府投资项目规划选址初步对接表信息</span></li>			
		</ul>
	</div>
	<div class="bsboxC">
		...
		<table style="margin-top: -1px;display: block;" cellpadding="0" cellspacing="0" class="bstable1" id="sqjg">	
			...
			<tr>
				<th>控制线宽度(m)</th>
				<td>
				<input type="text" maxlength="16" name="ANNEX_TUMU_CONTROLLINEWIDTH" class="tab_text validate[[],custom[numberplus]]" />
				</td>
				<th>投资估算(万元)</th>
				<td>
			...
			<tr>
				<th><span class="bscolor1">*</span>项目决策情况</th>
				<td  colspan="3">
