...
<form action="" id="CAPITAL_FORM"  >	
		...
		<table cellpadding="0" cellspacing="0" class="syj-table2 ">			
			<tr>
				...
				<td  title="系统会根据用户填写的认缴出资额信息自动计算">
					<input type="text" class="syj-input1 w280 inputBackgroundCcc validate[required],custom[JustNumber]" 
	...
	<div class="syj-title1 ">
		<a href="javascript:void(0);" onclick="javascript:addGdxxDiv();" class="syj-addbtn" id="addGdxx">添 加</a><span>合伙人信息</span>
	</div>
	<div id="gdxxDiv">	
		...
		<div style="position:relative;">
			<table cellpadding="0" cellspacing="0" class="syj-table2 ">
				...
				<tr>
					...
					<td><input type="text" class="syj-input1 validate[required]" onblur="setPartnershipName();isEqualShahareholderName('');"
					...
					<td>
						...
						dataInterface="dictionaryService.findDatasForSelect"
						defaultEmptyText="请选择合伙人类型" name="SHAREHOLDER_TYPE"  onchange="setGdlxValidate(this.value,'LEGAL_PERSON');showLicenceAppoint('');">
						</eve:eveselect>
					</td>
				</tr>
			</table>
			<table cellpadding="0" cellspacing="0" class="syj-table2 " style="margin-top: -1px;">
				...
				<tr>
					...
					<td>
						<input type="text" class="syj-input1 validate[[],custom[email]]"
							   name="SHAREHOLDER_EMAIL"  placeholder="请输入电子邮箱"  maxlength="16"/>
					</td>
				</tr>
				<tr>
				...
				<tr class="licenceAppointTr" style="display:none;">
					...
					<td colspan="3"><input type="text" class="syj-input1"  onblur="isEqualShahareholderName('');"
						name="LICENCE_APPOINT_NAME"  maxlength="32"  placeholder="请输入姓名"/></td>		
				...
				<tr>
					...
					<td colspan="3">
						...
						onblur="onlyNumber(this);setInvestment();setEvaluateWayNeed('EVALUATE_WAY','INVESTMENT_CASH');
						isEqualToCash(this.value)" onkeyup="onlyNumber(this);" style="width: 638px;"/>
				...
				<tr>
					...
					<td><input type="text" class="syj-input1 validate[required],custom[JustNumber]" maxlength="16"
						name="PAIDIN_QUOTA"  placeholder="请输入实缴出资额（万元）"   onblur="setRealCapital();isEqualToSjcze(this.value)"/></td>
					<th>缴款日期：</th>
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 ">		
		<tr>
			...
			<td colspan="3"><input type="text" class="Wdate w878 validate[required]" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false,onpicked:handleDate})" 
