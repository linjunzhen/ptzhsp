...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body class="bsbody">
    <%--开始编写头部文件 --%>
    <jsp:include page="../bsdt/head.jsp?currentNav=grbs" />
    <%--结束编写头部文件 --%>
     ...
     <div class="container">
    	<div class="bsMain clearfix">
            ...
            <jsp:param value="lsgrbs" name="busType"/>
            </jsp:include>
            <%--结束引入查下界面 --%>
            <%--开始映入列表页 --%>
		    ...
		    <jsp:param value="serviceItemController.do?pagelistnew&busType=lsgrbs" name="pageURL"/>
