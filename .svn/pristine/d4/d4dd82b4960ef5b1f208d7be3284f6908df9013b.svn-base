		...
		<table class="tab_tk_pro2">
			    <tr>
                    <td class="tab_width"><font class="tab_color ">*</font>出租人：</td>
                   	<td colspan="1">
     <input id="CZR_NAME" name="CZR_NAME" class="easyui-combobox tab_text_1  " style="width:200px;"  
      data-options="prompt : '请选择或者输入出租人',
       editable:true,
       valueField: 'label',textField: 'value',data:[{}]" >
                 ...
                 <tr>
                  ...
                  <td colspan="1"><input type="text" class="tab_text validate[]"  maxlength="128"
				 id="CZRXZ"  name="CZRXZ" value="${busRecord.CZRXZ}"/></td>
					...
					<td>
						...
						defaultEmptyText="选择证件类型" id="CZR_CARD_TYPE" name="CZR_CARD_TYPE" value="选择证件类型" >
						</eve:eveselect>
					</td>
                </tr>
				...
				<tr>
					...
					<td>
                    <input id="CZR_CARD_NO" name="CZR_CARD_NO" class="easyui-combobox tab_text_1 " style="width:200px;"   maxlength="128"
                     data-options="prompt : '请选择或者输入出租人证件号码',
                      editable:true,
                      valueField: 'label',textField: 'value',data:[{}]" >
                     </input>					
                     </td>
				...
				<tr>
                    ...
                    <td colspan="1">
                         <select name="CZR_SEX" class="tab_text validate[]">
                      <option>请选择性别</option>
                      <option>男</option>
                      <option>女</option>
                      </select> 
					...
					<td>
			<input type="text" class="tab_text validate[]" maxlength="128" id="CZR_PHONE" style="float: left;" name="CZR_PHONE" value="${busRecord.CZR_PHONE}"/>
					</td>
                </tr>
                	<tr>
                    <td class="tab_width">地址：</td>
                    <td colspan="1">
                 <input type="text" class="tab_text validate[]" maxlength="128" id="CZR_ADDRESS" style="float: left;" name="CZR_ADDRESS" value="${busRecord.CZR_ADDRESS}"/>

                    </td>
                    <td class="tab_width"><font class="tab_width"> 	邮编：</td>
					<td>
				<input type="text" class="tab_text validate[]" maxlength="128" id="CZR_EMAIL" style="float: left;" name="CZR_EMAIL" value="${busRecord.CZR_EMAIL}"/>
					</td>
                </tr>
				<tr>					
				...
				<tr>
			      ...
			      <input type="button" id="addczfryxx" class="eflowbutton" onclick="addCzfryxx();" style="float:right; margin: 10px 5px; padding: 0 20px;" value="添加">  </tr>
				
			</table>
	</tr>
	<tr>
		 <table cellpadding="0" cellspacing="1" class="tab_tk_pro" id="czf_xxtab" >
	
       <tbody> 
	     <tr>
            <td class="tab_width1" style="width: 10%;color: #000; font-weight: bold;text-align: center;">序号</td>
			<td class="tab_width1" style="width: 10%;color: #000; font-weight: bold;text-align: center;">出租人</td>
			<td class="tab_width1" style="width: 10%;color: #000; font-weight: bold;text-align: center;">出租人性质</td>
...
<table cellpadding="0" cellspacing="1" class="tab_tk_pro2">
	<tr>
		...
		<table class="tab_tk_pro2">
			...
			name="FW_ZL" value="${busRecord.FW_ZL}" style="width: 72%;background:#bbb"  disabled="true" />
                    </td>
                     <td class="tab_width">幢号：</td>
                     <td colspan="3">
                       <input type="text"  class="tab_text validate[]" maxlength="60"
			name="FW_ZH" value="${busRecord.FW_ZH}"   disabled="true"  style="background:#bbb" />
                    </td>
                </tr>
                 <tr>
                    ...
                    <td colspan="1">
                         <input type="text" class="tab_text validate[]" maxlength="60"
			name="FW_SZC" value="${busRecord.FW_SZC}"  disabled="true" style="background:#bbb" />
                    </td>
                    <td class="tab_width">户号：</td>
					<td>
						<input type="text"  class="tab_text validate[]"  maxlength="60" 
			 name="FW_HH" value="${busRecord.FW_HH}"   disabled="true" style="background:#bbb" /> 
					</td>
                </tr>
				...
				<tr>
					...
					<td>
					  <input type="text" class="tab_text validate[]" maxlength="128" id="FW_ZCS" style="float: left;background:#bbb" name="FW_ZCS" value="${busRecord.FW_ZCS}" disabled="true" >
					</td>
					<td class="tab_width"><font class="tab_color">*</font>规划用途：</td>
					<td>
					  <input type="text" class="tab_text validate[]" maxlength="128" id="FW_GHYT" style="float: left;background:#bbb" name="FW_GHYT" value="${busRecord.FW_GHYT}"  disabled="true">
					</td>
				</tr>
				<tr>
                    <td class="tab_width">竣工时间：</td>
                    <td colspan="1">
                       <input type="text" class="tab_text validate[]" maxlength="128" id="JGSJ" style="float: left;background:#bbb" name="JGSJ" value="${busRecord.JGSJ}" disabled="true" >
                    </td>
                    <td class="tab_width"><font class="tab_color">*</font>	用途说明：</td>
					<td>
				      <input type="text" class="tab_text validate[]" maxlength="128" id="YTSM" style="float: left;background:#bbb" name="YTSM" value="${busRecord.YTSM}" disabled="true" >
                    ...
                    <td colspan="1">
                  	 <input type="text" class="tab_text validate[]" maxlength="128" id="FW_XZ" style="float: left;background:#bbb" name="FW_XZ" value="${busRecord.FW_XZ}" disabled="true" >
                    </td>
                    <td class="tab_width">	<font class="tab_color">*</font>房屋结构：</td>
					<td>
			          <input type="text" class="tab_text validate[]" maxlength="128" id="FW_JG" style="float: left;background:#bbb" name="FW_JG" value="${busRecord.FW_JG}" disabled="true" >
					</td>
                </tr>
				<tr>					
					<td class="tab_width">交易价格：</td>
					<td><input type="text" class="tab_text validate[]" id="JYJG" name="JYJG" maxlength="32" value="${busRecord.JYJG}" disabled="true" style="background:#bbb"></td>
					<td class="tab_width">独用土地面积：</td>
					<td>
					  <input type="text" class="tab_text validate[]" maxlength="128" id="DYTDMJ" style="float: left;background:#bbb" name="DYTDMJ" value="${busRecord.DYTDMJ}" disabled="true" >
					</td>
				</tr>
				<tr>
					<td class="tab_width">分摊土地面积：</td>
					<td>
					  <input type="text" class="tab_text validate[]" maxlength="128" id="FTTDMJ" style="float: left;background:#bbb" name="FTTDMJ" value="${busRecord.FTTDMJ}" disabled="true" >
					</td>
					<td class="tab_width">建筑面积：</td>
					<td>
					  <input type="text" class="tab_text validate[]" maxlength="128" id="JZMJ" style="float: left;background:#bbb" name="JZMJ" value="${busRecord.JZMJ}" disabled="true" >
					</td>
				</tr>
				<tr>					
					<td class="tab_width">房屋共有情况：</td>
					<td><input type="text" class="tab_text validate[]" name="FWGYQK" maxlength="128" value="${busRecord.FWGYQK}" disabled="true" style="background:#bbb"></td>
					<td class="tab_width">专有建筑面积：</td>
					<td>
					 <input type="text" class="tab_text validate[]" maxlength="128" id="ZYJZMJ" style="float: left;background:#bbb" name="ZYJZMJ" value="${busRecord.ZYJZMJ}" disabled="true" >
				...
				<tr>
					...
					<td>
					  <input type="text" class="tab_text validate[]" maxlength="128" id="FTJZMJ" style="float: left;background:#bbb" name="FTJZMJ" value="${busRecord.FTJZMJ}" disabled="true" >
					</td>
					<td class="tab_width">权利类型：</td>
					<td>
					<input type="text" class="tab_text validate[]" maxlength="128" id="QLLX" style="float: left;background:#bbb" name="QLLX" value="${busRecord.QLLX}" disabled="true" >
				...
				<tr>
					...
					<td>
					  <input type="text" class="tab_text validate[]" maxlength="128" id="TDSYQR" style="float: left;background:#bbb" name="TDSYQR" value="${busRecord.TDSYQR}" disabled="true" >
					</td>
					<td class="tab_width">权证号：</td>
					<td>
					  <input type="text" class="tab_text validate[]" maxlength="128" id="QZH" style="float: left;background:#bbb" name="QZH" value="${busRecord.QZH}" disabled="true" >
					</td>
					...
					<td colspan='5'>
					  <textarea  type="text" class="tab_text validate[]" maxlength="128" id="FW_BZ" style="float: left;background:#bbb" name="FW_BZ" value="${busRecord.FW_BZ}" disabled="true">
					   </textarea>
                </td>
