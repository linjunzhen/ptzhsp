...
<script type="text/javascript">function doSelectRows(){
    ...
    if(rows.length==0){
        ...
        for(var i = 0;i<rows.length;i++){
            ...
            readIds+=rows[i].READ_ID;
            readNames+=rows[i].READ_NAME;
        }
        art.dialog.data("selectReadInfo", {
        	readIds:readIds,
        	readNames:readNames
        });
    ...
    <div class="easyui-layout" fit="true" >
        <div data-options="region:'center',split:false" style="width: 425px;">
                    ...
                    <table class="dddl-contentBorder dddl_table"
                        ...
                        <tr style="height:28px;">
                            ...
                            <td style="width:135px;"><input class="eve-input"
                                ...
                                name="Q_T.READ_NAME_LIKE" /></td>
                            <td ><input type="button" value="查询"
                                class="eve-button"
                                onclick="AppUtil.gridDoSearch('ReadToolbar','ReadGrid')" />
                                <input type="button" value="重置" class="eve-button"
                                onclick="AppUtil.gridSearchReset('ReadForm')" /></td>
                        </tr>
            ...
            <table class="easyui-datagrid" rownumbers="true" pagination="true"
                ...
                method="post" idField="READ_ID" checkOnSelect="false"
                selectOnCheck="false" fit="true" border="false" nowrap="false"
                url="readTemplateController.do?datagrid">
                <thead>
                    <tr>
                        <th data-options="field:'READ_ID',hidden:true" width="80">READ_ID</th>
                        <th data-options="field:'READ_NAME',align:'left'" width="100">阅办模板名称</th>
                    </tr>
                </thead>
            </table>
        ...
        <div data-options="region:'east',split:false" style="width: 375px;">
                            ...
                            <div class="e-toolbar-overflow">
                               <div style="color:#005588;">
                                    <img src="plug-in/easyui-1.4/themes/icons/tick-btn.png"
                                        style="position: relative; top:7px; float:left;" />&nbsp;已选阅办模板列表
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <table class="easyui-datagrid" rownumbers="true" id="SelectedReadGrid" 
                ...
                method="post" idField="READ_ID" checkOnSelect="false" url="readTemplateController.do?selected&readIds=${readIds}"
