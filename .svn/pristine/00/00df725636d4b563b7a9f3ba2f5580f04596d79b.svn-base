...
<table cellpadding="0" cellspacing="1" class="tab_tk_pro"  id="tzjbxx">
	...
	<tr>
		<td class="tab_width"><font class="tab_color">*</font> 项目所属行政区划：</td>
		<td>
	...
	<tr>
		<td class="tab_width"><font class="tab_color">*</font> 项目类型：</td>
		<td>
		...
		<td class="tab_width"><font class="tab_color">*</font> 建设性质：</td>
		<td>
	...
	<tr>
		<td class="tab_width"><font class="tab_color">*</font> 项目（法人）单位：</td>
		<td>
			<input readonly="true" id="enterpriseName" type="text" maxlength="128" class="tab_text validate[required]"  name="ENTERPRISE_NAME" />
		</td>
		<td class="tab_width"><font class="tab_color">*</font> 项目法人证照类型：</td>
		<td>
			<eve:eveselect clazz="tab_text validate[required] lerepCertTypeSelect" dataParams="LEREPCERTTYPE"
			dataInterface="dictionaryService.findDatasForSelect"
	...
	<tr>
		<td class="tab_width"><font class="tab_color">*</font> 项目法人证照号码：</td>
		<td>
		<input readonly="true" id="lerepCertNo" type="text" maxlength="50" class="tab_text validate[required]"  name="LEREP_CERTNO" />
		</td>
		<td class="tab_width"><font class="tab_color">*</font> 申报日期：</td>
		<td>
	...
	<tr>
		...
		<td  colspan="3">
			<textarea readonly="true" id="projectRemark" class="eve-textarea validate[maxSize[2000]]" rows="3" cols="200"  
	...
	<tr>
		...
		<td>
		<input readonly="true" id="contactEmail" type="text" maxlength="64" class="tab_text validate[custom[email]]" name="CONTACT_EMAIL"  />
		</td>
	...
	<tr>
		...
		<td>
		<input readonly="true" id="contactMobile" type="text" maxlength="11" class="tab_text validate[custom[mobilePhoneLoose]]" name="CONTACT_MOBILE"  />
		</td>
	...
	<tr>
		...
		<td>
		<input readonly="true" id="contactPostCode" type="text" maxlength="11" class="tab_text ,validate[custom[chinaZip]]" name="CONTACT_POSTCODE"  />
		</td>
...
<%--		</td>--%>
		...
		<%--<td>
		<input readonly="true" id="placeCode" type="text" maxlength="250" class="tab_text validate[required]" name="PLACE_CODE"  />
		</td>--%>
	<td>     
	...
	<tr>
		<td class="tab_width"><font class="tab_color">*</font> 建设地点详情：</td>
		<td  colspan="3">
			<textarea readonly="true" id="placeCodeDetail" class="eve-textarea validate[required],maxSize[512]" rows="3" cols="200"  
	...
	<tr>
		...
		<td>
			<select id="isDeArea" onChange="onSelectClass(this.value)"   class="tab_text " name="IS_DE_AREA">
	...
	<tr>
		<td class="tab_width"><font class="tab_color">*</font> 国标行业：</td>
<%--		<td>	--%>
<%--			<eve:eveselect clazz="tab_text " dataParams="INDUSTRY"--%>
<%--			dataInterface="dictionaryService.findDatasForSelect"--%>
<%--			defaultEmptyText="请选择国标行业分类" name="INDUSTRY" id="industry">--%>
<%--			</eve:eveselect>--%>
<%--		</td>--%>
		<td>     
	...
	<tr>
		...
		<td>
			<eve:eveselect clazz="tab_text " dataParams="PROJECTSTAGE"
			dataInterface="dictionaryService.findDatasForSelect"
		...
		<td>
		<input  readonly="true" id="totalMoney" type="text"  maxlength="16" class="tab_text validate[required]" name="TOTAL_MONEY"  />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="tab_width"><font class="tab_color">*</font> 拟开工时间：</td>
		<td>
		...
		<td class="tab_width"><font class="tab_color">*</font> 拟建成时间：</td>
		<td>
