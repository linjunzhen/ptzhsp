	...
	<div class="bsboxC">
		...
		<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="bstable1" id="sqr" >	
			<tr>
				...
				<td>
				<input type="text" maxlength="30" name="SQRMC" class="tab_text validate[required,custom[equalsSgsStr]]" />
				</td>
				...
				<%-- <input type="text" maxlength="30" name="JBR_SEX" class="tab_text" value="${sessionScope.curLoginMember.YHXB}"/> --%>
				</td>
			</tr>
			<tr>			    
				...
				<%-- <input type="text" name="JBR_ZJLX" class="tab_text" value="${sessionScope.curLoginMember.ZJLX}"/> --%>
				</td>
				<th><span class="bscolor1">*</span> 证件号码</th>
				<td>
				<input type="text" maxlength="30" name="SQRSFZ" id="zjhm" class="tab_text validate[required]" onchange="personCreditHandle(this.value)"/>
				</td>
			</tr>
				<th><span class="bscolor1">*</span> 联系手机号</th>
				<td>
				<input type="text" maxlength="11" name="SQRSJH" class="tab_text validate[required,custom[mobilePhoneLoose]]" />
				</td>
				<th>电话号码</th>
				<td>
				<input type="text" maxlength="14" class="tab_text validate[[],custom[fixPhoneWithAreaCode]]" name="SQRDHH" />
				</td>
			<tr>
			</tr>
			<tr>
				...
				<td colspan="3">
				<input type="text" maxlength="60" class="tab_text validate[required]" name="SQRLXDZ"  style="width: 850px;"/>
			...
			<tr>
				<th> 电子邮箱</th>
				<td colspan="3">
				<input type="text" maxlength="30" class="tab_text validate[[],custom[email]]" name="SQRYJ" style="width: 850px;"/>
				</td>
			</tr>
		</table>
		<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="bstable1" id="sqjg" >	
			<tr>
				...
				<td>
				<input type="text" maxlength="60" name="SQJG_NAME" class="tab_text validate[required,custom[equalsSgsStr]]" value="${sessionScope.curLoginMember.YHMC}"/>
				</td>	    
			...
			<tr>
				<th> 联系地址</th>
				<td colspan="3">
				<input type="text" maxlength="60" class="tab_text" name="SQJG_ADDR" value="${sessionScope.curLoginMember.DWDZ}"  style="width: 850px;"/>
		...
		<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="bstable1">
			<tr>
				...
				<td >
				<input type="text" maxlength="8" name="BJCXMM" class="tab_text validate[required]" style="width: 670px;"/>
	...
	<div class="bsboxC">
		...
		<c:if test="${sessionScope.curLoginMember.USER_TYPE=='1'}">
			<table cellpadding="0" cellspacing="0" class="bstable1">
				...
				<tr>
					...
					<th>电子邮箱</th>
					<td>
					<input type="text" maxlength="30" class="tab_text " name="JBR_EMAIL" value="${sessionScope.curLoginMember.DZYX}"/>
					</td>
				</tr>
				<tr>
					<th>联系地址</th>
					<td colspan="3">
					<input type="text" maxlength="60" class="tab_text" name="JBR_ADDRESS" value="${sessionScope.curLoginMember.ZTZZ}" style="width: 850px;" />
					</td>
				</tr>
				<tr>
					<th> 备注</th>
					<td colspan="3">
					<input type="text" maxlength="126" class="tab_text" name="JBR_REMARK" style="width: 850px;"/>
		...
		<table cellpadding="0" cellspacing="0" class="bstable1">
			...
			<tr>
				<th>联系地址</th>
				<td colspan="3">
				<input type="text" maxlength="60" class="tab_text" name="JBR_ADDRESS" value="${sessionScope.curLoginMember.DWDZ}"  style="width: 850px;"/>
				</td>
			</tr>
			<tr>
				<th> 备注</th>
