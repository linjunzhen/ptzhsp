...
<table cellpadding="0" cellspacing="1" class="tab_tk_pro2">
	...
	<tr>
		...
		<td>
		  <input type="text" class="tab_text validate[required]" maxlength="128" id="DLR_ZJNO" style="float: left;"
			name="DLR_ZJNO"  /><a href="javascript:void(0);" onclick="IDCRAD_Read('DLR_MC','DLR_ZJNO');" class="eflowbutton">身份证读卡</a>
		</td>
	</tr>-->
	<tr>
	...
	<tr>
		...
		<td>
		  <input type="text" class="tab_text validate[required]" maxlength="128" id="YWR_ZJNO" style="float: left;"
			name="YWR_ZJNO"  /><a href="javascript:void(0);" onclick="IDCRAD_Read('YWR_MC','YWR_ZJNO');" class="eflowbutton">身份证读卡</a>
		</td>
	</tr>
	<!--<tr>
	...
	<tr>
		...
		<td>
		  <input type="text" class="tab_text validate[]" maxlength="128" id="DLR2_ZJNO" style="float: left;"
			name="DLR2_ZJNO"  /><a href="javascript:void(0);" onclick="IDCRAD_Read('DLR2_MC','DLR2_ZJNO');" class="eflowbutton">身份证读卡</a>
		</td>
	</tr>-->
	<tr>
	...
	<tr>
		...
		<tr class="dbxxtr" style="display:none">
			...
			<td>
				<a href="javascript:void(0);" id="zsyl3" onclick="bdcBfbdcdjzmDJZMprint3(1);" class="eflowbutton">证书预览</a>&nbsp;
				<a href="javascript:void(0);" class="eflowbutton" id="qrdb3" onclick="bfbdcdjzmBooking3();">确认登簿</a>
				<a href="javascript:void(0);" id="zsdy3" onclick="bdcBfbdcdjzmDJZMprint3(2);" class="eflowbutton">证书打印</a>&nbsp;
			</td>
			<td></td>
		</tr>
		<tr class="dbxxtr" style="display:none">
			...
			<td>
				...
				name="BDC_QZBSM" id="BDC_QZBSM3" value="${busRecord.BDC_QZBSM}" style="width: 72%;"
