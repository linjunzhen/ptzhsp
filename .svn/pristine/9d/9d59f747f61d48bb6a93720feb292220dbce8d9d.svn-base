...
public class Des {
     ...
     * @return
     */
    public static String strEnc(String data, String  
        ...
        if (StringUtils.isNotEmpty(thirdKey)) {
            thirdKeyBt = getKeyBytes(thirdKey);
            thirdLength = thirdKeyBt.size();
        }
        if (leng > 0) {
            if (leng < 4) {
                int[] bt = strToBt(data),encByte = null;
                if (StringUtils.isNotEmpty(firstKey)&&StringUtils.isNotEmpty(secondKey)
                        &&StringUtils.isNotEmpty(thirdKey)) {
                    int[] tempBt= bt;
                    tempBt=setTempBt(tempBt,firstLength,secondLength,firstKeyBt,secondKeyBt);
     ...
     * @return
     */
    public static int[] setTempBt(int[] tempBt,int firstLength,
            int secondLength,List firstKeyBt,List secondKeyBt){
        for (int x = 0; x < firstLength; x++) {
            tempBt = enc(tempBt, (int[]) firstKeyBt.get(x));
        }
    ...
    public static String strDec(String data, String firstKey, String secondKey,
        ...
        for (i = 0; i < iterator; i++) {
            ...
            int[] decByte = null;
            if (StringUtils.isNotEmpty(firstKey)
                    &&StringUtils.isNotEmpty(secondKey)
                    &&StringUtils.isNotEmpty(thirdKey) ) {
                int[] tempBt;
                int x, y, z;
                tempBt = intByte;
    ...
    public static int[][] generateKeys(
        ...
        int[] loop = new int[] { 1, 1, 2, 2, 2, 2, 2, 2,
                1, 2, 2, 2, 2, 2, 2, 1 };
        for (int i = 0; i < 7; i++) {
     ...
     * @return
     */
    public static int[] setKeyTemp(int[] key){
        int[] tempKey = new int[48];
        tempKey[0] = key[13];
        tempKey[1] = key[16];
        tempKey[2] = key[10];
