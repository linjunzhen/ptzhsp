...
<c:if test="${itemMap.roomNo!='A'&&itemMap.roomNo!='B'}">
	...
	<script type="text/javascript">
		...
		function backToTop(){
			window.parent.document.getElementById('takeFrame').src="callController.do?toYctbTypeChoose&roomNo=${itemMap.roomNo}&ifMaterPrint=${itemMap.ifMaterPrint}&departId=${itemMap.departId}";
		}
