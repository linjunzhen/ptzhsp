...
function addCyjbDiv(){
	...
	$.post("cyjbPtController/refreshPtCyjbDiv.do",{
...
function saveCyjb(){
	...
	if(flowSubmitObj.busRecord){
		...
		$.post("cyjbPtController.do?saveCyjb",{
			CYJB_ID:flowSubmitObj.busRecord.BUS_RECORDID,
			CyjbJson:CyjbJson,
...
<div id="ptcyjb" style="display: none;">
	...
	<table cellpadding="0" cellspacing="1" class="tab_tk_pro" id="cyjbTable">
		<tr>
			<td class="tab_width1" style="width: 18%;color: #000; font-weight: bold;text-align: center;" align="center">奖补类型</td>
			<td class="tab_width1" style="width: 10%;color: #000; font-weight: bold;text-align: center;">奖补金额<br/>(元)</td>
			<td class="tab_width1" style="width: 10%;color: #000; font-weight: bold;text-align: center;">纳税总额<br/>(元)</td>
			<td class="tab_width1" style="width: 10%;color: #000; font-weight: bold;text-align: center;">地方级收入<br/>(元)</td>
			<td class="tab_width1" style="width: 10%;color: #000; font-weight: bold;text-align: center;">个税金额<br/>(元)</td>
