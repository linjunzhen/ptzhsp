    ...
    <div style="padding: 10px">
        <table cellpadding="0" cellspacing="0" class="bstable1" id="slxx_div">
          ...
          <%--   <tr>
                ...
                <td colspan="3">
                    <eve:radiogroup fieldname="ZYDJ_TYPE" width="500" onclick="queryTypeFn();" typecode="zydjlx4" defaultvalue="1" value="${busRecord.ZYDJ_TYPE}"></eve:radiogroup>
                </td>
            </tr> --%>
            <tr id="hthCheck">
                <th>合同备案号：</th>
            ...
            <tr>
                <th>不动产单元号：</th>
                <td colspan="3"><input type="text" class="tab_text validate[custom[estateNum]]"
            ...
            <tr style="display: none;" id="powTr">
                ...
                <th style="display: none;" id="dlhhName"><font class="tab_color">*</font>电力户号：</th>
            ...
            <tr style="display: none;" id="waterTr">
                ...
                <th style="display: none;" id="slhhName"><font class="tab_color">*</font>水力户号：</th>
			...
			<tr style="display: none;" id="gasTr">
				...
				<th style="display: none;" id="rqhhName"><font class="tab_color">*</font>燃气户号：</th>
			...
			<tr style="display: none;" id="svaTr">
				...
				<th style="display: none;" id="gdhhName"><font class="tab_color">*</font>广电户号：</th>
