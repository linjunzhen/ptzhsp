		...
		<div id="BackFlowFormDiv">
			...
			<table style="width:100%;border-collapse:collapse;" id="SHYJTABLE"
				...
				<tr style="height:29px;">
					<td colspan="1" class="dddl-legend" style="font-weight:bold;">预审意见信息</td>
				</tr>
				<tr>
					<td><span style="width: 100px;float:left;text-align:right;">预审意见：</span>
					     <textarea rows="5" cols="5" class="eve-textarea " 
							style="width: 750px" name="BJYJ" readonly="readonly">${bjxx.BJYJ}</textarea>
					</td>
				</tr>
			</table>
            <table style="width:100%;border-collapse:collapse;" 
                class="dddl-contentBorder dddl_table">
                <tr style="height:29px;"><td colspan="1" class="dddl-legend"  style="font-weight:bold;" >材料审核信息</td></tr>
                  <tr >
                      <td>
                          <table style="width:100%;border-collapse:collapse;"class="dddl-contentBorder dddl_table">
                                <tr>
                                    ...
                                    <td style="text-align: center;font-weight:bold;">不通过意见</td>
                                </tr>
                                <c:forEach var="bjcl" items="${bjxx.bjclList}">
                                <tr>
                                    <td style="width:60%;">${bjcl.MATER_NAME}</td>
                                    <td style="width:40%;">${bjcl.BJYJ}</td>
                                </tr>
                                </c:forEach>
                          </table>
                      </td>
