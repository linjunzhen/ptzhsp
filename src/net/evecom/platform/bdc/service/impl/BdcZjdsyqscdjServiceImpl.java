...
import net.evecom.platform.bdc.dao.BdcZjdsyqscdjDao;
import net.evecom.platform.bdc.service.BdcSpbPrintConfigService;
import net.evecom.platform.bdc.service.BdcZjdsyqscdjService;
...
/**
 * 描述:  宅基地使用权首次登记业务service
 *
 * @author Madison You
 * @created 10:18
 */
@Service("bdcZjdsyqscdjService")
public class BdcZjdsyqscdjServiceImpl extends BaseServiceImpl implements BdcZjdsyqscdjService {

    /**
     * log4J声明
     */
    private static Log log = LogFactory.getLog(BdcZjdsyqscdjServiceImpl.class);
    /**
     * 引入service
     */
    @Resource
    ...
    /**
     * 描述  宅基地使用权首次登记业务审批表业务数据
     * @author Allin Lin
     * @created 2020年5月12日 上午10:54:03
     * @param args
     * @see net.evecom.platform.bdc.service.BdcZjdsyqscdjService#setZjdsyqscdjData(java.util.Map)
     */
    @Override
    public void setZjdsyqscdjData(Map<String, Map<String, Object>> args) {
        /*获取args数据*/
        ...
        /*宅基地使用权首次登记业务审批表业务数据*/
        this.setZjdsyqscdjBusInfo(returnMap, busInfo, execution);
     ...
     * @param execution
     */
    private void setZjdsyqscdjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
            Map<String, Object> execution) {
        returnMap.put("qllx", "宅基地使用权");
