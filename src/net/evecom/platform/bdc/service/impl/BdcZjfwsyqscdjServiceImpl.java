...
import net.evecom.platform.bdc.dao.BdcZjfwsyqscdjDao;
import net.evecom.platform.bdc.service.BdcSpbPrintConfigService;
import net.evecom.platform.bdc.service.BdcZjfwsyqscdjService;
import net.evecom.platform.system.service.DictionaryService;

/**
 * 描述   宅基地使用权及房屋所有权首次登记业务Service
 * @author Allin Lin
 * @created 2020年8月12日 上午11:41:03
 */
@Service("bdcZjfwsyqscdjService")
public class BdcZjfwsyqscdjServiceImpl extends BaseServiceImpl implements BdcZjfwsyqscdjService{


    /**
     * log4J声明
     */
    private static Log log = LogFactory.getLog(BdcZjfwsyqscdjServiceImpl.class);
    /**
     * 引入service
     */
    @Resource
    ...
    public void setZjfwsyqscdjData(Map<String, Map<String, Object>> args) {
        ...
        /*宅基地使用权及房屋所有权首次登记业务审批表业务数据*/
        this.setZjfwsyqscdjBusInfo(returnMap, busInfo, execution);
     ...
     * @param execution
     */
    private void setZjfwsyqscdjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
