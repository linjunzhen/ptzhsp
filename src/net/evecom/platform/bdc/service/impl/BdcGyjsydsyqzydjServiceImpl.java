...
import net.evecom.platform.bdc.dao.BdcGyjsydsyqzydjDao;
import net.evecom.platform.bdc.service.BdcGyjsydsyqzydjService;
import net.evecom.platform.bdc.service.BdcSpbPrintConfigService;
import net.evecom.platform.system.service.DictionaryService;

/**
 * 描述  国有建设用地使用权转移登记业务service
 * @author Allin Lin
 * @created 2020年5月12日 上午10:43:47
 */
@Service("bdcGyjsydsyqzydjService")
public class BdcGyjsydsyqzydjServiceImpl extends BaseServiceImpl implements BdcGyjsydsyqzydjService{
    /**
     * log4J声明
     */
    private static Log log = LogFactory.getLog(BdcGyjsydsyqzydjServiceImpl.class);
    /**
     * 引入service
     */
    @Resource
     ...
     */
    @Resource
    private BdcGyjsydsyqzydjDao dao;
     ...
     * @param args
     * @see net.evecom.platform.bdc.service.BdcGyjsydsyqzydjService#setGyjsydsyqzydjData(java.util.Map)
     */
    @Override
    public void setGyjsydsyqzydjData(Map<String, Map<String, Object>> args) {
        /*获取args数据*/
        ...
        /*国有建设用地使用权转移登记通用业务数据*/
        this.setGyjsydsyqzydjBusInfo(returnMap, busInfo, execution);
     ...
     * @param execution
     */
    private void setGyjsydsyqzydjBusInfo(Map<String, Object> returnMap, Map<String, Object> busInfo,
