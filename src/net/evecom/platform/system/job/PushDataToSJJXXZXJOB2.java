 ...
 */
public class PushDataToSJJXXZXJOB2 implements Job {
    /**
     * log
     */
    private static Log log = LogFactory.getLog(PushDataToSJJXXZXJOB2.class);
    /**
     * 引入service
     */
    @Resource
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        pushDataToSJJXXZXService.pollingWithAddProcessItemSourceInfo();
    }
}
