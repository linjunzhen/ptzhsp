...
public class OsQuestionServiceImpl extends BaseServiceImpl implements OsQuestionService {
    /**
     * 所引入的dao
     */
    @Resource
    private OsQuestionDao dao;
    /**
     * 覆盖获取实体dao方法
     * 描述
     * @author Rider Chen
    ...
    public List<Map<String, Object>> findBySqlFilter(SqlFilter sqlFilter, String whereSql) {
        ...
        StringBuffer sql = new StringBuffer("select T.TOPICID,T.QUESTIONID,T.TITLE" +
                ",T.TYPE,T.SEQNUM,T.LIMITNUM,T.CREATE_TIME from T_HD_OS_QUESTION T ");
        sql.append(whereSql);
    ...
    public void updateSn(String[] ids, String table, String columnName,String keyId) {
        ...
        dao.updateSn(ids, table, columnName,keyId);
    }
}
