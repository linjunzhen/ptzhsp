 ...
 */
public class BdcProvDataParseJob implements Job {
    
    /**
     * log
     */
    private static Log log = LogFactory.getLog(BdcProvDataParseJob.class);
    /**
     * bdcDataParseService
     */
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        bdcDataParseService.parseBdcDataFromProa(log);
    }
