 ...
 */
public class ProjectPushFinishJob implements Job {
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        ...
        log.info("开始执行向住建上报竣工验收数据定时任务");
        try {
            projectFinishManageService.pushFlowinfo();
        } catch (Exception e) {
            // TODO: handle exception
            log.error("", e);
        }
        log.info("结束执行向住建上报竣工验收数据定时任务");
    }
