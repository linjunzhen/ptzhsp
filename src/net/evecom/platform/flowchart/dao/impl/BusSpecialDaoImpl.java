 ...
 */
@Repository("busSpecialDao")
public class BusSpecialDaoImpl  extends BaseDaoImpl implements BusSpecialDao{
    /**
     * 描述 根据业务编码查询业务环节列表
     * @author Toddle Chen
    ...
    public List<Map<String, Object>> findTacheByBuscode(String busCode){
        ...
        sql.append(" WHERE BUS_CODE=?  ORDER BY TREE_SN ASC");
    ...
    public List<Map<String, Object>> findByUnitCode(String unitCode){
        ...
        sql.append(" FROM T_LCJC_BUS_SPECIAL T ");
        if(StringUtils.isNotBlank(unitCode)){
            sql.append(" WHERE UNIT_CODE=? AND STATUS = '3' ORDER BY TREE_SN ASC");
    ...
    public Map<String, Object> getBusByBuscode(String busCode){
        ...
        StringBuffer sql = new StringBuffer("select T.* FROM T_LCJC_BUS_SPECIAL T ");
