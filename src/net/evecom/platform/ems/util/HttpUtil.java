...
public class HttpUtil {
    ...
    public static String convertToBody(Map<String, Object> params) {
        ...
        String rtnbody = body.substring(0, body.length() - 1);
        return rtnbody;
    }
