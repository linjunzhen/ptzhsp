 ...
 */
public class EvaluatePushFlowJob implements Job {

    /**
     * log
     */
    private static Log log = LogFactory.getLog(EvaluatePushFlowJob.class);
     ...
     * 审批互联网服务器地址
     */
    private final String URL = "http://192.168.129.178/evaluateController/getSaveEvaluation.do";

    /**
     * 方法_构造方法
     * 
     */
    public EvaluatePushFlowJob() {
        super();
