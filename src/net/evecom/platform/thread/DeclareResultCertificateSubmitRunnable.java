 ...
 * @Created 2019/10/8.
 */
public class DeclareResultCertificateSubmitRunnable implements Runnable{
     ...
     * @param itemData 数据对象
     */
    public DeclareResultCertificateSubmitRunnable(Map<String, Object> itemData) {
    ...
    @Override
    public void run() {
        electronicLicenseService.declareResultCertificateSubmit(itemData);
    }
}
