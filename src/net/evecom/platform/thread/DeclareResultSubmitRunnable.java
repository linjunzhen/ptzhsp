 ...
 * @Created 2019/10/8.
 */
public class DeclareResultSubmitRunnable implements Runnable{
     ...
     * @param itemData 数据对象
     */
    public DeclareResultSubmitRunnable(Map<String, Object> itemData) {
    ...
    @Override
    public void run() {
        electronicLicenseService.declareResultSubmit(itemData);
    }
}
