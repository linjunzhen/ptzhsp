 ...
 * @Created 2019/10/8.
 */
public class DeclareRegisterSubmitRunnable implements Runnable{
     ...
     * @param itemData 数据对象
     */
    public DeclareRegisterSubmitRunnable(Map<String, Object> itemData) {
    ...
    @Override
    public void run() {
        electronicLicenseService.declareRegisterSubmit(itemData);
    }
}
