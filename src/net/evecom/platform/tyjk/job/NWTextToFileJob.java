 ...
 */
public class NWTextToFileJob implements Job {

    /**
     * log
     */
    private static Log log = LogFactory.getLog(NWTextToFileJob.class);
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        ...
        String fileWebType = properties.getProperty("fileWebTypeTwo");
        String attachFileFolderPath = properties.getProperty("AttachFilePath");
        List<Map<String, Object>> list  = flowWebService.getFileTrans(fileWebType);
