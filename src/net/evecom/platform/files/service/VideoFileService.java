...
/**
 * 描述 多媒体中心视频类管理Service
 * @author Bryce Zhang
 * @created 2016-10-19 下午5:29:50
 */
public interface VideoFileService extends BaseService{
    
    /**
     * 允许上传的文件后缀，多个逗号分割
     */
    public static final String ACCEPTFILETYPES = "mp4,avi,flv,wmv,rmvb";
    
    /**
     * 文件大小限制-字节数
     */
    public static final long FILESIZELIMIT = 524288000L;
    
    /**
     * 文件大小限制
     */
    public static final String FORMAT_FILESIZELIMIT = "500M";
