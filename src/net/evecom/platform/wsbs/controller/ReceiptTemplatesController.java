 ...
 */
@Controller
@RequestMapping("/receiptTemplatesController")
public class ReceiptTemplatesController extends BaseController {
    /**
     * log4J声明
     */
    private static Log log = LogFactory.getLog(ReceiptTemplatesController.class);
    /**
     * 引入Service
     */
    @Resource
    ...
    public ModelAndView info(HttpServletRequest request) {
        ...
        return new ModelAndView("wsbs/serviceItem/info");
    }
    ...
    public AjaxJson saveOrUpdate(HttpServletRequest request) {
        ...
        String recordId = serviceItemService.saveOrUpdate(variables, "T_WSBS_SERVICEITEM", entityId);
    ...
    public ModelAndView view(HttpServletRequest request) {
        return new ModelAndView("wsbs/receiptTemplates/receiptTemplatesview");
    }
}
