 ...
 */
@Service("ybExecutionService")
public class YbExecutionServiceImpl extends BaseServiceImpl implements YbExecutionService {
     ...
     */
    @Override
    public List<Map<String, Object>> findYbNeedMeHandle(SqlFilter sqlFilter, boolean isHaveHandUp) {
    ...
    public List<Map<String, Object>> findYbHandledByUser(SqlFilter sqlFilter, String userAccount) {
        // TODO Auto-generated method stub
        return dao.findYbHandledByUser(sqlFilter, userAccount);
    }
