 ...
 */
public class YxData extends SubmitDataTable  {
    /**
     *
     */
    public static String  tableName="T_COMMERCIAL_DOMESTIC";
    /**
     *
     */
     ...
     * @param curStepName
     */
    public YxData(String curStepName){
        setTableName(YxData.tableName);
