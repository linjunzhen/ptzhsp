...
import net.evecom.platform.zzhy.dao.SsnzqybaDao;
 ...
 */
@Service("ssnzqybaService")
public class SsnzqybaServiceImpl extends BaseServiceImpl implements SsnzqybaService {
    /**
     * 所引入的dao
     */
    @Resource
    private SsnzqybaDao dao;
