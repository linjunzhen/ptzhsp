...
public class DAOUtil {
        ...
        for (int i = 0; i < args.length; i++) {
            if (args[i] == null)
                throw new NullPointerException(
                        "No arguments may be null "
                        + "when using "
                        + "callMethod(Object, String, Object...)"
                        + " because every argument is"
                        + " needed in order to determine the parameter types."
                        + " Use callMethod(Object, String, Class<?>[], Object...) "
                        + "instead and specify parameter types.");
     ...
     * implement the GenericDAO interface.
     */
    public static Object callMethod(Object object, String methodName, Class<?>[] paramTypes, 
