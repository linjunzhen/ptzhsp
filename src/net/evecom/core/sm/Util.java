...
public class Util {
    ...
    public static String algorismToHexString(int algorism, int maxLength) {
        StringBuffer sb = new StringBuffer();
        sb.append(Integer.toHexString(algorism));
        StringBuffer result = new StringBuffer();
        if (sb.length() % 2 == 1) {
            result.append("0").append(sb);
        } else {
            result.append(sb);
        }
        return patchHexString(result.toString().toUpperCase(), maxLength);
    }
