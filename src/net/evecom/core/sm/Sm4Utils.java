...
public class Sm4Utils {
     ...
     */
    public Sm4Utils() {
        this.secretKey = "evecom@123456789";
        this.iv = "evecom@987654321";
    }
     ...
     * @return
     */
    public String decryptDataECBByCharsetName(String cipherText,String charsetName) {
        try {
            Sm4Context ctx = new Sm4Context();
            ctx.isPadding = true;
    ...
    public static void main(String[] args) throws IOException {
        String plainText = "jdbc:oracle:thin:@192.168.180.12:1521:ORCL";
