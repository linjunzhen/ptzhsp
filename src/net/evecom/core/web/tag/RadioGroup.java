 ...
 */
public class RadioGroup extends TagSupport {
    /**
     * log声明
     */
    private static Log log = LogFactory.getLog(RadioGroup.class);
    /**
     * 宽度
     */
    ...
    public int doEndTag() throws JspException {
        try {
            ...
            for (Map<String, Object> map : list) {
                ...
                sb.append("<li>").append("<input class=\"validate[required]\" type=\"radio\" name=\"").append(fieldname)
