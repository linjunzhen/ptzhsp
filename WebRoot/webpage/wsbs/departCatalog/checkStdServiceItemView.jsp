...
<form id="checkStdServiceItemForm" method="post" action="">
    <div id="checkStdServiceItemFormDiv" data-options="region:'center',split:true,border:false">
        <table style="width:100%;border-collapse:collapse;"
               class="dddl-contentBorder dddl_table" id="checkStdServiceItemTable">
            <tr>
