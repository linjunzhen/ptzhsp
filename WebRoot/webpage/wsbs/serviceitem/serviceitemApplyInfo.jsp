...
<tr style="height:50px;"><td><span style="width: 100px;float:left;text-align:right;">申请意见：</span>
<c:if test="${fileFlag==2||fileFlag==5||fileFlag==-1||fileFlag==1 }">
<textarea rows="7" cols="5" class="eve-textarea validate[required]"  style="width: 470px" name="THYJ" maxlength="500"></textarea>
</c:if>
...
<font
                                class="dddl_platform_html_requiredFlag">*</font>  </td></tr>
                                <tr><td>
                                <span style="width: 500px;color:red;float:left;text-align:center;margin-left:50px;">备注：请填写该事项申请发布的依据（可以是书面、微信、QQ、口头说明等），以供各方查阅</span>
                                </td>
