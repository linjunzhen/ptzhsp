	        ...
	        <div class="rfloat">
                ...
                <div class="gpy-af">
                	<div class="gpy-af-con">
                    	分辨率
                        <select class="select1" style="width: 100px !important;" id="ResolutionList" name="ResolutionList" onchange="changeresolution()">
                        </select>
                    </div>
                	<div class="gpy-af-con">
                    	旋转角度
                        <select class="select1" style="width: 100px !important;" id="selRotateList"  name="selRotateList" onchange="rotateangle()">
                        </select>
                    </div>
                	<div class="gpy-af-con">
                    	颜色设置
                        <select class="select1" style="width: 100px !important;" id="ColorMode"  name="ColorMode" onchange="changecolormode()">
                	...
                	<div class="gpy-af-con">
                    	曝光
                        <select class="select1" style="width: 100px !important;" id="ExposureList"  name="ExposureList" onchange="changeexposure()">
                        </select>
                    </div>
                </div>
	        </div>
