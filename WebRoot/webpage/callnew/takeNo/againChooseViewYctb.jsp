...
<head>
	...
	<script language="javascript" src="plug-in/jquery2/jquery.min.js"></script>
<script type="text/javascript">
	...
	function showAgainGridRecord(entityId,parentId,name){
        ...
        var time = hour+":"+minu;
		$.ajax({
			url : "newCallController/againTakeNo.do",
			data:{entityId:id},
			success:function(resultJson) {
				...
				if(resultJsonObj.success){
					...
					if(parentId=='2c90b38a571eb7e40157265c46261c7a'){
							...
							<ul>
           					<c:forEach items="${appointList}" var="appointInfo" varStatus="infoStatus">
								<li>
									...
									<span class="td4">${appointInfo.BUSINESS_NAME}</span>
									<span class="td5">
									<a href="javascript:void(0);" 
									onclick="showAgainGridRecord('${appointInfo.RECORD_ID}','${appointInfo.DEPART_ID}','${appointInfo.LINE_NAME}');">
									重新打印</a></span>
								</li>
           					</c:forEach>
           					</ul>
