...
<!-- 	<div class="eui-title"><a href="javascript:void(0);" >目前仅支持试点业务！</a></div> -->
    ...
    <script type="text/javascript">
		...
		jQuery(".mul5 .eui-sx li").each(function(i){ jQuery(".mul5 .eui-sx li").slice(i*50,i*50+50).wrapAll("<ul></ul>");});
		...
		function chooseMaterType(itemCode,itemName,defKey,businessCode,businessName){					
	    	location.href="<%=path%>/newCallController.do?toMaterChooseMacW&itemCode="+itemCode+"&itemName="
