...
<head>
    ...
    <eve:resources loadres="jquery,easyui,apputil,artdialog,laydate,layer,validationegine,icheck,json2"></eve:resources>
...
<script>
    ...
    function CloseURL() {
		parent.art.dialog.confirm("您确定要提交吗?", function () {
	        ...
	        $.ajax({
	            method:"post",
	            async:false,
	            url:"newCallController.do?saveEvaluateWeb",
	            data:{
	                EXE_ID : EXE_ID,
	                evaln : eval,
	                strInfo : str
