...
<body class="eui-diabody" style="margin:0px;">
	<form id="AppointmentTakeForm" method="post" action="newCallController/generateNo.do">
	    <div id="AppointmentTakeFormDiv" data-options="region:'center',split:true,border:false">
		    <%--==========隐藏域部分开始 ===========--%>
		    <input type="hidden" name="businessCode" value="${appointment.BUSINESS_CODE }">
		    <input type="hidden" name="LINE_ZJLX" value="SF">
		    <input type="hidden" name="isAppoint" value="1">
		    <input type="hidden" name="appointmentId" value="${appointment.RECORD_ID }">
		    <%--==========隐藏域部分结束 ===========--%>
			<table style="width:100%;border-collapse:collapse;"
				...
				<tr>
					<td><span
						style="width: 100px;float:left;text-align:right;">取号业务：</span> <input
						type="text" style="width:150px;float:left;" readonly="readonly"
						class="eve-input validate[required]" name="BUSINESS_NAME" value="${appointment.BUSINESS_NAME }"/> <font
						class="dddl_platform_html_requiredFlag">*</font></td>
				</tr>
			</table>
		</div>
