...
<script type="text/javascript" src="<%=path%>/webpage/flowchange/monitorNode/changeFactorMng.js"></script>
<style type="text/css">
.tdOver{
...
<body class="easyui-layout bodySelectNone">
	...
	<div data-options="region:'north'" title="${busInfo.busName}" split="false" border="false"
		 ...
		 <div class="left_float">
            	<ul>
                    <li><a href="javascript:void(0);" onclick="submitFactor('change');" id="submitAudit"><p><img src="<%=path%>/webpage/flowchart/images/submitAudit.png"></p>确认</a></li>
                </ul>
            </div>
	...
	<div data-options="region:'east',collapsible:false" title="基本信息"  style="width:470px;background-color: #d8e4fe;height: auto;" >
		 ...
		 <p class="fix_height clearfix" style="text-align: left;">
		 	...
		 	是否监察点：</label>
		    <input type="radio" id="monitorNodeYes" name="isAutoCreate" value="1" onclick="monitorClk('yes');" style="text-align: l">
		    <label for="monitorNodeYes" style="margin-left: 0px;">是&nbsp;&nbsp;&nbsp;</label>
            <input type="radio" id="noMonitor" name="isAutoCreate" checked="checked" value="2" onclick="monitorClk('no');">
