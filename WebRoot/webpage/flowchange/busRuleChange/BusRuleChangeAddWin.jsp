...
<script type="text/javascript" src="<%=path%>/webpage/flowchange/busRuleChange/BusRuleChangeAddWin.js"></script>
 	...
 	<div region="east"  style="width:386px;font-size: 12px;" title="属性面板" split="true">
		...
		<tr style="width:350px;font-size: 12px;">
			<td style="padding-top: 5px;padding-left: 1px;height:300px;">
				<!-- =========================表格开始==========================-->
				<div id="BusRuleChangeAddbar">
					<input type="hidden" name="Q_T.PROCESS_CODE_EQ" id="busrulechange_addprocess"/>
				</div>
				<table id="BusRuleChangeAddGrid"></table>
				<!-- =========================表格结束==========================-->
			</td>
		</tr>
	</table>
