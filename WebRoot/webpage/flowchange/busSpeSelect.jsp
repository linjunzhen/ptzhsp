...
<script type="text/javascript">
	$(function() {
		AppUtil.initWindowForm("busSpeSelectForm", function(form, valid) {
			if (valid) {
				//将提交按钮禁用,防止重复提交
				$("input[type='submit']").attr("disabled", "disabled");
				var formData = $("#busSpeSelectForm").serialize();
				var url = $("#busSpeSelectForm").attr("action");
...
<body style="margin:0px;background-color: #f7f7f7;">
	<form id="busSpeSelectForm" method="post"
		action="flowChange.do?startChange">
		<!--==========隐藏域部分开始 ===========-->
			...
			<tr style="height:36px;">
				<td><span style="width: 100px;float:left;text-align:right;">专项名称：</span>
					<input style="width:350px;height:25px;float:left;" id="BUS_NAMECombx"
							...
							name="BUS_CODE"
							data-options="url:'flowChange.do?comboxSpecial',
