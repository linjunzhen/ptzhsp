...
<script type="text/javascript">
	$(function() {
				...
				$.ajax({
					...
					success: function(resultJson) {
						...
						if (obj.success) {
							...
							parent.$("#TaxiLisenceGrid").datagrid("reload");
							AppUtil.closeLayer();
						} else {
							parent.art.dialog({
								content: obj.msg,
		...
		}, "T_CZCZGZ_YGXTGETSCORE");
	});
</script>
</head>
<body style="margin:0px;background-color: #f7f7f7;">
	<form id="ExcelImportForm" method="post"
	action="TaxiLicenseController.do?uploadexcel&startRowNum=1" enctype="multipart/form-data">
		<table style="width:100%;border-collapse:collapse;"
				class="dddl-contentBorder dddl_table">
			<tr>
				<td colspan='3' style="text-align:center;">
					<a href="attachFiles/spmb/驾考系统成绩导入模板.xls">下载excel导入模板</a>
				</td>
			</tr>
			<tr>
				<td colspan='3' style="text-align:center;">
