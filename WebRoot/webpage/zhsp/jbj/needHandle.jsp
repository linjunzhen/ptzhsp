...
<script type="text/javascript">
	 ...
	 * 删除流程实例列表记录
	 */
	function deleteNeedMeHandleJbjGridRecord() {
	 ...
	 * 编辑流程实例列表记录
	 */
	function editNeedMeHandleJbjGridRecord() {
		var entityId = AppUtil.getEditDataGridRecord("NeedMeHandleJbjGrid");
		if (entityId) {
	...
	$(document).ready(function() {
		var needHandleStart = {
			elem : "#NeedMeHandleJbjT.CREATE_TIME_BEGIN",
			format : "YYYY-MM-DD",
			istime : false,
		...
		var needHandleEnd = {
			elem : "#NeedMeHandleJbjT.CREATE_TIME_END",
			format : "YYYY-MM-DD",
			istime : false,
			choose : function(datas) {
				var beginTime = $("input[name='Q_T.CREATE_TIME_>=']").val();
		...
		laydate(needHandleStart);
		laydate(needHandleEnd);
	});
</script>
<div class="easyui-layout" fit="true">
	<div region="center">
		<!-- =========================查询面板开始========================= -->
		<div id="NeedMeHandleJbjToolbar">
			<!--====================开始编写隐藏域============== -->
			<!--====================结束编写隐藏域============== -->
					...
					<tbody>
						...
						<tr style="height:28px;">
							...
							<td style="width:135px;"><input type="text"
								...
								id="NeedMeHandleJbjT.CREATE_TIME_BEGIN" name="Q_E.CREATE_TIME_>=" /></td>
							<td style="width:68px;text-align:right;">申请日期至</td>
							<td style="width:135px;"><input type="text"
								style="width:108px;float:left;" class="laydate-icon"
								id="NeedMeHandleJbjT.CREATE_TIME_END" name="Q_E.CREATE_TIME_<=" /></td>
							...
							<td colspan="2"><input type="button" value="查询"
								class="eve-button"
								onclick="AppUtil.gridDoSearch('NeedMeHandleJbjToolbar','NeedMeHandleJbjGrid')" />
		...
		<table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
			id="NeedMeHandleJbjGrid" fitcolumns="true" toolbar="#NeedMeHandleJbjToolbar"
			method="post" idfield="EXE_ID" checkonselect="false"
			selectoncheck="false" fit="true" border="false" nowrap="false"
			url="serviceHandleController.do?needHandle&Q_TWS.SXLX_EQ=1">
			<thead>
				<tr>
