...
<div class="easyui-layout" fit="true">
	<div region="center">
	       <table>
            <thead>
                <tr>
                <th style="font-weight: normal;" align:'center'"  width="50"></th>
                    <th style="font-weight: normal;" align:'center'"  width="100">事项名称：</th>
                    <th  style="font-weight: normal" align:'left'" width="500" >建设工程规划许可证（含临时）核发</th>
                    <th  style="font-weight: normal" align:'center'" width="100">申报号：</th>
                    <th style="font-weight: normal"  align:'left'" width="200">${exeId}-1</th>
		...
		<table class="easyui-datagrid" rownumbers="false" pagination="false"
			id="FlowTaskGrid2" fitcolumns="true" nowrap="false" 
			method="post" idfield="TASK_ID" checkonselect="false"
			selectoncheck="false" fit="false" border="false"
			url="flowTaskController.do?datagrid&isFiled=${isFiled}&Q_T.EXE_ID_EQ=${exeId}&Q_T.TASK_NODENAME_IN=特殊程序（审签）,行政审批&Q_T.STEP_SEQ_NEQ=0&start=0&limit=100">
			<thead>
				<tr>
					<th data-options="field:'LEFT_WORKDAY',hidden:true" width="80">LEFT_WORKDAY</th>
					<th data-options="field:'TASK_NODENAME',align:'left'"  formatter="formatnodename"  width="100">环节名称</th>
...
<%--					<th data-options="field:'IS_HANG',align:'left'" width="150">结束时间</th>--%>
		...
		<!-- =========================表格结束==========================-->
		 <table>
            <thead>
                ...
                <th style="font-weight: normal;" align:'center'"  width="50"></th>
                    <th style="font-weight: normal;" align:'center'"  width="100">事项名称：</th>
                    <th  style="font-weight: normal" align:'left'" width="500" >建设项目环境影响登记表备案（不涉密）</th>
                    <th  style="font-weight: normal" align:'center'" width="100">申报号：</th>
                    <th style="font-weight: normal"  align:'left'" width="200">${exeId}-2</th>
        ...
        <!-- =========================表格开始==========================-->
        <table class="easyui-datagrid" rownumbers="false" pagination="false"
            id="FlowTaskGrid3" fitcolumns="true" nowrap="false" 
            method="post" idfield="TASK_ID3" checkonselect="false"
            selectoncheck="false" fit="false" border="false"
            url="flowTaskController.do?datagrid&isFiled=${isFiled}&Q_T.EXE_ID_EQ=${exeId}&Q_T.TASK_NODENAME_IN=特殊程序（审签）,行政审批&Q_T.STEP_SEQ_NEQ=0&start=0&limit=100">
            <thead>
                <tr>
                    <th data-options="field:'LEFT_WORKDAY',hidden:true" width="80">LEFT_WORKDAY</th>
                    <th data-options="field:'TASK_NODENAME',align:'left'"  width="100" formatter="formatnodename"  >环节名称</th>
                    <th data-options="field:'TEAM_NAMES',align:'left'"  width="150">受理人</th>
                    <th data-options="field:'ASSIGNER_DEPNAMES',align:'left'"  width="150"  formatter="formatDeptDesc">审批单位</th>
                    <th data-options="field:'TASK_STATUS',align:'left'"  width="110" formatter="formatTaskStatus">办理状态</th>
                    <th data-options="field:'CREATE_TIME',align:'left'"  width="150">提交时间</th>
...
<%--                    <th data-options="field:'IS_HANG',align:'left'" width="150">结束时间</th>--%>
        ...
        <!-- =========================表格结束==========================-->
            ...
            <thead>
                ...
                <th style="font-weight: normal;" align:'center'"  width="50"></th>
                    <th style="font-weight: normal;" align:'center'"  width="100">事项名称：</th>
                    <th  style="font-weight: normal" align:'left'" width="500" >生产建设项目水土保持方案报告表审批（市级）</th>
                    <th  style="font-weight: normal" align:'center'" width="100">申报号：</th>
                    <th style="font-weight: normal"  align:'left'" width="200">${exeId}-3</th>
        ...
        <!-- =========================表格开始==========================-->
        <table class="easyui-datagrid" rownumbers="false" pagination="false"
            id="FlowTaskGrid4" fitcolumns="true" nowrap="false" 
            method="post" idfield="TASK_ID4" checkonselect="false"
            selectoncheck="false" fit="false" border="false"
            url="flowTaskController.do?datagrid&isFiled=${isFiled}&Q_T.EXE_ID_EQ=${exeId}&Q_T.TASK_NODENAME_IN=特殊程序（审签）,行政审批&Q_T.STEP_SEQ_NEQ=0&start=0&limit=100">
            <thead>
                <tr>
...
<%--                    <th data-options="field:'IS_HANG',align:'left'" width="150">结束时间</th>--%>
        ...
        <!-- =========================表格结束==========================-->
            ...
            <thead>
                ...
                <th style="font-weight: normal;" align:'center'"  width="50"></th>
                    <th style="font-weight: normal;" align:'center'"  width="100">事项名称：</th>
                    <th  style="font-weight: normal" align:'left'" width="500" >城市新建民用建筑修建防空地下室审批 </th>
                    <th  style="font-weight: normal" align:'center'" width="100">申报号：</th>
                    <th style="font-weight: normal"  align:'left'" width="200">${exeId}-4</th>
        ...
        <!-- =========================表格开始==========================-->
        <table class="easyui-datagrid" rownumbers="false" pagination="false"
            id="FlowTaskGrid5" fitcolumns="true" nowrap="false" 
            method="post" idfield="TASK_ID5" checkonselect="false"
            selectoncheck="false" fit="false" border="false"
            url="flowTaskController.do?datagrid&isFiled=${isFiled}&Q_T.EXE_ID_EQ=${exeId}&Q_T.TASK_NODENAME_IN=特殊程序（审签）,行政审批&Q_T.STEP_SEQ_NEQ=0&start=0&limit=100">
            <thead>
                <tr>
...
<%--                    <th data-options="field:'IS_HANG',align:'left'" width="150">结束时间</th>--%>
        ...
        <!-- =========================表格结束==========================-->
            ...
            <thead>
                ...
                <th style="font-weight: normal;" align:'center'"  width="50"></th>
                    <th style="font-weight: normal;" align:'center'"  width="100">事项名称：</th>
                    <th  style="font-weight: normal" align:'left'" width="500" >特殊建设工程消防设计审查  </th>
                    <th  style="font-weight: normal" align:'center'" width="100">申报号：</th>
                    <th style="font-weight: normal"  align:'left'" width="200">${exeId}-5</th>
        ...
        <!-- =========================表格开始==========================-->
        <table class="easyui-datagrid" rownumbers="false" pagination="false"
            id="FlowTaskGrid6" fitcolumns="true" nowrap="false" 
            method="post" idfield="TASK_ID6" checkonselect="false"
            selectoncheck="false" fit="false" border="false"
            url="flowTaskController.do?datagrid&isFiled=${isFiled}&Q_T.EXE_ID_EQ=${exeId}&Q_T.TASK_NODENAME_IN=特殊程序（审签）,行政审批&Q_T.STEP_SEQ_NEQ=0&start=0&limit=100">
            <thead>
                <tr>
