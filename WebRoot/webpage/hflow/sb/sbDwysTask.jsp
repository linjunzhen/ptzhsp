...
<script type="text/javascript">
    ...
    function restartFlowTaskExplain(){
        ...
        if (!(rowsData != null && typeof (rowsData) != 'undefined' && rowsData.length != 0)) {
            ...
            if(!isAllowStart){
                ...
                AppUtil.operateDataGridRecord("flowTaskController.do?reStart",{selectTaskIds:selectTaskIds},"SbDwysGrid");
            }else{
     ...
     * 编辑流程实例列表记录
     */
    function editSbDwysGridRecord() {
        var entityId = AppUtil.getEditDataGridRecord("SbDwysGrid");
        if (entityId) {
    ...
    $(document).ready(function() {
        var start1 = {
            elem : "#SbDwysT.CREATE_TIME_BEGIN",
            format : "YYYY-MM-DD",
            istime : false,
    ...
    function showSbDwysBjxxGridRecord() {
        var rows = $("#SbDwysGrid").datagrid("getChecked");
        if(rows.length==0){
            art.dialog({
                content: "请至少选择一条记录!",
                icon:"warning",
...
<div class="easyui-layout eui-jh-box" fit="true">
    <div region="center">
                        ...
                        <div class="e-toolbar-overflow">
                            <div style="color:#005588;">
                                ...
                                <a href="#"
                                   ...
                                   onclick="showSbDwysBjxxGridRecord();">查看补件要求</a>
                                <%--                                <a href="#"--%>
                ...
                <table class="dddl-contentBorder dddl_table"
                    ...
                    <tr style="height:28px;">
                        ...
                        <td style="width:135px;padding-left:4px;"><input type="text"
                                                                         ...
                                                                         id="SbDwysT.CREATE_TIME_BEGIN" name="Q_E.CREATE_TIME_>=" /></td>
                        <td style="width:68px;text-align:right;">申请日期至</td>
                        <td style="width:135px;padding-left:4px;"><input type="text"
                                                                         style="width:108px;float:left;" class="laydate-icon"
                                                                         id="SbDwysT.CREATE_TIME_END" name="Q_E.CREATE_TIME_<=" /></td>
                        ...
                        <td colspan="2"><input type="button" value="查询"
                                               class="eve-button"
                                               onclick="AppUtil.gridDoSearch('SbDwysToolbar','SbDwysGrid')" />
        ...
        <table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
               id="SbDwysGrid" fitcolumns="false" toolbar="#SbDwysToolbar"
               method="post" idfield="EXE_ID" checkonselect="false"
               selectoncheck="false" fit="true" border="false" nowrap="false"
               url="sbExecutionController.do?sbNeedMeHandle&Q_T.TASK_NODENAME_LIKE=%E9%A2%84%E5%AE%A1&Q_E.APPLY_STATUS_EQ=1&isHaveHandup=true">
            <thead>
            <tr>
