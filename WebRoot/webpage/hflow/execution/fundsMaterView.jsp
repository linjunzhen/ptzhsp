...
<script type="text/javascript">
    ...
    function formatdownFile(val,row){
        var href = "<a href='ktStampController.do?downLoadStampFile&exeId=" + row.EXE_ID + "&stampCode=zfgjjkhsq";
...
<div class="easyui-layout eui-jh-box" fit="true">
                ...
                <table class="dddl-contentBorder dddl_table"
                    ...
                    <tr style="height:28px;">
                        ...
                        <td style="width:135px;padding-left:4px;"><input type="text"
                                                                         ...
                                                                         id="FundsA.CREATE_TIME_BEGIN" name="Q_A.CREATE_TIME_>=" /></td>
                        <td style="width:68px;text-align:right;">申请日期至</td>
                        <td style="width:135px;padding-left:4px;"><input type="text"
                                                                         style="width:128px;float:left;" class="laydate-icon"
                                                                         id="FundsA.CREATE_TIME_END" name="Q_A.CREATE_TIME_<=" /></td>
    ...
    <table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
           ...
           url="flowTaskController.do?fundsNeedMeHandle">
        <thead>
        <tr>
