				...
				<div class="e-toolbar" style="z-index: 1111;top: 0px;left: 0px;">
					<div class="e-toolbar-ct">
						<div class="e-toolbar-overflow">
							<a href="#" class="easyui-linkbutton" reskey="exe_result"
								iconCls="icon-edit" plain="true" 
								onclick="updateFlowExe();">修改办件结果</a> 
							<a href="#" class="easyui-linkbutton" reskey="backMyFlow"
								iconCls="eicon-rotate-left" plain="true" id="chlc"
...
url:'dictionaryController.do?load&amp;defaultEmpty=true&amp;typeCode=FlowRunStatus',editable:false,method: 'post',valueField:'DIC_CODE',textField:'DIC_NAME',panelWidth: 128,panelHeight: 'auto' " />
		...
		<table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
			...
			method="post" idfield="EXE_ID" checkonselect="false"  data-options="onCheck:getoption"
			selectoncheck="false" fit="true" border="false" nowrap="false"
			url="executionController.do?handledByMe">
			<thead>
				<tr>
					...
					<th data-options="field:'tzxm',hidden:true"></th>
