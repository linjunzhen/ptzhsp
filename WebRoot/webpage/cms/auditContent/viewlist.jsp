...
<div class="easyui-layout" fit="true">
	<div region="center">
		...
		<table class="easyui-datagrid" rownumbers="false" pagination="false"
			...
			url="auditContentController.do?viewdatagrid&Q_T.CONTENT_ID_EQ=${contentId}&start=0&limit=100">
			<thead>
				<tr>
					<th data-options="field:'ROWNO',align:'center'" width="60" formatter="formatStepSeq">步骤序号</th>
					<th data-options="field:'CURRENT_STATUS',align:'left'"  width="100" formatter="formatStatus">环节名称</th>
					<th data-options="field:'NEXT_STATUS',align:'left'"  width="100" formatter="formatStatus">下一环节</th>
					<th data-options="field:'FULLNAME',align:'left'"  width="80">审核人</th>
					<th data-options="field:'AUDIT_STATUS',align:'left'"  width="60" formatter="formatAuditStatus">办理状态</th>
					<th data-options="field:'AUDIT_OPINION',align:'left'"  width="180">审核意见</th>
					<th data-options="field:'CREATE_TIME',align:'left'"  width="110">提交时间</th>
				</tr>
			</thead>
		</table>
		<!-- =========================表格结束==========================-->
