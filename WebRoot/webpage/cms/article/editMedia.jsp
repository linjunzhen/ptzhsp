...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/webpage/cms/article/scripts/editMedia.js"></script>
</head>
                   ...
                   <div class="editor_top">
                        <table width="615px" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td>
                                <select id="selContentType" name="CONTENTTYPE" style="width:174px" disabled="disabled">
                                    ...
                                    <option value="3" selected="selected">视频新闻</option>
                                </select><span>*</span>
                            </td>
                            <th></th>
                          </tr>
                          ...
                          <tr id="trLinkUrl" style="display:none">
                            <th>网页链接：</th>
                            <td colspan="3"><input type="text" class="easyui-validatebox" name="LINKURL" value="${content.LINKURL}" style="width:445px" /><span>*</span></td>
                            <th></th>
                          </tr>
                          <tr id="trVideoUrl">
                            <th>视频地址：</th>
                            <td colspan="3"><input type="text" class="easyui-validatebox" data-options="validType:'maxLength[2000]',required:true"  value="${content.VIDEOURL}" name="VIDEOURL" style="width:442px" readonly="readonly"/><span>*</span></td>
                            <th>
                    ...
                    <div class="editor_boxR">
                        ...
                        <div class="editor_table"> 
							<table border="0" cellspacing="0" cellpadding="0"> 
                                ...
                                <tr>
                                    <th width="80">关键字：</th>
                                    <td><input type="text" class="easyui-validatebox" name="KEYWORD" style="width:170px" data-options="validType:'maxLength[30]'"  value="${content.KEYWORD}"/></td>
                                </tr>                               
                            </table>
                        </div>
