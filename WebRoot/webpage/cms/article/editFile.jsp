...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/webpage/cms/article/scripts/editFile.js"></script>
</head>
                ...
                <td> 
                   <div class="editor_top">
                       <table width="615px" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td>
                                <select id="selContentType" name="CONTENTTYPE" style="width:174px" disabled="disabled">
                                    ...
                                    <option value="1" selected="selected">文件类型</option>
                          ...
                          <tr id="trFileUrl">
                            <th>文件地址：</th>
                            <td colspan="3"><input type="text" class="easyui-validatebox" data-options="validType:'maxLength[2000]',required:true"  value="${content.LINKURL}" name="LINKURL" style="width:442px" readonly="readonly"/><span>*</span></td>
                            <th>
