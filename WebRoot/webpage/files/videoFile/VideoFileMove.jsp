...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
        	AppUtil.initWindowForm("VideoFileMoveForm", function(form, valid){
				if(valid){
					//将提交按钮禁用,防止重复提交
					$("input[type='submit']").attr("disabled", "disabled");
					var formData = $("#VideoFileMoveForm").serialize();
					var url = $("#VideoFileMoveForm").attr("action");
...
<body style="margin:0px;background-color: #f7f7f7;">
    <form id="VideoFileMoveForm" method="post" action="videoFileController.do?saveMove">
        <div id="VideoFileMoveFormDiv">
            <!--==========隐藏域部分开始 ===========-->
