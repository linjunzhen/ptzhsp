        ...
        $(document).ready(function(){
        	...
        	$("#remoteFilePicker").click(function(){
        		if(!$("#remoteFilePicker").hasClass("disabledBtn")){
        			$.dialog.open('${webRoot}/fileTypeController.do?fileSelector&allowCount=1&needSelectRowIds=' + $("#remoteFileId").val()+'&attachType=${requestScope.attachType}', {
        				title: "多媒体资源选择器",
        				width: "1000px",
        				lock: true,
        				resize: false,
...
<body class="eui-diabody" style="margin:0px;">
    <form id="FileUploadForm">
        ...
        <table style="width:100%;border-collapse:collapse;"class="dddl-contentBorder dddl_table">
            ...
            <tr>
				<td colspan="2" class="dddl-legend"><div class="eui-dddltit"><a>文件来源</a></div></td>
			</tr>
			<tr>
