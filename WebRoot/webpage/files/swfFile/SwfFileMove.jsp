...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
        	AppUtil.initWindowForm("SwfFileMoveForm", function(form, valid){
				if(valid){
					//将提交按钮禁用,防止重复提交
					$("input[type='submit']").attr("disabled", "disabled");
					var formData = $("#SwfFileMoveForm").serialize();
					var url = $("#SwfFileMoveForm").attr("action");
...
<body style="margin:0px;background-color: #f7f7f7;">
    <form id="SwfFileMoveForm" method="post" action="swfFileController.do?saveMove">
        <div id="SwfFileMoveFormDiv">
            <!--==========隐藏域部分开始 ===========-->
