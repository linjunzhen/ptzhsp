...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
        	AppUtil.initWindowForm("ImageFileMoveForm", function(form, valid){
				if(valid){
					//将提交按钮禁用,防止重复提交
					$("input[type='submit']").attr("disabled", "disabled");
					var formData = $("#ImageFileMoveForm").serialize();
					var url = $("#ImageFileMoveForm").attr("action");
...
<body style="margin:0px;background-color: #f7f7f7;">
    <form id="ImageFileMoveForm" method="post" action="imageFileController.do?saveMove">
        <div id="ImageFileMoveFormDiv">
            <!--==========隐藏域部分开始 ===========-->
