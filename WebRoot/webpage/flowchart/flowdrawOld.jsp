...
<body class="easyui-layout bodySelectNone" >
	...
	<div data-options="region:'north'," title="${busInfo.busName}" split="false" border="false"
		 class="design_titletool" style="height: 82px;">
		 <style>
            	ul{list-style: none;}
				li,ul{margin:0px; padding:0px;}
				.left_float{float:left; display:inline-block; width:135px; height:58px; margin-left:10px;}
				.left_float ul li{float:left; width:42px; height:52px; text-align:center; font-size:12px; margin:3px 10px;}
				.left_float ul li p{display:block; width:42px; height:36px; margin:0px; padding:0px; text-align:center; vertical-align:middle;}
				.left_float ul li p img{vertical-align:middle; margin-top:5px;}
				.left_float ul li a{display:block; width:42px; height:52px; color:#333; text-decoration:none; line-height:16px;}
