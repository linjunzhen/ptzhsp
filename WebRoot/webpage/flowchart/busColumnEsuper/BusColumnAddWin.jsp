...
<script type="text/javascript" src="<%=path%>/webpage/flow/busColumnEsuper/BusColumnAddWin.js"></script>
...
<body class="easyui-layout" fit="true" onload="initflow()">
	<form id="BusColumnAddForm" method="post" action="busColumnEsuperController.do?saveEditColumn">
 	...
 	<div region="east"  style="width:386px;font-size: 12px;" title="属性面板" split="true">
		...
		<tr style="width:350px;font-size: 12px;">
			<td style="padding-top: 5px;padding-left: 1px;height: 300px;">
				<!-- =========================表格开始==========================-->
				<div id="BusColumnAddbar">
					<input type="hidden" name="Q_T.PROCESS_CODE_EQ" id="buscolumn_addprocess"/>
				</div>
				<table id="BusColumnAddGrid"></table>
				<!-- =========================表格结束==========================-->
			</td>
		</tr>
	</table>
