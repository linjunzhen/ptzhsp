...
<script type="text/javascript">
	...
	*/
	...
	function showCountsWindow(operatorId) {
		...
		$.dialog.open("fdaStaticController.do?countsDetail&operatorId="
	...
	function showBanJSWindow(operatorId) {
		...
		$.dialog.open("fdaStaticController.do?banJSDetail&operatorId="
				+operatorId+"&beginTime="+beginTime+"&endTime="+endTime
				+"&beginTime2="+beginTime2+"&endTime2="+endTime2, {
			title : "办结件详情",
			width : "700px",
	...
	function showZBSWindow(operatorId) {
		...
		$.dialog.open("fdaStaticController.do?zBSDetail&operatorId="
				+operatorId+"&beginTime="+beginTime+"&endTime="+endTime
				+"&beginTime2="+beginTime2+"&endTime2="+endTime2, {
			title : "在办件详情",
			width : "700px",
	...
	function showTJSWindow(operatorId) {
		...
		$.dialog.open("fdaStaticController.do?tJSDetail&operatorId="
				+operatorId+"&beginTime="+beginTime+"&endTime="+endTime
				+"&beginTime2="+beginTime2+"&endTime2="+endTime2, {
			title : "退件详情",
			width : "700px",
...
<div class="easyui-layout" fit="true">
	<div region="center">
		...
		<table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
			...
			url="fdaStaticController.do?indPerData">
			<thead>
				<tr>
