...
<script type="text/javascript">
	function syncGcxx(){
		var rows = $("#gcxxSyncGrid").datagrid("getChecked");
		if(rows.length<=0){
			parent.art.dialog({
				content : "请选择需要同步的记录",
				icon : "warning",
		...
		AppUtil.ajaxProgress({
			url : "swbDataController.do?gcxxSync",
			params : {exeIds : exeIds},
			callback : function(resultJson) {
				$("#gcxxSyncGrid").datagrid("reload");
				parent.art.dialog({
...
<div class="easyui-layout" fit="true">
	<div region="center">
		...
		<table class="easyui-datagrid" rownumbers="true" pagination="true"  striped="true"
			id="gcxxSyncGrid" nowrap="false"
			toolbar="#gcxxSyncToolbar" method="post" idfield="EXE_ID"
			checkonselect="false" selectoncheck="false" fit="true" border="false"
			url="swbDataController.do?gcxxUnSyncData">
			<thead>
				<tr>
