...
String takeRoomNo = request.getParameter("takeRoomNo");
request.setAttribute("takeRoomNo", takeRoomNo);
...
<body class="bg-none" onbeforeunload="window_onUnload()" ondragstart="return false" oncontextmenu="return false" onselectstart="return false">
	...
	<script type="text/javascript">
		...
		function backToTop(){
		    var takeRoomNo="${takeRoomNo}";
		    var zzType="${zzType}";
			if (zzType && zzType == 'qykb') {
				window.parent.document.getElementById('takeFrame').src= "callYqyzController/toYqyzZzTypeMacW.do?departId=402801336f54e413016f5615914b3cc6&roomNo=D&ifMaterPrint=0&cleanItem=1"
			} else {
				if(takeRoomNo!=''){
					window.parent.document.getElementById('takeFrame').src="callController.do?toYctbTypeChooseMacW&roomNo="+takeRoomNo+"&ifMaterPrint=${ifMaterPrint}&departId=${departId}";
				}else{
