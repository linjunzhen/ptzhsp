...
<c:if test="${itemMap.roomNo!='A'&&itemMap.roomNo!='B'}">
	...
	<script type="text/javascript">
		...
		function backToTop(){
			window.parent.document.getElementById('takeFrame').src="callController.do?toYctbTypeChooseMacW&roomNo=${itemMap.roomNo}&ifMaterPrint=${itemMap.ifMaterPrint}&departId=${itemMap.departId}";
		}
...
<script LANGUAGE="javascript" for="PrintIDCard1" event="OnIdCard()">
    ...
    if(cardNo==""||cardNo==null){
		...
		$.post("callYctbController/yctbGenerateNo.do",{
	   		lineName:name,
	   		lineCardNo:cardNo,
	   		LINE_ZJLX:'SF',
			address:Addr
