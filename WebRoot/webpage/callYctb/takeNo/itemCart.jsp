...
<body class="bg-none">
    ...
    <script type="text/javascript">
		...
		function backToParent(){		
			window.parent.document.getElementById('takeFrame').src="callYctbController/toYctbBusinessItemChoose.do?roomNo=${itemMap.roomNo}&ifMaterPrint=${itemMap.ifMaterPrint}&departId=${itemMap.departId}";
		}
		
		function readCard(){					
			window.parent.document.getElementById('takeFrame').src="callYctbController/yctbReadCard.do";
		}
