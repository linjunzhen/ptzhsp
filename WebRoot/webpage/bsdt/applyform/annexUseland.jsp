	...
	<div class="bsboxC">
		...
		<table style="margin-top: -1px;display: block;" cellpadding="0" cellspacing="0" class="bstable1" id="sqjg">	
			...
			<tr>
				...
				<th><span class="bscolor1">*</span>投资估算(万元)</th>
				<td>
			...
			<tr>
				<th>对接联络员</th>
				<td>
				<input type="text" maxlength="16" name="ANNEX_JOINTNAME" class="tab_text" />
				</td>
				<th>联络员电话</th>
				<td>
			...
			<!-- <tr>
				<th>申请人</th>
				<td>
				<input type="text" maxlength="16" name="ANNEX_APPLYER" class="tab_text" />
				</td>
				<th>窗口收件人员</th>
				<td>
				<input type="text" maxlength="16" class="tab_text" name="ANNEX_WINDOWER" />
				</td>
			</tr>
			<tr>
				<th>收件时间</th>
				<td>
				<input id="annexAccepttime" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false})" 
				readonly="true" class="tab_text Wdate" name="ANNEX_ACCEPTTIME" />
				</td>
				<th></th>
				<td>
				</td>
