...
<body class="eui-diabody" style="margin:0px;">
	<form id="dwinfoForm" method="post">
		...
		<table style="width:100%;border-collapse:collapse;"
			...
			<tr>
				<td>
					<span style="width: 140px;float:left;text-align:right;">造价机构资质等级：</span>
					<eve:eveselect clazz="eve-input  validate[required]" dataParams="QUALLEVEL"
					dataInterface="dictionaryService.findDatasForSelect" value="${info.QUALLEVEL}"
					defaultEmptyText="请选择造价机构资质等级" name="QUALLEVEL">
					</eve:eveselect>
					<font class="dddl_platform_html_requiredFlag">*</font>
				</td>
				<td>
					<span style="width: 140px;float:left;text-align:right;">造价机构资质证书号：</span>
					<input type="text" class="eve-input validate[required]" style="width:186px;float:left;" 
					name="QUALCERTNO"  placeholder="请输入资质证书号"  maxlength="32"   value="${info.QUALCERTNO}"/>
					<font class="dddl_platform_html_requiredFlag">*</font>
				</td>
			</tr>
			<tr>	
			...
			<tr>
				<td>
					<span style="width: 140px;float:left;text-align:right;">造价工程师：</span>
					<input type="text" class="eve-input  validate[required]" style="width:186px;float:left;" 
			...
			<tr>
				<td>
					<span style="width: 140px;float:left;text-align:right;">造价工程师资格等级：</span>
					<input type="text" class="eve-input  validate[]" style="width:186px;float:left;" 
					name="PERSONQUALLEVEL"  placeholder="请输入资格等级"   maxlength="16" value="${info.PERSONQUALLEVEL}"/>
				</td>
				<td>
					<span style="width: 140px;float:left;text-align:right;">执业资格证书号：</span>
					<input type="text" class="eve-input  validate[]"  style="width:186px;float:left;" 
					name="PERSONCERT"  placeholder="请输入执业资格证书号"   maxlength="16" value="${info.PERSONCERT}"/>
				</td>
