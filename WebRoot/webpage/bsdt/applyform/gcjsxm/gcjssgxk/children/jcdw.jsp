...
<body class="eui-diabody" style="margin:0px;">
	<form id="dwinfoForm" method="post">
		...
		<table style="width:100%;border-collapse:collapse;"
			...
			<tr>
				<td>
					<span style="width: 140px;float:left;text-align:right;">检测单位资质等级：</span>
					<input type="text" class="eve-input validate[required]" style="width:186px;float:left;" 
					name="QUALLEVEL"  placeholder="请输入资质等级"  maxlength="32"   value="${info.QUALLEVEL}"/>
					<font class="dddl_platform_html_requiredFlag">*</font>
				</td>
				<td>
					<span style="width: 140px;float:left;text-align:right;">检测单位资质证书号：</span>
					<input type="text" class="eve-input validate[required]" style="width:186px;float:left;" 
