...
<body class="eui-diabody" style="margin:0px;">
	<form id="dwinfoForm" method="post">
		...
		<table style="width:100%;border-collapse:collapse;"
			...
			<tr>
				<td>
					<span style="width: 140px;float:left;text-align:right;">设计机构资质等级：</span>
					<eve:eveselect clazz="eve-input validate[required]" dataParams="sjjgzzdj"
					dataInterface="dictionaryService.findDatasForSelect" 
					defaultEmptyText="请选择资质等级" name="QUALLEVEL" value="${info.QUALLEVEL}">
					</eve:eveselect>
					<font class="dddl_platform_html_requiredFlag">*</font>
				</td>
				<td>
					<span style="width: 140px;float:left;text-align:right;">设计机构资质证书号：</span>
					<input type="text" class="eve-input validate[required]" style="width:186px;float:left;" 
