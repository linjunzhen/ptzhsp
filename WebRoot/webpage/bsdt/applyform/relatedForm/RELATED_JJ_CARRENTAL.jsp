...
<head>
	...
	<script type="text/javascript">
		$(function() {
			...
			$('#CARRENTAL_FORM').find('input,textarea').prop("readonly", true);
			$('#CARRENTAL_FORM').find('select').prop("disabled", "disabled");
			$('#CARRENTAL_FORM').find(":radio,:checkbox").attr('disabled',"disabled");
			$('#CARRENTAL_FORM').find(".laydate-icon").attr('disabled',"disabled");
