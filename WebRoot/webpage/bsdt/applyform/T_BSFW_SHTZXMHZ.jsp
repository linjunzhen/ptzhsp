...
<script type="text/javascript">
	$(function(){
    	...
    	if(flowSubmitObj){
    		...
    		if(flowSubmitObj.busRecord){
    			FlowUtil.initFormFieldValue(flowSubmitObj.busRecord,"T_BSFW_SHTZXMHZ_FORM");
    			//获取表单字段权限控制信息
        		var currentNodeFieldRights = flowSubmitObj.currentNodeFieldRights;
        		 //初始化表单字段权限控制
        		FlowUtil.initFormFieldRightControl(currentNodeFieldRights,"T_BSFW_SHTZXMHZ_FORM");
    		}
	...
	function FLOW_SubmitFun(flowSubmitObj) {
		//先判断表单是否验证通过
		var validateResult = $("#T_BSFW_SHTZXMHZ_FORM").validationEngine(
				"validate");
		if (validateResult) {
			...
			if (submitMaterFileJson || submitMaterFileJson == "") {
				...
				var formData = FlowUtil
						.getFormEleData("T_BSFW_SHTZXMHZ_FORM");
...
<body>
   ...
   <form id="T_BSFW_SHTZXMHZ_FORM" method="post" >
    <%--===================重要的隐藏域内容=========== --%>
	...
	<jsp:include page="./matterListZF.jsp" >
           <jsp:param value="T_BSFW_SHTZXMHZ_FORM" name="formName"/>
     </jsp:include>
