...
<head>
    ...
    <script type="text/javascript" src="<%=basePath%>/webpage/bsdt/applyform/hydj/js/lhdj.js"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if (flowSubmitObj) {
                ...
                //初始化表单字段权限控制
                FlowUtil.initFormFieldRightControl(currentNodeFieldRights,"T_BSFW_LHDJ_FORM");
                if (flowSubmitObj.busRecord) {
                    FlowUtil.initFormFieldValue(flowSubmitObj.busRecord, "T_BSFW_LHDJ_FORM");
                    if (flowSubmitObj.busRecord.RUN_STATUS != 0) {
                        ...
                        $("#applyLhdjDiv input , #applyLhdjDiv select").each(function () {
                            $(this).attr("disabled", "disabled");
                        })
                        $("#emsDiv input , #emsDiv select , #emsDiv textarea").each(function () {
                            $(this).attr("disabled", "disabled");
                        })
                    }
                } else {
...
<body>
    ...
    <form id="T_BSFW_LHDJ_FORM" method="post">
        <%--===================重要的隐藏域内容=========== --%>
        ...
        <%--开始引入离婚登记特殊字段--%>
        <jsp:include page="./hydj/applyLhdj.jsp" />
        <%--结束引入离婚登记特殊字段 --%>
