...
<script type="text/javascript"
	src="<%=basePath%>/webpage/bsdt/applyform/ssqcwb/ssnzqyba/js/commercial.js"></script>
...
<body>
	...
	<form id="T_COMMERCIAL_SSNZQYBA_FORM" method="post">
		<%--===================重要的隐藏域内容=========== --%>
		...
		<%--开始引入备案事项选择界面--%>
		<jsp:include page="./ssqcwb/ssnzqyba/T_COMMERCIAL_BASXXZ.jsp" />
		<%--结束引入备案事项选择界面 --%>		
		
		
		<%--开始引入基本信息界面--%>
		<jsp:include page="./ssqcwb/ssnzqyba/T_COMMERCIAL_COMPANY.jsp" />
		<%--结束引入基本信息界面 --%>		
		
		<%--开始引入股东信息--%>
		<jsp:include page="./ssqcwb/ssnzqyba/T_COMMERCIAL_CAPITAL.jsp" /> 
		<%--结束引入股东信息 --%>

		<%--开始引入备案信息--%>
		<jsp:include page="./ssqcwb/ssnzqyba/T_COMMERCIAL_BAXX.jsp" /> 
		<%--结束引入备案信息 --%>
		
		<%--开始引入人员信息界面 --%>
		<jsp:include page="./ssqcwb/ssnzqyba/T_COMMERCIAL_LEGAL.jsp" />
		<%--结束引入人员信息界面 --%>
		
		<%--开始引入其他材料下载--%>
		<jsp:include page="./ssqcwb/ssnzqyba/T_COMMERCIAL_FILE.jsp" />
		<%--结束引入其他材料下载 --%>
		
		<%--开始引入商事材料下载--%>
		<jsp:include page="./ssqcwb/ssnzqyba/commercialMaterList.jsp" />
		<%--结束引入商事材料下载 --%>
		<%--开始引入公用申报对象--%>
