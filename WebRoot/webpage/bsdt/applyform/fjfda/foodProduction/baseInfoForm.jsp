...
<form action="" id="BASEINFO_FORM"  >
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2">
		<tr>
			...
			<td>					
					<fda:fda-excheckbox name="SQLX" width="80%" datainterface="fdaDictionaryService.findList" datavalidate="validate[required]"
					queryparamjson="{TYPE_CODE:'spscsqlx',ORDER_TYPE:'ASC'}" puremode="true" isstartp="false"></fda:fda-excheckbox>
			</td>
