...
<form action="" id="CLIENT_FORM"  >
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2">
		...
		<tr>
			<th>证件类型：</th>
			<td>
			<fda:fda-exselect name="WTRZJLX" datainterface="dictionaryService.findList" 
		...
		<tr>
			<th>委托权限</th>
			<td colspan="3">
				<p>1、<fda:fda-exradiogroup name="WTQX_XGCL" width="120" 
				...
				修改自备材料中的修改材料 </p>
				<p>2、<fda:fda-exradiogroup name="WTQX_XGCW" width="120" 
						datainterface="dictionaryService.findList"
						queryparamjson="{TYPE_CODE:'AgreeOrDisagree',ORDER_TYPE:'ASC'}"
						allowblank="true" puremode="true"></fda:fda-exradiogroup>
				修改有关表格的填写错误 </p>
				<p>3、<fda:fda-exradiogroup name="WTQX_LQXKZ" width="120" 
						datainterface="dictionaryService.findList"
						queryparamjson="{TYPE_CODE:'AgreeOrDisagree',ORDER_TYPE:'ASC'}"
						allowblank="true" puremode="true"></fda:fda-exradiogroup>
				领取许可证有关证书 </p>
				<p>4、<fda:fda-exradiogroup name="WTQX_KDCL" width="120" 
						datainterface="dictionaryService.findList"
						queryparamjson="{TYPE_CODE:'AgreeOrDisagree',ORDER_TYPE:'ASC'}"
						allowblank="true" puremode="true"></fda:fda-exradiogroup>
				核对申请材料中的复印件并签署核对意见</p>
				<p>5、其他委托事项及权限（请详细注明）<input type="text"  style="width: 400px;"
					placeholder="请输入其他委托事项及权限" maxlength="200" class="syj-input1 " name="WTQX_QTQX" /></p>
			</td>
		</tr>
		<tr>
			<th>固定电话：</th>
