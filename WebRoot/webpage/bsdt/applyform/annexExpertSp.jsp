...
<div class="bsbox clearfix" id="fjbdDiv1">
	...
	<div class="bsboxT">
		<ul>
			<li class="on" style="background:none"><span>综合（专家）评审申请表信息</span></li>			
		</ul>
	</div>
	<div class="bsboxC">
		...
		<table style="margin-top: -1px;display: block;" cellpadding="0" cellspacing="0" class="bstable1" id="sqjg">	
			...
			<tr>
				<th><span class="bscolor1">*</span>规划选址情况</th>
				<td  colspan="3">
					<textarea id="annexAddressOverview" class="eve-textarea validate[required],maxSize[300]" rows="3" cols="200"  
					  name="ANNEX_ADDRESS_OVERIVEW" style="width:660px;height:100px;" ></textarea>
				</td>
			</tr>
			<tr>
				<th><span class="bscolor1">*</span>用地情况</th>
				<td  colspan="3">
					<textarea id="annexUselandOverview" class="eve-textarea validate[required],maxSize[300]" rows="3" cols="200"  
					  name="ANNEX_USELAND_OVERVIEW" style="width:660px;height:100px;" ></textarea>
				</td>
			</tr>
		</table>
	</div>	
