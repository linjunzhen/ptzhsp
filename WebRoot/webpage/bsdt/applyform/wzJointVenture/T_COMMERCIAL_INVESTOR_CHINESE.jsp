...
<table cellpadding="0" cellspacing="1" class="tab_tk_pro2" id="ChineseInvest">
	<tr>
		<th colspan="4" style="background-color: #FFD39B;">中方合伙人信息</th>
	</tr>
	<tr id="ChineseInvest_1">
		<td>
			<table class="tab_tk_pro2">
				<tr>
					<td class="tab_width"><font class="tab_color">*</font>中方合伙人名称：</td>
					<td colspan="3">
				...
				<tr>
					<td class="tab_width"><font class="tab_color">*</font>中方合伙人移动电话：</td>
				...
				<tr>
					...
					<td colspan="3"><input type="text" class="tab_text validate[]" style="width:600px;"
						name="LEGAL_PERSON" maxlength="64"/>
					</td>
				</tr>
				<tr class="chineseAppointTr" style="display:none;">
				...
				<tr>
					...
					<td class="tab_width"><font class="tab_color">*</font>出资日期：</td>
					<td><input type="text" class="tab_text " disabled="disabled"
