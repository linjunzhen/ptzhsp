				...
				<form action="#" name="fdchtbaxxcxForm">
					...
					<table class="dddl-contentBorder dddl_table"
						...
						<tr style="height:28px;">
							<td style="width:120px;text-align:right;"><c:if test="${isKfsywsl == '1'}"><font class="tab_color">*</font></c:if>合同编号：</td>
						...
						<tr style="height:28px;">
							<td style="width:120px;text-align:right;"><c:if test="${isKfsywsl == '1'}"><font class="tab_color">*</font></c:if>买受人证件号码：</td>
							<td style="width:300px;"><input class="eve-input"
