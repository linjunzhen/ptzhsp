...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if (flowSubmitObj) {
                ...
                if(flowSubmitObj.EFLOW_CURUSEROPERNODENAME!="受理" && flowSubmitObj.EFLOW_CURUSEROPERNODENAME!="预审" 
                   && flowSubmitObj.EFLOW_CURUSEROPERNODENAME!="抽查"){
                ...
                if(flowSubmitObj.EFLOW_CURUSEROPERNODENAME=="抽查"){
                    $("#SF_CHECK").attr("style","");                    
                }   
                if(flowSubmitObj.EFLOW_CURUSEROPERNODENAME=="专家抽取"){
        ...
        function redioChangeEvent(){
            var value = $("input[name='SYDYXZ']:checked").val();
            if(value == "1"){
                $("input[name='CHECK_SCALE']").val("50%");
            }else if(value == "2"){
                $("input[name='CHECK_SCALE']").val("30%");
            }else if(value == "3"){
                $("input[name='CHECK_SCALE']").val("10%");
            }
            $('input[type=radio][name=SYDYXZ]').change(function() {
                if(this.value == "1"){
                    $("input[name='CHECK_SCALE']").val("50%");
        ...
        function redioIsCheckChangeEvent(){
            var value = $("input[name='ISCHECK']:checked").val();
            if(value == "1"){
                $("#CHECK_SCALE_TD1").attr("style", "");
                $("#CHECK_SCALE_TD2").attr("style", "");
            }else{
                $("#CHECK_SCALE_TD1").attr("style", "display:none");
                $("#CHECK_SCALE_TD2").attr("style", "display:none");
            }
    ...
    <table cellpadding="0" cellspacing="1" class="tab_tk_pro">
        ...
        <tr>
         ...
         <tr>
            ...
            <td id="CHECK_SCALE_TD1" style="display: none;">抽查比例</td>
            <td id="CHECK_SCALE_TD2" style="display: none;" colspan="1">
               <input type="text" class="tab_text" maxlength="100" name="CHECK_SCALE"/>
            </td>
        </tr>
    </table>
...
<%--            </td>--%>
    ...
    <table cellpadding="0" cellspacing="1" class="tab_tk_pro" id="YWCZ_TABLE" >
        ...
        <tr id="SF_CHECK" style="display: none;">
            <td class="tab_width"><font class="tab_color">*</font>是否抽查：</td>
            <td><eve:radiogroup typecode="YesOrNo" width="130px"
                    fieldname="ISCHECK"></eve:radiogroup></td>
        </tr>        
