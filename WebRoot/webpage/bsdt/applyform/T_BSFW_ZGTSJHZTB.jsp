...
<script type="text/javascript">
	$(function(){
    	...
    	if(flowSubmitObj){
    		...
    		if(flowSubmitObj.busRecord){
    			FlowUtil.initFormFieldValue(flowSubmitObj.busRecord,"T_BSFW_ZGTSJHZTB_FORM");
    			
    			//获取表单字段权限控制信息
        		var currentNodeFieldRights = flowSubmitObj.currentNodeFieldRights;
        		 //初始化表单字段权限控制
        		FlowUtil.initFormFieldRightControl(currentNodeFieldRights,"T_BSFW_ZGTSJHZTB_FORM");
    		}
    		if(flowSubmitObj.EFLOW_CURUSEROPERNODENAME){
                if(flowSubmitObj.EFLOW_CURUSEROPERNODENAME=="汇总意见"){
                    ...
                    $("#YWCZ_TABLE").attr("style","");
                    $("#QFSFTG_TR").attr("style","");
                    $("#GSSFTG_TR").attr("style","");
                    $("#GSJG_TR").attr("style", "");
                } else if (flowSubmitObj.EFLOW_CURUSEROPERNODENAME == "拟批复《施工图》联合审查意见"
                        ...
                        || flowSubmitObj.EFLOW_CURUSEROPERNODENAME == "批复《施工图》联合审查意见") {
                    $("#YWCZ_TABLE").attr("style", "");
                    $("#GSSFTG_TR").attr("style","");
                    $("#GSJG_TR").attr("style", "");
					...
					if(flowSubmitObj.EFLOW_CURUSEROPERNODENAME=="批复《施工图》联合审查意见"){
	    				$("#PF_TR").attr("style","");
	    			}
                    //$("#NHZ_TR").attr("style", "");
                }
                if (flowSubmitObj.EFLOW_CURUSEROPERNODENAME == "填写公示材料"
                    ...
                    || flowSubmitObj.EFLOW_CURUSEROPERNODENAME == "拟批复《施工图》联合审查意见"
                    || flowSubmitObj.EFLOW_CURUSEROPERNODENAME == "区行政审批局项目投资处领导审批"
                    || flowSubmitObj.EFLOW_CURUSEROPERNODENAME == "区审批局领导审签"
                    || flowSubmitObj.EFLOW_CURUSEROPERNODENAME == "区管委会领导签发"
                    || flowSubmitObj.EFLOW_CURUSEROPERNODENAME == "批复《施工图》联合审查意见") {
	...
	function FLOW_SubmitFun(flowSubmitObj){
		 //先判断表单是否验证通过
		 var validateResult =$("#T_BSFW_ZGTSJHZTB_FORM").validationEngine("validate");
		 if(validateResult){
			 ...
			 if(submitMaterFileJson||submitMaterFileJson==""){
				 ...
				 //先获取表单上的所有值
				 var formData = FlowUtil.getFormEleData("T_BSFW_ZGTSJHZTB_FORM");
				 for(var index in formData){
					 flowSubmitObj[eval("index")] = formData[index];
				 }
				 //定义目标合并任务节点
	             //flowSubmitObj.EFLOW_JOINPRENODENAMES = "办理消防设计备案或审核手续,并联审查";
   ...
   <form id="T_BSFW_ZGTSJHZTB_FORM" method="post" >
    ...
    <table cellpadding="0" cellspacing="1" class="tab_tk_pro" id="YWCZ_TABLE" style="display: none;">
        ...
        <tr id="GSJG_TR" style="display: none;">
            ...
            <td><textarea rows="10" cols="140" name="GSJG" maxlength="1998"></textarea> </td>
        </tr>
    ...
    <table cellpadding="0" cellspacing="1" class="tab_tk_pro" id="GS_TABLE" style="display: none;">
        ...
        <tr>
            ...
            <td colspan="3"><textarea rows="10" cols="140" maxlength="1998" name="JSGMJZYNR"></textarea> </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="EMAIL" maxlength="14"
                /></td>
