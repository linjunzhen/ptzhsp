...
<table cellpadding="0" cellspacing="1" class="tab_tk_pro2" id="slxx_div">
		...
		<td colspan="4">
			<c:if test="${ param.isKfsywsl == null && busRecord.IS_KFSYWSL == null}">
				<c:if test="${isBank eq 'false'}">
					<eve:radiogroup fieldname="ZYDJ_TYPE" width="500" onclick="queryTypeFn();" typecode="zydjlx1" defaultvalue="4" value="${busRecord.ZYDJ_TYPE}"></eve:radiogroup>
				</c:if>
				<c:if test="${isBank eq 'true'}">
					<eve:radiogroup fieldname="ZYDJ_TYPE" width="500" onclick="queryTypeFn();" typecode="zydjlx3" defaultvalue="4" value="${busRecord.ZYDJ_TYPE}"></eve:radiogroup>
				</c:if>
			</c:if>
			<c:if test="${ !(param.isKfsywsl == null && busRecord.IS_KFSYWSL == null)}">
				<eve:radiogroup fieldname="ZYDJ_TYPE" width="500" onclick="queryTypeFn();" typecode="zydjlx2" defaultvalue="1" value="${busRecord.ZYDJ_TYPE}"></eve:radiogroup>
			</c:if>
		</td> 
	</tr> --%>
	<tr id="hthCheck">
	...
	<tr>
		...
		<td colspan="4"><input type="text" class="tab_text validate[]" maxlength="60"
