...
<script>
    function submitPowLimitInfo(type){
        ...
        var flag = validatePowerParams("powerLimitInfo","required");
        ...
        var powerLimitInfo = FlowUtil.getFormEleData("powerLimitInfo");
        ...
        if(""!=trid && undefined !=trid){
            ...
            appendPowLimitRow(powerLimitInfo,i,trid);
            art.dialog({
                content : "权利限制信息更新成功。",
                icon : "succeed",
                ok : true
            ...
            if($("#powerLimitInfoList .powerlimitinfo_tr")){
                index = $("#powerLimitInfoList .powerlimitinfo_tr").length;
                if(index > 0){
            ...
            index = index + 1;
            appendPowLimitRow(powerLimitInfo,index,null);
        } 
        if(type == '0'){
    ...
    function appendPowLimitRow(item,index,replaceTrid){
        if(item != "" && null != item) {
            ...
            $("#powerLimitInfo").attr("trid","powerlimitinfotr_"+index);
        }
    }
    ...
    function getPowLimitJson(){
       ...
       $("#POWERLIMITINFO_JSON").val(JSON.stringify(datas));
       return datas;
    }
            ...
            <td style="padding: 10px">
                <table class="tab_tk_pro2">
                    ...
                    <tr>
                        ...
                        <td>
                          <eve:eveselect clazz="tab_text " dataParams="QLXZZL"
                            dataInterface="dictionaryService.findDatasForSelect" 
                    ...
                    <tr>
                        <td class="tab_width">权利限制编号：</td>
                        <td colspan="3"><input type="text" class="tab_text" maxlength="60" style="width: 72%;" name="LIMIT_CODE" id="LIMIT_CODE"></td>
                    </tr>
                    <tr>
                        <th colspan="4">
                            <input type="button" class="eflowbutton"  value="保存" onclick="submitPowLimitInfo('1');"/>
                            <input type="button" class="eflowbutton"  value="添加" onclick="submitPowLimitInfo('0');"/>
                        </th>
                    </tr>
                </table>                
            </td>           
