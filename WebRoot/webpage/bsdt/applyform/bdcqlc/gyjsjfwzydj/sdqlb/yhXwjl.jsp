...
<div class="bsbox clearfix" style="display: none">
    ...
    <div id="yhxwjlxx" name="yhxwjlInfo">
            ...
            <tr>
                <td style="padding: 10px">
                    <table cellpadding="0" cellspacing="1" class="bstable1" id="yhxwjlInfo">
                        ...
                        <tr>
                            <td colspan="3">
                                <font class="tab_color">*</font>3、按份共有的（1）是否知悉共有的不动产可由占份额三分之二以上的按份共有人进行处分的相关规定？
                            </td>
                            <td>
                        ...
                        <tr>
                            <td colspan="3">
                                <font class="tab_color">*</font>3、按份共有的（2）对按份共有的不动产处分，共有人之间是否另有约定？有约定的，申请人应当提交约定协议书
                            </td>
                            <td>
