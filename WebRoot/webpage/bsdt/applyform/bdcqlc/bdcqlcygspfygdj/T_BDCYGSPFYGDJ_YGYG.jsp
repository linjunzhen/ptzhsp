...
<div class="tab_height"></div>
	...
	<table cellpadding="0" cellspacing="1" class="tab_tk_pro2">
		<tr>
			<td colspan='2' class="tab_width">权利人
			<div id="addOrSaveButton" style="float: right;">
				<a href="javascript:void(0);" class="eflowbutton titleButton" onclick="addQlrInfo();" name="addQlrxx">新增 </a>
			</div>
			</td>
		</tr>
	</table>
	
    <input type="hidden" name="QLR_JSON" />	
	<table cellpadding="0" cellspacing="1" class="tab_tk_pro2"  id="qlrInfo" style="margin-left: -8px; margin-top: -3px;">
		<tr id="qlrInfo_1">
			<td>
					...
					<tr>
						...
						<td>
						  <input type="text" class="tab_text validate[required]" maxlength="128" id="MSFZJHM" style="float: left;"
							name="MSFZJHM" value="${busRecord.MSFZJHM}" /><a href="javascript:void(0);" onclick="cardRead(this,'MSFXM','MSFZJHM');" class="eflowbutton">身份证读卡</a>
						</td>
						<td><font class="tab_color">*</font>手机号码：</td>
						<td>
							<input type="text" class="tab_text validate[required,custom[mobilePhoneLoose]]" maxlength="11" name="MSFSJHM">
						</td>
					</tr>
				</table>
			</td>
			<td><input type="button" class="eflowbutton" name="deleteQlrInfoInput" value="删除" onclick="deleteQlrInfo('1');">
			</td>
		</tr>
	</table>
	<table cellpadding="0" cellspacing="1" class="tab_tk_pro2"  id='ygygInfo' style="margin-top: -2px;">
		<tr>
		...
		<tr>
			...
			<td>
			  <input type="text" class="tab_text validate[]" maxlength="128" id="LZRZJHM" style="float: left;"
				name="LZRZJHM" value="${busRecord.LZRZJHM}" />
				<a href="javascript:void(0);" onclick="YgygLzrRead()" class="eflowbutton">身份证读卡</a>
			</td>	
			<td>手机号码：</td>
			<td>
				<input type="text" class="tab_text validate[],custom[mobilePhoneLoose]" maxlength="11" name="LZRSJHM">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
			  <input type="text" class="tab_text validate[required]" maxlength="128" id="ZRFZJHM" style="float: left;"
				...
				<a href="javascript:void(0);" onclick="YgygYwrRead();" class="eflowbutton">身份证读卡</a>
			</td>
			<td></td>
			<td></td>
		</tr>
		...
		<tr>
			...
			<td>
			  <input type="text" class="tab_text validate[required]" maxlength="128" id="DLRZJHM" style="float: left;"
				...
				<a href="javascript:void(0);" onclick="YgygDlrRead();" class="eflowbutton">身份证读卡</a>
			</td>
			<td><font class="tab_color">*</font>手机号码：</td>
			<td>
				<input type="text" class="tab_text validate[required,custom[mobilePhoneLoose]]" maxlength="11" name="DLRSJHM">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" class="tab_text validate[]" maxlength="32"
				name="JZMJ" value="${busRecord.JZMJ}" style="width: 72%;"  />平方米
			</td>
		...
		<tr>
			...
			<td>
				...
				name="CJJG" value="${busRecord.CJJG}" style="width: 72%;"  />万元
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" class="tab_text validate[]" maxlength="32"
				name="SYQMJ" value="${busRecord.SYQMJ}" style="width: 72%;"  />平方米
			</td>
		</tr>
		...
		<tr class="dbxxtr" style="display:none">
			...
			<input type="hidden" name="BDC_DBJSON">
			...
			<td>
				<a href="javascript:void(0);" id="zsyl" class="eflowbutton" onclick="bdcYgspfygdjDJZMprint(1);">证书预览</a>&nbsp;
				<a href="javascript:void(0);" id="qrdb" onclick="bdcYgspfygdjBooking()" class="eflowbutton">确认登簿</a>&nbsp;
				<a href="javascript:void(0);" id="zsdy" class="eflowbutton" onclick="bdcYgspfygdjDJZMprint(2)">证书打印</a>
			</td>
			<td></td>
		</tr>
		<tr class="dbxxtr" style="display:none">
		...
		<tr>
			...
			<td colspan='3'>
				...
				name="DJYY" id="DJYY" value="预购商品房预告登记" style="width: 72%;"  />
			</td>
		</tr>
		<tr>
