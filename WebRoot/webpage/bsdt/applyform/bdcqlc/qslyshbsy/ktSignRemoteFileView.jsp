...
<SCRIPT LANGUAGE="javascript">
     $(function () {
         var signFileType="${signFileType}";
         if("docx"==signFileType || "doc"==signFileType){            
             LoadPDFDocument();
         }else{            
             LoadEDCDocument();
         }
    ...
    function LoadPDFDocument(){
        ...
        var fileUrl=__file_server
            + "download/fileDownload?attachId=${fileId}"
            +"&attachType=attach";
       // var fileUrl="DownLoadServlet?fileId=${fileId}";
        console.log(fileUrl);
        control.WordToPDFAndLoad(fileUrl,'',3);
    ...
    function LoadEDCDocument(){
        var fileUrl=__file_server
            ...
            +"&attachType=attach";
        console.log(fileUrl);
        control.LoadEDCDocument(fileUrl);
    ...
    function DealFileExport(){
        ...
        if(bool){
            ...
            $.post("<%=basePath%>/ktStampController/uploadKtStampBase64File.do",{
