            ...
            <td style="padding: 10px">
                <table class="tab_tk_pro2">
                    ...
                    <tr>
                        ...
                        <td>
                            <eve:eveselect clazz="tab_text validate[required]" dataParams="DocumentType"
                                           dataInterface="dictionaryService.findDatasForSelect" onchange="bdcSetValidate(this.value,'POWERPEOPLEIDNUM')"
                    ...
                    <tr>
                        ...
                        <td>
                            <eve:eveselect clazz="tab_text validate[]" dataParams="DocumentType"
                                           dataInterface="dictionaryService.findDatasForSelect" onchange="bdcSetValidate(this.value,'POWLEGALIDNUM')"
                    ...
                    <tr>
                        ...
                        <td>
                            <eve:eveselect clazz="tab_text validate[]" dataParams="DocumentType"
                                           dataInterface="dictionaryService.findDatasForSelect" onchange="bdcSetValidate(this.value,'POWAGENTIDNUM')"
