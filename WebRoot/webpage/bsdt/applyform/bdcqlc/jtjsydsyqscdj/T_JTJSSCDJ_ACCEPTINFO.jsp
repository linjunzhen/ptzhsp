...
<div name="SLXX" id="SLXX">
	<table cellpadding="0" cellspacing="1" class="tab_tk_pro2">
		...
		<tr>
			...
			<td><input type="text" class="tab_text" style="color:red;"
			...
			<td>
			    ...
			    name="DZWLX" id="DZWLX" value="${busRecord.DZWLX}" defaultEmptyText="请选择定着物类型">
				</eve:eveselect>
			</td>
		</tr>
		<tr>
			...
			<td><input type="text" class="tab_text validate[required]"
		   	...
		   	<td class="tab_width">持证类型：</td>
			<td>
				<eve:eveselect clazz="tab_text" dataParams="CZLX"
				dataInterface="dictionaryService.findDatasForSelect" onchange="setValidate(this.value);"
		...
		<tr>
			...
			<td><input type="text" class="tab_text" id="SLRY"
					   name="SLRY" value="${busRecord.SLRY}"/></td>
		    <td colspan="3">
				<!--<input type="button" class="eflowbutton"  id="printBtn"
					onclick="" value="打印受理回执单"/>
				<input type="button" class="eflowbutton"  id="printApplyBtn"
						onclick=";" value="打印申请表"/>-->
			</td>
		</tr>
		<tr>
			...
			<td colspan="3">
				<!--<input type="button" class="eflowbutton"  id="Btn1"
					onclick="" value="不予受理"/>
				<input type="button" class="eflowbutton"  id="Btn2"
						onclick=";" value="补交材料"/>-->
			</td>
		</tr>
	</table>
