...
<div id="djshxx">
		...
		<tr>
			<th>
				...
				<a href="javascript:void(0);" style="float:right; margin: 2px 10px;" class="eflowbutton"
					onclick="goPrintTemplate('DYQZXDJSPBYS',3);">审批表（单方）</a>
				<a href="javascript:void(0);" style="float:right; margin: 2px 0" class="eflowbutton"
					onclick="goPrintTemplate('DYQZXDJSPBYS',3);">审批表（双方）</a>
			</th>
		</tr>
	</table>
	...
	<table cellpadding="0" cellspacing="1" class="tab_tk_pro2" id="djshxxInfo">
		<tr>
			...
			<td>
				<eve:eveselect clazz="tab_text validate[required]" dataParams="YesOrNo"
					...
					name="DJSH_SFGG" id="DJSH_SFGG" defaultEmptyValue="0" value="${busRecord.DJSH_SFGG}">
				</eve:eveselect>
			</td>
		...
		<tr>
			...
			<td colspan="2">
				<a href="javascript:void(0);"  onclick="goPrintTemplate('DYQZXGG',3);" style="padding: 0 20px;" class="eflowbutton">打印公告</a>
			</td>
		</tr>
