	...
	<table cellpadding="0" cellspacing="1" class="tab_tk_pro2">
		<tr>
			<th>
				...
				<a href="javascript:void(0);" style="float:right; margin: 2px 10px;" class="eflowbutton" id="dfspb" onclick="showSelectBdcdaxxcx();">审批表（单方）</a>
				<a href="javascript:void(0);" style="float:right; margin: 2px 0;" class="eflowbutton" id="sfspb" onclick="showSelectBdcdaxxcx();">审批表（双方）</a>
			</th>
		</tr>
	</table>
		...
		<tr>
			...
			<td colspan="2">
				<a href="javascript:void(0);" class="eflowbutton"
					style="margin: 2px 0; margin-right: 5px; padding: 0 20px;"
					onclick="showSelectBdcdaxxcx();">打印公告</a>
				<a href="javascript:void(0);" class="eflowbutton" onclick="viewCertificate(3)" name="dyzs" id="dyzs">打证</a>
			</td>
		</tr>
