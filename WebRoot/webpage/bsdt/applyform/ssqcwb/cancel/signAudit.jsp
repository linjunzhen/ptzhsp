...
<script type="text/javascript">
    ...
    $(function(){
        ...
        if(flowSubmitObj) {
            ...
            if(flowSubmitObj.EFLOW_CURUSEROPERNODENAME=='审批'&&isneedsign==1){
                ...
                success: function (data) {
                    ...
                    if (data.total > 0) {
                        ...
                        for (var i = 0; i < rows.length; i++) {
							...
							var signOpinion = rows[i].SIGN_OPINION;
							if(!signOpinion ||null==signOpinion||''==signOpinion||'undefined'==signOpinion){
								signOpinion="";
							}
                            if(rows[i].SIGN_FLAG=='1'){
                                ...
                                html += '<td>' + "<input style='width:400px;height:30px;'"  + "onblur=\"delSignByOpinion(\'"+num+"\',\'"+rows[i].SIGN_ID+"\');\""  +  "name='SIGN_OPINION"+num+"' value=\""+signOpinion+"\"/>" + '</td>';
