...
<table cellpadding="0" cellspacing="1" class="tab_tk_pro2" id="director">
	...
	<tr id="director_1">
			...
			<table class="tab_tk_pro2">
				<tr>
					...
					<td><input type="text" class="tab_text validate[required]" 
						name="DIRECTOR_NAME_OLD" maxlength="30"/></td>
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" class="tab_text validate[required]"  style="width: 185px;"
		...
		<!-- <td>
			<br>
			<input type="button" class="eflowbutton" name="deleteCurrentDirector" value="删除行" onclick="deleteDirector('1');">
			<br>
			<br>
			<input type="button" class="eflowbutton" name="addOneDirector" value="增加一行" onclick="addDirector();">
		</td> -->
	</tr>
</table>
	
<table cellpadding="0" cellspacing="1" class="tab_tk_pro2" id="newdirector" style="display:none">	
	<!--新董事信息  -->
	<tr>
		<th colspan="4"  style="background-color: #FFD39B;">董事信息(变更后)</th>
	</tr>
	<tr id="newdirector_1">
		<td>
			<table class="tab_tk_pro2">
		...
		<td>
			<input type="button"  class="eflowbutton" name="deleteCurrentDirector" value="删除行" onclick="deleteBgDirector('1');">
			<br>
			<br>
			<input type="button" class="eflowbutton" name="addOneDirector" value="增加一行" onclick="addBgDirector();">
		</td>
	</tr>
</table>
