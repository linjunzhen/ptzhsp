...
<table cellpadding="0" cellspacing="1" class="tab_tk_pro2" id="manager">
	...
	<tr id="manager_1">
			...
			<table class="tab_tk_pro2">
				<tr>
					...
					<td><input type="text" class="tab_text validate[required]" 
						name="MANAGER_NAME_OLD" maxlength="8"/></td>
		...
		<!-- <td>
			<br>
			<input type="button" class="eflowbutton"  name="deleteCurrentManager" value="删除行" onclick="deleteManager('1');">
			<br>
			<br>
			<input type="button" class="eflowbutton"  name="addOneManager" value="增加一行" onclick="addManager();">
		</td> -->
	</tr>
</table>
...
<!--新经理信息  -->
<table cellpadding="0" cellspacing="1" class="tab_tk_pro2" id="newmanager" style="display:none">
	<tr>
		<th colspan="4"  style="background-color: #FFD39B;">经理信息(变更后)</th>
	</tr>
	<tr id="newmanager_1">
		<td>
			<table class="tab_tk_pro2">
		...
		<td>
			<input type="button" class="eflowbutton" name="deleteCurrentManager" value="删除行" onclick="deleteBgManager('1');">
			<br>
			<br>
			<input type="button" class="eflowbutton" name="addOneManager" value="增加一行" onclick="addBgManager();">
		</td>
	</tr>
</table>
