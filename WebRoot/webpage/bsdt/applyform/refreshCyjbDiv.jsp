...
<tr>
		...
		<td><input type="text" class="tab_text validate[[],custom[numberplus]]" maxlength="16"
				name="${currentTime}CYJB_GSNSZE" style="width: 60px;" 
					 onkeyup="onlyNumber(this);sumNumber('${currentTime}CYJB_GSNSZE','${currentTime}CYJB_DSNSZE','${currentTime}CYJB_NSZE');"
					 onblur="onlyNumber(this);sumNumber('${currentTime}CYJB_GSNSZE','${currentTime}CYJB_DSNSZE','${currentTime}CYJB_NSZE');"/></td>
		<td><input type="text" class="tab_text validate[[],custom[numberplus]]" maxlength="16"
				name="${currentTime}CYJB_GSDFJSS" style="width: 60px;"  
					 onkeyup="onlyNumber(this);sumNumber('${currentTime}CYJB_GSDFJSS','${currentTime}CYJB_DSDFJSS','${currentTime}CYJB_DFJSR');"
					 onblur="onlyNumber(this);sumNumber('${currentTime}CYJB_GSDFJSS','${currentTime}CYJB_DSDFJSS','${currentTime}CYJB_DFJSR');"/></td>
		<td><input type="text" class="tab_text validate[[],custom[numberplus]]" maxlength="16"
				name="${currentTime}CYJB_DSNSZE" style="width: 60px;" 
					 onkeyup="onlyNumber(this);sumNumber('${currentTime}CYJB_GSNSZE','${currentTime}CYJB_DSNSZE','${currentTime}CYJB_NSZE');"
					 onblur="onlyNumber(this);sumNumber('${currentTime}CYJB_GSNSZE','${currentTime}CYJB_DSNSZE','${currentTime}CYJB_NSZE');"/></td>
		<td><input type="text" class="tab_text validate[[],custom[numberplus]]" maxlength="16"
				name="${currentTime}CYJB_DSDFJSS" style="width: 60px;"  
					 onkeyup="onlyNumber(this);sumNumber('${currentTime}CYJB_GSDFJSS','${currentTime}CYJB_DSDFJSS','${currentTime}CYJB_DFJSR');"
					 onblur="onlyNumber(this);sumNumber('${currentTime}CYJB_GSDFJSS','${currentTime}CYJB_DSDFJSS','${currentTime}CYJB_DFJSR');"/></td>
