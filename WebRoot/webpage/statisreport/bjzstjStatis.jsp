...
$(document).ready(function() {
 ...
 function searchData(){
	 myChart.showLoading();
	 var formData = $("form[name='bjzstjForm']").serialize();
	 
	 var url = "statisticalReportController.do?bjzstjData&Q_T.CREATE_TIME_LE="+$("input[name='Q_T.CREATE_TIME_<=']").val()+" 23:59:59&Q_T.CREATE_TIME_GE="+$("input[name='Q_T.CREATE_TIME_>=']").val()+" 00:00:00&echartType="+$("#echartType").val();
...
<div class="easyui-layout" fit="true">
	<div region="center">
		<!-- =========================查询面板开始========================= -->
		<div id="bjzstjStatisToolBar">
			<form action="#" name="bjzstjForm">
					...
					<tbody>
						<tr style="height:28px;">
							...
							<td colspan="2"><input type="button" value="查询"
								...
								onclick="AppUtil.gridSearchReset('bjzstjForm')" /></td>
						</tr>
					</tbody>
				</table>
			</form>
