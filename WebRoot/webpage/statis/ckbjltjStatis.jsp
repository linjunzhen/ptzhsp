...
<script type="text/javascript">
    ...
    function exportCkbjltjExcel(){
    	...
    	window.location.href = "statisticsController.do?exportCkbjltjExcel&Q_T.CREATE_TIME_GE="+beginDate+" 00:00:00&Q_T.CREATE_TIME_LE="+endDate+" 23:59:59&beginDate="+beginDate+"&endDate="+endDate;
    }
...
<div class="easyui-layout eui-jh-box" fit="true">
	<div region="center">
		...
		<table class="easyui-datagrid" rownumbers="true" pagination="false" striped="true"
			...
			url="statisticsController.do?ckbjltjData">
			<thead>
				<tr>
					<th data-options="field:'PARENT_NAME'" width="15%" rowspan="3">上级部门</th>
					<th data-options="field:'DEPART_NAME'" width="15%" rowspan="3">部门</th>
					<th data-options="field:'CUR_WIN'" width="10%" rowspan="3">窗口号</th>
					<th colspan="11">预登记统计</th>
				</tr>
				<tr>
					<th data-options="field:'TOTAL',align:'center'" width="7%" rowspan="2">收件总数</th>
					<th data-options="field:'SL',align:'center'" width="7%" rowspan="2">受理数</th>
					<th data-options="field:'WCL',align:'center'" width="7%" rowspan="2">未处理数</th>					
					<th data-options="field:'PASS',align:'center'" width="7%" rowspan="2">过号数</th>
					<th data-options="field:'JHZ',align:'center'" width="7%" rowspan="2">叫号中数</th>
					<th data-options="field:'OTHER',align:'center'" width="8%" rowspan="2">其他收件数</th>
					<th colspan="5">导向统计</th>
					
				</tr>
				<tr>
					<th data-options="field:'BS',align:'center'" width="7%">办事数</th>
					<th data-options="field:'ZX',align:'center'" width="7%">咨询数</th>
					<th data-options="field:'LZ',align:'center'" width="7%">领照数</th>					
