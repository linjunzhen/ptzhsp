	...
	<script type="text/javascript">
		...
		function toChildDepart(){
		    ...
		    if(cardNo==""||cardNo==null){
		    	...
		    	location.href="callController.do?toAppointChoose&roomNo="+roomNo+"&cardNo="+cardNo;
			}
		}
	</script>
</body>
...
<%--	}else if(ActivityTo<today){		--%>
    	...
    	//location.href="callController.do?toAppointChoose&cardNo="+cardNo;
    	//location.href="callController.do?toAppointChoose&roomNo="+roomNo+"&cardNo="+cardNo;    	
    	location.href="newCallController/toAppointChoose.do?roomNo="+roomNo+"&cardNo="+cardNo;
<%--		$.post("callController.do?toAppointDeptChoose",{--%>
<%--			roomNo:roomNo,--%>
<%--			cardNo:cardNo--%>
<%--			},function(data) {--%>
<%--				 $(".result").html(data);--%>
