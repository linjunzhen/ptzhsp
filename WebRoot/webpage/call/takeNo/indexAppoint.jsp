...
<body ondragstart="return false" oncontextmenu="return false" onselectstart="return false">
    ...
    <div class="eui-content" style="height: 535px;">
	    ...
	    src="callController.do?toTypeChoose&roomNo=${roomNo}"></iframe>
	    </iframe>
    </div>
	<!-- 主页面结束 -->
    ...
    <div class="eui-footer">   	
    	...
    	<c:if test="${roomNo == 'H'||roomNo == 'I'}">    	
    		<div class="tips"><span class="fs16">上班时间：</span>上午8:15-12:00，下午14:00-17:30。</div>
    	</c:if>
