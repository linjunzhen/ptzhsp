...
<body ondragstart="return false" oncontextmenu="return false" onselectstart="return false">
    ...
    <div class="eui-content">
    	<iframe id="takeFrame" frameBorder="0" width="100%" height="100%" marginHeight="0" marginWidth="0" scrolling="no" allowtransparency="true" src="callController.do?toDeptChoose&roomNo=${roomNo}"></iframe>
    </div>
	<!-- 主页面结束 -->
    
    <style type="text/css">
    	.txtMarquee-left{ width:950px;  position:relative;margin-left:155px; font-size:13px;}
		.txtMarquee-left .bd{ padding:0px; }
		.txtMarquee-left .bd .tempWrap{ width:700px !important; }/* 用 !important覆盖SuperSlide自动生成的宽度，这样就可以手动控制可视宽度。 */
		.txtMarquee-left .bd ul{ overflow:hidden; zoom:1; }
		.txtMarquee-left .bd ul li{ margin-right:10px;  float:left; height:24px; line-height:24px;  text-align:left; _display:inline; width:auto !important; color:#fff }
		.txtMarquee-left .bd ul li span{margin-left:140px;font-size:16px;color:#ff0}
	</style>
    ...
    <div class="eui-footer">
    	<div class="txtMarquee-left">
			...
			<div class="bd">
				<ul class="infoList">
					<li ><span >温馨提示：</span>请在取号前，先准备好您的身份证，系统将识别您的身份信息并打印出排队单据,如需帮助，请询问前台向导。</li>
					<li  >除本人或委托人办理，其他人取号无效。</li>
					<li><span >温馨提示：</span>请在取号前，先准备好您的身份证，系统将识别您的身份信息并打印出排队单据,如需帮助，请询问前台向导。</li>
					<li  >除本人或委托人办理，其他人取号无效。</li>
				</ul>
			</div>
