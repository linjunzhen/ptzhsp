...
<body>
	...
	<div class="pub-con in-box clearfix" data-aos="fade-up">
		<div class="lfloat in-l">			
			<jsp:include page="/webpage/website/bdc/leftList.jsp?currentNav=1" />
		</div>
		<div class="rfloat in-r">						
			<form id="ysggxxForm" method="post" action="bdcQueryController/ysggxx.do">
				<div class="display-table index-ywcx">
					...
					<p style="text-align: right;width: 100px;">预售证号：</p>
					<p style="width: 275px;"><input type="text" placeholder="请输入预售证号" name="LicenceId" maxlength="32" value="${variables.LicenceId}"></p>
					<p style="text-align: right;right;width: 100px;">开发商：</p>
					<p style="width: 275px;"><input type="text" placeholder="请输入开发商" name="DeveloperName" maxlength="32" value="${variables.DeveloperName}"></p>
					<p class="btn"></p>
				</div>
				<div class="display-table index-ywcx">
					<p style="text-align: right;width: 100px;">项目名称：</p>
					<p style="width: 275px;"><input type="text" placeholder="请输入项目名称" name="ProjectName" maxlength="32" value="${variables.ProjectName}"></p>
					<p style="text-align: right;width: 100px;">批准日期：</p>
					<p style="width: 275px;"><input type="text"  class="Wdate" 
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly" 
					placeholder="请输入批准日期" name="BulletinDate" maxlength="32" value="${variables.BulletinDate}"></p>
					<p class="btn"><a class="index-btn" href="javascript:void(0);" onclick="$('#ysggxxForm').submit();">查 询</a></p>
				</div>
			</form>
			<div class="in-table-box">
				<table class="index-table" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td><a href="<%=path%>/bdcQueryController/getCaseProject.do?CaseID=${item.CaseID}" target="_blank">${item.ProjectName}</a></td>
						<td>${item.Location}</td>
						<td>
						...
						<td style="width: 40px;"><a href="<%=path%>/bdcQueryController/getCaseProject.do?CaseID=${item.CaseID}" target="_blank">查看</a></td>
					</tr>
					</c:forEach>
				</table>
