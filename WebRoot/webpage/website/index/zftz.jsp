...
ServiceItemService serviceItemService = (ServiceItemService)AppUtil.getBean("serviceItemService");
    List<Map<String,Object>> list = serviceItemService.findByCatalogCodeForWebSite("350128XK002");
    ...
    <div class="container lbpadding">
    	...
    	<div class="listMain clearfix">
        	<div class="listL">
                ...
                <div class="sublist">
                	<ul>
                    	<li><a href="webSiteController/view.do?navTarget=website/index/shtz">社会投资项目</a></li>
                        <li class="subOn"><a href="webSiteController/view.do?navTarget=website/index/zftz">政府投资项目</a></li>
                    </ul>
                </div>
            </div>
            <div class="listR">
