	...
	<div class="eui-main">
		...
		<div class="eui-con">
			...
			<div class="eui-tit round line">
				<b>政策法规<small>POLICIES AND REGULATIONS</small></b>
			</div>
	...
	<script type="text/javascript">
		...
		function currentPage(currentPage){
			...
			var url= '${webRoot}/projectWebsiteController.do?findContentForPage&start='+start+
					'&paras=:${zcfgModuleId}'+'&limit=15&dsid=235';
			url=encodeURI(url);
			$.ajax({
				url: url,
				type: 'post',
				...
				success: function (data) {
					...
					for(var i=0; i<rows.length; i++){
						...
						var tid=rows[i].TID;
						var itemReldate=rows[i].RELEASE_TIME.substring(0,11);
						html=html+"<li><a href=\"<%=path%>/contentController/view.do?currentNav=5&contentId="+tid+"\"><span>"+itemReldate+"</span>• "+itemtitle+"</a></li>";
					}
					$("#wraper").html(html);
				}
			});
