...
<div id="${serviceItem.ITEM_CODE}_MATER">
	...
	<table cellpadding="0" cellspacing="1" class="syj-table2 tmargin2" id="${currentTime}materCheckList" style="margin-top: 15px;">
		<tr>
			<th style="width:50px;text-align: center" id="xhTitle">序号</tthd>
			<th style="width:120px;text-align: center" id="sxzxTitle">事项子项</th>
			<th style="width:300px;text-align: center">材料名称</th>
			<th style="width:180px;text-align: center"
							<c:if test="${isWebsite=='1'}">style="display: none;"</c:if>>
							注意事项</th>
			<th style="width:100px;text-align: center">材料说明</th>
<%--			<th>附件</th>--%>
