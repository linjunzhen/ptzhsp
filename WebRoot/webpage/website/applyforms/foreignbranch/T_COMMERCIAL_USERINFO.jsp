	...
	<div style="position:relative;">
		...
		<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="syj-table2 tmargin20" id="sqjg" >	
			<tr>
				...
				<input style="width:82%;" type="text" maxlength="60" name="SQJG_NAME" class="syj-input1 validate[required,custom[equalsSgsStr]]" value="${sessionScope.curLoginMember.YHMC}"/>
				</td>
			</tr>
			<tr>			    
