    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if (EFLOW_FLOWOBJ) {
                ...
                if (eflowObj.busRecord) {
                    FlowUtil.initFormFieldValue(eflowObj.busRecord, "T_BSFW_GCJSQTXFYS_FORM");
                            /*特殊项目信息判定*/
        ...
        function submitFlow(){
            ...
            if (new Date(yanshouDate) < new Date(applyDate)) {
                var valifileResult=AppUtil.getSubmitMaterFileJson("T_BSFW_GCJSQTXFYS_FORM",1);
                if (valifileResult) {
                    AppUtil.submitWebSiteFlowForm('T_BSFW_GCJSQTXFYS_FORM');
                }else{
                    art.dialog({
	                    content: "材料未上传",
	                    icon:"error",
        ...
        function saveFlow() {
            //valiSpecialProject();
            //var valifileResult=AppUtil.getSubmitMaterFileJson("T_BSFW_GCJSQTXFYS_FORM",1);
            var validateResult =$("#T_BSFW_GCJSQTXFYS_FORM").validationEngine("validate");
            if(validateResult){
	            //setHiddenValue();
	            //valiSpecialProject();
	            AppUtil.tempSaveWebSiteFlowForm('T_BSFW_GCJSQTXFYS_FORM');
            }
        }
...
<body  style="background: #f0f0f0;">
    ...
    <form id="T_BSFW_GCJSQTXFYS_FORM" method="post">
        <%--===================重要的隐藏域内容=========== --%>
        <%--开始引入公共隐藏域部分 --%>
        ...
        <div class="bsbox clearfix">
            ...
            <div class="bsboxC">
                <table cellpadding="0" cellspacing="0" class="bstable1" style="table-layout: fixed;">
                    <tr>
                        ...
                        <td>
                            <input style="width:82%;" type="text"  name="PRJ_NUM" class="tab_text validate[required]" value="${serviceItem.PRJ_NUM}" />
                        </td>
                        <th> <span class="bscolor1">*</span>项目代码</th>
                        <td>
                            <input style="width:82%;" type="text"  name="PRJ_CODE" class="tab_text validate[required]" value="${serviceItem.PRJ_CODE}" />
                        </td>
                    </tr>
                    <tr>
                        <th> <span class="bscolor1">*</span>项目名称</th>
                        <td colspan="3"><input style="width:82%;" type="text"  name="PRJ_NAME" class="tab_text validate[required]" value="${serviceItem.PRJ_NAME}" /></td>
                    </tr>
                    <tr>
                        <th> <span class="bscolor1">*</span>工程地址</th>
                        <td colspan="3"><input style="width:82%;" type="text"  name="ADDRESS" class="tab_text validate[required]" value="${serviceItem.ADDRESS}" /></td>
                    </tr>
                    <tr>
                        <th><span class="bscolor1">*</span> 建设单位</th>
                        <td colspan="3"><input style="width:82%;" type="text"  name="BUILD_CORPNAME" class="tab_text validate[required]" value="${serviceItem.BUILD_CORPNAME}" /></td>
                    </tr>
                    <tr>
                        <th><span class="bscolor1">*</span> 项目负责人</th>
                        <td>
                            <input style="width:82%;" type="text" maxlength="60"  name="CONTACTOR" class="tab_text validate[required]" value="${serviceItem.CONTACTOR}" />
                        </td>
                        <th><span class="bscolor1">*</span> 联系电话</th>
                        <td>
                            <input style="width:82%;" type="text"  name="CONTACT_INFORMATION" class="tab_text validate[required,custom[mobilePhoneLoose]]" value="${serviceItem.CONTACT_INFORMATION}" />
                        </td>
                    </tr>
                    <tr>
                        <th><span class="bscolor1">*</span> 法定代表人</th>
                        <td>
                            <input style="width:82%;" type="text" maxlength="60"  name="LEGAL_REPRESENT" class="tab_text validate[required]" value="${serviceItem.LEGAL_REPRESENT}" />
                        </td>
                        <th><span class="bscolor1">*</span> 联系电话</th>
                        <td>
                            <input style="width:82%;" type="text"  name="LEGAL_INFORMATION" class="tab_text validate[required,custom[mobilePhoneLoose]]" value="${serviceItem.LEGAL_INFORMATION}" />
                        </td>
                    </tr>
                    <tr>
                        <th> 消防检测机构</th>
                        <td colspan="3"><input style="width:82%;" type="text"  name="XF_CHECKJG" class="tab_text " maxlength="128" value="${serviceItem.XF_CHECKJG}"/></td>
                    </tr>
                    <tr>
                        <th><span class="bscolor1">*</span> 建设主管部门</th>
                        <td colspan="3"><input style="width:82%;" type="text" maxlength="60"  name="BUILDMANAGERJG" class="tab_text validate[required]" maxlength="128" value="${serviceItem.BUILDMANAGERJG}"/></td>
                    </tr>
                    <tr>
                        <th><span class="bscolor1">*</span> 消防验收申请（备案）编号</th>
                        <td colspan="3"><input style="width:82%;" type="text" maxlength="60"  name="FCACCEPTANCENUM" class="tab_text validate[required]" maxlength="64" value="${serviceItem.FCACCEPTANCENUM}"/></td>
                    </tr>
                    <tr>
            ...
            <!-- 
            <div id="specialProject" style="display: none;">
                <div class="bsboxT">
                    <ul>
...
<%--                        </tr>--%>
                        <tr>
                            ...
                            <td>
                                <input style="width:82%;" type="text" maxlength="60"  name="DESIGNREVIEWNUM" class="tab_text validate[required]" value="${serviceItem.DESIGNREVIEWNUM}"/>
                            </td>
                        ...
                        <tr><th colspan="4" style="text-align: center;color:#426fa4;font-weight: 700;">竣工验收情况</th></tr>
                        <tr>
                            <th> 建筑类别</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION1" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION1}"/>
                            </td>
                            <th> 总平面布局</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION2" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION2}"/>
                            </td>
                        </tr>
                        <tr>
                            <th> 平面布置</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION3" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION3}"/>
                            </td>
                            <th> 消防水源</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION4" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION4}"/>
                            </td>
                        </tr>
                        <tr>
                            <th> 消防电源</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION5" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION5}"/>
                            </td>
                            <th> 装修防火</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION6" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION6}"/>
                            </td>
                        </tr>
                        <tr>
                            <th> 建筑保温</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION7" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION7}"/>
                            </td>
                            <th> 防火分区</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION8" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION8}"/>
                            </td>
                        </tr>
                        <tr>
                            <th> 室外消火栓系统</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION9" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION9}"/>
                            </td>
                            <th> 火灾自动报警系统</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION10" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION10}"/>
                            </td>
                        </tr>
                        <tr>
                            <th> 室内消火栓系统</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION11" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION11}"/>
                            </td>
                            <th> 自动喷水灭火系统</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION12" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION12}"/>
                            </td>
                        </tr>
                        <tr>
                            <th> 其他灭火设施</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION13" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION13}"/>
                            </td>
                            <th> 防烟排烟系统</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION14" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION14}"/>
                            </td>
                        </tr>
                        <tr>
                            <th> 安全疏散</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION15" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION15}"/>
                            </td>
                            <th> 防烟分区</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION16" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION16}"/>
                            </td>
                        </tr>
                        <tr>
                            <th> 消防电梯</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION17" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION17}"/>
                            </td>
                            <th> 防爆</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION18" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION18}"/>
                            </td>
                        </tr>
                        <tr>
                            <th> 灭火器</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION19" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION19}"/>
                            </td>
                            <th> 其他事项</th>
                            <td>
                                <input style="width:82%;" type="text"  name="OTHERMATTER" maxlength="100" class="tab_text" value="${serviceItem.OTHERMATTER}"/>
                            </td>
                        </tr>
                        <tr>
                            <th> 其他验收情况</th>
                            <td>
                                <input style="width:82%;" type="text"  name="ACCEPTANCESITUATION20" maxlength="100" class="tab_text" value="${serviceItem.ACCEPTANCESITUATION20}"/>
                            </td>
                            <th></th>
                            <td></td>
                        </tr>
                ...
                <div class="bsboxC">
                    <table cellpadding="0" cellspacing="0" class="bstable1">
                        <tr>
                            ...
                            <td colspan="3"><input style="width:82%;" type="text"  name="QUALITYDEPART" maxlength="128" class="tab_text validate[required]" value="${serviceItem.QUALITYDEPART}"/></td>
                        </tr>
                        <tr>
                            <th><span class="bscolor1">*</span> 消防设计备案凭证文号</th>
                            <td>
                                <input style="width:82%;" type="text"  name="DESIGNRECORDNUM" class="tab_text validate[required]" maxlength="128" value="${serviceItem.DESIGNRECORDNUM}"/>
                            </td>
            ...
            <input type="hidden" name="IFSPECIALBUILDING" value="0">
            <input type="hidden" name="DECLARATIONTYPE" value="002">
        ...
        <div class="bsbox clearfix">
            ...
            <jsp:include page="/webpage/website/applyforms/xfsj/applyForm.jsp" >
                <jsp:param value="T_BSFW_GCJSQTXFYS_FORM" name="formId"/>
