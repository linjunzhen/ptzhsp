...
<head>
    ...
    <script type="text/javascript" src="<%=basePath%>/webpage/website/applyforms/bdcqlc/gyjsscdj/js/gyjsscdj.js"></script>
    ...
    <script type="text/javascript">
        $(function () {
			...
			//个人、法人账号均可办理业务，不做限制
            var userType = '${sessionScope.curLoginMember.USER_TYPE}';//用户类型
			initSlxx();//初始化受理信息
            //获取流程信息对象JSON
...
<body style="background: #f0f0f0;">
	...
	<div class="eui-main">
        ...
        <form id="T_BDCQLC_GYJSSCDJ_FORM" method="post">
            ...
            <input type="hidden" name="ISQCWB" value="0">
            ...
            <%--开始引入受理信息--%>
            <jsp:include page="./bdcqlc/gyjsscdj/T_GYJSSCDJ_ACCEPTINFO.jsp" />
            <%--结束引入受理信息--%>
           ...
           <%--  <jsp:include page="./bdcqlc/gyjsjfwzydj/yhXwjl.jsp" /> --%>
            ...
            <jsp:include page="./submitdiv.jsp" >
                <jsp:param value="submitFlow('T_BDCQLC_GYJSSCDJ_FORM');" name="submitFn"/>
                <jsp:param value="saveFlow('T_BDCQLC_GYJSSCDJ_FORM');" name="tempSaveFn"/>
            </jsp:include>
            <%--结束引入提交DIV界面 --%>
