				...
				function(responseText, status, xhr) {
					...
					if(resultJson.success == true){
						...
						for(var i=0;i<obj.length;i++){				
							/* if(Trim(obj[i].CQZT)=='预售预告 总登记 已售' || Trim(obj[i].CQZT)=='预售预告 已售' || Trim(obj[i].CQZT)=='预售预告' ){
								art.dialog.data("bdcygdacxInfo",rows);
								AppUtil.closeLayer(); 
							} else{								
								parent.art.dialog({
									content: "请注意：该不动产单元号产权状态处于“"+obj[i].CQZT+"”中,不可受理此登记！",
									icon:"warning",
									ok: true
								});
							} */
    ...
    <div data-options="region:'center',split:false" >
            ...
            <form action="#" name="bdcygdacxForm" id="bdcygdacxForm">
                ...
                <table class="dddl-contentBorder dddl_table"
                    ...
                    <tr style="height:28px;">
                        ...
                        <td style="width:120px;text-align:right;"><font class="tab_color">*</font>不动产登记证明号：</td>
                        <td style="width:135px;"><input class="eve-input"
                                                        type="text" maxlength="50" style="width:128px;"
                                                        name="bdcdjzmh" /></td>
                    ...
                    <tr>
                        <td style="width:120px;text-align:right;"><font class="tab_color">*</font>权利人证件号码：</td>
                        <td style="width:135px;"><input class="eve-input"
                                                        type="text" maxlength="50" style="width:128px;"
                                                        name="qlrzjh" /></td>
        ...
        <table class="easyui-datagrid" rownumbers="true" pagination="false"
            ...
            <tr>
                ...
                <th data-options="field:'YGDJZL',align:'left'" width="100">登记种类</th>
