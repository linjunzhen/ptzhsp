...
<script type="text/javascript">
    ...
    function setValidate(zjlx){
		if(zjlx=="SF"){
			$("#SSSB_QSRZJLX").addClass(",custom[vidcard]");
		}else{
			$("#SSSB_QSRZJLX").removeClass(",custom[vidcard]");
		}
	}
...
<!-- 涉税申报签署人信息开始 -->
<div class="bsbox clearfix" id="sssbqsrxx" style="display:none">
    <div class="bsboxT">
        <ul>
            <li class="on" style="background:none"><span>涉税申报签署人信息</span></li>
        </ul>
    </div>
    <div name="sssbqsrxx">
        <table cellpadding="0" cellspacing="1" class="bstable1">
            <tr>
                <td style="padding: 10px">
                    <table cellpadding="0" cellspacing="1" class="bstable1" >
                        <tr>
                        	<th class="tab_width"><font class="tab_color">*</font>签署人姓名：</th>
                            <td>
                            ...
                            <th class="tab_width"><font class="tab_color">*</font>签署人证件类型：</th>
                            <td>
                        ...
                        <tr>
                        	<th class="tab_width"><font class="tab_color">*</font>签署人证件号码：</th>
                            <td >
                            ...
                            <th class="tab_width"><font class="tab_color">*</font>签署人手机号码：</th>
                            <td >
