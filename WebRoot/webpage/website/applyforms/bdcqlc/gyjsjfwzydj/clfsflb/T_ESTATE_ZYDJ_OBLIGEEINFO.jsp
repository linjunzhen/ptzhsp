...
<div id="powerDY_div" style="display: none;">
        ...
        <div style="padding: 10px">
            <table cellpadding="0" cellspacing="0" class="bstable1" id="powerDY">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="easyui-combobox tab_text" name="DY_DYQR" id="DY_DYQR"
                                           data-options="
                                            prompt : '请输入或者选择抵押权人',
                            ...
                            <tr>
                                <th>登记原因：</th>
                                <td colspan="3">
                                    <input type="text" class="tab_text1 validate[]" maxlength="256" id="DY_DYDJYY" style="width: 70%"
                                           name="DY_DYDJYY" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" class="tab_text1 validate[required]" maxlength="500" id="DY_ZGZQQDSS" style="width: 70%"
                                           name="DY_ZGZQQDSS" />
                                </td>
                            </tr>
                            <tr id="dy_bdcdjzmh_tr" style="display:none;">
                                <th>不动产登记证明号：</th>
                                <td colspan="3">
                                    <input type="text" class="tab_text1 validate[]" maxlength="64" id="DY_BDCDJZMH"
                                           name="DY_BDCDJZMH" />
                            ...
                            <tr id="dy_bdcqzbsm_tr" style="display:none;">
                                ...
                                <td colspan="3">
                                    <input type="text" class="tab_text1 validate[]" maxlength="64" id="DY_BDCQZBSM"
                                           name="DY_BDCQZBSM" />
                                </td>
                            </tr>
    ...
    <%--                        </tr>--%>
                            ...
                            <tr>
                                <th>附记：</th>
                                <td colspan="3">
                                    <input type="text" class="tab_text1 validate[]" maxlength="500" id="DY_FJ" style="width: 70%"
                                           name="DY_FJ" />
                                </td>
                            </tr>
                        </table>
