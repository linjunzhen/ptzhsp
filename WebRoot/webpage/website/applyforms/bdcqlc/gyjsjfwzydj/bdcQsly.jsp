...
<script>
    ...
    function submitPowSourceInfoS(type){
        if($("#powerSourceInfoList_blank_tr")){
            $("#powerSourceInfoList_blank_tr").remove();
        }
        var powerSourceInfo = FlowUtil.getFormEleData("powerSourceInfo");
    ...
    function appendPowSourceRow(item,index,replaceTrid){
        if(item != "" && null != item) {
            ...
            html += ' <a href="javascript:void(0);" style="padding: 4px 10px;" class="eflowbutton" onclick="delDjxxTr(this);">删除</a></td>';
            html += '</tr>';
            if(replaceTrid){
...
<!-- 权属来源信息开始 -->
<div class="bsbox clearfix" id="qslyInfo">
    <div class="bsboxT">
        <ul>
            <li class="on" style="background:none"><span>权属来源</span></li>
            <input type="button" class="eflowbutton" style="float:right; margin: 10px 5px; padding: 0 20px;" value="保存" onclick="submitPowSourceInfo('1');"/>
            <input type="button" class="eflowbutton" style="float:right; margin: 10px 5px; padding: 0 20px;" value="添加" onclick="submitPowSourceInfo('0');"/>
        </ul>
    </div>
            ...
            <tr>
                <td style="padding: 25px 30px">
                    <table class="bstable1">
                        <tr>
                            <th class="tab_width"><font class="tab_color">*</font>权属来源类型：</th>
                            <td>
                                <eve:eveselect clazz="tab_text w280 validate[required]" dataParams="QSLYLX" value="3"
                                               dataInterface="dictionaryService.findDatasForSelect" onchange="setValidate(this.value);"
                                               defaultEmptyText="选择权属来源类型" name="POWERSOURCE_QSLYLX" id="POWERSOURCE_QSLYLX">
                                </eve:eveselect>
                            </td>
                            <th class="tab_width">证书（文号）：</th>
                            <td>
                        ...
                        <tr>
                            ...
                            <th class="tab_width"><font class="tab_color">*</font>权属状态：</th>
                            <td>
                                <eve:eveselect clazz="tab_text w280 validate[required]" dataParams="DYQSZT"
                        ...
                        <tr>
                            <th class="tab_width"><font class="tab_color">*</font>权利人：</th>
                            <td>
                            ...
                            <td name="isWcnr">
                                <eve:eveselect clazz="tab_text w280 " dataParams="YesOrNo"
                                               dataInterface="dictionaryService.findDatasForSelect"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tab_text validate[custom[mobilePhoneLoose]]"  maxlength="30" id="POWERSOURCE_QLR_TEL" style="float: left;"
                        ...
                        <tr>
                            ...
                            <td colspan="3"><input type="text" class="tab_text" maxlength="60" style="width: 838px;"
                                                   name="POWERSOURCE_BZ" id="POWERSOURCE_BZ"  />
                            </td>
                        </tr>
                    </table>
                </td>
