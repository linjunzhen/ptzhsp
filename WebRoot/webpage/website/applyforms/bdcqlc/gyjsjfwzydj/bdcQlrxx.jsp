                ...
                <td style="padding: 25px 30px">
                    <table class="bstable1">
                        ...
                        <tr>
                            ...
                            <td>
                                <eve:eveselect clazz="tab_text w280 validate[]" dataParams="QLRXZ"
                        ...
                        <tr>
                            ...
                            <td>
                                <eve:eveselect clazz="tab_text w280 validate[]" dataParams="DocumentType"
...
<%--                                                   name="BDC_SZZH"  placeholder="【确认登簿】后调用不动产登记系统登簿接口，返回不动产登记证明号。"/>--%>
...
<%--                                                   name="BDC_QZBSM" placeholder="请输入该权利人对应的权证标识码。"/>--%>
...
<%--                        </tr>--%>
                        <tr>
                            ...
                            <td colspan="3" class="tab_width"><input type="text" class="tab_text" style="width: 850px;"
                                                                     name="POWREMARK" value="${busRecord.POWREMARK}"  />
                            </td>
                        </tr>
