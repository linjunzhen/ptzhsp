        ...
        <table cellpadding="0" cellspacing="1" class="bstable1">
            <tr>
                <td style="padding: 25px 30px">
                    <table cellpadding="0" cellspacing="1" class="bstable1" id="ywrXwjlInfo">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <input type="text" class="tab_text" maxlength="128" style="width: 720px;"
...
<%--                        </tr>--%>
                    ...
                    <table cellpadding="0" cellspacing="1" class="bstable1" id="qlrXwjlInfo">
                        <tr>
                            <th colspan="4" style="text-align: center;">
                        ...
                        <tr>
                            ...
                            <td>
                                <eve:radiogroup fieldname="BDC_XWJL_QLR5" width="500" onclick="afgyEvent(this.value);" typecode="YesOrNo" value="${busRecord.BDC_XWJL_QLR5}"></eve:radiogroup>
                            </td>
                        </tr>
                        <tr>
...
<%--                        </tr>--%>
                        <tr>
                            ...
                            <td colspan="3">
                                <textarea cols="140" rows="5" class="tab_text" maxlength="256" name="BDC_XWJL_BZ" style="width: 720px;" value="${busRecord.BDC_XWJL_BZ}"></textarea>
                            </td>
                        </tr>
                    </table>
                </td>
