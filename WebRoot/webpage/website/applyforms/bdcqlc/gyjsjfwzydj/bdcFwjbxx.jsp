                ...
                <td style="padding:  25px 30px">
                    <table cellpadding="0" cellspacing="1" class="bstable1" id="djshxxInfo">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tab_text " maxlength="30" id="FW_ZH"  name="FW_ZH"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tab_text " maxlength="30" id="FW_SZC" 
                                       name="FW_SZC" value="${busRecord.FW_SZC}" />
                            </td>
                            <th class="tab_width">户号：</th>
                            <td>
                                <input type="text" class="tab_text " maxlength="30" id="FW_HH"  name="FW_HH"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tab_text" maxlength="30" id="FW_ZCS" 
                                       name="FW_ZCS" value="${busRecord.FW_ZCS}" />
                            </td>
                            <th class="tab_width">规划用途：</th>
                            <td>
                                <eve:eveselect clazz="tab_text w280" dataParams="GHYT"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="FW_JGSJ" class="tab_text tab_text_1 Wdate" name="FW_JGSJ"
                                       onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true})" 
                                       maxlength="60" />
                            </td>
                            <th class="tab_width">用途说明：</th>
                            <td>
                                <input type="text" class="tab_text " maxlength="30" id="FW_YTSM" 
                                       name="FW_YTSM" value="${busRecord.FW_YTSM}"  />
                            </td>
                        </tr>
                        <tr>
                            <th class="tab_width"><font class="tab_color">*</font>备案合同号：</th>
                            <td colspan="3">
                                <input type="text" class="tab_text validate[required]" maxlength="32" id="FW_BAHTH" style="width: 850px;"
...
<%--                                <input type="button" style="margin-left: 50px;" class="eflowbutton" value="查询备案信息" onclick="showSelectFdchtbacx();"/>--%>
                        ...
                        <tr>
                            ...
                            <td>
                                <eve:eveselect clazz="tab_text w280" dataParams="FWXZ"
                                               dataInterface="dictionaryService.findDatasForSelect" onchange="setValidate(this.value);"
                            ...
                            <td>
                                <eve:eveselect clazz="tab_text w280" dataParams="FWJG"
                                               dataInterface="dictionaryService.findDatasForSelect" onchange="setValidate(this.value);"
                        ...
                        <tr>
                            <th class="tab_width"><font class="tab_color">*</font>交易价格（万）：</th>
                            <td>
                                <input type="text" class="tab_text validate[required]" maxlength="30" id="FW_JYJG" 
                                       name="FW_JYJG" value="${busRecord.FW_JYJG}" />
                            </td>
                            <th class="tab_width">独用土地面积（平方米）：</th>
                            <td>
                                <input type="text" class="tab_text " maxlength="30" id="FW_DYDYTDMJ" 
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tab_text " maxlength="30" id="FW_FTTDMJ" 
                                       name="FW_FTTDMJ" value="${busRecord.FW_FTTDMJ}" />
                            </td>
                            <th class="tab_width">建筑面积（平方米）：</th>
                            <td>
                                <input type="text" class="tab_text " maxlength="30" id="FW_JZMJ" 
                                       name="FW_JZMJ" value="${busRecord.FW_JZMJ}" />
                            </td>
                        </tr>
                        <tr>
                            <th class="tab_width"><font class="tab_color">*</font>房屋共有情况：</th>
                            <td>
                            ...
                            <td>
                                <input type="text" class="tab_text" maxlength="30" id="FW_ZYJZMJ" 
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tab_text" maxlength="30" id="FW_FTJZMJ" 
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tab_text" maxlength="30" id="FW_TDSYQR" 
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <input type="text" class="tab_text" maxlength="80" name="FW_DJYY" style="width: 850px;"
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <textarea name="FW_FJ" cols="100" rows="5" name="FW_FJ"
                                          class="validate[[maxSize[200]]" style="border: 1px solid #c9deef;width: 850px;">${busRecord.FW_FJ}</textarea>
                            </td>
                        </tr>
                    </table>
                </td>
