                ...
                <td style="padding: 10px">
                    <table cellpadding="0" cellspacing="1" class="bstable1" id="djshxxInfo">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <input type="text" class="tab_text validate[required]" maxlength="32" style="float: left;width: 72%;" id="FW_BAHTH"
...
<%--                                <input type="button" style="margin-left: 50px;" class="eflowbutton" value="查询备案信息" onclick="showSelectFdchtbacx();"/>--%>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tab_text validate[required]" maxlength="30" id="FW_JYJG" style="float: left;"
