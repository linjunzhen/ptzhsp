...
<script type="text/javascript">
    ...
    function doSelectRows(){
    	...
    	if(rows.length==0){
			...
			var mainBussinessId="${mainBussinessId}";
			if(ids.indexOf(mainBussinessId)!=0){
				alert("主经营范围必须在第一条!");
			}else{
	...
	<div class="easyui-layout eui-jh-box" fit="true" >
		...
		<div data-options="region:'center',split:false" style="width: 375px;">
			...
			<table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
				...
				url="domesticControllerController.do?businessScopeDatagrid&Q_T.IS_USABLE_EQ=1&Q_T.IS_MP_EQ=1">
				<thead>
					<tr>
