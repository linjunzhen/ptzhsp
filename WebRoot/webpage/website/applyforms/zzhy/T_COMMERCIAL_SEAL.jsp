    ...
    <c:if test="${busRecord.IS_FREE_ENGRAVE_SEAL==1||requestParams.IS_FREE_ENGRAVE_SEAL==1}">
        ...
        <div style="position:relative;">
            <div style="margin-top: 10px;margin-bottom: 10px;">
                <input type="radio" name="SEAL_PACKAGE" value="2" class="validate[required]" <c:if
                        test="${busRecord.SEAL_PACKAGE==2}"> checked="checked"</c:if>/>套餐一
            </div>
        ...
        <div style="position:relative;">
            <div style="margin-top: 10px;margin-bottom: 10px;">
                <input type="radio" name="SEAL_PACKAGE" value="1" class="validate[required]" <c:if
                        test="${busRecord.SEAL_PACKAGE==1}"> checked="checked"</c:if>/>套餐二
            </div>
            <table cellpadding="0" cellspacing="1" class="syj-table2 syj-table3">
                <tr>
                    <th>采购内容</th>
        ...
        <div style="position:relative;display:none">
            <table cellpadding="0" cellspacing="0" class="syj-table2">
                <tr>
                    ...
                    <td>
                        <input type="radio" name="ISEMAIL" value="1" <c:if
                                test="${busRecord.ISEMAIL==1}"> checked="checked"</c:if>/>是
                        <input type="radio" name="ISEMAIL" value="0" <c:if
                                test="${busRecord.ISEMAIL!=1}"> checked="checked"</c:if>/>否
                    </td>
                </tr>
            </table>
        </div>
