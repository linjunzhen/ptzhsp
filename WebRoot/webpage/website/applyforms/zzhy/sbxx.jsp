...
<form action="" id="SBXX_FORM" style="padding: 25px 30px;">	
	...
	<table cellpadding="0" cellspacing="0" class="syj-table1" >
		...
		<tr>
			...
			<td colspan="3"><input name="SBMC" type="text" value="${sessionScope.curLoginMember.YHMC}-${serviceItem.ITEM_NAME} "
			class="syj-input validate[required] w878" disabled="disabled" maxlength="128" />
			<!-- <span class="bscolor1"><strong>友情提醒：请规范填写“申报对象信息”</strong></span> -->
			</td>
		</tr>		
	</table>
</form>
