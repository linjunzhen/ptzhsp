...
<div class="addBox">
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 tmargin20" style="margin-top: -1px;">
		...
		<tr>
			...
			<td><input type="text" class="syj-input1 validate[required,custom[JustNumber]]"  onblur="onlyNumber(this);isEqualToSjcze(this.value)" onkeyup="onlyNumber(this);" onchange="alertInvesment(this.value)"
