...
<div class="addBox"">
	<table cellpadding="0" cellspacing="0" class="syj-table2 ">			
		...
		<tr>
			...
			<td>	
				<c:if test="${requestParams.COMPANY_SETNATURE=='01'||busRecord.COMPANY_SETNATURE=='01'
					...
					defaultEmptyText="请选择职务" name="${s.index}DIRECTOR_JOB"  onchange="setGenerationModeByDirector(this.value,'${s.index}DIRECTOR_GENERATION_MODE'),setDirectorJob(this.value,'${s.index}DIRECTOR_APPOINTOR')"
		...
		<script type="text/javascript">
			$(function() {
				setGenerationModeByDirector('${director.DIRECTOR_JOB}','${s.index}DIRECTOR_GENERATION_MODE');
