	...
	<div style="position:relative;">
		<table cellpadding="0" cellspacing="0" class="syj-table2 ">
			...
			<script type="text/javascript">
				$(function() {
					setlegalProducemode('${busRecord.LEGAL_JOB}');
				});
			</script>
	...
	<div style="position:relative;">
		<table cellpadding="0" cellspacing="0" class="syj-table2 " style="display: none">
			<tr>
				...
				<td colspan="3">
					<input type="text" class="Wdate" id="VALIDITY_START_DATE"
					...
					<input type="text" class="Wdate" id="VALIDITY_END_DATE" readonly="readonly"
