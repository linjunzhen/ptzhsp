...
<title>平潭综合实验区商事主体登记申报系统</title>
	...
	<!---引入公共JS--->
	<script src="<%=path%>/webpage/website/applyforms/ssqcwb/ssnzqyba/js/commercial.js"></script>
...
<div class="container" >
        <div class="syj-sbmain1 t" style=" margin-top:0px;"  id="lct">
       		<div class="syj-sbm1l">
            	<h3>${serviceItem.ITEM_NAME}</h3>
                <p>登记类别：<font id="companyTypeFont">备案登记</font></p>
            </div>
            <div class="syj-sbm1r" style="width:838px;">
            	<div class="eui-steps-round" style="float:right;padding-right: 10px;">
					...
					<c:if test="${EFLOWOBJ.HJMC!=null}">
						<jsp:include page="/webpage/website/applyforms/ssqcwb/ssnzqyba/flowchart.jsp" >
        ...
        <div class="syj-sbmain2 t"  id="jbxx">
			...
			<%--开始引入申报信息界面 --%>
			<jsp:include page="/webpage/website/applyforms/ssqcwb/ssnzqyba/sbxx.jsp" >
				<jsp:param value="1" name="registerType" />
			</jsp:include>
			<%--结束引入申报信息界面 --%>	

            <div class="borderb t"></div>
            <div class="syj-tyys t" style="z-index: 99;" id="formcontainer">
            	<div class="hd syj-tabtitle" id="formtabtitle" style="z-index: 99;">
                    <ul>
						<li><a href="javascript:AppUtil.validateSingleForm('BASXXZ_FORM');"  id="BASXXZ_FORM_A">备案事项选择</a></li>
						<li><a href="javascript:AppUtil.validateSingleForm('COMPANY_FORM');"  id="COMPANY_FORM_A">基本信息</a></li>
                        <li class="ybzx"><a href="javascript:AppUtil.validateSingleForm('CAPITAL_FORM');"  id="CAPITAL_FORM_A">股东信息</a></li>
                        <li class="ybzx"><a href="javascript:AppUtil.validateSingleForm('BAXX_FORM');"  id="BAXX_FORM_A" >备案信息</a></li>    
                        <li class="ybzx"><a href="javascript:AppUtil.validateSingleForm('LEGAL_FORM');"  id="LEGAL_FORM_A" >人员信息</a></li>     
                ...
                <div class="bd" style="padding: 25px 30px;">
                    <div>					
                    	<%--开始引入备案信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/ssqcwb/ssnzqyba/T_COMMERCIAL_BASXXZ.jsp" />
						<%--结束引入备案信息界面 --%>
                    </div>
					<div>						
						<%--开始引入基本信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/ssqcwb/ssnzqyba/T_COMMERCIAL_COMPANY.jsp" />
						<%--结束引入基本信息界面 --%>
					</div>
                	<div>
                    	<%--开始引入人员信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/ssqcwb/ssnzqyba/T_COMMERCIAL_CAPITAL.jsp" />
						<%--结束引入人员信息界面 --%>
                    </div>
                    <div>					
                    	<%--开始引入备案信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/ssqcwb/ssnzqyba/T_COMMERCIAL_BAXX.jsp" />
						<%--结束引入备案信息界面 --%>
                    </div>
                    <div>					
                    	<%--开始引入人员信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/ssqcwb/ssnzqyba/T_COMMERCIAL_LEGAL.jsp" />
						<%--结束引入人员信息界面 --%>
                    </div>
					
                    <div>								
                    	<%--开始引入申报人信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/ssqcwb/ssnzqyba/T_COMMERCIAL_USERINFO.jsp" />
						<%--结束引入申报人信息界面 --%>
					</div>
                    <div>								
                    	<%--开始引入其他材料界面 --%>
						<jsp:include page="/webpage/website/applyforms/ssqcwb/ssnzqyba/T_COMMERCIAL_FILE.jsp" />
						<%--结束引入其他材料界面 --%>
					</div>
					<c:if test="${isQueryDetail!=null && EFLOWOBJ.EFLOW_CUREXERUNNINGNODENAMES=='窗口办理'}">
					<div>
						<jsp:include page="/webpage/website/applyforms/ssqcwb/ssnzqyba/applyMaterList.jsp">
