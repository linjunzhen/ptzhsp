...
<script type="text/javascript">
	...
	//选择招标方式  并变换理由内容选项
	function selectZbfs(xmType,val,obj){
		//材料显示初始化
		$(".tr_zbtbcl0001").css('display','');
		$(".tr_zbtbcl0002").css('display','none');
		$(".tr_zbtbcl0003").css('display','none');
	...
	function setFileByBZBLY(){
		...
		if(isShowFiles){
			$(".tr_zbtbcl0001").css('display','');
			$(".tr_zbtbcl0002").css('display','');
			$(".tr_zbtbcl0003").css('display','');
			$(".tr_zbtbcl0004").css('display','');
			$(".tr_zbtbcl0005").css('display','');
		}
	}
...
<input type="hidden" name="zyclXM_Record" value=""/>
 <div class="bsbox clearfix">
	<div class="bsboxT">
		<ul>
			<li class="on" style="background:none"><span>招标事项核准申报信息</span></li>
		</ul>
	</div>
	<div class="bsboxC">
		<table cellpadding="0" cellspacing="0" class="bstable1"  id="tzjbxx" >
			<tr>
				<th><span class="bscolor1">*</span> 招标项目类型：</th>
				<td style="width:490px;">
					<span  style="width:10px;display:inline-block;"></span><input type="checkbox" name="kcXM" value="1" onclick="showZbxx(this);"/> <a href="javascript:void(0);" onclick="selectType('kcXM')">勘察</a>
					<span  style="width:10px;display:inline-block;"></span><input type="checkbox" name="sjXM" value="2" onclick="showZbxx(this);"/> <a href="javascript:void(0);" onclick="selectType('sjXM')"> 设计</a>
				    <span  style="width:10px;display:inline-block;"></span><input type="checkbox" name="jlXM" value="3" onclick="showZbxx(this);"/>  <a href="javascript:void(0);" onclick="selectType('jlXM')">监理</a>
					<span  style="width:10px;display:inline-block;"></span><input type="checkbox" name="gcXM" value="4" onclick="showZbxx(this);"/>  <a href="javascript:void(0);" onclick="selectType('gcXM')">工程施工</a>
				    <span  style="width:10px;display:inline-block;"></span><input type="checkbox" name="zysbXM" value="5" onclick="showZbxx(this);"/>  <a href="javascript:void(0);" onclick="selectType('zysbXM')">重要设备</a>
					<span  style="width:10px;display:inline-block;"></span><input type="checkbox" name="zyclXM" value="6" onclick="showZbxx(this);"/>  <a href="javascript:void(0);" onclick="selectType('zyclXM')">重要材料</a>
				</td>
				<th style="line-height:30px;padding-top:5px;padding-bottom:5px;width:150px;color:#000;"><span class="bscolor1">*</span> 是否是国家、省重点建设项目：</th>
				<td >
					<span  style="width:10px;display:inline-block;"></span><input type="radio" name="isImport" value="1"/>是
					<span  style="width:10px;display:inline-block;"></span><input type="radio" name="isImport" value="2"/>否
					<!--  
	 ...
	 function makeHtml(xmType,titles,backColorStr){
		    ...
		    document.write('    <span  style="width:10px;display:inline-block;"></span><font class="tab_color">*</font><span  style="width:90px;display:inline-block;">招标形式：</span>');
			document.write('	<span  style="width:5px;display:inline-block;"></span><input type="radio" name="'+xmType+'zbfs" value="1" id="'+xmType+'zbfs1" onclick="selectZbfs(\''+xmType+'\',1,this);"><a href="javascript:void(0);" onclick="selectTypeById(\''+xmType+'zbfs1\')"/>邀请招标</a>');
			document.write('	<span  style="width:10px;display:inline-block;"></span><input type="radio" name="'+xmType+'zbfs" value="2" id="'+xmType+'zbfs2" onclick="selectZbfs(\''+xmType+'\',2,this);"><a href="javascript:void(0);" onclick="selectTypeById(\''+xmType+'zbfs2\')"/>不招标</a> <span style="width:90px;display:inline-block;"></span>   项目估算金额：<input type="text" name="'+xmType+'zbje" style="width:100px;" maxlength="15" class="tab_text validate[required,custom[numberp6plus]]"/> 万元 ');
			document.write(	'</td>');
			document.write('</tr>');
			document.write('<tr class="'+xmType+'zbxxClass" style="display:none;">');
			document.write(	'<td colSpan="3" style="line-height:30px;">');
			document.write(	 '<div id="'+xmType+'yqzbDiv" style="display:none;">');
			document.write(		  '  <span  style="width:10px;display:inline-block;"></span><span  style="width:150px;display:inline-block;">邀请招标申请理由：</span></br>');
			document.write(		  '  <span  style="width:20px;display:inline-block;"></span><input type="checkbox" name="'+xmType+'yqzbly1" value="1"/>  ');
			document.write(		  '  	<a href="javascript:void(0);" onclick="selectType(\''+xmType+'yqzbly1\')">（一）涉及国家安全、国家秘密或者抢险救灾，不适宜公开招标的；</a></br>');
			...
			document.write(			'	<a href="javascript:void(0);" onclick="selectType(\''+xmType+'yqzbly3\')">（三）采用公开招标方式的费用占项目合同金额的比例过大，不符合经济合理性要求的；</a></br>');
			...
			document.write(			'	<a href="javascript:void(0);" onclick="selectType(\''+xmType+'yqzbly5\')">（五）城市重要地段、重要景观地区的建设工程、景观绿化工程，以及建筑功能有特殊要求的省重大型工程和公共建筑等项目的工程设计；</a></br>');
			...
			document.write(		  '  <span  style="width:10px;display:inline-block;"></span><span  style="width:150px;display:inline-block;">不招标申请理由：</span></br>');
