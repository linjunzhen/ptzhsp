...
<div class="syj-title1 tmargin20">
	...
	<div style="position:relative;">
		<table cellpadding="0" cellspacing="0" class="syj-table2 tmargin20">
			<tr>
				<th> 申报种类</th>
				<td style="border-right-style: none;"><input type="text" class="syj-input1" readonly="readonly" style="border: thin;"
		...
		<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="syj-table2 tmargin20" id="sqr" >	
			<tr>
				...
				<th> 性别</th>
				<td>
				<eve:eveselect clazz="input-dropdown sel"
			...
			<tr>
				...
				<td colspan="3">
				<input type="text" maxlength="60" class="syj-input1 validate[required]" style="width: 82%;" name="SQRLXDZ" value="${sessionScope.curLoginMember.ZTZZ}" />
			...
			<tr>
				<th> 电子邮箱</th>
				<td colspan="3">
				<input type="text" maxlength="30" class="syj-input1 validate[[],custom[email]]" name="SQRYJ" value="${sessionScope.curLoginMember.DZYX}"/>
				</td>
			</tr>
		</table>
		</c:if>
		<c:if test="${sessionScope.curLoginMember.USER_TYPE=='2'}">
		<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="syj-table2 tmargin20" id="sqjg" >	
			<tr>
				<th><span class="syj-color2">*</span> 申请机构</th>
				<td colspan="3">
				<input type="hidden" maxlength="30" name="SQRMC" value="${sessionScope.curLoginMember.YHMC}"/>
				<input style="width:82%;" type="text" maxlength="60" name="SQJG_NAME" class="syj-input1" value="${sessionScope.curLoginMember.YHMC}"/>
				</td>
			</tr>
			<tr>			    
				<th><span class="syj-color2">*</span> 机构类型</th>
				<td>
				<eve:eveselect clazz="input-dropdown sel validate[required]"
				...
				<td>
				<input type="text" maxlength="18" name="SQJG_CODE" class="syj-input1 validate[required]" value="${sessionScope.curLoginMember.ZZJGDM}"/>
				</td>
			</tr>
			<tr>
				<th class="tab_width">统一社会信用代码：</th>
				<td><input type="text" class="syj-input1" maxlength="18"
					name="SQJG_CREDIT_CODE" value="${execution.SQJG_CREDIT_CODE}" id="SQJG_CREDIT_CODE" />
				</td>
				<th class="tab_width">工商注册号：</th>
				<td><input type="text" class="syj-input1" maxlength="15"
			...
			<tr>
				<th> 联系地址</th>
				<td colspan="3">
				<input type="text" maxlength="60" class="syj-input1" style="width: 82%;" name="SQJG_ADDR" value="${sessionScope.curLoginMember.DWDZ}" />
		...
		<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="syj-table2 tmargin20">
			<tr>
				...
				<td >
				<input type="text" maxlength="8"  style="width: 50%;" name="BJCXMM"  value="${busRecord.BJCXMM}" class="syj-input1 validate[required]"  placeholder="请输入查询密码"/>
	...
	<div style="position:relative;">
		<c:if test="${sessionScope.curLoginMember.USER_TYPE=='1'}">
			<table cellpadding="0" cellspacing="0" class="syj-table2 tmargin20">
				<tr>
					...
					<th> <span class="syj-color2">*</span>性别</th>
					<td>
					<eve:eveselect clazz="input-dropdown sel validate[required]"
										dataParams="sex" value="${sessionScope.curLoginMember.YHXB}"
										dataInterface="dictionaryService.findDatasForSelect"
				...
				<tr>			    
					<th><span class="syj-color2">*</span> 证件类型</th>
					<td>				
					<eve:eveselect clazz="input-dropdown sel validate[required]" onchange="setValidatejbr(this.value);"
										dataParams="DocumentType" value="${sessionScope.curLoginMember.ZJLX}"
				...
				<tr>
					<th>联系地址</th>
					<td colspan="3">
					<input type="text" maxlength="60" class="syj-input1" style="width: 82%;" name="JBR_ADDRESS" value="${sessionScope.curLoginMember.ZTZZ}" />
					</td>
				</tr>
				<tr>
					<th> 备注</th>
					<td colspan="3">
					<input type="text" maxlength="126" class="syj-input1" style="width: 82%;" name="JBR_REMARK" />
		...
		<table cellpadding="0" cellspacing="0" class="syj-table2 tmargin20">
			...
			<tr>
				<th>联系地址</th>
				<td colspan="3">
				<input type="text" maxlength="60" class="syj-input1" style="width: 82%;" name="JBR_ADDRESS" value="${sessionScope.curLoginMember.DWDZ}" />
				</td>
			</tr>
			<tr>
				<th> 备注</th>
