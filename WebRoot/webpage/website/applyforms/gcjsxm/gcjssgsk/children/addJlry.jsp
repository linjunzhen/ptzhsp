...
<head>
	...
	$(function() {
		...
		AppUtil.initWindowForm("jlryForm", function(form, valid) {
			if (valid) {
				//将提交按钮禁用,防止重复提交
				$("input[type='submit']").attr("disabled","disabled");
				var info = {};
				$("#jlryForm").find("*[name]").each(function(){
		...
		<table style="width:100%;border-collapse:collapse;"
			...
			<tr>
				<td>
					...
					<input type="text" style="width:186px;float:left;" value="${info.STATION}" maxlength="16" class="eve-input validate[required]" name="STATION" /> 
					<font class="dddl_platform_html_requiredFlag">*</font>
				</td>
				<td>
					<span style="width: 100px;float:left;text-align:right;">工作岗位：</span>
					<eve:eveselect clazz="eve-input w280 validate[required] field_width" dataParams="JLRYGZGW"
			...
			<tr>
				<td>				
					<span style="width: 100px;float:left;text-align:right;">计划进场时间：</span>
					<input type="text" style="width:186px;float:left;" class="eve-input Wdate validate[required]" id="MARCHDATE" 
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'RETREATDATE\',{d:-1})}'})" 
					readonly="readonly" name="MARCHDATE"  placeholder="请选择进场时间" value="${info.MARCHDATE}"  maxlength="16"/>
					<font class="dddl_platform_html_requiredFlag">*</font>
				</td>
				<td>
					<span style="width: 100px;float:left;text-align:right;">计划退场时间：</span>
					<input type="text" style="width:186px;float:left;" class="eve-input Wdate validate[required]" id="RETREATDATE" readonly="readonly"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'MARCHDATE\',{d:1})}'})"
					name="RETREATDATE"  placeholder="请选择退场时间" value="${info.RETREATDATE}"  maxlength="16"/>
					<font class="dddl_platform_html_requiredFlag">*</font>
				</td>
			</tr>
		</table>
