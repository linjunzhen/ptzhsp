...
<title>平潭综合实验区商事主体登记申报系统</title>
	...
	<!---引入公共JS--->
	<script src="<%=path%>/webpage/website/applyforms/foreign/js/commercial.js"></script>
...
<div class="container" >
            ...
            <div class="syj-sbm1r">
            	<div class="eui-steps-round" style="float:right; padding-right: 10px;">
					...
					<c:if test="${EFLOWOBJ.HJMC!=null}">
						<jsp:include page="/webpage/website/applyforms/foreign/flowchart.jsp" >
        ...
        <div class="syj-sbmain2 tmargin20"  id="jbxx">
			...
			<%--开始引入申报信息界面 --%>
			<jsp:include page="/webpage/website/applyforms/foreign/sbxx.jsp" >
            ...
            <div class="syj-tyys tmargin20" style="z-index: 99;" id="formcontainer">
            	<div class="hd syj-tabtitle" id="formtabtitle" style="z-index: 99;">
                    <ul>
                        ...
                        <li><a href="javascript:AppUtil.validateSingleForm('CAPITAL_FORM');"  id="CAPITAL_FORM_A">资金、投资者信息</a></li>
                ...
                <div class="bd margin20">
					<div>						
						<%--开始引入企业基本信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/foreign/T_COMMERCIAL_COMPANY.jsp" />
						<%--结束引入企业基本信息界面 --%>
					</div>
                	<div>
                    	<%--开始引入企业资金、投资者信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/foreign/T_COMMERCIAL_CAPITAL.jsp" />
						<%--结束引入企业资金、投资者信息界面 --%>
                    </div>
                    <div>
                    	<%--开始引入企业人事信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/foreign/T_COMMERCIAL_PERSONNEL.jsp" />
						<%--结束引入企业人事信息界面 --%>
                    </div>
					<div>
                    	<%--开始引入法定代表人信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/foreign/T_COMMERCIAL_LEGAL.jsp" />
						<%--结束引入法定代表人信息界面 --%>
                    </div>
                    <div>					
                    	<%--开始引入印章信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/foreign/T_COMMERCIAL_SEAL.jsp" />
						<%--结束引入印章信息界面 --%>
                    </div>
                    <div>					
                    	<%--开始引入其他信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/foreign/T_COMMERCIAL_OTHER.jsp" />
						<%--结束引入其他信息界面 --%>
                    </div>
                    ...
                    <div>								
                    	<%--开始引入经办人信息界面 --%>
						<jsp:include page="/webpage/website/applyforms/foreign/T_COMMERCIAL_USERINFO.jsp" />
						<%--结束引入经办人信息界面 --%>
					</div>
                    <div>								
                    	<%--开始引入关联事项材料界面 --%>
					...
					<c:if test="${isQueryDetail!=null && EFLOWOBJ.EFLOW_CUREXERUNNINGNODENAMES=='窗口办理'}">
					<div>
						<jsp:include page="/webpage/website/applyforms/foreign/applyMaterList.jsp">
