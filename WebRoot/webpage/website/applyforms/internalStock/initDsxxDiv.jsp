	...
	<table cellpadding="0" cellspacing="0" class="syj-table2">			
		...
		<tr>
			...
			<td><input type="text" class="syj-input1 validate[required]" 
				name="${s.index}DIRECTOR_NAME"  placeholder="请输入姓名"  maxlength="8" value="${director.DIRECTOR_NAME}"/></td>
		...
		<th> 职工代表：</th>
			<td>
			<input type="checkbox" name="${s.index}DIRECTOR_REPRESENTATIVE" class="checkbox validate[]" value="1" dicdesc="null" <c:if test="${director.DIRECTOR_REPRESENTATIVE==1}">checked</c:if>>
			是否为职工代表</td>
		</tr> -->
	</table>
	<c:if test="${s.index>0}">
