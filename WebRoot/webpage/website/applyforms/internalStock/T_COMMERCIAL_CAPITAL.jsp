...
<form action="" id="CAPITAL_FORM"  >	
	...
	<div class="syj-title1 ">
		<a href="javascript:void(0);" onclick="javascript:addGdxxDiv();" class="syj-addbtn" id="addGdxx" style="display:none;">添 加</a><span>股东信息</span>
	</div>
	<div id="gdxxDiv">	
			...
			<table cellpadding="0" cellspacing="0" class="syj-table2 " style="margin-top: -1px;">
				...
				<tr>
					...
					<td colspan="3"><input type="text" class="syj-input1 w878"
						name="LEGAL_PERSON"  placeholder="请输入法定代表人姓名（股东类型为企业和其他组织机构时必须填写）"  maxlength="32"/></td>
				</tr>
				<tr>
