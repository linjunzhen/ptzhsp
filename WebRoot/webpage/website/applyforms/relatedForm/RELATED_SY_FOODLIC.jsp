		...
		$(function() {
			...
			if(${materForm.RECORD_ID!=null }){
				...
				if(itemCode=='201605170002XK00101'||itemCode=='201605170002XK00102'){
					$("input[name='LEADER_NAME']").val(parent.$("input[name='LEGAL_NAME']").val());
					$("input[name='LEADER_MOBILE']").val(parent.$("input[name='LEGAL_MOBILE']").val());
					$("input[name='LEADER_PHONE']").val(parent.$("input[name='LEGAL_FIXEDLINE']").val());
					$("input[name='LEADER_JOB']").val(parent.$("select[name='LEGAL_JOB']").find("option:selected").text());
					$("select[name='LEADER_CARDTYPE']").val(parent.$("select[name='LEGAL_IDTYPE']").val());
					$("input[name='LEADER_CARDNO']").val(parent.$("input[name='LEGAL_IDNO']").val());
				}else if(itemCode=='201605170002XK00103'){
					$("input[name='LEADER_NAME']").val(parent.$("input[name='INVESTOR_NAME']").val());
					$("select[name='LEADER_SEX']").val(parent.$("select[name='INVESTOR_SEX']").val());
					$("select[name='LEADER_NATION']").val(parent.$("select[name='INVESTOR_NATION']").val());
					$("input[name='LEADER_MOBILE']").val(parent.$("input[name='INVESTOR_MOBILE']").val());
					$("select[name='LEADER_CARDTYPE']").val(parent.$("select[name='INVESTOR_IDTYPE']").val());
					$("input[name='LEADER_CARDNO']").val(parent.$("input[name='INVESTOR_IDCARD']").val());
				}
			}
			//初始化经营项目选择联动
						...
						<div id="techDiv">
							<div style="position:relative;">
								...
								<table class="easyui-datagrid" toolbar="#techToolbar" id="techGrid" rownumbers="true" border="true" fitColumns="true"
									data-options="singleSelect:true,autoSave:true,url:'',method:'post',onClickRow: onClickRowTech">
									<thead>
										<tr>
											...
											<th data-options="field:'NATION',align:'left',editor:{type:'combobox',options:{required:true,editable:false,panelHeight:120,
												...
												width="7%">民族</th>
											<th data-options="field:'DOMICILE',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,32]'}}"
												width="15%">户籍登记住址</th>
											<th data-options="field:'ID_TYPE',align:'left',editor:{type:'combobox',options:{required:true,editable:false,panelHeight:120,
												...
												width="12%">证件类型</th>
											<th data-options="field:'ID_NO',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,18]'}}"
												width="15%">证件号</th>
											...
											<th data-options="field:'PHONE',align:'left',editor:{type:'validatebox',options:{required:true,validType:'mobilePhoneLoose'}}"
												width="10%">联系电话</th>
											<th data-options="field:'POINTDEP',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
												width="15%">任免单位</th>
										</tr>
									</thead>
								</table>
						...
						<div id="manageDiv">
							<div style="position:relative;">
								...
								<table class="easyui-datagrid" toolbar="#manageToolbar" id="manageGrid" rownumbers="true" border="true" fitColumns="true"
									data-options="singleSelect:true,autoSave:true,url:'',method:'post',onClickRow: onClickRowManage">
									<thead>
										<tr>
											<th data-options="field:'NAME',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,6]'}}"
												width="8%">姓名</th>
						...
						<div id="employeeDiv">
							<div style="position:relative;">
								...
								<table class="easyui-datagrid" toolbar="#employeeToolbar" id="employeeGrid" rownumbers="true" border="true" fitColumns="true"
									data-options="singleSelect:true,autoSave:true,url:'',method:'post',onClickRow: onClickRowEmployee">
									<thead>
										<tr>
											<th data-options="field:'NAME',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,6]'}}"
												width="6%">姓名</th>
											...
											<th data-options="field:'POINTDEP',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
												width="9%">任免单位</th>
											<th data-options="field:'HEALTHNO',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
												width="7%">健康证号</th>
											<th data-options="field:'WTYPE',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
												width="5%">工种</th>
											<th data-options="field:'SENDDEP',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
												width="9%">发证单位</th>
										</tr>
									</thead>
								</table>
						...
						<div id="equipDiv">
							<div style="position:relative;">
								...
								<table class="easyui-datagrid" toolbar="#equipToolbar" id="equipGrid" rownumbers="true" border="true" fitColumns="true"
									data-options="singleSelect:true,autoSave:true,url:'',method:'post',onClickRow: onClickRowEquip">
									<thead>
										<tr>
											<th data-options="field:'EQUIPNAME',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
												width="30%">设备名称</th>
											<th data-options="field:'COUNT',align:'left',editor:{type:'numberbox',options:{required:true,min:0,max:999}}"
												width="15%">数量</th>
											<th data-options="field:'LOCATION',align:'left',editor:{type:'validatebox',options:{required:true,validType:'length[1,16]'}}"
												width="30%">位置</th>
											<th data-options="field:'REMARK',align:'left',editor:{type:'validatebox',options:{validType:'length[1,16]'}}"
												width="24%">备注</th>
										</tr>
									</thead>
								</table>
