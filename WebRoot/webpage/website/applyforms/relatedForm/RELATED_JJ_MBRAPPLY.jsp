...
<head>
	...
	<script type="text/javascript">
	    $(document).ready(function(){
	    	//表单绑定验证插件
	    	AppUtil.initWindowForm("MBRAPPLY_FORM", function(form, valid){
	    		if(valid){
	    			//组装业户管理负责人json
	    			var leaderJson = $('#leaderTable').MyEditableTable('getData');
	    			$("#MBRAPPLY_FORM").find("input[name='LEADER_JSON']").val(JSON.stringify(leaderJson));
	    			//组装质量检验人员json
	    			var qapersonJson = $('#qapersonTable').MyEditableTable('getData');
	    			$("#MBRAPPLY_FORM").find("input[name='QAPERSON_JSON']").val(JSON.stringify(qapersonJson));
	    			//组装从业人员json
	    			var staffJson = $('#staffInfoTable').MyEditableTable('getData');
	    			$("#MBRAPPLY_FORM").find("input[name='STAFF_JSON']").val(JSON.stringify(staffJson));
	    			//组装设备json
	    			var deviceJson = $('#deviceTable').MyEditableTable('getData');
	    			$("#MBRAPPLY_FORM").find("input[name='DEVICE_JSON']").val(JSON.stringify(deviceJson));
	    			
						//序列化表单
						var formData = $("#MBRAPPLY_FORM").serialize();
						var url = $("#MBRAPPLY_FORM").attr("action");
						//提交表单
		                    ...
		                    <table id="deviceTable" class="syj-table2" cellpadding="0" cellspacing="0">
        						...
        						<tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="轮胎拆装设备或专用工具"/>                                    
                                                                          轮胎拆装设备或专用工具</td>
		                            <td>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="补胎专用工具"/>                                    
                                                                          补胎专用工具</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
						            ...
						            <td>必备 <input type="hidden" class="syj-input1" iptName="devRemark" value="必备"/>  </td>
		                        </tr>
		                        <tr>
		                            <th>3</th>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="钳工作业台及工具"/>                                    
                                                                           钳工作业台及工具</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="手电钻"/>                                    
                                                                           手电钻</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="台钻"/>                                    
                                                                           台钻</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="扭力扳手"/>                                    
                                                                           扭力扳手</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="内径千分表"/>                                    
                                                                           内径千分表</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="游标卡尺"/>                                    
                                                                           游标卡尺</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="充电设备"/>                                    
                                                                           充电设备</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="焊接设备"/>                                    
                                                                            焊接设备</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="气门研磨设备或工具"/>                                    
                                                                            气门研磨设备或工具</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="涂漆设备"/>                                    
                                                                            涂漆设备</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
						            ...
						            <td>允许外协 <input type="hidden" class="syj-input1" iptName="devRemark" value="允许外协"/>  </td>
		                        </tr>
		                        <tr>
		                            <th>21</th>
		                            <th><input chkIndex="21" disabled type="checkbox"/></th>
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="尾气分析仪"/>                                    
                                                                            尾气分析仪</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
		                        ...
		                        <tr>
		                            ...
		                            <td style="text-align:center;">
                                        <input type="hidden" class="syj-input1" iptName="devName" value="镗缸设备"/>                                    
                                                                            镗缸设备</td>
		                            <td>
		                                <input type="text" class="syj-input1 validate[custom[numberplus]]" iptName="amount" maxlength="10" style="width:78%;"/>
		                            </td>
