					...
					<form action="domesticControllerController/saveRelatedMaterForm.do" method="post" id="RDGTAPPLY_FORM">
						...
						<div style="position:relative;">
							...
							<table cellpadding="0" cellspacing="0" class="syj-table2">
								...
								<th style="text-align: right;"><font class="syj-color2">*</font>经营许可证编号：</th>
							...
							<table cellpadding="0" cellspacing="0" class="syj-table2">
								...
								<tr>
									<th ><font class="syj-color2">*</font>营运里程(公里)：</th>
										...
										<tr>
											<th style="text-align: right;"><font class="syj-color2">*</font>高速公路里程(公里)：</th>
											<td><input type="text"
											...
											<th>占总营运里程:</th>
											<td><input type="text" 
												class="syj-input1 validate[required,custom[number2plus],max[100]]" name="PERCENTAGE_MILEAGE" value="${materForm.PERCENTAGE_MILEAGE }"
												placeholder="请输入占总营运里程" maxlength="4"  style="width:70%;"/>%</td>
										</tr>
								<tr>
						...
						<div id="purchasePlanDiv">
							<div style="position:relative;">
								...
								<table class="easyui-datagrid" toolbar="#carConditionToolbar" id="carConditionGrid" rownumbers="true" border="true" fitColumns="true"
									data-options="singleSelect:true,autoSave:true,url:'',method:'post',onClickRow: onClickRowCarCondition">
									<thead>
										<tr>
									...
									<thead>
										<tr>
											...
											data:[  
												...
												width="10%">性别</th>
											<th data-options="field:'AGE',align:'center',editor:{type:'numberbox',options:{required:true,min:0,max:999}}"
												width="5%">年龄</th>
