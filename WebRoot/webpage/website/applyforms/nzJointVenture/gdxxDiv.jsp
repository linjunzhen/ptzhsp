	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 " style="margin-top: -1px;">
		...
		<tr>
			...
			<td>
				<input type="text" class="syj-input1 validate[[],custom[email]]"
					   name="${currentTime}SHAREHOLDER_EMAIL"  placeholder="请输入电子邮箱"  maxlength="16"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="3" ><input type="text" class="syj-input1 validate[],custom[JustNumber]"
				...
				onblur="onlyNumber(this);setInvestment();setEvaluateWayNeed('${currentTime}EVALUATE_WAY','${currentTime}INVESTMENT_CASH');isEqualToCash(this.value)" onkeyup="onlyNumber(this);" style="width: 638px;"/>
		...
		<tr>
			...
			<td><input type="text" class="syj-input1 validate[required],custom[JustNumber]" maxlength="16"
				name="${currentTime}PAIDIN_QUOTA"  placeholder="请输入实缴出资额（万元）"   onblur="setRealCapital();isEqualToSjcze(this.value)"/></td>
			<th>缴款日期：</th>
