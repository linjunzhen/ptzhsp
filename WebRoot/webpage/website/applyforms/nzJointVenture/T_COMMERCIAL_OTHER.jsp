					...
					<c:if test="${empty accountAndAgreementList}">
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" class="Wdate "  onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false,maxDate:'%y-%M-%d'})"
							...
							<tr>
								...
								<th> 账户标识：</th>
								<td>
									<eve:eveselect clazz="input-dropdown w280" dataParams="ACCOUNTIDENTIFY"
		...
		<div style="position:relative;">
			<table cellpadding="0" cellspacing="0" class="syj-table2 ">
				...
				<tr>
					...
					<td colspan="3">
						<eve:excheckbox
							dataInterface="dictionaryService.findDatasForSelect" width="749px"
							name="INSURANCE_TYPE" clazz="checkbox validate[required]"
		...
		<div id="bankInfo" style="display: none;">
			...
			<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="syj-table2 ">
				...
				<tr>
					...
					<td><input type="text" class="syj-input1" 
						id="legalPersonName" name="LEGAL_NAME" value="${busRecord.LEGAL_NAME}" maxlength="16"/></td>
				</tr>
				<tr>
					...
					<td>
						...
						dataInterface="dictionaryService.findDatasForSelect"
						defaultEmptyText="请选择证件类型" name="LEGAL_IDTYPE"  id="legalPersonIDType" value="${busRecord.LEGAL_IDTYPE}">
						</eve:eveselect>
					</td>
					<th><font class="syj-color2">*</font>证件号码：</th>
					<td><input type="text" class="syj-input1"  onchange="setZjValidate(this.value,'LEGAL_IDNO');"
						id="legalPersonIDNo" name="LEGAL_IDNO" value="${busRecord.LEGAL_IDNO}" maxlength="32"/></td>
				</tr>
				<tr>
					<th> 经营范围：</th>
					<td colspan="3">
