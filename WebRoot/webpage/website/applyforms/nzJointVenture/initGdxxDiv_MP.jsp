...
<div style="position:relative;">
	<table cellpadding="0" cellspacing="0" class="syj-table2 tmargin20">
		...
		<tr>
			...
			<td>
				...
				setGdType(this.value,'${s.index}SHAREHOLDER_TYPE','${s.index}LICENCE_TYPE','${s.index}LICENCE_NO','${s.index}SHAREHOLDER_NAME');
				setGdlxValidate(this.value,'${s.index}LEGAL_IDNO_PERSON');
					setGdlxValidate(this.value,'${s.index}LEGAL_MOBILE_PERSON');
	...
	<table cellpadding="0" cellspacing="0" class="syj-table2 tmargin20" style="margin-top: -1px;">
		...
		<tr>
			...
			<td>
				<input type="text" class="syj-input1 validate[[],custom[email]]"  value="${holder.SHAREHOLDER_EMAIL}"
					   name="${s.index}SHAREHOLDER_EMAIL"  placeholder="请输入电子邮箱"  maxlength="32"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th>  <font class="syj-color2 ${s.index}LEGAL_PERSON_CLASS" style="display: none" >*</font>合伙企业或其他组织机构法定代表人姓名：</th>
			<td ><input type="text" class="syj-input1"
		...
		<tr>
			<th><font class="syj-color2   ${s.index}LEGAL_PERSON_CLASS" style="display: none">*</font> 法定代表人移动号码：</th>
			<td colspan="3"><input type="text" class="syj-input1  validate[],custom[mobilePhone]" value="${holder.LEGAL_MOBILE_PERSON}"
								   name="${s.index}LEGAL_MOBILE_PERSON"  placeholder="请输入法定代表人移动号码"  maxlength="32"/></td>
		...
		<script type="text/javascript">
			$(function(){
				...
				setGdlxValidate('${holder.SHAREHOLDER_TYPE}','${s.index}LEGAL_MOBILE_PERSON');
				setZjValidate('${holder.LICENCE_TYPE}','${s.index}LICENCE_NO');
				setGdType('${holder.SHAREHOLDER_TYPE}','${s.index}SHAREHOLDER_TYPE','${s.index}LICENCE_TYPE','${s.index}LICENCE_NO','${s.index}SHAREHOLDER_NAME');
				setPartnershipByDutyMode('${holder.DUTY_MODE}','${s.index}IS_PARTNERSHIP','${holder.IS_PARTNERSHIP}');
				setRealCapital();
			});
		</script>
		<tr>
		...
		<tr>
			...
			<td colspan="3"><input type="text" class="syj-input1 validate[required,custom[numMustBiggerZero]],custom[JustNumber]"
				name="${s.index}INVESTMENT_CASH"  placeholder="请输入现金(万元)" maxlength="16"  onchange="alertInvesment(this.value)"
				onblur="onlyNumber(this);setInvestment();setEvaluateWayNeed('${s.index}EVALUATE_WAY','${s.index}INVESTMENT_CASH')" onkeyup="onlyNumber(this);" style="width: 638px;"  value="${holder.INVESTMENT_CASH}"/>
		...
		<tr>
			...
			<td><input type="text" class="syj-input1 validate[required],custom[JustNumber]" maxlength="16"  onblur="setRealCapital()"  onchange="alertInvesment(this.value)"
