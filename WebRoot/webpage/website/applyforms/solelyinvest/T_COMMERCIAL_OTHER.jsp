...
<script type="text/javascript">
	function downloadApply(){		
     ...
     function openResultFileUploadDialog3(){
         ...
         art.dialog.open('fileTypeController.do?openWebStieUploadDialog&attachType=attachToImage&materType=image&busTableName=T_COMMERCIAL_SOLELYINVEST&uploadUserId='
...
<form action="" id="OTHER_FORM"  >
			...
			<div id="getbillDiv">
				...
				<table cellpadding="0" cellspacing="0" class="syj-table2">
					<tr>
						...
						<td style="border-top: none;">
							<eve:eveselect clazz="input-dropdown w280" dataParams="MainBusinessCategory"
					...
					<tr>
						...
						<td>
							<eve:eveselect clazz="input-dropdown w280" dataParams="EffectiveDate"
							dataInterface="dictionaryService.findDatasForSelect"
				...
				<div id="taxbankaccount" style="display: none;">
					<div style="float: right; margin-right: 100px;">
						<a href="javascript:void(0);" onclick="javascript:addYhzhDiv();" class="syj-addbtn" style="position: absolute;margin-top: 5px;">添 加</a>
					</div>
					<table cellpadding="0" cellspacing="0" class="syj-table2">
						<tr>
						...
						<c:if test="${empty accountAndAgreementList}">
							<tbody>
								...
								<tr>
									...
									<td>
							            <input name="DIVISION" id="DIVISION" class="easyui-combotree w280"/>
									</td>
								</tr>
								<tr>
				...
				<div id="invoiceapplyDiv" style="display: none;">
					<div style="float: right; margin-right: 100px;">
						<a href="javascript:void(0);" onclick="javascript:addInvoiceApplyDiv();" class="syj-addbtn" style="position: absolute;margin-top: 5px;">添 加</a>
					</div>
					<table cellpadding="0" cellspacing="0" class="syj-table2">
						<tr>
	...
	<c:if test="${busRecord.ISSOCIALREGISTER==1||requestParams.ISSOCIALREGISTER==1}">
		...
		<div style="position:relative;">
            ...
            根据《中华人民共和国社会保险法》用人单位应当自成立之日起三十日内持单位印章，向当地社会保险经办机构申请办理养老、工伤保险登记。
            </font>
            </span>
		</div>
	</c:if>
			...
			<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="syj-table2 ">
				...
				<tr>
					...
					<td colspan="3"><input type="text" class="syj-input1 validate[required]" maxlength="32" disabled="disabled"
						name="CONTROLLER" value="${busRecord.CONTROLLER}"/></td>
				</tr>
				<tr>
					<th> 存款人名称：</th>
