	...
	<div style="position:relative;">
		...
		<table cellpadding="0" cellspacing="0" class="syj-table2 " id="sqjg" style="table-layout: auto;">	
			...
			<tr>			    
				...
				<td>
				<eve:eveselect clazz="input-dropdown sel w280 validate[required]"
		...
		<table style="margin-top: -1px;" cellpadding="0" cellspacing="0" class="syj-table2 ">
			<tr>
				...
				<td >
				<input type="text" maxlength="8" name="BJCXMM"  value="${busRecord.BJCXMM}" class="syj-input1 validate[required]"  placeholder="请输入查询密码"/>
