...
<form action="" id="SBXX_FORM"  >	
	...
	<table cellpadding="0" cellspacing="0" class="syj-table1 tmargin14">
		...
		<tr>
			...
			<td colspan="3"><input style="width:55%;" name="SBMC" type="text" value="${sessionScope.curLoginMember.YHMC}-${serviceItem.ITEM_NAME}"
			class="syj-input validate[required]" maxlength="128"  />
