...
<div class="syj-title1 ">
	...
	<div style="position:relative;">
		...
		<table cellpadding="0" cellspacing="0" class="syj-table2 " id="sqr" >	
			<tr>
			...
			<tr>			    
				...
				<td>
				<eve:eveselect clazz="input-dropdown sel w280 validate[required]" onchange="setValidate(this.value);"
			...
			<tr>
				...
				<td colspan="3">
				<input type="text" maxlength="60" class="syj-input1 w878 validate[required]"  name="SQRLXDZ" value="${sessionScope.curLoginMember.ZTZZ}" />
			...
			<tr>
				<th> 电子邮箱</th>
				<td colspan="3">
				<input type="text" maxlength="30" class="syj-input1 w878 validate[[],custom[email]]" name="SQRYJ" value="${sessionScope.curLoginMember.DZYX}"/>
				</td>
			</tr>
		</table>
		</c:if>
