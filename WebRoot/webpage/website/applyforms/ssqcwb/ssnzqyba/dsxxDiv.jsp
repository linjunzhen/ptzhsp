...
<div class="addBox">
	<table cellpadding="0" cellspacing="0" class="syj-table2">			
		...
		<tr>
			...
			<th>复用旧董事：</th>
			<td>
				<select name="oldDirectorInfo" class="input-dropdown " onchange="setDirectorInfo(this,'${currentTime}')">
		...
		<tr>
			...
			<td>	
				...
				defaultEmptyText="请选择职务" name="${currentTime}DIRECTOR_JOB" onchange="setDsbaxx();setGenerationModeByDirector(this.value,'${currentTime}DIRECTOR_GENERATION_MODE');setDirectorJob(this.value,'${currentTime}DIRECTOR_APPOINTOR')">
				</eve:eveselect>
			</td>
