...
<div class="addBox">
	<table cellpadding="0" cellspacing="0" class="syj-table2 ">			
		<tr>
			<select name="setDsInfo" style="margin-left: 50px;margin-top: 20px;width:auto;padding-right:20px;" class="input-dropdown  w280 w280" onchange="setDsxxInfoMsg(this,this.value,'DIRECTOR')" >
