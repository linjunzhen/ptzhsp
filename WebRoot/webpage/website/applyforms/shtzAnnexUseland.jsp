...
<div class="bsbox clearfix" id="fjbdDiv">
	<div class="bsboxT">
		<ul>
			<li class="on" style="background:none"><span>社会投资项目规划选址及用地意向申请表</span></li>			
		</ul>
	</div>
	<div class="bsboxC">
		...
		<table style="margin-top: -1px;display: block;" cellpadding="0" cellspacing="0" class="bstable1" id="sqjg">	
			...
			<tr>
				...
				<td>
				<input type="text" maxlength="16" class="tab_text validate[required]" name="ANNEX_TUMU_LAYCOST" />
				</td>
			</tr>
			<tr>
				<td colspan="3">
			...
			<tr>
				<th>对接联络员</th>
				<td>
				<input type="text" maxlength="16" name="ANNEX_JOINTNAME" class="tab_text validate[[],custom[fixOrMobilePhone]]" />
				</td>
				<th>联络员电话</th>
				<td>
