...
<script type="text/javascript">
	function downloadApply(){		
     ...
     function openResultFileUploadDialog3(){
         ...
         art.dialog.open('fileTypeController.do?openWebStieUploadDialog&attachType=attachToImage&materType=image&busTableName=T_COMMERCIAL_BRANCH&uploadUserId='
			...
			<div id="getbillDiv">
				...
				<div id="taxbankaccount" style="display: none;">
					<div style="float: right; margin-right: 100px;">
						<a href="javascript:void(0);" onclick="javascript:addYhzhDiv();" class="syj-addbtn" style="position: absolute;margin-top: 2px;">添 加</a>
					</div>
					<table cellpadding="0" cellspacing="0" class="syj-table2">
						<tr>
						...
						<c:if test="${empty accountAndAgreementList}">
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="text" class="Wdate syj-input1" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false,maxDate:'%y-%M-%d'})"
											readonly="readonly" name="RELEASE_DATE"  placeholder="请选择发放日期" />
									</td>
									<th><font class="syj-color2">*</font>行政区划：</th>
									<td>
										
							            <input name="DIVISION" id="DIVISION" class="easyui-combotree"/>
								...
								<tr>
									...
									<td>
										<input type="text" class="Wdate  w280" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false,maxDate:'%y-%M-%d'})"
				...
				<div id="invoiceapplyDiv" style="display: none;">
					<div style="float: right; margin-right: 100px;">
						<a href="javascript:void(0);" onclick="javascript:addInvoiceApplyDiv();" class="syj-addbtn" style="position: absolute;margin-top: 2px;">添 加</a>
					</div>
					<table cellpadding="0" cellspacing="0" class="syj-table2">
						<tr>
					...
					<table cellpadding="0" cellspacing="0" class="syj-table2" id="invoiceapplyTable" style="table-layout: auto;">
			...
			<table cellpadding="0" cellspacing="0" class="syj-table2 ">
				...
				<tr>
					...
					<td colspan="3"><input type="text" class="syj-input1 validate[required],custom[vidcard]"  
						name="INSURANCE_IDNO" placeholder="请输入身份证号码"  value="${busRecord.INSURANCE_IDNO}"/></td>				
				</tr>
				<tr>
...
根据《中华人民共和国社会保险法》用人单位应当自成立之日起三十日内持单位印章，向当地社会保险经办机构申请办理养老、工伤保险登记。</font>
	...
	<c:if test="${requestParams.ISMEDICALREGISTER == '1' || busRecord.ISMEDICALREGISTER == '1'}">
		<div class="syj-title1 ">
			<span>医疗保险登记信息</span>
			<!-- <select   style="margin-left: 50px;" class="input-dropdown " onchange="setInfoMsg(this.value,'MEDICAL')">
		...
		<div style="position:relative;">
			<table cellpadding="0" cellspacing="0" class="syj-table2 ">
				...
				<tr>
					<th>经办人证件类型：</th>
					<td>
						<eve:eveselect clazz="input-dropdown validate[] w280" dataParams="DocumentType"
				...
				<tr class="zfgjj">
					...
					<td>
						<input type="text" class="syj-input1 inputBackgroundCcc validate[required],custom[JustNumber]" maxlength="8" readonly="readonly"
