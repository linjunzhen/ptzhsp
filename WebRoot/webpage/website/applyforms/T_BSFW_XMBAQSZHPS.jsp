...
<script type="text/javascript">
	$(function(){
		...
		if(EFLOW_FLOWOBJ){
    		...
    		if(eflowObj.busRecord){
    			FlowUtil.initFormFieldValue(eflowObj.busRecord,"T_BSFW_XMBAQSZHPS_FORM");
    		}
		}
	...
	function submitFlow(flowSubmitObj){
		 //先判断表单是否验证通过
	//	 var validateResult =$("#T_BSFW_XMBAQSZHPS_FORM").validationEngine("validate");
		 if(eWebEditor.getHTML()==null||eWebEditor.getHTML()==""){
			 layer.alert("请填写项目投资概况");
			 return null;
		 }
		 $("#NTZXMGK").val(eWebEditor.getHTML());
		 AppUtil.submitWebSiteFlowForm('T_BSFW_XMBAQSZHPS_FORM');
	}
...
<body style="background: #f0f0f0;">
	...
	<div class="eui-main">
	    ...
	    <form id="T_BSFW_XMBAQSZHPS_FORM" method="post" >
	    <%--===================重要的隐藏域内容=========== --%>
	        <%--开始引入公共隐藏域部分 --%>
		...
		<jsp:include page="./submitdiv.jsp" >
		     ...
		     <jsp:param value="AppUtil.tempSaveWebSiteFlowForm('T_BSFW_XMBAQSZHPS_FORM');" name="tempSaveFn"/>
		</jsp:include>
		<%--结束引入提交DIV界面 --%>
