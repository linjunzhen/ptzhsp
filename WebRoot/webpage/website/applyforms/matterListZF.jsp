...
<script type="text/javascript">
	...
	function onlineWord(materCode,fileId,materName){
		//政府投资
		var arrstr="345071904QT00201_03,345071904QT00202_02,345071904QT00204_03,34507190400204,345071904QT00205_02,345071904QT02302_01,345071904QT00206_12,345071904QT01801_12";
		//社会投资
		arrstr+="345071904QT02101_03,345071904QT01401_02,350128XK00111_01,350128XK00111_13,350128XK00110_01,350128XK00110_13,345071904QT01901_02,345071904QT01901_06,345071904QT02201_10";
		var rootpath='<%=path%>';
	...
	function getElectDocumentInfo(selectValue, attachKey, type) {
        ...
        if(typeof(projectCode)=="undefined" || projectCode==""){
        	projectCode="2018-350128-47-03-022986";
		}
        if(projectCode==""){
            alert("请填写投资项目编号");
            return;
...
<table cellpadding="0" cellspacing="1" class="tab_tk_pro1" style="margin: 10px 30px;width: calc(100% - 60px);">
	<tr>
