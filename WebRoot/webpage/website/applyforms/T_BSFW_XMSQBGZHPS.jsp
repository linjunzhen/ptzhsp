...
<script type="text/javascript">
	$(function(){
		...
		//	busTableName:"T_BSFW_XMSQBGZHPS"
		//});
		...
		if(EFLOW_FLOWOBJ){
    		...
    		if(eflowObj.busRecord){
    			FlowUtil.initFormFieldValue(eflowObj.busRecord,"T_BSFW_XMSQBGZHPS_FORM");
    		}
		}
	...
	function submitFlow(flowSubmitObj){
		 //先判断表单是否验证通过
	//	 var validateResult =$("#T_BSFW_XMSQBGZHPS_FORM").validationEngine("validate");
		 if(eWebEditor.getHTML()==null||eWebEditor.getHTML()==""){
			 layer.alert("请填写项目投资概况");
			 return null;
		 }
		 $("#NTZXMGK").val(eWebEditor.getHTML());
		 AppUtil.submitWebSiteFlowForm('T_BSFW_XMSQBGZHPS_FORM');
	}
...
<body style="background: #f0f0f0;">
	...
	<div class="eui-main">
    	<jsp:include page="./formtitle.jsp" />
   		<form id="T_BSFW_XMSQBGZHPS_FORM" method="post" >
    	<%--===================重要的隐藏域内容=========== --%>
	    <%--开始引入公共隐藏域部分 --%>
            ...
            <div class="bsboxC">
				<table cellpadding="0" cellspacing="0" class="bstable1">
					...
					<tr>
                        ...
                        <td>
                          <input type="text" maxlength="62" class="tab_text validate[required]" name="NTZXMC" /><a href="javascript:AppUtil.showProjectSelector('NTZXMC');" class="projectBtnA">选 择</a>
                        </td>
                        <th><span class="bscolor1">*</span> 投资人</th>
                        <td>
                          <input type="text" class="tab_text validate[required]" name="TZR" maxlength="14" />
                        </td>
                    </tr>
                    <tr>
                    	<th><span class="bscolor1">*</span> 项目负责人姓名</th>
                        <td>
                        <input type="text" maxlength="14" class="tab_text validate[required]" name="XMFZRXM" />
                        </td>
                        <th><span class="bscolor1">*</span> 项目负责人电话</th>
                        <td>
                        <input type="text" maxlength="14" class="tab_text validate[required,custom[mobilePhoneLoose]]" name="XMFZRDH" />
                        </td>
                    </tr>
                    <tr>
                    	<th><span class="bscolor1">*</span> 项目联系人姓名</th>
                        <td>
                        <input type="text" maxlength="14" class="tab_text validate[required]" name="XMLXRXM" />
                        </td>
                        <th><span class="bscolor1">*</span> 项目联系人电话</th>
                        <td>
                        <input type="text" maxlength="14" class="tab_text validate[required,custom[mobilePhoneLoose]]" name="XMLXRDH" />
                        </td>
                    </tr>
				</table>
            </div>
        ...
        <div class="bsbox clearfix">
        	<div class="bsboxT">
            	<ul>
                	<li class="on" style="background:none"><span>项目前期办理情况</span></li>
                </ul>
            </div>
            <div class="bsboxC">
				<table cellpadding="0" cellspacing="0" class="bstable1">
					<tr>			
						...
						<td colspan="3"><textarea name="GHXZJYDQK" cols="130" rows="10" maxlength="1998" class="validate[required]"></textarea></td>
					</tr>
				</table>
            </div>
        </div>
		...
		<jsp:include page="./submitdiv.jsp" >
		     ...
		     <jsp:param value="AppUtil.tempSaveWebSiteFlowForm('T_BSFW_XMSQBGZHPS_FORM');" name="tempSaveFn"/>
		</jsp:include>
		<%--结束引入提交DIV界面 --%>
        
        <%--引入阶段流程图 --%>
        <jsp:include page="tzxmjddetail.jsp" >
           <jsp:param value="SHTZ" name="TZLX"/>
           <jsp:param value="2" name="DQJD"/>
           <jsp:param value="1" name="DQLC"/>
        </jsp:include>
