...
<head>
	...
	<script type="text/javascript">
        function doSelectRows(){
            ...
            var IS_PREAPPROVAL_PASS = $("input[name='IS_PREAPPROVAL_PASS']:checked").val();
            ...
            var alertStr="";
            if(IS_PREAPPROVAL_PASS=="1"){
               //alertStr+="您选择已自主选用企业名称；</br>";
			}else{
                //alertStr+="您选择未自主选用企业名称；</br>";
			}
            ...
            if(ISNEEDSIGN=="1"){
                alertStr+="您选择办理无纸化营业执照；</br>";
            }else{
                alertStr+="您选择不办理无纸化营业执照；</br>";
            }
			if(ISGETBILL=="1"){
							...
							<div class="top-tap">
								<div style="margin-left: 50px;" class="colorOfChecked">
									...
									<!--<div class="qlist" style="border: 0;">
										<div class="problem">1.您是否已自主选用企业名称？</div>
										<div class="key">
											<label style="margin-right: 60px;">
												<input type="radio" name="IS_PREAPPROVAL_PASS" value="1"  checked="checked" />
												<span>是</span></label>
											<label>
												<input type="radio" name="IS_PREAPPROVAL_PASS" value="0"  onclick="toUrl('http://61.154.11.191/usermana/login.do?method=index')" />
												<span>否，新起名</span></label>
										</div>
									</div>-->
									...
									<div class="qlist">
										<div class="problem">2.您是否选择无纸化办理营业执照？</div>
										<div class="key">
											<label style="margin-right: 60px;">
												<input type="radio" name="ISNEEDSIGN" value="1"  />
												<span>是（预审通过后办理实名面签）</span></label>
											<label>
												<input type="radio" name="ISNEEDSIGN" value="0" checked="checked" />
												<span>否（提交纸质材料到窗口办理）</span></label>
										</div>
									</div>
									<div class="qlist">
										<div class="problem">3.您是否办理税务登记信息确认？</div>
										<div class="key">
											<label style="margin-right: 60px;">
									...
									<div class="qlist">
										<div class="problem">4.您是否选择办理社会保险登记？</div>
										<div class="key">
											<label style="margin-right: 60px;">
									...
									<div class="qlist">
										<div class="problem">5.您是否选择办理医疗保险登记？</div>
										<div class="key">
											<label style="margin-right: 60px;">
									...
									<div class="qlist">
										<div class="problem">6.您是否选择办理公积金登记？</div>
										<div class="key">
											<label style="margin-right: 60px;">
									...
									<div class="qlist" style="background: #f8f8f8">
										<div class="problem">7.您是否进行银行预约开户？</div>
										<div class="key">
											<label style="margin-right: 60px;">
									...
									<div class="qlist" style="background: #f8f8f8">
										<div class="problem">8.您的经营范围是否涉及前置审批或类金融项目？</div>
										<div class="key">
											<label style="margin-right: 60px;">
												<input type="radio" name="ISFIRSTAUDIT" value="1"  />
												<span>是（上传许可证及相关批文）</span></label></br>
											<label>
												<input type="radio" name="ISFIRSTAUDIT" value="0"  checked="checked"  />
												<span>否</span></label>
										</div>
									</div>
									<div class="qlist" style="background: #f8f8f8">
										<div class="problem">9.您是否需要邮寄营业执照和印章？</div>
										<div class="key">
											<label style="margin-right: 60px;">
												<input type="radio" name="ISEMAIL" value="1"  />
												<span>是（填写收件信息）</span></label>
											<label>
