...
<html>
<head>
<title>信件详情_平潭综合实验区行政服务中心</title>
...
<body>
    ...
    <div class="container lbpadding">
    	<div class="current"><span>您现在所在的位置：</span><a href="webSiteController/view.do">首页</a> > <a href="webSiteController/view.do?navTarget=website/hd/xsqx">咨询互动</a> > <i>信件详情</i></div>
                ...
                <div class="faq_detail">
					<table cellspacing="1" cellpadding="0">
						<tbody>
							<tr>
								<th>信件编号：</th>
								<td colspan="3"><pre class="word_break">${letter.LETTER_CODE} </pre></td>
							</tr>
							<tr>
								<th>信件标题：</th>
								<td colspan="3">${letter.LETTER_TITLE} </td>
							</tr>
							<tr>
								<th>信件内容：</th>
								<td colspan="3"><pre class="word_break">${letter.LETTER_CONTENT} </pre></td>
							</tr>
							<tr>
								<th>回复内容：</th>
								<td colspan="3"><pre class="word_break">${letter.REPLY_CONTENT} </pre></td>
							</tr>
							<tr>
								<th>回复时间：</th>
								<td colspan="3">${letter.REPLY_TIME} </td>
							</tr> 
							<tr>
								<th>来信人：</th>
								<td>${letter.LETTER_NAME} </td>
								<th>事件时间：</th>
								<td>${letter.LETTER_TIME} </td>
							</tr>   
							<tr>
								<th>事件地点：</th>
								<td>${letter.LETTER_PLACE} </td>
								<th></th>
								<td></td>
							</tr>                   
						</tbody>
