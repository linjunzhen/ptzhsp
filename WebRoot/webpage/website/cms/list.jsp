...
<body>
	...
	<div class="container lbpadding">
    	...
    	<div class="listMain clearfix">
            ...
            <div class="listR">
				<c:if test="${module.MODULE_ID == '101' || module.MODULE_ID == '49' || module.MODULE_ID == '483' || module.MODULE_ID == '262'}">
					<div>
						<input type="text" id="seachVal" style="height: 25px;width: 30%;"/>
						<a href="javascript:searchView()" class="Searchbtn">搜索</a>
					</div>
				</c:if>
