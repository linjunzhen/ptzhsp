...
function bskscx(){
		var sbh = $("#exeId").val().Trim();
		var cxmm = $("#bscxmm").val().Trim();
            ...
            <div class="margin10">
              <form class="form-common" method="post" id="bsjdcqForm" action="webSiteController/bsjdcx.do">
                <div class="card tmargin20">
                  <ul>
                      <li>
                        <input type="text" placeholder="请输入申报号" autocomplete="on" required maxlength="30" class="eve-input validate[required]" id="exeId" name="exeId" style="width:100%;">
                      </li>
                      <li class="noborder">
                        <input type="password" placeholder="请输入查询密码" autocomplete="on" required maxlength="8" class="textinput validate[required]" id="bscxmm" name="bscxmm" style="width:100%;">
                      </li>
                  </ul>
                </div>
                <button class="block tmargin20 btnbgcolor" onclick="bskscx();">查 询</button>
              </form>
              <div class="tmargin20">
                ...
                <div class="form-common card">
                  <ul class="listitem">
                      <li>
                        ...
                        <label class="label-right fontcolor"><span id="bjname"></span> </label>
                      </li><!-- 
                      <li>
                      ...
                      <li>
                        ...
                        <label class="label-right fontcolor"><span id="subdate"></span> </label>
                      </li>
                      <li>
                        <label class="label-left" style="font-size: 14px;">当前节点</label>
                        <label class="label-right fontcolor"><span id="curnode"></span> </label>
                      </li>
                      <li class="noborder">
                        <label class="label-left" style="font-size: 14px;">状态</label>
                        <label class="label-right fontcolor"><span id="curstate"></span> </label>
                      </li>
                  </ul>
                </div>
              </div>
