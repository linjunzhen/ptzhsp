	...
	$(function(){
		...
		if(dataObj){
    		...
    		if(dataObj.variableMap){
    			WordUtil.initFormFieldValue(dataObj.variableMap,"GCKXXYJBGPFFW");
    		}
    	}
    	//初始化input时宽度自适应
    	$("input").each(function(){
		...
		AppUtil.initWindowForm("GCKXXYJBGPFFW", function(form, valid) {
			if (valid) {
				$("input[type='submit']").attr("disabled","disabled");
				var formData = WordUtil.getFormEleData("GCKXXYJBGPFFW");
				var url = $("#GCKXXYJBGPFFW").attr("action");
...
<body>
	<form id="GCKXXYJBGPFFW" method="post" action="variableController.do?saveHtmlData">
		<!-- ==============开始引入通用的隐藏界面============= -->
		...
		<div class="eui-word">
			...
			<div class="eui-word-con">
				<div class="eui-word-xmbh">
					岚综实项目审批〔<input type="text" name="VB_KXXBGXMBHN_ST" data-validation-engine="validate[required]" class="eui-ipt1" style="width:60px"/>〕<input type="text" name="VB_KXXBGXMBHH_ST"  data-validation-engine="validate[required]" class="eui-ipt1" style="width:40px"/>号
				</div>
				...
				<div class="eui-word-title">
					平潭综合实验区关于<input type="text" class="eui-ipt"
						...
						name="VB_XMMC_ST" readonly="readonly"
						value="${SQData.blxmmc}" /><br />项目《可行性研究报告+》的批复
				</div>
				<div class="eui-word-name">
					<input type="text" class="eui-ipt"
						data-validation-engine="validate[required]" style="width:180px"
						name="VB_KXXBGXMSQR_ST" readonly="readonly" maxlength="50"
						value="${SQData.xmsqry}" />：
				</div>
				...
				<div class="eio-word-content">
					...
					<input type="text" class="eui-ipt1 laydate-icon" data-validation-engine="validate[required]"
						style="width:150px;height: 36px;" name="VB_KXXBGXMSLSJ_ST"	maxlength="16" value=""
						onclick="laydate({istime: false, format: 'YYYY年MM月DD日'})" />受理了你公司提出的项目《可行性研究报告+》申请，按照《行政许可法》第二十五条和第二十六条的规定，经审查，集中公示后，决定如下。
				<br>
					&nbsp;&nbsp;一、关于工程可行性的意见：<br>
					&nbsp;&nbsp;<textarea rows="6" 
					...
					name="VB_KXXBGXMQFYJ_GK_ST" ></textarea><br>
					&nbsp;&nbsp;二、关于节能审查的意见：<br>
					&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_KXXBGXMQFYJ_JN_ST" ></textarea><br>
					&nbsp;&nbsp;三、关于环境影响的审查意见：<br>
					&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_KXXBGXMQFYJ_HJ_ST" ></textarea><br>
					&nbsp;&nbsp;四、关于水土保持的意见：<br>
					&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_KXXBGXMQFYJ_ST_ST" ></textarea><br>
					&nbsp;&nbsp;五、资金来源审查的意见：<br>
					&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_KXXBGXMQFYJ_ZJ_ST" ></textarea><br>
					&nbsp;&nbsp;六、关于社会稳定风险的意见：<br>
					&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_KXXBGXMQFYJ_SH_ST" ></textarea><br>
					&nbsp;&nbsp;七、其他事项：<br>
					&nbsp;&nbsp;<textarea rows="6" 
					style="width: 95%;font-size:21px; vertical-align:top; overflow: hidden;line-height: 36px;"
					onpropertychange="this.style.height=this.scrollHeight + 'px'"
					oninput="this.style.height=this.scrollHeight + 'px'"
					name="VB_KXXBGXMQFYJ_QT_ST" ></textarea><br>
				</div>
				<div class="eui-word-bname">平潭综合实验区行政审批局</div>
				<div class="eui-word-time">
					<input type="text" class="eui-ipt1 laydate-icon"
						data-validation-engine="validate[required]"
						style="width:150px;height: 36px;" name="VB_KXXBGXMDQ_TIME_ST"
