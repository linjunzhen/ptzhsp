	...
	$(function(){
		...
		if(dataObj){
    		...
    		if(dataObj.variableMap){
    			WordUtil.initFormFieldValue(dataObj.variableMap,"GCKXXYJBGPFQPG");
    		}
    	}
    	//初始化input时宽度自适应
    	$("input").each(function(){
		...
		AppUtil.initWindowForm("GCKXXYJBGPFQPG", function(form, valid) {
			if (valid) {
				$("input[type='submit']").attr("disabled","disabled");
				var formData = WordUtil.getFormEleData("GCKXXYJBGPFQPG");
				var url = $("#GCKXXYJBGPFQPG").attr("action");
...
<body>
	<form id="GCKXXYJBGPFQPG" method="post" action="variableController.do?saveHtmlData">
		<!-- ==============开始引入通用的隐藏界面============= -->
			...
			<div class="eui-word-con">
				<div class="eui-word-title">
					平潭综合实验区关于<input type="text" class="eui-ipt"
						...
						name="VB_KXXBGSUBJECT_ST" readonly="readonly"
