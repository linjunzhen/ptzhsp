...
<script type="text/javascript">function doSelectRows(){
    ...
    if(rows.length==0){
        ...
        var readNames = "";
        var readCodes = "";
        art.dialog.data("selectLimitNodeNameInfo", {
        	readIds : readIds,
        	readNames : readNames,
        	readCodes : readCodes
        });
    ...
    <div class="easyui-layout" fit="true" >
        <div data-options="region:'center',split:false" style="width: 425px;">
            ...
            <table class="easyui-datagrid" rownumbers="true" pagination="true"
                ...
                url="readTemplateController.do?limitNodeNameDatagrid">
                <thead>
                    <tr>
        ...
        <div data-options="region:'east',split:false" style="width: 375px;">
            ...
            <table class="easyui-datagrid" rownumbers="true" id="SelectedReadGrid" 
                ...
                method="post" idField="DIC_ID" checkOnSelect="false" url="readTemplateController.do?limitNodeNameSelected&readIds=${readIds}"
