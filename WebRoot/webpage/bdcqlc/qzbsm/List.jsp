...
<script type="text/javascript">
    ...
    function editBdcDwspGridRecord() {
        var entityId = AppUtil.getEditDataGridRecord("BdcQlcQzPrintGrid");
        if (entityId) {
    ...
    function formatSubject(val,row){
        ...
        var href = "<a href='";
        href += "executionController.do?goBdcFzjfmx&exeId="+exeId+"&bdc_optype=1";
        /* if(taskStatus!="1"){
    ...
    $(document).ready(function() {
        var start1 = {
            elem : "#BdcqlcT.CREATE_TIME_BEGIN",
            format : "YYYY-MM-DD",
            istime : false,
...
<div class="easyui-layout eui-jh-box" fit="true">
    <div region="center">
                    ...
                    <tbody>
                        ...
                        <tr style="height:28px;">
                            ...
                            <td style="width:135px;padding-left:4px;"><input type="text"
                                ...
                                id="BdcqlcT.CREATE_TIME_BEGIN" name="Q_E.CREATE_TIME_>=" /></td>
                            <td style="width:68px;text-align:right;">申请日期至</td>
                            <td style="width:135px;padding-left:4px;"><input type="text"
                                style="width:108px;float:left;" class="laydate-icon"
                                id="BdcQlcT.CREATE_TIME_END" name="Q_E.CREATE_TIME_<=" /></td>
                            ...
                            <td colspan="2"><input type="button" value="查询"
                                class="eve-button"
                                onclick="AppUtil.gridDoSearch('BdcQlcQzPrintToolbar','BdcQlcQzPrintGrid')" />
        ...
        <table class="easyui-datagrid" rownumbers="true" pagination="true" striped="true"
            id="BdcQlcQzPrintGrid" fitcolumns="false" toolbar="#BdcQlcQzPrintToolbar"
            method="post" idfield="EVEID" checkonselect="false"
            selectoncheck="false" fit="true" border="false" nowrap="false"
            url="bdcQlcSffzInfoController.do?qzprintdatagrid">
            <thead>
                <tr>
